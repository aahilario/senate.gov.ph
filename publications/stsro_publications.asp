	...
	<tr>
		...
		<div class="pubitem">
			<div class="alight">
				...
				<small>March 2018 (1.1 MB)</small><p>
...
<p class="auto-style1"><a href="STSRO/SKMBT_42114112617061.pdf">COCCTRP Materials</a></p>
		
		<div class="pubitem"><div class="alight">
		<p>
		Materials for the 2014 Second Meeting of the Joint Congressional Oversight Committee on the Comprehensive Tax Reform Program (COCCTRP)
				
		<a href="STSRO/SKMBT_42114112617061.pdf">(download)</a><p>
					Letter of BIR Commissioner Henares to the COCCTRP dated 12 November 2014<a href="STSRO/SKMBT_42114112617060.pdf"> 
					(download)</a><br />
				<br />
			<table class="publist">
			</table>
		...
		<p class="auto-style1">Tax Bits</p>
		...
		<small>September - October 2018 (3.7 MB)</small><p>
 ...
 <p>
		...
		<small>May - June 2018 (5.26 MB)</small><p>
			Whether it is purely coincidental or largely relative, consumer prices have been rising steadily since the start of implementation of Republic Act No. 10963 or the “Tax Reform for Acceleration and Inclusion (TRAIN)” in January this year. Heading off from a moderate annual rate of 2.9% in 2017, year-on-year headline inflation in 2018 rose to 3.4% in January; increased to 3.8% in February and accelerated further to 4.3% and 4.5% in March and April, respectively.<p>
			<br />
		<br />
		</div></div>
		...
		<small>March - April 2018 (6.7MB)</small><p>
			2018 started on a high note with the effectivity of Republic Act No. 10963 or the Tax Reform for Acceleration and Inclusion (TRAIN) Law on the very first day of the year.<p>
			<br />
		<br />
		</div></div>
		...
		<small>January - February 2018 (7.8MB)</small><p>
			...
			<p>
			Republic Act (RA) No. 10963 is based on Senate Bill (SB) No. 1592 which consolidates 31 Senate Bills and 3 House Bills and 3 Senate Resolutions.<br />
		<br />
		</div></div>
		...
		<small>November - December 2017 (5MB)</small><p>
			Taxation and tax reforms have been primarily used as policy 
			instruments to achieve a set of economic and fiscal goals. According 
			to Rao1 (2014) tax reforms are generally undertaken to improve the 
			efficiency of tax administration and to maximize the economic and 
			social benefits that can be achieved through the tax system.<br />
		<br />
		</div></div>
		...
		The Senate Tax Study and Research Office (STSRO) held its 2nd tax forum entitled “Taxation in a Federal
...
the tax implications of such a move. 					
		...
		<div id="h_TB">
		<p><a href="javascript:ShowHide('TB')">more...</a></p>
		</div>
		...
		<table class="publist">
			...
			<!--	<li>
				...
				<td style="width: 250px">
					...
					<span>POINTS TO CONSIDER IN EVALUATING AN ANTI-SMUGGLING BILL</span><br />
