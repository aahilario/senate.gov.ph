...
<title>Site Map - Senate of the Philippines</title>
					...
					<tr>
						...
						<ul>
							<li><a href="index.html">Home</a><ul>
								<li>
								<a href="lis.aspx" target="_blank">Legislative Information System</a></li>
								<li>
								<a href="http://post.senate.gov.ph/cgi-bin/sqwebmail">Senate WebMail</a></li>
								<!--<li>
								<a href="http://library.senate.gov.ph/">Library Service</a></li>-->
								<li>
								<a href="sp.aspx">Senate SharePoint Site</a></li>
								<li>
								<a href="hrms/onlineleave_hrms.aspx">HRMS Online Leave Application</a><br />
								&nbsp;</li>
							</ul>
							</li>
							<li><a href="photos.aspx?year=2020&amp;p=1">Photo archives</a>
							<a href="rss/rss_photos.aspx">
							<img src="images/feed10.png" alt="Latest Photo Feed" /></a><br />
							&nbsp;</li>
							<li><a href="news.asp?year=2020">News archives</a>
							<a href="rss/rss_news.aspx">
							<img src="images/feed10.png" alt="Latest News Feed" /></a><br />
							&nbsp;</li>
							<li>About<ul>
								<li><a href="http://senate.gov.ph/about/rules.asp">Rules 
								of the Senate</a><ul>
									<li><a href="about/procedure.pdf">Rules of Procedure Governing 
									<br />
								Inquiries in Aid of Legislation</a><br />
									</li>
								</ul>
								</li>
							</ul>
							<ul>
								<li><a href="about/history.asp">History of the Senate</a></li>
								<li>
								<a href="about/symbols&#32;of&#32;authority.asp">Symbols of Authority</a></li>
	<!--								
								<li><a href="">Powers and 
								Functions</a></li>
	-->
								<li><a href="about/legpro.asp">Legislative Process</a><br />
								&nbsp;</li>
							</ul>
							</li>
							<li>Senators<ul>
								<li><a href="senators/sen16th.asp">16th Congress Senators</a></li>
								<li><a href="senators/senlist.asp">List of Previous Senators</a></li>
								<li><a href="senators/roll.asp">Roll 
								of Senate Presidents</a></li>
								<li><a href="senators/composition.asp">Composition of the Senate</a></li>
								<li><a href="senators/terms.asp">Term of Office &amp; Privileges</a><br />
								&nbsp;</li>
							</ul>
							</li>
							<li>Committees<ul>
								<li><a href="committee/list.asp">List of 
							Committees</a></li>
								<li><a href="committee/duties.asp">Duties, Power and Jurisdiction</a></li>
								<li><a href="http://senate.gov.ph/committee/ctte_mem.pdf">Committee Directory</a>
								<img src="images/pdf1.gif" alt="Adobe PDF" /></li>
								<li><a href="http://senate.gov.ph/committee/oversight_mem.pdf">Ad hoc/Oversight Committee Directory</a>
								<img src="images/pdf1.gif" alt="Adobe PDF" /></li>
						<!-- 	<li><a href="spotreport.asp">Committee 
							Spot Reports</a></li>-->
								<li><a href="http://senate.gov.ph/committee/notice_ctte.asp">Notice of Committee Meetings</a></li>
								<li><a href="committee/schedwk.asp">Committee Schedule</a></li>
							</ul>
							</li>
						</ul>
						...
						<ul>
							<li>Secretariat<ul>
								<li><a href="secretariat/officers.asp">
								Officers of the Secretariat</a></li>
								<li><a href="secretariat/osec.asp">
								Office of the Secretary</a></li>
								<li><a href="secretariat/leg.asp">
								Legislation</a></li>
								<li><a href="secretariat/extaffairs.asp">
								External Affairs and Relations</a></li>
								<li><a href="secretariat/admin.asp">
								Administration and Financial 
								Services</a></li>
								<li><a href="secretariat/osaa.asp">
								Office of the Sergeant-At-Arms</a></li>
							</ul></li>
						</ul>

						<ul>
							<li>Legislative Documents<ul>
								<li><a href="lis/leg_sys.aspx?congress=16&amp;type=bill">Bills</a>
								</li>
								<li><a href="lis/leg_sys.aspx?congress=16&amp;type=resolution">Resolutions</a>
								</li>
								<li><a href="lis/leg_sys.aspx?congress=16&amp;type=journal">Journals</a>
								</li>
								<li><a href="lis/leg_sys.aspx?congress=16&amp;type=committee_rpt">Committee Reports</a>
								</li>
								<li><a href="lis/pdf_sys.aspx?congress=16&amp;type=republic_act">Republic Acts</a>
								</li>
								<li><a href="lis/pdf_sys.aspx?congress=16&amp;type=adopted_res">Adopted Resolutions</a>
								</li>
								<li>
								<a href="16th_congress/treaties_16thcongress.asp">Treaties</a>
								</li>
								<li><a href="statistical.pdf">Statistical Data</a>
								</li>
							</ul></li>
						</ul>
						...
						<ul>
							<li>Publications<ul>
								<li>
								<a href="publications/sepo_publications.asp">SEPO Publications</a>
								</li>
								<li>
								<a href="publications/stsro_publications.asp">STSRO Publications</a>
								</li>
								<li>
								<a href="publications/lbrmo_publications.asp">LBMRO Publications</a>
								</li>
								<li>
								<a href="publications/ils_publications.asp">ILS Publications</a>
								</li>
								<li>
								<a href="publications/other_publications.asp">Other Publications</a><br />&nbsp;
								</li>
							</ul></li>
						</ul>
						...
						<ul>
						<!--	<li>
							<a href="publications.asp">
							Senate Economic Planning Office (SEPO) 
							Publications</a><br />&nbsp;</li>-->
							<li><a href="photo_gallery/gallery.aspx">Gallery</a><br />&nbsp;</li>
	<!--						<li><a href="invitebid.asp"></li>-->
							<li><a href="invitation_bid.asp">Invitation to Bid</a></a><br />&nbsp;</li>
							<li><a href="http://senate.gov.ph/contact.asp">Contact 
							Information</a><br />&nbsp;</li>
							<li><a href="rss.asp">RSS Feeds</a> <a href="rss.asp"><img src="images/feed10.png" alt="RSS Feeds" /></a><br />&nbsp;</li>
