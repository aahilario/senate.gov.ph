...
<title>Office of the Sergeant-At-Arms - Senate of the Philippines</title>
...
<td>&nbsp;<a href="http://www.newsenatebuilding.com">Bagong Senado</a></td></tr></table></div></div>
   <table id="container">
      <tr>
         <td id="content">
					<p class="h1_bold">
			        	Office of the Sergeant-At-Arms</p>
						...
						<div id="Secretariat_list">
							<div id="h_OSAA">
							<p><a href="javascript:ShowHide('OSAA')">Office of the Sergeant-At-Arms</a></p>
							</div>
							<div id="OSAA" class="iL1">
								<p class="OfficeDesc">The Office of the 
								Sergeant-at-Arms is responsible for the security 
								and maintenance of order in the Senate in 
								accordance with the orders of the Senate 
								President or Secretary. It provides physical and 
								logical security for the members of the Senate 
								and their staff, offices of the Secretariat and 
								all properties located within its premises.</p>
								<table>
									<tr>
									...
									<tr>
										...
										<td>MGen Rene C Samonte AFP (Ret), Senate 
										Sergeant-at-Arms<br />
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>(632) 8-552-6601 to 6670 loc. 1403 / 06, 
										(632) 8-552-6866-67</td>
									</tr>
								</table>
							</div>

							<div id="h_SES">
							<p><a href="javascript:ShowHide('SES')">Security Enforcement Service</a></p>
							</div>
							<div id="SES" class="iL1">
								<p class="OfficeDesc">Security 
								Enforcement Service is responsible for the 
								implementation of security rules and regulations 
								of the Senate, vis-à-vis the protection of the 
								Senators, Senate employees, guests and all 
								properties found therein. It coordinates with 
								other government agencies when the need arises 
								in the implementation of security measures. 
								Aside from the physical security, the SES 
								maintains a round-the-clock communications 
								network. It also has a CCTV surveillance system 
								for electronic monitoring.</p>
								<table>
									<tr>
										<th class="OfficeLeftCol"></th>
										<th></th>
									...
									<tr>
										<td>Head of Office</td>
										<td>Manuel Parlade, Director III<br />
										Gil Valdez, Director II</td>
									</tr>
									<tr>
										<td>Contact Numbers</td>
										<td>(632) 8-552-6601 to 6670 loc. 1402, 
										(632) 8-552-6893</td>
									</tr>
								</table>
							</div>
							...
							<div id="h_SSS">
							<p><a href="javascript:ShowHide('SSS')">Security Support Service</a></p>
							</div>
							<div id="SSS" class="iL1">
								<p class="OfficeDesc">Security Support 
								Service is the administrative arm of the Office 
								of Sergeant-at-Arms. It is responsible for 
								policy drafting and review; administrative 
								disciplinary investigation; subpoena and warrant 
								service; logistics and supplies; legislative 
								paging; ID design and issuance; and OSAA 
								training and welfare.</p>
								<table>
									<tr>
										<th class="OfficeLeftCol"></th>
										<th></th>
									...
									<tr>
										<td>Head of Office</td>
										<td>Anthony A. Samonte, Director III<br />
										Felicisima P. Dato, Director II</td>
									</tr>
									<tr>
										<td>Contact Numbers</td>
										<td>(632) 8-552-6601 to 6670 loc. 1408, 
										(632) 8-552-6828</td>
									</tr>								
								</table>
							</div>
