...
<!-- file generated by WebNewsGen 100809 on 2/10/2014 3:31:28 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Chiz: LTO, LTFRB liable to reduce road crashes</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->CHIZ: LTO, LTFRB LIABLE TO REDUCE ROAD CRASHES<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator Chiz Escudero tasked the Land Transportation Office and the Land Transportation Franchising and Regulatory Board to lessen the number of road crashes in the country.</p>
<p style="text-align: justify">Escudero reacted following the recent spate of fatal road accidents involving public utility vehicles (PUVs) especially buses,  in different parts of the country and the metropolis.</p>
<p style="text-align: justify">"There is no guarantee to prevent all road accidents because of many factors including human, mechanical and environmental. But regulators like the LTO and the LTFRB carry the weight of preventing fatal accidents before these happen by strictly implementing the road safety fundamentals of all public utility vehicles. They have the responsibility to make all public transportations reasonably safe to drive and to travel on."</p>
<p style="text-align: justify">The senator said these two agencies should conduct strict, regular inspections of all PUVs not only when an accident has already occurred.</p>
<p style="text-align: justify">"These regulators must do their jobs. Stern measures need to be strictly implemented to ensure road safety. Conscious efforts from all sectors of government and the society should be at high level to avoid further loss of lives and damage to person and property."</p>
<p style="text-align: justify">Escudero said these agencies should totally cleanse its system from fixers who make skirting around the rules possible, for a fee. "Every year a vehicle needs to be registered; its engine needs to be inspected for safety. Every year emission standards need to be met. If LTO and LTFRB are just implementing these rules with hawk's eyes, then the number of vehicular crashes can be minimized."</p>
<p style="text-align: justify">As this developed, Escudero introduced Senate Bill Number 123 (SBN 123) which penalizes bus drivers who commit criminal negligence in road mishaps with 20 years of imprisonment once the bill passes. The senator wants to provide more teeth to existing preventive policies to achieve safety benefits.</p>
<p style="text-align: justify">Common carriers' criminal liability is found in Article 365 of the Revised Penal Code, Criminal Negligence, which provides as penalty of imprisonment arresto mayor to prision correccional or from one (1) month to four (4) years and two (2) months, depending on the gravity of the resultant crime or felony.</p>
<p style="text-align: justify">Escudero said these penalties may no longer be apt with the way common carriers, especially buses, have lightly treated their obligation under existing laws. He added that the culture of carelessness among buses or common carriers is already too alarming too ignore.</p>
<p style="text-align: justify">"As a matter of fundamental statutory policy, common carriers are required to carry their passengers safely as far as human care and foresight can provide, using utmost diligence of very cautious persons, with due regard for all the circumstances."</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
