...
<!-- file generated by WebNewsGen 100809 on 9/15/2014 6:53:55 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Angara to BIR: Simplify tax system to encourage Pinoys to pay taxes</title>
...
Press Release<br />
<!-- NewsDate.start -->September 14, 2014<!-- NewsDate.end -->
...
<span class="PRTitle"><!-- NewsTitle.start -->ANGARA TO BIR: SIMPLIFY TAX SYSTEM 
<br />
TO ENCOURAGE PINOYS TO PAY TAXES<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator Sonny Angara has urged the Bureau of Internal Revenue (BIR) to simplify the tax system to encourage more Filipinos, especially self-employed individuals, to pay their taxes.</p>
...
<p style="text-align: justify">"Tapos marami pang kailangan i-fill up na mga form. Eh minsan, kapag hindi naintindihan ng ordinaryong tao 'yan, matatakot sila na baka makikilan pa sila. Dyan pwedeng magumpisa ang korapsyon, fixing at kotongan," he added.</p>
<p style="text-align: justify">During previous hearings on tax reform measures, the chair has emphasized the need to make the requirements simple particularly to the informal sector.</p>
<p style="text-align: justify">At present, BIR registration and documentary requirements include birth certificate, mayor's permit, Department of Trade and Industry certificate of business name, Professional Regulation Commission ID, and payment of professional tax receipt.</p>
<p style="text-align: justify">Taxpayers must also pay a registration fee of P500 annually, apply for invoices, and register their books of accounts.</p>
<p style="text-align: justify">A tax return should then be filed monthly for percentage tax, quarterly and annually for income tax, and monthly and quarterly for value added tax, even when there is no payment to be made.</p>
<p style="text-align: justify">"It's already proven that a complicated tax system does not work in our country. Marami ngang nagsasabi na gusto naman nila magbayad ng buwis pero pinapatagal at pinapahirapan pa sila. So dapat mas kaunti talaga ang forms at requirements," said Angara, who also authored a bill that aims to lower income tax rates in the country.</p>
<p style="text-align: justify">The senator suggested to BIR to impose just a one-time payment--a flat fee of P100 a year--to the national and local government for small entrepreneurs and informal economy workers in lieu of all taxes due in a year.</p>
<p style="text-align: justify">In fact, since his days in Congress, Angara has been pushing for the Magna Carta of Workers in Informal Economy (MACWIE) that seeks to exempt informal economy workers, business, enterprise or organization from all taxes, national or local.</p>
<p style="text-align: justify">Under Senate Bill 1941 or the MACWIE, informal economy workers include small farmers and fisherfolks, sari-sari store owners, sidewalk vendors, tricycle and jeepney drivers, domestic workers, among others.</p>
<p style="text-align: justify">The bill only requires a simple and standard system of accreditation with a one-time fee of not more than P50 for an individual worker and not less than P100 for business, enterprise and organization.</p>
<p style="text-align: justify">Moreover, the lawmaker noted that under the Anti-Red Tape Law, all government agencies are required to undertake time and motion studies of transactions to reduce processing time and bureaucratic red tape.</p>
<p style="text-align: justify">"We already requested from BIR their time and motion studies so we can look into how long it takes for a taxpayer to file, register and pay their taxes, and see how we can simplify and shorten the process," he said.</p>
<p style="text-align: justify">The BIR is currently running a public information campaign that shows the basic steps that a taxpayer should follow to comply with the right payment of taxes. The BIR's campaign carries the tagline, "I love the Philippines. I pay my taxes right. It's as easy as RFP," which stands for register, file and pay.</p>
<p style="text-align: justify">"The efforts of the BIR to inform the public is commendable but this might not be enough. What we need to do is to incentivize our taxpayers, especially the informal sector. We should make it easy for them to comply for us to be able to widen our tax base," Angara said.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
