...
<!-- file generated by WebNewsGen 100809 on 2/24/2014 7:29:26 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Trillanes: Teachers deserve higher pay</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Trillanes: Teachers deserve higher pay<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">In recognition of the essential role of teachers as the prime movers of the education system, Senator Antonio "Sonny" F. Trillanes IV files Senate Bill No. 487, increasing the minimum salary grade of public school teachers from salary grade 11 to 20.</p>
<p style="text-align: justify">Trillanes said "Public school teachers are considered the most underpaid and overworked professionals in the society. Their low compensation belies the vital role they play in molding our youth. "</p>
<p style="text-align: justify">Under SBN 487, the minimum salary grade of teachers will increase to Salary Grade 20, which is equivalent to P36,567.00 based on the present Salary Standardization Law, from the present Salary Grade 11, which is equivalent to P18,549.00.</p>
<p style="text-align: justify">The Department of Education (DepEd) shall be tasked to create a specific programmed budget needed to cover the expenses for the upgrading in salary levels for all the corresponding teacher plantilla positions over a period of three (3) years, allowing the Department of Budget and Management (DBM) to make the necessary budgetary adjustments to facilitate the smooth implementation of this Act.</p>
<p style="text-align: justify">"This measure fulfills the mandate of our Constitution for the government to 'assign the highest budgetary priority to education and ensure that teaching will attract and retain its rightful share of the best available talents through adequate remuneration.' We hope that the immediate passage of this bill will boost the morale of and provide more vigor to our teachers to further assist the government in enhancing the quality of education in our country," Trillanes, co-author of the Salary Standardization Law 3, explained.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
