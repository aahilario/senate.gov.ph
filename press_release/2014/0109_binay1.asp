...
<!-- file generated by WebNewsGen 100809 on 1/9/2014 12:21:37 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Nancy bothered by DOH statements on measles</title>
...
Press Release<br />
<!-- NewsDate.start -->January 9, 2014<!-- NewsDate.end -->
...
<span class="PRSuper"><!-- NewsTitleSuper.start -->Can gov't deliver a 'zero' measles target in 2017?<!-- NewsTitleSuper.end --></span><br />
<span class="PRTitle"><!-- NewsTitle.start -->NANCY BOTHERED BY DOH STATEMENTS ON MEASLES<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator Nancy Binay is bothered by the statements of Department of Health (DOH) officials directing the blame on parents or super typhoon "Yolanda" survivors for the measles outbreak in Metro Manila and other parts of the country.</p>
<p style="text-align: justify">"Instead of blaming parents and survivors of super typhoon 'Yolanda' for the measles outbreak, the DOH should act now to stem any epidemic," Binay said.</p>
<p style="text-align: justify">She added that the DOH should also assess the apparent failure of the government's anti-measles campaign over the past years.</p>
<p style="text-align: justify">"For DOH to blame people outside the organization is bothering when they have the mandate to abate, control and monitor public health," Binay added.</p>
<p style="text-align: justify">The senator noted that if the DOH had the capability to conduct a door-to-door campaign for the first round of the measles immunization shots, "then they have the capability to do it one more time."</p>
<p style="text-align: justify">"A government agency has the resources it needs to ensure its objectives are met. In this case targeting a 'zero' measles environment," she said.</p>
<p style="text-align: justify">Free vaccinations are supposed to be given to children between 6 and 48 months old and are given in two doses of MMR (measles, mumps and rubella) jab.</p>
<p style="text-align: justify">"It's frustrating that the DOH is putting the onus on the parents themselves or on Yolanda survivors for bringing the virus here in Metro Manila," Binay said.</p>
<p style="text-align: justify">The DOH can always ask the help of the local government units (LGUs) for the implementation and ensure success of its immunization programs, she added.</p>
<p style="text-align: justify">Binay earlier voiced her frustration over the apparent collapse of the DOH's "Ligtas Tigdas" immunization programs for the last 15 years.</p>
...
<p style="text-align: justify">She added that the DOH made the promise to eradicate the disease as early as 2008, but is now upping the target year to 2017, 20 years after the pledge was delivered.</p>
<p style="text-align: justify">"Kung isinisisi ng DOH sa mga magulang ang pagkabigo o pagbagsak ng programa, ganito rin ba ang gagawin nila sa ibang nakalinyang programa tulad ng implementasyon ng RH Law? Ganito rin ba ang sigasig na ipapakita nila?" she asked.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
