...
<!-- file generated by WebNewsGen 100809 on 11/4/2014 2:09:07 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Implement Salary Grade 15 for Entry-Level Public Nurses - Sen. Bam to DBM</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Implement Salary Grade 15 for Entry-Level 
<br />
Public Nurses - Sen. Bam to DBM<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator Bam Aquino has asked the Department of Budget and Management (DBM) to fully implement the law which provides salary grade 15 to entry-level government nurses.</p>
<p style="text-align: justify">"The DBM should provide the necessary funding so that the salary grade 15 mandated by law for entry-level government nurses must be fulfilled," Aquino said during the hearing of the Committee on Civil Service and Government Reorganization.</p>
<p style="text-align: justify">According to latest data from the Department of Health (DOH), approximately P450 million is needed to fully implement the salary mandated by Republic Act No. 9173 or The Philippine Nursing Act of 2002.</p>
<p style="text-align: justify">When asked by Aquino on why RA 9173 is not being implemented, DOH Undersecretary Teodoro Herbosa blamed the lack of funding from the DBM for its failure.</p>
<p style="text-align: justify">The DBM, for its part, admitted that DOH has already created nursing positions starting at salary grade 15.</p>
<p style="text-align: justify">However, the DBM said it cannot implement the salary grade adjustment because it will ruin the hierarchal relationship with other medical and allied positions.</p>
<p style="text-align: justify">"We seek that the law be fully implemented and give the nurses their proper compensation," Aquino stressed.   "This is the budget season. This is the best time to talk about it so the law can be funded," Aquino stressed.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
