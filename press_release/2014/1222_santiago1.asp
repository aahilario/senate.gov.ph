...
<!-- file generated by WebNewsGen 100809 on 12/22/2014 3:28:27 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Miriam wants Senate to investigate the alleged squandered P2.7b pork in 2013</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->MIRIAM WANTS SENATE TO INVESTIGATE THE ALLEGED SQUANDERED P2.7B PORK IN 2013<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Sen. Miriam Defensor Santiago filed a resolution on Monday, 22 December, for the Senate to conduct an inquiry, in aid of legislation, following the Commission on Audit's (COA) report that some governors and mayors misused P2.7 billion in pork barrel funds in 2013.</p>
<p style="text-align: justify">According to COA, at least P1.035 billion of the allocations given by representatives and senators were used "inappropriately" through projects that were not specified in the special allotment release orders (Saro) of the Priority Development Assistance Fund (PDAF).</p>
<p style="text-align: justify">Further, a number of local government units (LGUs) exceeded the cash limits in paying cash advances for pork barrel projects, did not follow National Budget Circular (NBC) No. 537 which aims to enforce strict guidelines on the use of pork barrel funds, and did not return the PDAF funds after it was declared unconstitutional by the Supreme Court.</p>
<p style="text-align: justify">Some of the LGUs mentioned were those in Metro Manila, Western Visayas, Bicol, Calabarzon, Cagayan Valley, Central Visayas, and Ilocos, among others.</p>
<p style="text-align: justify">Santiago said that whatever remaining PDAF allocations must be remitted immediately to the National Treasury, following the Supreme Court decision declaring the pork barrel system unconstitutional.</p>
<p style="text-align: justify">She urged the Senate to strictly monitor public funds against ghost projects so that transparency can be practiced in all stages of the implementation of projects.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
