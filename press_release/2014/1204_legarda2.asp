...
<!-- file generated by WebNewsGen 100809 on 12/4/2014 2:00:28 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Legarda to LGUs in Ruby Path: Relay Info to Citizens</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Legarda to LGUs in Ruby Path: Relay Info to Citizens<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator Loren Legarda today called on all local government units  (LGUs) in the forecasted path of Typhoon Ruby to ensure that information about the storm is relayed to citizens so that everyone is prepared.</p>
<p style="text-align: justify">Legarda, Chair of the Senate Committee on Climate Change, said it is crucial for LGUs, including barangay officials, to conduct information dissemination campaign on the strength of the typhoon and its effects including expected storm surges, and the community evacuation plan.</p>
<p style="text-align: justify">"Every barangay should gather their citizens or have roaming officials to inform citizens of the effects of the coming typhoon and the preparedness measures that every family should undertake. Are we expecting a storm surge? Then, we should warn our communities of the expected height of the waves and how far inland the flooding would reach. This would help us ensure that people are evacuated in safe places that would not be reached by the storm surge," she said.</p>
<p style="text-align: justify">The Senator also reminded government agencies to carry out their respective duties in preparing for the typhoon.</p>
<p style="text-align: justify">"We should all be on heightened alert now as the storm has entered the Philippine Area of Responsibility. We remind LGUs to ensure that all canals and drainage systems are cleaned up and no families are living in high-risk areas, release frequently updated advisories and ensure that areas expected to be affected are prepared--activate all forms of early warning systems, set up evacuation centers, evacuate families living in landslide-prone and flood-prone areas," said Legarda.</p>
<p style="text-align: justify">She added that LGUs should implement forced evacuation when called for.  Shelters for evacuees should be well designed, built strong, and prepared ahead of time with emergency supplies of food, water, medicine, shelter, and toiletries, while government agencies are ready to augment the basic needs of evacuees.</p>
<p style="text-align: justify">Moreover, local disaster risk reduction and management officers should be alert. Quick communication, particularly real-time updates, is also vital in ensuring effective disaster response with first responders and search and rescue teams ready for dispatch anytime.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
