...
<!-- file generated by WebNewsGen 100809 on 9/23/2014 3:56:34 PM -->
<head>
...
<!-- NewsBody.start -->
<p style="text-align: justify">Q: On giving President Aquino additional powers</p>
<p style="text-align: justify">SPFMD: I have not received any, I do not know if it was sent directly to Senator Osme&ntilde;a, but I have informed the Palace that we cannot pass it by the end of September as they have requested. Given the fact that this will cover appropriation of about P6 billion, hindi po pwedeng bilisan ito at P6 billion ang hinihinging appropriation, kaya hindi po namin matalakay itong Setyembre. Pagbalik sa Oktubre, yan po ay aming titingnan ngunit si Senator Osme&ntilde;a, pagkaalam ko, may naka-set na mga hearings.</p>
<p style="text-align: justify">What I believe should happen is that we recognize the need for additional authority to acquire additional capacity, but we should do this as the last resort, we must first examine other options which will address the problem, if it can be done, without the need for additional capacity being acquired. Example, there is one plant, the Ilijan power plant, which is generating less than its full capacity, only half of its capacity, and number two, the Malaya plant. We should look at what is wrong with it and if it can be rehabilitated, because according to PSALM during the budget hearings, they would want to determine if what is needed is overhaul of the machine, which will only cost P90 million. These things we must examine.   They should give us a report as to why this is not possible; these other options are not possible.</p>
<p style="text-align: justify">Q: Is reviving the BNPP part of the options?</p>
<p style="text-align: justify">SPFMD: Hindi kasama.</p>
<p style="text-align: justify">Q: Kung makarating po yung draft, is it possible na magkaroon ng hearing before the break?</p>
<p style="text-align: justify">SPFMD: Yes, hearings over the break are allowed over existing resolutions.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
