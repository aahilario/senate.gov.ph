...
<!-- file generated by WebNewsGen 100809 on 10/29/2014 11:36:03 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Legarda: Include PWDs, Elderly in Disaster Resilience Efforts</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Legarda: Include PWDs, Elderly in Disaster Resilience Efforts<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator Loren Legarda today called for the inclusion of every citizen, including persons with disabilities (PWDs) and older persons, in the country's disaster risk reduction and management programs.</p>
<p style="text-align: justify">Speaking at the Symposium for the International Day for Disaster Reduction and ASEAN Day for Disaster Management, which was organized by the National Disaster Risk Reduction and Management Council (NDRRMC), Legarda stressed that "building resilience should be everybody's attitude," hence, even the PWDs and the elderly should be involved in disaster resilience efforts as their special needs are being addressed as well.</p>
...
<p style="text-align: justify">In the past years, the United Nations Office for Disaster Risk Reduction (UNISDR) has been highlighting the needs and strengths of various members of society. In 2013, the focus was on PWDs. For 2014, the vulnerability and strengths of the elderly were highlighted. Meanwhile, this year's ASEAN Day for Disaster Management focuses on the importance of the active participation of everyone in ensuring resilience of communities during disasters.</p>
<p style="text-align: justify">Legarda, the UNISDR Champion for Disaster Risk Reduction and Climate Change Adaptation for Asia-Pacific, said that PWDs are disproportionately affected by disasters. A survey by the UNISDR among persons with disabilities revealed that, if a disaster occurs, 80% said they would be unable to evacuate immediately without difficulty, while six percent said they would not be able to evacuate at all.</p>
...
<p style="text-align: justify">"Our PWDs are twice more likely to lose their lives or be injured than any other person, but their disability does not mean inability. Actually, they can and should be active partners in making communities safer and more resilient," said Legarda.</p>
...
<p style="text-align: justify">"Building resilience should be everybody's attitude. With this kind of mindset, we can promote the scaling up of existing government programs to rectify the social and economic structures that breed disaster risk and trap the poor and vulnerable citizens in the vicious cycle of risk and poverty," Legarda concluded.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
