...
<!-- file generated by WebNewsGen 100809 on 3/12/2014 3:04:28 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - ERC decision covers Luzon coops - Recto</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->ERC decision covers Luzon coops - Recto<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">The ERC decision reads in part that "it voids Luzon Wholesale Electricity Spot Market prices and declares the imposition of regulated prices in lieu thereof."</p>
<p style="text-align: justify">This means that customers outside the Meralco franchise area stands to benefit as well from the implementation of the ERC order.</p>
<p style="text-align: justify">The ERC decision orders the Philippine Electricity Market Corp to calculate and implement the regulated prices in the revised WESM bills of the affected distribution utilities in Luzon.</p>
<p style="text-align: justify">Coops and distribution utilities in the cities and provinces of Luzon which bought power using the disallowed October December WESM prices will have to refund their customers.</p>
<p style="text-align: justify">So it is not just Meralco customers who stand to gain relief, but customers of other electric coops which sourced power from generation companies at prices and terms the ERC has ruled as onerous.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
