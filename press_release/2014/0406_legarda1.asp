...
<!-- file generated by WebNewsGen 100809 on 4/7/2014 7:00:52 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Legarda: Implement Plans, Allocate Funds to Build Resilience</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Legarda: Implement Plans, Allocate Funds to Build Resilience<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator Loren Legarda today stressed on the need to allocate sufficient funds and prioritize the implementation of action plans for disaster risk reduction and management (DRRM) and climate change adaptation and mitigation (CCAM).</p>
<p style="text-align: justify">Legarda, Chair of the Senate Committee on Climate Change, said climate experts have already warned of the grim scenario that nations, especially in Southeast Asia, could face due to the warming climate.</p>
<p style="text-align: justify">The Senator noted that the latest report from the United Nations Intergovernmental Panel on Climate Change (IPCC) builds on its previous forecast that global temperature may rise by 4 degrees Celsius.</p>
<p style="text-align: justify">"The newest IPCC Report states that seas will rise by 26-82 centimeters by 2100. Sea level rise is a great threat to small island nations, and for an archipelago like the Philippines, it would mean more floods. We have already seen and experienced the wrath of Yolanda, how the surge of seawater engulfed communities. We cannot prevent a storm, but we can save our communities from devastation if we actually fund and implement our disaster and climate resilience plans without delay," said Legarda.</p>
<p style="text-align: justify">"For instance, under the National Disaster Risk Reduction and Management Act, every province, city and municipality should have a Local Disaster Risk Reduction and Management Office (LDRRMO), and every barangay should establish a Barangay Disaster Risk Reduction and Management Committee. Do our LGUs have these local DRRM offices? Are local DRRM officers equipped and trained to carry out their tasks? These local DRRM offices should be created to institutionalize arrangements and measures for reducing disaster risks, and enhance disaster preparedness and response capabilities at all levels," she added.</p>
<p style="text-align: justify">Moreover, Legarda said that local government units (LGUs) must look into the National Disaster Risk Reduction and Management Plan (NDRRMP), which guides LGUs in the formulation and implementation of a comprehensive and integrated local disaster risk reduction and management plan.</p>
<p style="text-align: justify">The NDRRMP provides for the identification of hazards, vulnerabilities and risks to be managed at the national level; disaster risk reduction and management approaches and strategies to be applied in managing said hazards and risks; agency roles, responsibilities and lines of authority at all government levels; and vertical and horizontal coordination of disaster risk reduction and management in the pre-disaster and post-disaster phases.</p>
