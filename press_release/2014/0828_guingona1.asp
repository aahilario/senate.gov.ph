...
<!-- file generated by WebNewsGen 100809 on 8/28/2014 2:23:49 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Sen. Guingona bats for strict accreditation &amp; validation of NGOs</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->SEN. GUINGONA BATS FOR STRICT ACCREDITATION 
<br />
&amp; VALIDATION OF NGOs<!-- NewsTitle.end --></span>
<br /><span class="PRSub"><!-- NewsTitleSub.start -->PROPOSED MEASURE AN OFFSHOOT OF PDAF SCAM PROBE<!-- NewsTitleSub.end--></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator Teofisto "TG" Guingona III has filed Senate Bill No. 2375 that seeks to institutionalize a strict accreditation and validation mechanism for Non-Government Organizations (NGOs) and People's Organizations (POs) that are eligible to gain access to government funds.</p>
<p style="text-align: justify">The proposed measure was filed after the findings of the Senate Blue Ribbon Committee on the alleged misuse of government's funds involving unscrupulous organizations and some government officials.</p>
<p style="text-align: justify">"Owing to the serious allegations of massive misappropriation of the Priority Development Assistance Fund (PDAF), which was accomplished purportedly through certain NGOs, it is imperative that a law should be passed, that would immediately require all government agencies, releasing funds to NGOs and POs, to authenticate these entities," Sen. Guingona said.</p>
<p style="text-align: justify">Under the bill, it proposes that the Department of Social Welfare and Development (DSWD) will serve as the accreditation body of the government to screen and monitor NGOs and POs that want to participate in government contracts. The validation process aims to ensure that these entities are legitimate, committed, and competent enough to participate in the implementation of government programs using public funds.</p>
<p style="text-align: justify">With this mechanism, DSWD will determine whether or not those NGOs and POs would be given the "seal of good housekeeping," that would allow them to transact with government.</p>
<p style="text-align: justify">One of the major highlights of the bill is the government audit of NGOs and POs which are recipients of government funds, in line with the principle that public funds granted to these entities retain their character as government funds.</p>
<p style="text-align: justify">"The passage of this bill will enhance transparency and accountability in the allocation and utilization of public funds by ensuring that only legitimate entities that have good reputations for integrity, established track records and proven contributions to the betterment of society, would be able to participate in government projects," Sen. Guingona said.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
