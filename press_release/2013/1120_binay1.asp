...
<!-- file generated by WebNewsGen 100809 on 11/20/2013 10:56:24 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Nancy urges DSWD to implement cash-for-work program for 'Yolanda' victims</title>
...
<span class="PRSuper"><!-- NewsTitleSuper.start -->Program to restore livelihood, human dignity in affected areas<!-- NewsTitleSuper.end --></span><br />
<span class="PRTitle"><!-- NewsTitle.start -->Nancy urges DSWD to implement cash-for-work program 
<br />
for 'Yolanda' victims<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator Nancy Binay urged the Department of Social Work and Development (DSWD) to implement the cash-for-work (CFW) program to include victims of Super Typhoon 'Yolanda'.</p>
<p style="text-align: justify">The lady solon filed Senate Resolution No. 373 urging the DSWD, other concerned government agencies, and local government units to coordinate efforts in the implementation of the CFW program to support families affected by typhoon 'Yolanda'.</p>
<p style="text-align: justify">"Yolanda has left families homeless and without food, clean water and livelihood. The CFW will help victims of the super typhoon to restore not only their livelihood but human dignity as well," the lady solon said.</p>
<p style="text-align: justify">The CFW is a relief effort that provides cash in exchange for community service which includes, among others, maintaining the cleanliness of evacuation centers, repair and reconstruction of damaged houses and community facilities, clean-up and garbage collection, declogging of drainages and assistance in the clearing operations in the affected areas in the Southern Tagalog; Bicol; Western, Central and Eastern Visayas regions.</p>
<p style="text-align: justify">The lady solon said that the DSWD has previously implemented the program to support families affected by the typhoons 'Pedring', 'Quiel', 'Sendong' and the armed conflict in Zamboanga.</p>
<p style="text-align: justify">Binay also encouraged the private sector to assist in the implementation of the CFW program, noting the previous contributions of the private sector in the relief effort.</p>
<p style="text-align: justify">The super typhoon affected at least 2,212, 955 families or 10, 306,318 persons from 44 provinces, 574 municipalities, and 57 cities in several provinces in the Southern Tagalog; Bicol; Western, Central and Eastern Visayas regions according to the National Disaster Risk Reduction and Management Council (NDRRMC).</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
