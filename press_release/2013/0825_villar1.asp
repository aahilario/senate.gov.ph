...
<!-- file generated by WebNewsGen 100809 on 8/27/2013 8:39:28 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Statement of Sen. Cynthia Villar re: Abolition of pork barrel</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->STATEMENT OF SEN. CYNTHIA VILLAR RE: ABOLITION OF PORK BARREL<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">I am in favor of the abolition of the pork barrel if it is the only way to ensure that the people's money will not be wasted or stolen. While as a legislator for nine (9) years, I have seen how the use of PDAF has helped many Filipinos. It has to be acknowledged that the PDAF has been abused and will always be susceptible to abuse in view of current policies and regulations.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
