...
<!-- file generated by WebNewsGen 100809 on 8/28/2013 9:32:26 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Senator Grace Poe's warning against e-mail scam:</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->SENATOR GRACE POE'S WARNING AGAINST E-MAIL SCAM:<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">"We strongly warn the public against bogus e-mails and text messages informing recipients that they 'won' in a raffle and unlawfully using my name. This is a scam. Please do not give credence to such messages. We further urge the public to report these incidents to the NBI to facilitate proper criminal action."</p>
<p style="text-align: justify">(Statement also posted on FB and Twitter on August 24, 2013 and in July 2013)</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
