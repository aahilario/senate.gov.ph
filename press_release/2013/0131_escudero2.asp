...
<!-- file generated by WebNewsGen 100809 on 1/31/2013 1:13:31 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Chiz tells cops: Win back public's confidence</title>
...
<span class="PRSuper"><!-- NewsTitleSuper.start -->Sounds alarm over spate of brazen criminal acts<!-- NewsTitleSuper.end --></span><br />
<span class="PRTitle"><!-- NewsTitle.start -->CHIZ TELLS COPS: WIN BACK PUBLIC'S CONFIDENCE<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Sen. Chiz Escudero expressed alarm over the spate of brazen robberies and shootouts in malls and other public places and called on the national police to take immediate measures to win back the public's confidence.</p>
<p style="text-align: justify">"The frequency of these incidents, and the fact that they were carried out in a brazen and reckless manner in malls and other public places, should be a wake-up call for the Philippine National Police and other law enforcement agencies," Escudero said.</p>
<p style="text-align: justify">The senator said the PNP must take immediate measures to address the situation.</p>
<p style="text-align: justify">"Increase visibility of policemen in public places and improve the intelligence gathering because there is a possibility that at least some of these incidents are not random but are in fact planned ahead. Nothing must be left for granted, especially when it comes to public safety and security," Escudero said.</p>
<p style="text-align: justify">He lamented that the spate of incidents - including an armed robbery inside the SM Megamall in Mandaluyong City in broad daylight, a robbery of a money transfer outlet in Paranaque City, and a reported shootout at the Robinsons Magnolia mall in Quezon City - could embolden other criminal groups if police are unable to deter such acts.</p>
<p style="text-align: justify">"Such incidents can be prevented if criminals are made to realize that there will be a timely and swift response from the police. Otherwise, criminals will start believing that they can commit crimes with impunity and get away with it," Escudero said.</p>
<p style="text-align: justify">"These incidents also have an adverse effect on the public. When we start worrying about our safety and the safety of our loved ones, then we will have a crisis of confidence. That can never be good," he added.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
