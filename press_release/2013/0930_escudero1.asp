...
<!-- file generated by WebNewsGen 100809 on 9/30/2013 3:58:23 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Chiz: Whole amount of DAP funding went to infra projects to LGUs</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->CHIZ: WHOLE AMOUNT OF DAP FUNDING 
<br />
WENT TO INFRA PROJECTS TO LGUs<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator Chiz Escudero today said the Disbursement Acceleration Program (DAP) released to him formed part of his request made to the Office of the President (OP) to bolster local government programs requested through his office.</p>
<p style="text-align: justify">Escudero, chairman of the senate finance committee also clarified that it was P96 million worth of projects and not P99 million, as initially reported by the Department of Budget and Management. The DBM said it will also issue correction about the figure.</p>
<p style="text-align: justify">"I have made several requests to the OP to boost program funding requests of the LGUs through our office. I have requested before OP and was granted with a P96 million worth of infrastructure projects and not P99 million as reported. The whole amount went to the construction or repair of public markets of LGUs for P500 thousand each".</p>
<p style="text-align: justify">Specifically, the whole amount was downloaded to and implemented by the municipalities and cities in Batangas, Laguna, Quezon, Cavite, Rizal, Ilocos Norte and Pangasinan".</p>
<p style="text-align: justify">He said all allocations and disbursements to and by his office from the time he first received his PDAF in 2010 and the succeeding years have been posted since last year on his official website (<a href="http://www.chizescudero.com">www.chizescudero.com</a>) where figures can be readily accessed. The senator said all his pork allocations went to two projects only: 1. allocation to all regional hospitals and specialty hospitals in the country and 2. Infrastructure projects principally construction or rehabilitation of public markets in all LGUs.</p>
<p style="text-align: justify">Escudero, who was the first among his peers in the senate to move for the abolition of the pork barrel through Senate resolution No. 193, reiterates his position that all legislators are responsible for the proper disbursement of the funds entrusted to them. This is why, he said, transparency plays a key role in the issue of PDAF.</p>
<p style="text-align: justify">"PDAF is not evil at all. It only becomes such when these have been used as tools for malfeasance, misfeasance and nonfeasance. As I have moved for the abolition of PDAF, it is also a good question to all legislators to ask where all these funding go and how were these utilized? It would also help to ease the unsettling of the public if we could all be transparent in the utilization of our funds by making all facts and figures available to the public".</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
