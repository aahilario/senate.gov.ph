...
<!-- file generated by WebNewsGen 100809 on 7/8/2013 3:16:56 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Angara: Statement on Cha-cha proposals</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Statement on Cha-cha proposals<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">We would like to see the concrete proposals since amendments to the Constitution can span a wide array of topics. If there are amendments that will help improve the unemployment situation then I think we should remain open to such proposals as constitutions must be stable but not set in stone. As to whether it is time for overhauling systems or forms of government, that remains to be seen.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
