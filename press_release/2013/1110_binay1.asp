...
<!-- file generated by WebNewsGen 100809 on 11/11/2013 7:42:17 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Nancy urges colleagues to remove P25B PDAF from 2014 budget</title>
...
<span class="PRSuper"><!-- NewsTitleSuper.start -->Consistent with the call of abolishing 'pork'<!-- NewsTitleSuper.end --></span><br />
<span class="PRTitle"><!-- NewsTitle.start -->Nancy urges colleagues to remove P25B PDAF from 2014 budget<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->

<p style="text-align: justify">After giving up her P200 million allocation in her Priority Development Assistance Fund (PDAF) in the proposed 2014 national budget, Sen. Nancy Binay is urging her colleagues to collectively withdraw the P25 billion PDAF allocation earmarked for senators from next year's General Appropriations Act (GAA).</p>
...
<p style="text-align: justify">Binay likewise has formally relinquished her P200 million PDAF allocation for 2014.</p>
<p style="text-align: justify">"Considering the public's perception on the use of the PDAF and other lump sum items in the national budget coupled with the fact that the PDAF's validity is under judicial inquiry, it is my view that it is of paramount necessity for the Senate to take action on the issue of its continued inclusion in the appropriations law," Binay said in the letter.</p>
<p style="text-align: justify"><a href="Binay&#32;PDAF&#32;letter.pdf">(Attached is the signed and received copy of Sen. Binay's letter addressed to the Office of Senator Francis Escudero, chairman of the Senate Finance Committee.)</a></p>
<!-- NewsBody.end -->
</td><td id="sidepane">
