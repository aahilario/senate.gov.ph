...
<!-- file generated by WebNewsGen 100809 on 11/21/2013 11:26:58 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Nancy: 'Prioritize re-integration of students displaced by 'Yolanda''</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Nancy: 'Prioritize re-integration of students displaced by 'Yolanda''<!-- NewsTitle.end --></span>
<br /><span class="PRSub"><!-- NewsTitleSub.start -->DepEd, CHED urged to relax transfer rules<!-- NewsTitleSub.end--></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator Nancy Binay urged the Department of Education (DepEd) and the Commission of Higher Education (CHED) to prioritize the re-integration of students displaced by Super Typhoon 'Yolanda'.</p>
<p style="text-align: justify">"We urge DepEd and CHED to relax the requirements soonest so that students in the afflicted areas can easily transfer to other educational institutions," Binay said. "What we are after is for their studies not to be cut or disrupted for a long time," she added.</p>
<p style="text-align: justify">Deped Secretary Armin Luistro has ordered all public schools to accept "emergency transferees" from affected areas.</p>
<p style="text-align: justify">The lady solon also requested CHED to coordinate with private colleges and universities to "persuade them to also relax their transfer rules".</p>
<p style="text-align: justify">"Getting students to school is one important aspect in restoring normalcy in the typhoon ravaged areas, especially in the Samar-Leyte and Panay areas," Binay said.</p>
<p style="text-align: justify">Around 3,200 classrooms were totally damaged in the affected areas according to an initial report made by DepEd regional officials in the Visayas.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
