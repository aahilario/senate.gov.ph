...
<!-- file generated by WebNewsGen 100809 on 2/18/2013 1:54:56 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Legarda seeks Albay's help in creating disaster-resilient barangays</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Legarda seeks Albay's help in creating disaster-resilient barangays<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator Loren Legarda sought the help of the local government of Albay in creating a model for disaster risk reduction (DRR) and climate change adaptation (CCA) that all barangays in the country can use as guide in making their communities disaster-resilient.</p>
<p style="text-align: justify">During her recent visit to the Bicol Region, Legarda, the United Nations Regional Champion for DRR and CCA for Asia-Pacific, said that she will seek the help of Albay Governor Joey Salceda in "instilling the DRR-CCA model of Albay in every barangay all over the country."</p>
<p style="text-align: justify">"I will ask Governor Joey Salceda through his Climate Change Academy to help me since we are both UNISDR champions. He is an economist, an environmentalist and a DRR champion. I will ask for his help in crafting plans, programs and policies in the barangay level to make sure each barangay is disaster-resilient," the Senator said.</p>
<p style="text-align: justify">She explained that Albay is a model for disaster mitigation and preparedness, especially because while the Bicol Region is disaster-prone and vulnerable to several natural hazards, Albay has become disaster-resilient.</p>
<p style="text-align: justify">In fact, Albay, along with Makati  City and the Municipality of San Francisco in Camotes Island, Cebu, is among the United Nations' 29 model communities  that are exemplars in disaster risk reduction and management.</p>
<p style="text-align: justify">The Province of Albay was recognized for its focus on preparing comprehensive land use plans that address climate and disaster risks, and for investing in disaster-resilient infrastructure.</p>
<p style="text-align: justify">"We have many best practices, like those in Albay, that other LGUs can use as guide in crafting their own programs. Communities that have yet to establish DRR and CCA practices should start now with both a short-term plan for the natural hazards expected to come within the next months, and a long-term program to ensure disaster-resilient communities in the future," said Legarda.</p>
<p style="text-align: justify">Even as the campaign for the May 2013 Elections has already started, Legarda, senatorial candidate of the Nationalist People's Coalition , continues her advocacy on disaster preparedness, stressing that she wants to have an "educational and environmental campaign."</p>
<p style="text-align: justify">"I want to have a meaningful campaign, one that is not just all about political issues but also issues that really matter most to the Filipino people. We will save lives by making each barangay disaster-resilient," she concluded.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
