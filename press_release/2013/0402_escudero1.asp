...
<!-- file generated by WebNewsGen 100809 on 4/2/2013 2:15:07 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Chiz tells COMELEC to set date for source code review</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->CHIZ TELLS COMELEC TO SET DATE FOR SOURCE CODE REVIEW<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator Chiz Escudero wants the Commission on Elections (Comelec) to set a definite date for the review of the precinct count optical scan (PCOS) machines source code, the absence of which, he said, is a major source of uncertainty for the May 13 elections.</p>
<p style="text-align: justify">"I have maintained that the source code for the 80,000 PCOS machines must be opened for checking by political parties and technology experts which is required under the Automated Polls Law," Escudero said.</p>
<p style="text-align: justify">Escudero said the Comelec should set a definite date for the review of the source code instead of giving a daily rundown on the progress it has achieved in obtaining the code from its owner the US-based Dominion Voting Systems, which is an action that Escudero said the Comelec should have done much earlier.</p>
<p style="text-align: justify">"The statement of Comelec Chairman Sixto Brillantes Jr. that he is 95 percent certain of obtaining the source code from Dominion does not offer much consolation to those seeking to review the code this close to the elections date," the reelectionist senator said.</p>
<p style="text-align: justify">Brillantes had explained that a court dispute in Delaware between Dominion and PCOS supplier Smartmatic had resulted in the delay of the release of the source code.</p>
<p style="text-align: justify">The Comelec had fixed the review of the code for the consolidation and canvassing system (CCS) next week but not the PCOS source code with Brillantes merely saying that a "big press conference" will be held to announce when the review will be held.</p>
<p style="text-align: justify">The Automated Poll Law provided that the source code should be reviewed by independent parties three months prior to the elections.</p>
<p style="text-align: justify">Almost a month to the 2013 midterm polls, Brillantes said that obtaining the code was 95 percent sure but he said a few details still needed ironing out.</p>
<p style="text-align: justify">Escudero said that while he has full confidence in the Comelec to hold credible elections, an unverified source code can be a point of protest particularly among losing candidates that may cause major post-election problems.</p>
<p style="text-align: justify">He said questions and concerns on the credibility of the elections in May will be soothed only if Comelec finally let the source code be subjected to reviews.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
