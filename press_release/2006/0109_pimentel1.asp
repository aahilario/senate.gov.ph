...
<title>Press Release - Pimentel: People's initiative for Charter Change won't work due to...</title>
...
Press Release<br /><!-- NewsDate.start -->
			January 9, 2006<!-- NewsDate.end --><p style="text-align: center">
			<span class="PRTitle"><!-- NewsTitle.start -->PEOPLES INITIATIVE FOR CHARTER CHANGE WONT WORK DUE TO CONSTITUTIONAL OBSTACLE<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start -->
			...
			exercise in futility.<br /><br />Pimentel said that while the adoption of a parliamentary system, as 
			...
			of the unicameral parliament.<br /><br />The minority leader cautioned the local chief executives against 
			...
			in the country.<br /><br />Im afraid the advocates of peoples initiative among the local 
			...
			the public pulse first, Pimentel said.<br /><br />The minority leader argued that a peoples initiative is applicable 
			...
			on Appointments.<br /><br />However, he said that since the local officials are backing the 
			...
			assembly.<br /><br />Pimentel said the 1987 Constitution limits the scope of the system 
			...
			through the direct action of the entire Filipino electorate.<br /><br />He said the record of proceedings of the 1986 Constitutional 
			...
			should not extend to the revision of the entire Constitution.<br /><br />Aside from this, Pimentel pointed out that the Supreme Court in a 
			...
			amendments to the Constitution.<br /><br />In the same decision, the high tribunal ruled that the Comelec 
			...
			to provide for the implementation of the system.</p><!-- NewsBody.end --></td>
         <td id="sidepane">
