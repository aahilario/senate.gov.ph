...
<!-- file generated by WebNewsGen on 10/17/2006 4:59:39 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko on the preventive suspension order of Binay, et al</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->KIKO ON THE PREVENTIVE SUSPENSION <br />ORDER OF BINAY, ET AL<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start --><p style="text-align: justify; text-indent: 25px">"Political tension will only increase with this latest suspension order.   It would be best for the administration to rethink its policy of clamping down on legitimate political dissent.  It should exercise greater restraint in dealing with those critical of its policies and programs.   Legitimate dissent exercised within the confines of the rule of law, no matter how abhorring it may be to those who wield the awesome powers of government is essential, if our constitutional democracy is to remain relevant and healthy."</p>
<!-- NewsBody.end -->
         </td>
         <td id="sidepane">
