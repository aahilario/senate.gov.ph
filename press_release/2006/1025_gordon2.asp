...
<!-- file generated by WebNewsGen on 10/26/2006 2:02:30 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Gordons reaction to the SC decision on peoples initiative</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->GORDONS REACTION TO THE SC DECISION <br />ON PEOPLES INITIATIVE<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start --><p style="text-align: justify; text-indent: 25px">I am glad that the Supreme Court (SC) dismissed the peoples initiative petition. It decided consistent with prevailing jurisprudence in Santiago vs. COMELEC, providing predictability, consistency, and stability to our legal system and the rule of law in our country.</p>
<p style="text-align: justify; text-indent: 25px">Although the people have been given by the Constitution the power to directly propose amendments to the Constitution, the dubious way by which the present peoples initiative was orchestrated, largely through the barangay assemblies, is indeed very disturbing. That is why a sound enabling law for the implementation of the exercise of this right, one that would protect the people from the manipulative scheming of the powerful, must be passed by Congress at the soonest possible time.</p>
