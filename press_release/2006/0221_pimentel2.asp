...
<title>Press Release - Pimentel: Deployment of US troops for rescue efforts in Southern Leyte lauded</title>
...
Press Release<br /><!-- NewsDate.start -->
			...
			<span class="PRTitle"><!-- NewsTitle.start -->DEPLOYMENT OF US TROOPS FOR RESCUE EFFORTS <br />IN SOUTHERN LEYTE LAUDED<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start -->
			...
			Leyte.<br /><br />American troops helping rescue victims in the St. Bernard landslide 
			...
			goodwill, Pimentel said.<br /><br />The 3,000 troops, representing more than half of the American 
			...
			cascaded down from the slope of a nearby mountain.<br /><br />US Brig. Gen. Martin Robeson said that up to 500 troops could be 
			deployed in the disaster site, while the rest will man three ships 
			to ferry relief supplies.</p><!-- NewsBody.end --></td>
         <td id="sidepane">
