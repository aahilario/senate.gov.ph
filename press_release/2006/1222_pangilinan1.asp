...
<!-- file generated by WebNewsGen on 12/26/2006 7:36:16 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko on the suspension of Balikatan exercises</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Kiko on the suspension of Balikatan exercises<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start --><p style="text-align: justify">Our interest too that the exercises be suspended, pending the determination not only of the rights of the US servicemen, but more importantly, the rights of our own citizens who may at some future time become victims of lawless acts that may be committed by these US servicemen. The judiciary should not allow the suspension to influence the outcome of the case. We are, just like the US, an independent state, with our own set of rules and laws that we must uphold. The exercises should rightfully be suspended until such time that the dispute has been resolved.</p>
<!-- NewsBody.end -->
         </td>
         <td id="sidepane">
