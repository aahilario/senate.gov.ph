...
<title>Press Release - Villar's committee to probe illegal drugs-related issues including Pasig...</title>
...
Press Release<br /><!-- NewsDate.start -->
			February 17, 2006<!-- NewsDate.end --><p style="text-align: center">
			<span class="PRTitle"><!-- NewsTitle.start -->VILLAR'S COMMITTEE TO PROBE ILLEGAL DRUGS-RELATED ISSUES <br />INCLUDING PASIG SHABU MART<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start -->
			<p style="text-align: left; text-indent:25px">
			As Chairman of the Senate Committee on Public Order and Illegal 
			Drugs, Senator Manny Villar is set to investigate the proliferation 
			of illegal drugs in the country, particularly in the light of the 
			recent discovery and raid of shabu (metamphetamine hydrochloride) 
			stalls in a neighborhood in Pasig City.</p>
			<p style="text-align: left; text-indent:25px">
			According to Villar, &quot;It's about time for our committee to look into 
			the proliferation of illegal drugs in the country, which continues 
			to be a major menace in our society. The so-called shabu supermarket 
			in Pasig City is just among the many issues that we will tackle in 
			our inquiry or investigation.&quot;</p>
			<p style="text-align: left; text-indent:25px">
			&quot;Although we will look closely on the Pasig incident, there might be 
			other areas in the country that operate similar drug dens or 
			establishments. We need to task our drug authorities to be more 
			aggressive and vigilant in performing their duties and functions,&quot; 
			adds Villar.</p>
			<p style="text-align: left; text-indent:25px">
			The public hearing to be conducted by Villar's committee jointly 
			with the Senate Blue Ribbon Committee, which is tentatively set for 
			Thursday (February 23) next week, is based on the Senate Resolutions 
			separately filed by Senators Miriam Defensor Santiago and Bong 
			Revilla.</p>
			<p style="text-align: left; text-indent:25px">
			...
			<p style="text-align: left; text-indent:25px">
			&quot;As per Senator Santiago's resolution, we will also check if there 
			is culpability or negligence on the part of public officials 
			regarding the Pasig shabu raid. But I don't want to preempt the 
			investigation by giving a conclusion right away. We will invite 
			resource persons to help us in our investigation,&quot; cites Villar.</p>
			<p style="text-align: left; text-indent:25px">
			As this develops, Pasig City Mayor Vicente Eusebio on Wednesday 
			(Feb. 15) ordered the demolition of the shabu shanties in Pasig 
			City, a move questioned and labeled by anti-drug authorities as 
			interference in the administration of justice and destruction of 
			evidence.</p><!-- NewsBody.end --></td>
         <td id="sidepane">
