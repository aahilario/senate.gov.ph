...
<!-- file generated by WebNewsGen on 11/29/2006 5:01:08 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Transcript of interview with Senator Mar Roxas</title>
...
<td>&nbsp;<a href="http://www.newsenatebuilding.com">Bagong Senado</a></td></tr></table></div></div>
   ...
   <table id="container">
      <tr>
         <td id="content">
Press Release<br />NEDA briefing on the 3Q economic performance<br />BSP, Pasay City<br /><!-- NewsDate.start -->November 29, 2006<!-- NewsDate.end --><p>
<span class="PRTitle"><!-- NewsTitle.start -->Transcript of interview with Senator Mar Roxas<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start --><p><i>Sir, please expound on your comment earlier that cha-cha is a major distraction in the performance of the economy?</i></p>

<p>The economy registered relatively disappointing statistics in the 3rd quarter and carried by the strength in the first semester. Needless to say this could have been better; it is principally consumption-led growth fueled by the remittances of our OFWs.</p>

<p>We see strength in consumption; we see weakness in production. That means that this demand or consumption is being met by external supply, meaning imports. How much better would it be if our own demand here is supplied by production, also here in our own economy?</p>

<p>For example, food and beverage production was a little bit weak versus the earlier parts of the year and last year and mainly we have been buying what our needs are from abroad. So it will be better for us, as well as for jobs and livelihood, if we are able to strengthen our domestic production.</p>

<p>The investment figures are relatively soft and if you note that nearly half of our external debt under the ROPsit means that there is money owned by Filipinos except that they prefer to be creditors to our country rather than investors or entrepreneurs.</p>

<p>So I think this is a symptom that they are not as confident about putting their money here as equity but they are only confident of putting it here as debtors, meaning pinapautang sa gobyerno.</p>

<p><i>What are the distractions that you were mentioning are affecting this?</i></p>

<p>I think the cha-cha continues to be a distraction and I am calling on its advocates to set it aside. In fact, all of the problems that the NEDA and that the economists are saying that beset our economy can be addressed in the near immediate, medium term by structural reforms, and governance reforms given the structure that we have now; given the Constitution that we have now and so this is not the weak link that holds back our economy.</p>
