...
<!-- file generated by WebNewsGen on 10/16/2006 12:18:09 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Gordon welcomes CA order for selective retake</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->GORDON WELCOMES CA ORDER FOR SELECTIVE RETAKE<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start --><p>Senator Richard J. Gordon welcomed the Court of Appeals (CA) order calling for a selective retake by 1,687 examinees of tests 3 and 5 of the June 2006 nursing board examinations.</p>
<p>Gordon said as the evidence gathered indicates that the leakage was limited to certain areas and benefited  only examinees from 3 review centers, only those examinees should be made to retake the affected portions.</p>
<p>This would be consistent with the finding from our hearings in the Senate. Given these findings, however, the PRC may need to re-examine its decision to remove portions of tests 3 and 5 in computing the passing rate for all examinees from the  board  examinations. Gordon emphasized.</p>
<p>We should now work to ensure that all those behind the leakage are  prosecuted. As a senator, I intend to push for legislation aimed, firstly, at ensuring that the  occurrence of such leakages are  avoided in the future and, secondly, that the standards of the nursing profession are  duly uplifted, He added.</p>
<p>According to Gordon, the Commission on Higher Education (CHED) should also ensure that our nursing schools have adequate training standards, monitor and publish schools passing rates, and shut down those which are not up to par.</p>
<p>The public should be protect from such diploma mills, Gordon insisted.</p>
<!-- NewsBody.end -->
         </td>
         <td id="sidepane">
