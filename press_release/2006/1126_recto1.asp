...
<!-- file generated by WebNewsGen on 11/27/2006 8:26:01 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Make govt cars experimental fleet for biofuels - Recto</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Make govt cars experimental fleet for biofuels -Recto<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start --><p>Government  should use its 68,437 vehicles  as experimental fleet  for biofuel use to  show to the public  the merits of shifting to fuel blended with ethanol  or  cocodiesel.</p>
<p>The suggestion was made by Sen. Ralph Recto who said  that by having government-owned cars as  demonstration units   in the run up to the full implementation of  the biofuels law three years from now all doubts  by  motorists on  the effectiveness  of alternative fuels will be answered.</p>
<p>The proof of the pudding is in the eating. The proof that biofuel works is to make its proponent use it .  The government must  patronize the product of its own policies," he said .</p>
<p>Gasoline sold three years from  the signing of the Biofuels Law should  be blended with five percent ethanol while mandatory blending of all diesel sold with  one percent cocodiesel  shall take effect three months after enactment of the  landmark legislation.</p>
<p>Recto urged  Malacanang  to hit the ground running   on its biofuels campaign by ordering  that a sizeable percentage  of  government-owned run on  ethanol-blended gas and cocodiesel.</p>
<p>Before we ask our poor jeepney drivers to buy cocodiesel,  perhaps we can show  them that  SUVs  owned by the government , especially by government corporations,  run fine on  this kind of fuel,  he said.</p>
<p>If possible , this should start with the car that sports  the no.1 plate. The message we would like to convey is that if its good for the President's BMW then it must be good for all,  Recto said, referring to the plate number assigned to the President of the Philippines .</p>
<p>In making his proposal, Recto noted  that  the efficacy of alternative  fuels has been the subject of a lot of debate even within the automotive industry. The best way to demolish these misconceptions is to let actual units running on biofuels be seen on the road.</p>
