...
<!-- file generated by WebNewsGen on 4/5/2006 6:29:54 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Angara questions Senate resolution on peoples initiative</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->ANGARA QUESTIONS SENATE RESOLUTION ON 
PEOPLES INITIATIVE<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start --><p>The Senate has virtually killed any hope of 
implementing constitutional changes through a constitutional convention, and now 
a constituent assembly as well.</p>
<p>This was the response of Senator Edgardo J. Angara to the question over why 
he did not sign a resolution that the signature campaign initiated by the 
Department of Interior and Local Government (DILG) to change the Constitution 
through a peoples initiative was unlawful.</p>
<p>A peoples initiative is one mode of changing the constitution that is 
reserved for the people. And now, we are trying to block even this particular 
mode, Angara said.</p>
<p>This gives the wrong impression that senators are for the status quo, when 
in fact, many of us want change. It is not for the Senate to judge as to what 
mode is improper or unauthorized. That decision is for the Supreme Court to 
make, he added.</p>
<p>Angara said the Senate should let the process proceed so as not to 
unwittingly convey the message that were anti-change or anti-reform.</p>
<!-- NewsBody.end -->
         </td>
         <td id="sidepane">
