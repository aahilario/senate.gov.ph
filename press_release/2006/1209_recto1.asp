...
<!-- file generated by WebNewsGen on 12/11/2006 8:48:39 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Recto on ConCon: "The ultimatum is on the House, not on the Senate"</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Recto on ConCon: &quot;The ultimatum is <br />on the House, not on the Senate"<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start --><p>"What the House should do is pass a ConCon bill ASAP and send it to the Senate. The ultimatum is on the House, not on the Senate," said Sen. Ralph Recto.</p>
<p>"Since the Constitutional Convention requires public funds, then all the more should the bill creating it emanate from the House, to comply with the Constitutional provision that bills on appropriations should originate from the Lower House. Complex mechanics that govern a ConCon reauire the passage of a bill and not a mere resolution."</p>
<p>"Because it is the House that is dying to ChaCha, then it should fashion the enabling law for a ConCon."</p>
<p>"However, let me warn that changing the mode of ChaCha is not a guarantee that it will change the mood of the people toward ChaCha if the agenda proponents remain and that is to turn Congress into a unicameral parliament."</p>
<p>"If the House will pass the ConCon measure, then the Senate is duty-bound to consider it," Recto stressed.</p>
<!-- NewsBody.end -->
         </td>
         <td id="sidepane">
