...
<!-- file generated by WebNewsGen on 11/6/2006 1:19:47 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko: Time to put Chacha to rest; focus on legislation</title>
...
<td>&nbsp;<a href="http://www.newsenatebuilding.com">Bagong Senado</a></td></tr></table></div></div>
   ...
   <table id="container">
      <tr>
         <td id="content">
Press Release<br /><!-- NewsDate.start -->November 5, 2006<!-- NewsDate.end --><p style="text-align: center">
<span class="PRTitle"><!-- NewsTitle.start -->KIKO: TIME TO PUT CHACHA TO REST; <br />FOCUS ON LEGISLATION<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start --><p style="text-align: justify">Senate Majority Leader Kiko Pangilinan today urged his fellow lawmakers to put Charter Change to rest and focus on legislation instead, as the Senate resumes session this Monday, November 6, 2006.</p>

<p style="text-align: justify">"The Senate is ready to hit the ground running and focus on pertinent legislation that addresses the real needs of our people. We are set to tackle amendments to the University of the Philippines Charter bill, which I have authored. The University of the Philippines is 98 years old today. In two years, it will be celebrating its centenary. Up to this time however, its affairs have been governed by its original Charter enacted on June 18, 1908 by the American colonial government."</p>

<p style="text-align: justify">"The UP Charter needs to be updated in order for the state university to remain competitive in a globalizing world. This bill seeks to democratize the governance of UP while upholding its institutional and fiscal autonomy," Kiko said,</p>

<p style="text-align: justify">Also up for discussion is the Patents Bill, which seeks to lower the prices of medicine for the Filipino people.  Bicameral meetings are also set for the Biofuels bill, which pushes for less dependence on oil and the preservation of dollar reserves, and the Poll Automation bill that aims to minimize cheating during elections."</p>

<p style="text-align: justify">"Our people expect results from the Senate in terms of life enhancing legislation.  The Senate intends to respond to this public clamor resolutely and pursue its goals of providing relevant legislation relentlessly," Kiko ended.</p>
<!-- NewsBody.end -->
         </td>
         <td id="sidepane">
