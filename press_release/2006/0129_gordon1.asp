...
<title>Press Release - Gordon pushes for urgent modernization of ballot-counting technology</title>
...
Press Release<br /><!-- NewsDate.start -->
			...
			<span class="PRTitle"><!-- NewsTitle.start -->GORDON PUSHES FOR URGENT MODERNIZATION <br />OF BALLOT-COUNTING TECHNOLOGY<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start -->
			...
			electoral system. <br /><br />A number of electoral exercises that we've had have been punctuated 
			...
			integrity and credibility of our electoral system, he said.<br /><br />Gordon, Chairman of the Senate Committee on Constitutional 
			...
			local and national polls. <br /><br />There are numerous attempts to push for Charter Change which they 
			...
			change. <br /><br />Since after his visit to India late last year to speak at the World 
			...
			efficient counting of electoral ballots.<br /><br />Gordon said Indias elections, participated in by more than 600 
			...
			and which automatically shuts down at the end of the day. <br /><br />There is no reason why we cannot adopt these technologies. With 
			...
			secures the choice of the people.</p><!-- NewsBody.end --></td>
         <td id="sidepane">
