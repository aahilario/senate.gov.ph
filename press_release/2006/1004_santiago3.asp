...
<!-- file generated by WebNewsGen on 10/4/2006 5:57:25 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Miriam: Senate tiff raises cloture issue</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->MIRIAM: SENATE TIFF RAISES CLOTURE ISSUE<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start --><p style="text-indent: 25px">Senator Miriam Defensor Santiago, fielding questions from the Senate media, said that the recent heated arguments between Sen. Juan Ponce Enrile and Sen. Aquilino Pimentel, Jr. has raised the issue of whether the so-called cloture rule of the Senate can be invoked in practice.</p>
<p style="text-indent: 25px">The Senate Rules of Procedure contains a provision for closing a debate. This is called the cloture rule. This is the law, but in practice it is never invoked, because senators do not wish to be muffled and they observe a quid pro quo on the matter, she said.</p>
<p style="text-indent: 25px">Santiago said the Sen. Enrile could invoke the cloture rule, thus effectively muzzling Sen. Pimentel and other senators who wish to extend the period of interpellation on the Anti-Terrorist Bill.</p>
<p style="text-indent: 25px">Sen. Enrile can invoke the cloture rule, but the result will probably be that the Senate President will call a caucus and try to effect a compromise between the two camps, she said.</p>
<!-- NewsBody.end -->
         </td>
         <td id="sidepane">
