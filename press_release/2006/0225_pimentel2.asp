...
<title>Press Release - Pimentel: Raid on Tribune spells death of press freedom</title>
...
Press Release<br /><!-- NewsDate.start -->
			...
			<span class="PRTitle"><!-- NewsTitle.start -->RAID ON TRIBUNE SPELLS DEATH OF PRESS FREEDOM<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start -->
			<p style="text-align: left;">
			Senate Minority Leader Aquilino Q. Pimentel, Jr. (PDP-Laban) today 
			denounced the police raid on the offices of the Daily Tribune, 
			Abante and Abante Tonite, saying it spells the death of press 
			freedom as a consequence of the declaration of a state of national 
			emergency.<br /><br />The raid on the Daily Tribune, Abante and Abante Tonite by the 
			Philippine National Police at dawn today is a true sign of the 
			impending death of free press. Democracy cannot survive without a 
			free press, speech and assembly. We should condemn it.
			</p>
			<p style="text-align: left;">
			</p><!-- NewsBody.end --></td>
         <td id="sidepane">
