...
<!-- file generated by WebNewsGen 100809 on 5/14/2011 3:39:13 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Angara: Science center explores use of seismographs for urban areas </title>
...
<span class="PRTitle"><!-- NewsTitle.start -->SCIENCE CENTER EXPLORES USE OF SEISMOGRAPHS FOR URBAN AREAS <!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">Senator Edgardo J. Angara said that the Philippine Disaster Science Management Center (DSMC) is studying the possible local application of new technology being employed by the United States Geological Survey (USGS) that is installed in homes and allows better measurements of ground motion.</p>

<p style="text-align: justify">The USGS uses this new technology, called NetQuakes, to better measure seismographic data. Units are installed in homes, public buildings, offices or schools and use wifi or local networks to transmit data via the internet to USGS stations. The data is then measured and used to calculate post-earthquake damage estimates and develop better engineering standards.</p>

<p style="text-align: justify">Angara, Chair of the Congressional Commission on Science Technology and Engineering (COMSTE) said that this is the kind of game changing technology that the DSMC is looking to utilize in order to better prepare the Philippines for earthquakes and similar disasters.</p>

<p style="text-align: justify">COMSTE is partnered with the Manila Observatory, in developing the capabilities of the DSMC. The DSMC is also in possession of the Metro Manila Earthquake Impact Reduction Study (MMEIRS).</p>

<p style="text-align: justify">The MMEIRS is a joint study that was undertaken by the Philippine Institute of Volcanology and Seismology (PHIVOLCS), the Japan International Cooperation Agency (JICA) and the Metro Manila Development Authority (MMDA) to create an earthquake scenario damage map of Metro Manila.</p>
