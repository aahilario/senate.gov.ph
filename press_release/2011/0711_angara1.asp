...
<!-- file generated by WebNewsGen 100809 on 7/11/2011 1:20:04 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Angara backs PPP's in telehealth</title>
...
Press Release<br />
<!-- NewsDate.start -->July 11, 2011<!-- NewsDate.end -->
...
<span class="PRTitle"><!-- NewsTitle.start -->ANGARA BACKS PPP'S IN TELEHEALTH<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->

<p style="text-align: justify">Senator Edgardo J. Angara expressed his support for a public-private partnership (PPP) that utilizes information and communications technology (ICT) to improve healthcare systems in some parts of the country that would otherwise be virtually inaccessible.</p>

<p style="text-align: justify">Angara, chair of the Senate Committee on Science and Technology, lauded the pilot program between Smart Communications, Inc. and the Department of Health (DOH) entitled Secured Health Information Network and Exchange (SHINE).</p>

<p style="text-align: justify">The SHINE program aims to create an electronic database of patients' medical histories and share it among rural health units and some government hospitals in Iloilo City.</p>

<p style="text-align: justify">SHINE boosts the efficiency of healthcare delivery by cutting down the time spent in time consuming and repetitive documentation of patient data. The system will also aid in recording consultations, filling up and sending of referral acknowledgement and feedback forms, searching for health care specialists or facilities, setting of appointments as well as the sending of short messaging system (SMS) notification and reminders to patients.</p>

<p style="text-align: justify">"Public-private collaborations like this can help make universal healthcare in the Philippines a reality. We have high hopes that programs such as this succeed," said Angara.</p>

<p style="text-align: justify">Under the program, health workers in the field will be able to access patient data through mobile phones equipped with the SHINE system.</p>

<p style="text-align: justify">Orlando Vea, chief wireless advisor of Smart shared, "SHINE will lessen the workloads of health professionals because the patient's records are recorded in computers. It also makes the referral of patients faster and more efficient."</p>

<p style="text-align: justify">Smart will provide SHINE-enabled computers and mobile phones to 13 rural health units, 10 health centers, five district hospital and two tertiary hospitals.</p>

<p style="text-align: justify">"Such a program, if successful, must be replicated across the country. Government has to be bolder and engage stakeholders--public and private--to boost telehealth in the country," said Angara.</p>

<p style="text-align: justify">Angara, author of the Philhealth Act, took note that the Congressional Commission on Science &amp; Technology and Engineering (COMSTE) identified telehealth as a top national priority for 2011.</p>

<p style="text-align: justify">He added that a similar telehealth system is being pioneered by the provincial government of Aurora, his home province, with the help of the National Telehealth Center at UP Manila.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
