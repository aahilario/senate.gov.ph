...
<!-- file generated by WebNewsGen 100809 on 6/7/2011 7:01:11 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Angara: Explanation of No Vote against Senate Joint Resolution No. 9 Extending the Term of the Power Commission</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Explanation of No Vote against Senate Joint Resolution No. 9 
<br />
Extending the Term of the Power Commission<!-- NewsTitle.end --></span>
...
<p style="text-align: justify">Senate Joint Resolution No. 9 is an encroachment on Executive power and is unconstitutional.</p>

<p style="text-align: justify">The powers of the Power Commission  (Powercom)  given under  Senate Joint  Resolution No. 9 authorize the Powercom to perform functions of the Executive Branch.  It does not merely act as an oversight committee.</p>

<p style="text-align: justify">Senate Joint  Resolution No. 9 seeks extension of another 10 years,  avowedly  to see to the completion of the following goals and objectives under the EPIRA:</p>

<p style="text-align: justify">1.      Implementation of retail competition and open access on distribution wires;</p>
<p style="text-align: justify">2.      Formation of the Independent Market Operation (IMO);</p>
<p style="text-align: justify">3.      Determination, fixing and approval by the Energy Regulatory Commission (ERC) of a Universal Charge (UC);</p>
<p style="text-align: justify">4.      Reduction of the royalties, returns &amp; taxes collected for the exploitation of all indigenous sources of energy to effect parity of tax treatment with existing rates for imported coal, crude oil and other imported fuels and the corresponding reduction of the power rates from all indigenous sources of energy; and</p>
<p style="text-align: justify">5.      Performance by the National Power Corporation-Small Power Utilities Group of the missionary electrification  function.</p>

<p style="text-align: justify">And in the case of the Renewable Energy Act, (RE Act),  under Senate Joint Resolution  No. 9 the Powercom is tasked with  the implementation of the</p>
<p style="text-align: justify">Renewable Energy Act which entails,  among others, the formulation or establishment of:</p>

<p style="text-align: justify">1.       The Feed-in-Tariff (FIT) system;</p>
<p style="text-align: justify">2.      The Renewable Portfolio Standards (RPS);</p>
<p style="text-align: justify">3.      The Renewable Energy Market (REM);</p>
<p style="text-align: justify">4.      The Green energy Option;</p>
<p style="text-align: justify">5.      Net-metering for Renewable Energy.</p>

<p style="text-align: justify">As can be seen readily, the above EPIRA and RE goals and functions are clearly matters for executive action.  They all partake of implementation of the EPIRA Act and the RE Act, purely executive in nature.</p>

<p style="text-align: justify">What the RE Act granted Powercom are the usual oversight functions, namely,  scrutiny   and investigation,  in order to ensure administrative efficiency and aid it in legislation.</p>

<p style="text-align: justify">However, Senate Joint Resolution No. 9  virtually invests the Powercom  with authority to implement both  laws and involve itself with administrative details, intrinsically executive in nature.</p>

<p style="text-align: justify">There is absolutely no good reason nor satisfactory justification for extending the term of the Powercom.  Possibly one reason why Powercom may</p>
<p style="text-align: justify">have failed to accomplish its duties under EPIRA in the last ten (10) years is it is ill- equipped to do so, considering its powers concern the execution of the law itself, performance of which properly belongs to the Executive.</p>
