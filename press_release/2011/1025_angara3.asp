...
<!-- file generated by WebNewsGen 100809 on 10/25/2011 8:27:01 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Angara urges speedy enactment of cybercrime, data privacy laws</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->ANGARA URGES SPEEDY ENACTMENT OF CYBERCRIME,<br />
DATA PRIVACY LAWS<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">Senator Edgardo J. Angara called for the speedy passage of the twin measures on cybercrime prevention and data privacy to beef up the policy framework for safeguarding the use of Information and Communications Technologies (ICT) in the country.</p>
<p style="text-align: justify">Angara, Chair of the Senate Committee on Science and Technology, pointed out that SBN 2796, the Cybercrime Prevention Act, seeks to protect Filipino Web users from internet fraud, theft, hacking and other online crimes.</p>
<p style="text-align: justify">He continued that this will be backed up by SBN 2965, the Data Privacy Act, which aims to improve the security and confidentiality of personal information collected, stored, used and transmitted by both public and private entities.</p>
<p style="text-align: justify">"If we are to make any headway in our transition to a digital economy, these measures have to be enacted as soon as possible. We only need to look to the arrest of a Korean hacker and the current Stradcom debacle to realize that these bills would provide us with legal protection," said Angara, also Chair of the Congressional Commission on Science, Technology and Engineering (COMSTE).</p>
<p style="text-align: justify">PNP-CIDG chief Director Samuel Pagdilao Jr. has pointed out that foreign crime groups are already running illegal operations from various parts of the country, evidenced by the recent arrest of a Korean national wanted by Philippine and Korean authorities for hacking a Seoul-based financial company.</p>
<p style="text-align: justify">Meanwhile, the Department of Transportation and Communications (DOTC) recently filed charges against Stradcom Corp. for collecting some P2 billion worth of interconnectivity fees for use of data from the Land Transportation Office (LTO).</p>
<p style="text-align: justify">Stradcom allegedly gave other entities access to the LTO database without the consent of government and the individuals who own the data.</p>
<p style="text-align: justify">"These issues highlight the gaps in our policy framework, which the twin measures will fill decisively. I hope that my colleagues in Congress will make these measures a priority once Congress resumes on Nov. 14," said Angara.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
