...
<!-- file generated by WebNewsGen 100809 on 9/9/2011 1:26:32 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Drilon wants detailed implementation of DILG peace, dev't projects </title>
...
<span class="PRTitle"><!-- NewsTitle.start -->DRILON WANTS DETAILED IMPLEMENTATION OF DILG 
<br />
PEACE, DEV'T PROJECTS <!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">Senator Franklin Drilon on Friday urged the Department of Interior and Local Government (DILG) to come up with a detailed list of beneficiaries of the agency's peace and development initiatives to local governments, saying the chamber will not allow a lump sum item which leaves much room for discretion.</p>

<p style="text-align: justify">"We would like to examine how realistic it is to have a more detailed budgeting for these amounts of money rather than a lump sum because lump sum appropriation would always give so much leeway to the implementers," said Drilon, chairman of the Senate Finance Committee that is scrutinizing the proposed P1.816 trillion national budget for 2012, referring to the Payapa at Masaganang Pamayanan or Peaceful and Resilient Communities (Pamana) program being undertaken by DILG and other agencies.</p>

<p style="text-align: justify">The Pamana program, which was originally implemented by the Office of the Presidential Adviser on the Peace Process (OPAPP), has been allotted a total of P1.9 billion. The DILG component of the program has a funding of P968.9 million, while other allocations were distributed among the Department of Social Welfare and Development (P586.7 million), Department of Agrarian Reform (P17.6 million) and OPAPP (P329.3 million).</p>

<p style="text-align: justify">The fund for the Pamana program will be used for development projects, such as infrastructure and livelihood, in 165 cities and municipalities in 30 conflict-hit provinces.</p>

<p style="text-align: justify">At the same time, Drilon said he is in favor of putting the P1.9 billion allocation for the program into a single item in the budget.</p>

<p style="text-align: justify">"There should be no problem with that. we can put it under one fund and have a special provision in the budget which will say that the implementation will be done through the DILG, DAR, OPAPP and DSWD," said Drilon, taking off from the suggestion made by Senate President Juan Ponce Enrile that the allocations of the program for various agencies could be put together under one fund "so that it is easier to monitor."</p>

<p style="text-align: justify">"It should only be under one fund so that when we analyze it, we just look at one fund. There are four agencies that will have to respond but insofar as the Senate is concerned, there is only one fund," said Drilon during the Senate Finance Committee hearing on the DILG's P95 billion budget proposal for 2012 early this week.</p>
