...
<!-- file generated by WebNewsGen 100809 on 3/15/2011 5:57:39 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Pia on hoax text messages: 'When in doubt, don't spread it!'</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Pia on hoax text messages: 'When in doubt, don't spread it!'<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator Pia S. Cayetano today advised the public not to panic over hoax text messages that started circulating this week spreading rumors that deadly radiation from earthquake-stricken nuclear plants in Japan had already reached Philippine territory and is directly threatening the health and safety of Filipinos.</p>
<p style="text-align: justify">"People should remain calm and vigilant by staying abreast of news developments instead of panicking over baseless text messages such as those warning of radiation and acid rain allegedly caused by the nuclear plant incidents in Japan that had supposedly reached our country," said Cayetano, Chairperson of the Senate Committee on health and Demography.</p>
<p style="text-align: justify">"Let us use instant messaging technology to share useful information only, and not to contribute to social anxiety by forwarding unscientific and baseless rumors. In case of doubt as to the source and veracity of any information we receive, we should simply not spread it. Instead, we should refer to official advisories from known authorities such as the Department of Health (DOH), Department of Science and Technology (DOST), PAGASA and the Philippine Nuclear Research institute (PNRI) which are regularly reported through the media.</p>
<p style="text-align: justify">"Suffice it to say, these government agencies should always be pro-active in educating and informing the people on these issues and should never allow rumor-mongers to overtake them."</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
