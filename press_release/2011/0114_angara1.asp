...
<!-- file generated by WebNewsGen 100809 on 1/15/2011 9:55:54 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - COMSTE presents R.E. projects to Energy Board  </title>
...
<span class="PRTitle"><!-- NewsTitle.start -->COMSTE PRESENTS R.E. PROJECTS TO ENERGY BOARD <!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">The Congressional Commission on Science Technology and Engineering (COMSTE), a non-voting member of the Board of NREB, presented its flagship programs in renewable energy (RE) to the National Renewable Energy Board (NREB) earlier today.</p>
...
<p style="text-align: justify">COMSTE reports that the creation of these institutes would need government funding, which would go to applied research in key areas, in turn enabling innovation and creating new companies and new jobs.  COMSTE said that funding for these projects can potentially come from the Department of Agriculture (DA), the Department of Science and technology (DOST), and the Department of Energy (DOE) or other government entities.</p>

<p style="text-align: justify">COMSTE Executive Director Dr. Gregory Tangonan presented the major thrusts of the commission related to energy, namely:</p>

<p style="text-align: justify">1.)    Funding Research &amp; Development in the Philippine Solar Testing Facility which was recently launched as a partnership with COMSTE and First Philec. The Facility would determine the best engineering options for solar Photovoltaic (PV) deployment in the Philippines. The facility will be testing state of the art arrays and electronics parts (inverters, battery systems, fuel cells, etc) under this Public-Private partnership in S&T. Solar research would also involve collaboration with the Semiconductor and Electronics Industries in the Philippines, Inc. (SEIPI).</p>

<p style="text-align: justify">2.)    Fund the Philippine Algae Research Center as a Consortium of Universities (Ateneo, UPLB, DLSU, USC, and UP) and Industry (Alsons Aquaculture, Tao Corporation) to develop fast growth of algae and novel oil extraction techniques for local species for energy, pharmaceuticals and aquaculture.</p>

<p style="text-align: justify">3.)    Fund the Philippines Biofuels Consortium Program, which would develop new approaches to biofuels in the country. Industry is being eyed to lead the Consortium, specifically in S&T development. The industry partner would participate by making facilities available to researchers of the Engineering Research and Development for Technology (ERDT) and other programs.</p>

<p style="text-align: justify">4.)    Fund the electric vehicle design, development and testing laboratory, with the Don Bosco Technology College as lead organization. With Industry/Academe participation in new vehicle design, battery optimization, electronics for power management, hybrid vehicles, and green transport systems deployment can be interfaced to Renewable energy.</p>

<p style="text-align: justify">5.)    Fund an energy efficiency laboratory and training laboratory with the DOE / DOST/ Technical Education and Skills Development Authority (TESDA) as co-leaders with the academe (notably ERDT) as research partner. Training and certification of energy efficiency specialists will be done under this program. These new capabilities are needed to carry out the mission of the new Energy Efficiency Bill, which was recently submitted by Angara.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
