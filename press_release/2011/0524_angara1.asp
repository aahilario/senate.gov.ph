...
<!-- file generated by WebNewsGen 100809 on 5/24/2011 1:59:47 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Angara: Power Commission may have outlived its purpose</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->ANGARA: POWER COMMISSION MAY HAVE OUTLIVED ITS PURPOSE<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->

<p style="text-align: justify">Senator Edgardo J. Angara questioned yesterday the need to extend the life of the Joint Congressional Power Commission (JCPC), saying that some of its proposed oversight functions are already being carried out by certain executive agencies.</p>

<p style="text-align: justify">The JCPC was created under the Electric Power Industry Reform Act (EPIRA) to perform certain functions in aid of legislation, including overseeing the EPIRA's implementation, endorsing the privatization plan of the Power Sector Assets and Liabilities Management Corporation, and ensuring transparency in the privatization of the National Power Corporation's generation and transmission assets.</p>

<p style="text-align: justify">Ultimately, the EPIRA seeks to bring down electricity rates and improve the delivery of power supply to end-users by promoting competition and boosting efficiency in the electricity industry.</p>

<p style="text-align: justify">"One of the main purposes of the EPIRA law is to foster competition among power suppliers so that consumers get better service and value for their money. However, I don't think this has been accomplished yet in the 10 years since it was passed. Our electricity rates are among the highest in Asia," he said.</p>

<p style="text-align: justify">Angara argued during yesterday's interpellation that functions not structural in nature are can be monitored more capably by permanent Senate committee on energy or relevant executive agencies, rather than by an ad hoc congressional oversight body.</p>

<p style="text-align: justify">"It seems that except for the implementation of taxes, the rest of its functions can be overseen and monitored by the usual committees on energy," he said.</p>

<p style="text-align: justify">According to Angara, the EPIRA initially planned to reduce the power costs for end-users through the income from universal charge, which is included in electricity bills.</p>

<p style="text-align: justify">"Under the EPIRA, the proceeds from the collected universal charges will be channeled into liquidating and compensating the stranded costs of the power companies, although we have yet to see this happen," explained Angara.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
