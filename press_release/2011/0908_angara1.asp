...
<!-- file generated by WebNewsGen 100809 on 9/8/2011 11:37:15 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Bid out gov't broadband network to private sector - Angara</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->BID OUT GOV'T BROADBAND NETWORK TO PRIVATE SECTOR - ANGARA<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->

<p style="text-align: justify">Senator Edgardo J. Angara said that the administration should bid out the proposed creation of a government broadband network (GBN).</p>

<p style="text-align: justify">Angara, Chair of the Senate Committee on Science and Technology, noted that the Department of Science and Technology (DOST) is currently making an inventory of government assets that can serve as the basis for the network.</p>

<p style="text-align: justify">"Connecting government through high-speed Internet is clearly a project to look forward to. But once the inventory is finished, private companies should be allowed to not only bid for putting up the necessary infrastructure, but also to maintain, improve and perhaps even innovate on the GBN," said Angara.</p>

<p style="text-align: justify">He cited General Services Administration (GSA) Networx, a program that manages the largest set of government contracts for telecommunications in the United States.</p>

<p style="text-align: justify">Through the GSA Networx, US federal agencies are able to source their information and communications technology (ICT) solutions from private contractors and vendors at competitive prices.</p>
<p style="text-align: justify">In 2007, GSA Networx awarded significant service contracts to AT&amp;T Corp., Verizon Business Services and Qwest Government Services, Inc.</p>

<p style="text-align: justify">Angara said, "ICT transforms very rapidly. For any broadband network to be responsive, it has to be updated continuously. Government should focus on its core governance functions, not on  maintaining its own network. Of course, this is not to say that caution should not be exercised in bidding out contract--more so, in fact."</p>

<p style="text-align: justify">A similar project for a national broadband network was marred with controversy during the Arroyo administration.  The US$329 million NBN-ZTE deal was cancelled in light of accusations of corruption.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
