...
<!-- file generated by WebNewsGen 100809 on 4/29/2011 3:07:55 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Statement of Sen. Ralph Recto on the resignation of Ombudsman Merceditas Gutierrez</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Statement of Sen. Ralph Recto on the resignation of 
<br />
Ombudsman Merceditas Gutierrez <!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">"This means that the latest reality TV show gets axed even before  the first live episode is aired. We won't be wearing those togas anymore. But it is a cancellation that both the actors and the audience do welcome. It doesn't mean however that this is 'The End' of this political telenovela because we are speaking here of one person's resignation and not the termination of the judicial proceedings that the cases will have to go through.  The action simply shifts to the proper forum - the courts - where these cases duly belong."</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
