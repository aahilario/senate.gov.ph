...
<!-- file generated by WebNewsGen 100809 on 10/10/2011 2:57:27 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Drilon: Road user's tax eyed to fund Metro Manila traffic control system upgrade</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->ROAD USER'S TAX EYED TO FUND METRO MANILA 
<br />
TRAFFIC CONTROL SYSTEM UPGRADE<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Proceeds from the motor vehicle user's charge (MVUC) or road user's tax are being eyed to fund the upgrade of traffic light system in Metro Manila.</p>
<p style="text-align: justify">Senator Franklin Drilon, chairman of the Senate Finance Committee, said upgrading traffic control system in the metropolis falls within the mandate of the Road Board, which oversees the disposal of the MVUC.</p>
<p style="text-align: justify">He added he will prod Public Works Secretary Rogelio Singson to allocate MVUC for the upgrade of 453 traffic light intersections and sit down with the Metropolitan Manila Development Authority (MMDA) and the Department of Public Works and Highways.</p>
<p style="text-align: justify">"We commit to assist the MMDA to get the MVUC funds," Drilon assured MMDA Chairman Francis Tolentino during a hearing on the P1.375 billion budget of the agency.</p>
<p style="text-align: justify">Tolentino lamented the "obsolete" traffic light system being used in Metro Manila, saying Cebu and Davao had been using a modern and computerized system that can monitor and prioritize areas which are heavily congested. He said that the MMDA needs approximately P1.5 billion to upgrade traffic lights.</p>
<p style="text-align: justify">Tolentino said that the Road Board is "willing to fund" about P400 million this year to develop a modern traffic response system, which could be implemented in several phases.</p>
<p style="text-align: justify">"Doing it in phases would be more feasible rather than a one-time upgrade," said Tolentino.</p>
<p style="text-align: justify">The balance, Drilon said, would be requested to the Road Board to complete the upgrade.</p>
<p style="text-align: justify">According to the MMDA chief, only P29 million of the agency's budget has been allocated for maintenance of traffic lights, which he added is insufficient to implement an upgrade.</p>
<p style="text-align: justify">The Road Board has exclusive jurisdiction over the projects which will be funded by the proceeds from MVUC. Republic Act 8794 that created it cites specific purposes for its use such as maintenance of roads, improvement of drainage system, installation of road safety devices and air pollution control.</p>
<p style="text-align: justify">The fee is collected from owners who are mandated by law to register their private, public as well as government vehicles annually at the Land Transportation Office.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
