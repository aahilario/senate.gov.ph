...
<!-- file generated by WebNewsGen 100809 on 9/26/2011 3:19:28 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Use GIS, ICT systems in disaster management - Angara</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->USE GIS, ICT SYSTEMS IN DISASTER MANAGEMENT - ANGARA<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator Edgardo J. Angara called for the deployment of a consolidated, S&amp;T-driven disaster monitoring system, as Typhoon 'Pedring' (International Name: Nesat) is expected to make landfall in the Isabela-Aurora area tomorrow.</p>

<p style="text-align: justify">Angara, Chair of the Senate Committee on Science and Technology, noted that according to the Philippine Atmospheric, Geophysical and Astronomical Services Administration (PAGASA), maximum sustained winds of 120 kph were projected to come with 'Pedring', prompting the weather agency to raise storm signals over almost all of Luzon.</p>

<p style="text-align: justify">"PAGASA definitely has the capability to determine wind strengths of typhoons, as well as estimate how much rain will fall. But to truly prepare in the face of natural disasters, we need projections on how these meteorological factors will actually affect conditions on the ground.</p>

<p style="text-align: justify">"We need to synergize our weather monitoring systems with our geographic information systems (GIS). This means advanced S&amp;T, in conjunction with ICT connectivity, has to be deployed to enhance our decision-making when it comes to potential calamities," said Angara, Chair of the Congressional Commission on Science, Technology and Engineering (COMSTE).</p>

<p style="text-align: justify">A 2010 study conducted by the United Nations Asia and Pacific Training Centre for Information and Communication Technology for Development (UN-APCICT-ESCAP) highlighted the importance of collecting disaster-related data on a national scale.</p>

<p style="text-align: justify">The study also underscored the importance of interoperability of ICT systems, so that data collected by different agencies can be used together for various purposes.</p>

<p style="text-align: justify">The veteran lawmaker noted that COMSTE has been pushing for the creation of the Philippine Disaster Science and Management Center (DSMC) to act as a clearinghouse of disaster-related data and a venue for collaboration between academe, government and the private sector.</p>

<p style="text-align: justify">"The DSMC can be a central hub for all the data we need to meaningfully address the risks brought about by strong typhoons or sudden flash floods and landslides," said Angara.  "I call on the government to immediately support and fund its creation."</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
