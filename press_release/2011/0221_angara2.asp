...
<!-- file generated by WebNewsGen 100809 on 2/21/2011 3:07:04 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Angara: Climate change experts: Human influence to bring increased flood risk</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->CLIMATE CHANGE EXPERTS: HUMAN INFLUENCE TO BRING 
<br />
INCREASED FLOOD RISK<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->

<p style="text-align: justify">The Philippine Disaster Science Management Center (DSMC) along with the Congressional Commission on Science Technology and Engineering (COMSTE) reported that a new study by three universities show that human contributions to the environment can cause more extreme rainfall and floods.</p>

<p style="text-align: justify">The study, with contributions from Environment Canada, the University of Edinburgh, and the university of Victoris indicates that, "human-influenced global warming may be partly responsible for increases in heavy precipitation."</p>

<p style="text-align: justify">The researchers used elaborate computer modeling to study the effects of natural conditions on weather variability, but the results show that under no normal natural conditions could the extreme flooding and rains come about. It is only when factoring in human contributions like carbon emissions that the extreme weather occurrences happen.</p>

<p style="text-align: justify">The DSMC and COMSTE have been holding a series of lectures by renowned scientists that present show the effects of climate change and disasters in the local setting.</p>

<p style="text-align: justify">The latest in the series of lectures was given by renowned control theorist Dr. Jose Cruz to discuss utilizing system complexity in disaster science. The lecture was entitled "Climate Change, Climategate and Geoengineering".</p>
...
<p style="text-align: justify">Dr. Kelvin Rodolfo began the series of lectures by giving a general overview of climate change with a lecture entitled, "Reading climate history from ice cores, how the world's glaciers are melting, and what that has to do with us Filipinos?"</p>
