...
<!-- file generated by WebNewsGen 100809 on 5/4/2011 1:23:58 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Angara : Protect transportation hubs vs. possible attacks</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->ANGARA : PROTECT TRANSPORTATION HUBS VS. POSSIBLE ATTACKS<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->


<p style="text-align: justify">As governments around the world beef up their security against possible retaliation following the death of Al Qaeda head Osama bin Laden, Senator Edgardo J. Angara called for stronger transport security especially in high-traffic areas like airports, seaports, and other public transportation hubs like bus stations and MRTs.</p>

<p style="text-align: justify">"Terrorist strikes are often carried out in places where there is a large amount of human traffic. The Philippines is no stranger to attacks resulting in a large number of casualties, damage to property and economic disruption," explained Angara.</p>

<p style="text-align: justify">Angara is pushing for the immediate passage of Senate Bill No. 2026: "An Act Providing for a Comprehensive Transportation Security Program, Creating for the Purpose the Philippine Transportation Security Administration (PTSA), Defining Its Powers and Functions, and Appropriating Funds Therefor".</p>

<p style="text-align: justify">The Philippine Transportation Security Act, which was filed at the beginning of the 15th Congress, seeks to protect airports, terminals and ports in the Philippines against possible terror attacks through the creation of the Philippine Transportation Security Administration (PTSA), a law enforcement agency tasked to safeguard and protect all modes of air, land and water travel.</p>

<p style="text-align: justify">Angara cited the Rizal Day bombings back in 2000 as an example: the Ninoy Aquino International Airport or NAIA, a bus along EDSA-Cubao, and the Blumentritt Station of the LRT Line 1 were all targeted with explosive devices, killing 22 people and injuring more than a hundred.</p>

<p style="text-align: justify">"Another tragedy was the SuperFerry bombing of 2004 with 116 fatalities, considered one of the worst terrorist attacks in our country. We must not let cases like these fade from memory--instead we must study them and learn how to prevent these kinds of crimes in the future," he asserted.</p>
