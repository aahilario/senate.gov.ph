...
<!-- file generated by WebNewsGen 100809 on 1/25/2011 10:34:12 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Angara: Philippine Disaster Science Center hosts the lectures of Professor Jose Cruz on system complexity applied 
...
<span class="PRTitle"><!-- NewsTitle.start -->PHILIPPINE DISASTER SCIENCE CENTER HOSTS THE LECTURES 
<br />
OF PROFESSOR JOSE CRUZ ON SYSTEM COMPLEXITY APPLIED <br />
TO REAL WORLD PROBLEMS<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->

<p style="text-align: justify">The Philippine Disaster Science Management Center (DSMC) along with the Congressional Commission on Science Technology and Engineering (COMSTE) and present a lecture by renowned control theorist Dr. Jose Cruz to discuss utilizing system complexity in disaster science, to be hosted by Ateneo de Manila University.</p>
...
<p style="text-align: justify">He has been given the Richard E. Bellman Control Heritage Award, the Curtis W. McGraw Research Award and the Richard M. Emberson Award from the Institute of Electrical and Electronics Engineers (IEEE).</p>
