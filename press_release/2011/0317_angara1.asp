...
<!-- file generated by WebNewsGen 100809 on 3/17/2011 2:04:34 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Prioritize establishment of disaster Science Center - Angara</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->PRIORITIZE ESTABLISHMENT OF DISASTER SCIENCE CENTER - ANGARA<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->

<p style="text-align: justify">Senator Edgardo J. Angara said that the establishment of the Disaster Science Management Center (DSMC) should be a national priority in order to better prepare the nation for the dealing with disasters, like the devastating earthquake that recently hit Japan.</p>
...
<p style="text-align: justify">The DSMC recently held a series of lectures tapping local and international scientists to lecture on a wide range of topics like the study of climate change on disaster science, and the use of complexity science in disaster management and prevention. The series marked the launching of the DSMC.</p>

<p style="text-align: justify">The DSMC is set to become a training center that will focus on scenario-type learning utilizing technology for disaster mitigation and management. Taiwan and Japan are already actively cooperating with training of local experts for situations like floods, earthquakes, volcanic eruptions and tsunamis.</p>

<p style="text-align: justify">The DSMC is set to be a public-private initiative that the scientific community can use to better understand the mechanics of managing disasters with the cooperation of neighboring countries that have experienced similar storms and natural calamities as the Philippines.</p>

<p style="text-align: justify">Angara noted that the DSMC will utilize tools like satellite imagery, remote sensing, and complexity science to help prepare the country for disasters.</p>

<p style="text-align: justify">Angara said that, "we need to adopt a pro-active approach in order to properly address this problem. A scientific approach supported by extensive research has already led me to appropriate PHP 100M from the budget for the establishment of a Philippine Disaster Science Center, roughly PHP40M of which is allocated for a proposed Disaster Science Management Center."</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
