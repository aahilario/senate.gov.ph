...
<!-- file generated by WebNewsGen 100809 on 9/30/2011 4:49:00 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Drilon seeks to realign DSWD overhead cost</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->DRILON SEEKS TO REALIGN DSWD OVERHEAD COST<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">Senator Franklin Drilon on Friday sought the realignment of some P1 billion in implementation cost of the Conditional Cash Transfer (CCT) program implemented by the Department of Social Welfare and Development (DSWD), saying the fund could be used to expand the benefits under the program.</p>
<p style="text-align: justify">Drilon, chairman of the Senate Finance Committee, questioned the high overhead cost of the program, saying the savings for this year could be used to bankroll the construction of classrooms, day care centers and core shelters, among others.</p>
<p style="text-align: justify">"I would like to see either you build classrooms, core shelters or day care centers in order to address the supply side," Drilon told DSWD officials during a budget hearing, also suggesting that the DSWD could increase the number of beneficiaries.</p>
<p style="text-align: justify">Based on the utilization of this year's implementation cost, Drilon said the agency could save about P1 billion out of the P4 billion implementation cost for CCT, also called the Pantawid Pamilyang Pilipino Program (4Ps).</p>
<p style="text-align: justify">Social Welfare Secretary Corazon "Dinky" Soliman said the agency "commits to submit a detailed budget on the implementation cost realigned for 2011 as agreed upon in this hearing."</p>
<p style="text-align: justify">Likewise, Drilon ordered the DSWD to review their overhead costs for CCT and the Payapa at Masaganang Pamayanan (Pamana) program for next year. The DSWD allotted P4.8 billion to implement CCT next year, representing 12% of the P39.4 billion fund for CCT, while P87 million, or about 15% of the P586.7 million Pamana fund for 2012, is earmarked as implementation cost.</p>
<p style="text-align: justify">In scrutinizing the DSWD's proposed P49.2 billion budget for 2012, Drilon said part of the agency's implementation cost for CCT included an allocation of P1.8 billion in salaries, from this year's P716 million and production of information and advocacy materials, from P333 million this year to P362.2 million.</p>
<p style="text-align: justify">"It is as if all materials will disappear next year," Drilon stated. "To me, this can stand improvement and I would suggest that you take a second look at your implementation cost to reduce this so that you can have more beneficiaries."</p>
<p style="text-align: justify">Soliman said, "We will be providing the chair and the committee also a detailed expenditure under the implementation cost for 2012. On the Pamana budget, we will be reviewing the P87 million administrative cost."</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
