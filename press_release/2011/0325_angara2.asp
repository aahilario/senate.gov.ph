...
<!-- file generated by WebNewsGen 100809 on 3/25/2011 4:09:45 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Gov't needs to set competitive fit rates for RE developers - Angara</title>
...
Press Release<br />
<!-- NewsDate.start -->March 25, 2011<!-- NewsDate.end -->
<p style="text-align: center">
<span class="PRTitle"><!-- NewsTitle.start -->GOV'T NEEDS TO SET COMPETITIVE FIT RATES 
<br />
FOR RE DEVELOPERS - ANGARA<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">Senator Edgardo J. Angara reiterated his warning that the Philippines is failing to take advantage Renewable Energy (RE) with the lack of government support for the industry, adding that the Feed In Tariff (FIT) rates need to be set in order to promote the use of RE and for the country not to lag behind as neighboring countries make aggressive moves to integrate RE systems into the energy mix.</p>
<p style="text-align: justify">Angara, Chair of the Congressional Commission on Science Technology and Engineering (COMSTE), said that RE systems like biomass have the capability to create a new green industry, which will not only benefit the country by ending foreign oil dependence but by also creating new jobs.</p>
...
<p style="text-align: justify">He added that Biomass has one of the lowest proposed FIT rates and consumer financial burden impact in the list of RE technologies submitted to the National Renewable Energy Board (NREB) at 8.22 per kilowatt hour (p/kwh) and yet, Biomass has a low installation target compared to the other RE technologies at 171 MW from 2011 to 2013.</p>
<p style="text-align: justify">Proponents for biomass also report that the potential sustainability for local communities are the use of a fuel source, including an abundance of field trash and agricultural waste, which will be produced and procured from host communities around the given biomass power plants.</p>
<p style="text-align: justify">Angara noted that biomass is sometimes overlooked as an alternative fuel source, and calls for a more detailed look into the swift development of this green industry, taking into account the potential social benefits of biomass.</p>
...
<p style="text-align: justify">According to COMSTE achieving the 65% mix is not farfetched since already the RE portion country's energy mix is at about 40%.</p>
