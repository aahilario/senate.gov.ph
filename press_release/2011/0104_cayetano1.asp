...
<!-- file generated by WebNewsGen 100809 on 1/4/2011 5:22:47 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Pia favors tighter restrictions on firecrackers sale, use</title>
...
Press Release<br />
<!-- NewsDate.start -->January 4, 2011<!-- NewsDate.end -->
<p style="text-align: center">
<span class="PRTitle"><!-- NewsTitle.start -->Pia favors tighter restrictions on firecrackers sale, use<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator Pia S. Cayetano is open to proposals to further tighten government regulations on firecrackers, following reports that 844 people were injured by firecracker blasts during New Year revelries to welcome 2011, while 11 were reportedly hurt after ingesting firecrackers.</p>
...
<p style="text-align: justify">But the senator reminded the government to be ready to define the standards and enforce full compliance if it were to expand the current policy of selectively banning certain firecrackers based on their explosives content and the hazards they pose to children.</p>
<p style="text-align: justify">"As we have seen year-in and out, there are many banned firecrackers like piccolo, pla-pla, watusi, super lolo etc., that are openly being sold in the streets. So what's the use, even of a selective ban, if our law enforcers can't properly implement it?" she asked.</p>
<p style="text-align: justify">Cayetano favors a system of tapping local government units to authorize licensed operators to handle pyrotechnics, and expanding the policy already being practiced by certain LGUs that designate firecracker zones in their respective localities.</p>
<p style="text-align: justify">"If we can guarantee support on the local government level, perhaps we can explore the option of having only licensed operators handle firework displays."</p>
<p style="text-align: justify">"LGUs can then authorize a firework display by a licensed operator on special national or local holidays only. And we can still congregate in the town plazas to watch the fireworks free from threats to our safety and with less fumes and harmful toxins released to the environment," she concluded.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
