...
<!-- file generated by WebNewsGen 100809 on 7/6/2011 1:27:36 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Cayetano: Remove 'politics' from PCSO and PAGCOR through reform</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Cayetano: Remove 'politics' from PCSO and PAGCOR through reform<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->

<p style="text-align: justify">Senate minority leader Alan Peter Cayetano reiterated the need to reform revenue-earning agencies such as the Philippine Charity Sweepstakes Office (PCSO) and Philippine Amusement and Gaming Corporation (PAGCOR) by instituting measures to remove 'politics' when dealing with the allotment of funds.</p>

<p style="text-align: justify">The senator explained that a potential conflict of interest may arise when agencies who earn the revenue are also the ones tasked to determine its use leaving it vulnerable to the influence of 'politics'.</p>

<p style="text-align: justify">"I believe that PCSO and PAGCOR, as revenue earners, should not be the one deciding where the money should go. For example, the planned P1billion allotment of PAGCOR for the construction of school buildings should be given instead to DepEd or DPWH to handle, he said.</p>

<p style="text-align: justify">Cayetano pointed out that based on his past experiences, all public servants have no choice but to refer to the PCSO and PAGCOR for funding for various projects due to the current system in place even if these are not mandated by law.</p>

<p style="text-align: justify">"It is not the job of PAGCOR to light roads or give out ambulances. It would be better, for example, if infrastructure projects are transferred to DOTC and DPWH so that there will be no politics or partisanship that comes in when it comes to the distribution of funds," he said.</p>

<p style="text-align: justify">"At the very least, the officials at PCSO and PAGCOR will not be affected by these (political influence)," he added.</p>
