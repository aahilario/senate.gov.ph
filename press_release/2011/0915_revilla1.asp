...
<!-- file generated by WebNewsGen 100809 on 9/15/2011 10:57:11 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Revilla: Statement on the proposal to exempt certain localities in the implementation the helmet law</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->STATEMENT ON THE PROPOSAL TO EXEMPT CERTAIN 
<br />
LOCALITIES IN THE IMPLEMENTATION THE HELMET LAW<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">I strongly condemn the absurd claim that the Republic Act 10054 or the Mandatory Helmet Act of 2009 aids in the commission of crimes.  Exempting certain localities in the implementation of the law will not be a guarantee that crime incidents will decrease. We must not sacrifice the safety of our riders to cover the laxity in maintaining peace and order.  Intensified law enforcement and police visibility is the key to crime prevention.</p>
<p style="text-align: justify">The compulsory wearing of standard protective helmets of all motorcycle riders, including the backriders, is already law, and this law must apply to all. It was crafted in order to address the alarming number of motorcycle-related accidents in the country. Let this law serve its purpose.</p>
<p style="text-align: justify">Walang katiyakan na masusugpo ang mga krimen kung ipagbabawal ang pagsusuot ng helmet; ang matitiyak natin ay malalagay sa panganib ang buhay ng mga nagmomotorsiklo. Hindi dapat na makompromiso ang kaligtasan ng ating mga riders.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
