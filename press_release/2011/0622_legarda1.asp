...
<!-- file generated by WebNewsGen 100809 on 6/22/2011 1:43:17 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Legarda Pushes for Child Nutrition Program in all Public Schools</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Legarda Pushes for Child Nutrition Program in all Public Schools<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator Loren Legarda has called for the establishment of a child nutrition program in all public schools nationwide to address both food insecurity and malnutrition among schoolchildren.</p>
<p style="text-align: justify">Legarda made the call following the Department of Health's appeal to schoolchildren to avoid junk food and other food items that contain ingredients such as Di(2-ethylhexyl) phthalate (DEHP), which may be dangerous to health.</p>
<p style="text-align: justify">The Senator explained that aside from urging parents to have their children bring nutritious snacks to school, the government should also establish a complementary feeding program that would ensure access to food supplements which will improve nutritional status of schoolchildren. This is what Legarda proposes under Senate Bill 2561.</p>
<p style="text-align: justify">"In addressing food insecurity, we must prioritize the needs of children who are most affected because they are the most vulnerable components of society. In fact, statistics from the DOH show that an estimated 50% of pupils are anemic, two out of ten children are iodine-deficient, and about 44.9% of schoolchildren suffer from malnutrition," Legarda said.</p>
<p style="text-align: justify">She added that the same report also revealed that four out of 100 pre-schoolers have night blindness, 84.3% of schoolchildren suffer from dental caries, and 75% from intestinal parasitism.</p>
<p style="text-align: justify">"In order to improve the health status of schoolchildren, we must have a system-wide plan to implement a nutrition and health program in schools and barangay day care centers, consisting of a complementary feeding program and may also include other nutrition-related activities such as micronutrient supplementation, weighing and growth monitoring, deworming of children, and promotion of improved hygiene practices," she stressed.</p>
<p style="text-align: justify">"This intervention is urgent, as undernourishment is largely preventable and the World Bank has reported of exceptionally high development returns to a number of direct nutrition interventions. Also, our success in addressing malnutrition is essential in meeting the Millennium Development Goals, which we aim to achieve by 2015," Legarda concluded.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
