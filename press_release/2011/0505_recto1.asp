...
<!-- file generated by WebNewsGen 100809 on 5/5/2011 11:02:06 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Recto: Senate bill rolls out tax breaks, number-coding pass &amp; parking privilege to electric-hybrid vehicles</title>
...
Press Release<br />
<!-- NewsDate.start -->May 5, 2011<!-- NewsDate.end -->
<p style="text-align: center">
<span class="PRSuper"><!-- NewsTitleSuper.start -->Shift to E-cars inevitable amid skyrocketing oil prices<!-- NewsTitleSuper.end --></span><br />
<span class="PRTitle"><!-- NewsTitle.start -->Senate bill rolls out tax breaks, number-coding pass &amp; parking privilege 
<br />
to electric-hybrid vehicles<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->

<p style="text-align: justify">Sen. Ralph G. Recto yesterday said there's no choice but to shift to harnessing electric energy to power up engines of transport vehicles to finally end the country's overdependence on expensive but fast-depleting oil.</p>
<p style="text-align: justify">"Other countries like Israel and China are already declaring freedom from petroleum dependence in the next three or four decades, we want to start the ball rolling by paving the way for a legislation that would fast track our shift to E-vehicles," Recto, chair of Senate ways and means, said.</p>
<p style="text-align: justify">"With soaring oil prices and with a downstream oil industry that can't be trusted with its price hike computations, there's really no recourse but to go electric to save oil money and save the environment," he added.</p>
<p style="text-align: justify">The senator batted for the shift to E-transport anew after oil companies raised again pump prices of gasoline on Tuesday by P1.40 to P1.50 per liter.</p>
<p style="text-align: justify">Recto said his committee will soon report out to the plenary a consolidated measure that would roll out tax incentives to people or groups which will import, convert, manufacture or assemble the pioneering fleet of electric vehicles in the country, including hybrid and other motor vehicles using alternative fuel.</p>
...
<p style="text-align: justify">Recto said E-vehicle proponents will be exempt from paying excise taxes and VAT for nine years to bring down the cost of importing and converting E-vehicles and their hybrid types, which should result to lower sticker price or dealer's price for consumers.</p>
<p style="text-align: justify">Recto said the draft committee report on the consolidated measure likewise provides other "incentives" to the developing E-motor vehicle industry such as exemption from the Motor Vehicle User's Charge and from color/number's coding to ensure all-week driving.</p>
<p style="text-align: justify">The senator said "non-tax" incentives include special priority lane for E-vehicle owners and operators when registering or renewing E-vehicles with the Land Transportation Office (LTO) and mandatory provision of parking facilities in every future commercial and public establishments.</p>
<p style="text-align: justify">Recto said under the proposed measure now being finalized for plenary approval, the LTO would issue special license plates to E-vehicle types while no building permit would be issued to business owners whose parking blueprints do not have a specially designated area for E-vehicles.</p>
<p style="text-align: justify">The senator was also joined as co-authors by Senators Juan Miguel Zubiri, Miriam Defensor-Santiago, and Antanio Trillanes IV who have filed similar measures on the matter.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
