...
<!-- file generated by WebNewsGen 100810 on 19/06/2020 2:21:42 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release -  Sen. Leila M. de Lima on Duterte's apathy towards jeepney drivers</title>
...
<span class="PRSuper"><!-- NewsTitleSuper.start -->Dispatch from Crame No. 824:<!-- NewsTitleSuper.end --></span><br />
<span class="PRTitle"><!-- NewsTitle.start -->Sen. Leila M. de Lima on Duterte's apathy towards jeepney drivers<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify; text-indent: 25px">"Gutom ang papatay sa amin, hindi COVID."</p>
<p style="text-align: justify; text-indent: 25px">Ito po ang hinaing ng marami nating jeepney drivers ngayon dahil sa  kawalang plano at malasakit sa kanila ng gobyerno.</p>
<p style="text-align: justify; text-indent: 25px">Ginawa pang dahilan ang pandemya hindi lang para pansamantalang ipatigil ang kanilang pamamasada, kundi para tuluyan nang ipagbawal ang mga lumang jeepney. Ang ilan tuloy sa kanila, namamalimos na sa kalsada. Kalunos-lunos!</p>
<p style="text-align: justify; text-indent: 25px">Ito ang problema sa gobyernong walang pakialam sa pinagdadaanan ng mahihirap.</p>
<p style="text-align: justify; text-indent: 25px">Bukod sa pagkain, maraming bayarin at pangangailangan ang dapat tustusan ng ating mga tsuper. Kahit wala pa ang krisis, pinagkakasya lang nila ang kaunting kita pagkatapos kaltasin ang boundary. Paano pa ngayon na mahigit tatlong buwan na silang hindi pinabibiyahe ng rehimeng Duterte?</p>
<p style="text-align: justify; text-indent: 25px">Huwag kayong manhid! Mag-isip naman kayo't magmalasakit!</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
