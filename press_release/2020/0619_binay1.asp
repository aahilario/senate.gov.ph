...
<!-- file generated by WebNewsGen 100810 on 19/06/2020 2:20:31 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Nancy to DOTr: Have you already tried, tested your unsafe road experiments?</title>
...
<span class="PRSuper"><!-- NewsTitleSuper.start -->With its totally impractical plans for the commuting public<!-- NewsTitleSuper.end --></span><br />
<span class="PRTitle"><!-- NewsTitle.start -->Nancy to DOTr: Have you already tried, tested your unsafe road experiments?<!-- NewsTitle.end --></span>
<br /><span class="PRSub"><!-- NewsTitleSub.start -->...doubts if agency understands people's hardships<!-- NewsTitleSub.end--></span>
</p>
<!-- NewsBody.start -->

<p style="text-align: justify">Senator Nancy Binay again asked government transport executives if they have tried and tested the transport guidelines they have put in place under General Community Quarantine (GCQ).</p>
<p style="text-align: justify">Binay expressed concern over the seemingly unsafe and poorly planned measures being implemented by the Department of Transportation (DOTr) for the commuting public.</p>
<p style="text-align: justify">"This is not the time to stretch experiments. Improving mobility and maximizing space are important, but spending on costly experiments that we know are bound to fail is totally unnecessary lalo pa ngayong kapos sa pondo," the senator said.</p>
<p style="text-align: justify">According to Binay, chaos and travel miseries will continue to confront the commuting public under GCQ or MGCQ until no holistic and realistic public transport plan is put in place.</p>
<p style="text-align: justify">"Sana try din nilang testingin yung kanilang science projects sa EDSA--para kasing virtual experiment ang ginagawa sa mga mananakay. Wag na po nating ipilit yung mga hilaw at minadaling plano sa EDSA which placed public safety as a secondary concern. Di po EDSA ang classroom sa online learning," she noted.</p>
<p style="text-align: justify">Moreover, Binay also questioned the transport agency's plan to place bus stops in the middle lane of EDSA saying this plan would not only cause safety concerns for passengers but also needs infrastructure that will not be readily built.</p>
<p style="text-align: justify">"Papaano naman yung mga pasahero? Saan sila tatawid para makapunta sa gitna ng EDSA? Lalo din papahirapan nito ang ating mga senior citizen at PWDs. If DOTr genuinely believes that their plans are well-thought of, then we presume that they understand the hardships of commuters under M/GCQ. ," Binay said.</p>
<p style="text-align: justify">"What we see now are totally unrealistic and impractical transport plans. Our workers and the commuting public don't deserve this kind of treatment. Ang nakakaloka, halos linggo-linggo ay may bagong ganap sa EDSA," Binay pointed out.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
