...
<!-- file generated by WebNewsGen 100810 on 08/05/2020 12:04:39 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Sen. Leila M. de Lima's Reaction to PAGCOR's One-Page Ad, Re: POGOs</title>
...
<span class="PRSuper"><!-- NewsTitleSuper.start -->Dispatch from Crame No. No. 792:<!-- NewsTitleSuper.end --></span><br />
<span class="PRTitle"><!-- NewsTitle.start -->Sen. Leila M. de Lima's Reaction to PAGCOR's One-Page Ad, Re: POGOs<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify; text-indent: 25px">Saw the other day in one of the major dailies a one-page ad - "The Truth About POGO: A Primer" - issued by PAGCOR, detailing the virtues of POGOs, even stressing that POGO is "not prostitution" and "not criminality."</p>
<p style="text-align: justify; text-indent: 25px">What these pro-POGO public functionaries failed to address is this simple, fundamental question - why are these POGOs being recognized and extolled here, and given the status and perks of a legitimate enterprise, when they are outlawed in their country of origin? Where is the logic and the morality of it all? This legal and social anomaly is unacceptable.</p>
<p style="text-align: justify; text-indent: 25px">We also need to ask, and aggressively seek for the answer to this - who are the unseen Filipino hands behind these Chinese POGOs? Who are these traitors?</p>
<p style="text-align: justify; text-indent: 25px">#NoToPOGOs</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
