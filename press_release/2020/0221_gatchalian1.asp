...
<!-- file generated by WebNewsGen 100810 on 2/22/2020 4:18:08 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Gatchalian urges DepEd: work with LGUs to enhance reading intervention programs</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Gatchalian urges DepEd: work with LGUs to enhance reading intervention programs<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->

<p style="text-align: justify">After the Philippine Informal Reading Inventory 2019's (Phil-IRI) pre-test results revealed a big number of struggling readers in Bicol, Senator Win Gatchalian urged the Department of Education (DepEd) to closely work with local government units (LGUs) to enhance intervention programs for struggling readers and non-readers.</p>

<p style="text-align: justify">Phil-IRI is a classroom-based assessment tool that determines whether students' reading and listening skills are appropriate to their grade level. According to Gatchalian, the results of the Phil-IRI should guide schools and LGUs to implement their intervention programs. To date, DepEd has not released the official nationwide results.</p>

<p style="text-align: justify">According to DepEd Undersecretary Nepomuceno Malaluan, it is difficult to release the results because the Phil-IRI is not standardized like the National Achievement Test (NAT). Hence, the data could not be used for analysis or guide policy implementation. For Gatchalian, however, it is a waste of time and resources to administer the Phil-IRI if it cannot guide future policies and interventions.</p>

<p style="text-align: justify">"DepEd should take Phil-IRI seriously. It should conduct a nationwide assessment and release the overall results", said Gatchalian.</p>

<p style="text-align: justify">The recent Phil-IRI revealed that 20,857 students from Grades 4 to 6 in Bicol are struggling to read in English and 18,143 students from Grades 3 to 6 who took the Filipino test are struggling readers too. According to the DepEd Region 5, students in Grade 4 to 6 who took the English test are the same ones who took the Filipino exams.</p>

<p style="text-align: justify">"Mahalagang malaman natin ang kabuuang larawan pagdating sa kakayahan ng ating mga mag-aaral upang malaman natin kung paano ba natin maiaangat ang kanilang kakayahang magbasa. Matapos lumabas itong datos ng Phil-IRI sa Bicol, malinaw sa atin ngayon kung bakit kailangan natin ng reporma sa ating sistema ng edukasyon upang masigurong walang batang maiiwan," stressed Gatchalian.</p>
...
<p style="text-align: justify">The first "Summer Reading Camp" had 18,736 participants from Grades 3 to 6. In 2016, the Development Academy of the Philippines (DAP) reported that the program helped 5,536 out of 6,375 non-readers in Valenzuela become instructional and independent readers.</p>

<p style="text-align: justify">The lawmaker also said that the Phil-IRI's findings reinforce the urgency of enacting education reforms following the dismal results of the 2018 Programme for International Student Assessment (PISA). The triennial survey by the Organisation for Economic Co-Operation and Development (OECD) revealed that out of 79 countries, the Philippines ranked lowest in Reading Comprehension.</p>
