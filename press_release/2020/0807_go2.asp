...
<!-- file generated by WebNewsGen 100810 on 8/8/2020 12:37:40 PM -->
<head>
...
<br /><span class="PRSub"><!-- NewsTitleSub.start -->Re: Creation of Task Force against Deeply Rooted and Systemic Corruption<!-- NewsTitleSub.end--></span>
</p>
<!-- NewsBody.start -->

<p style="text-align: justify">Tulad ng sabi ko, hindi po titigil si Pangulong Duterte na labanan ang corruption. Mabilis niyang tinutugunan ang hinaing ng taumbayan at ang panawagan nating magkaroon ng isang Task Force na may kakayahang linisin ang mga ahensyang laganap ang anomalya at panagutin ang mga mapatunayang may sala.</p>
<p style="text-align: justify">Sa paglabas ng kautusan ngayong araw, inaasahan natin na ang Task Force na ito -- sa pangunguna ng DOJ, kasama ang Ombudsman, COA, CSC, OES, at sa tulong rin ng PACC -- ay gagawin ang lahat upang matuldukan na ang mga problema sa PhilHealth. Bibigyang diin nito ang problema sa kabuuan ng organisasyon, sa loob at baba ng ahensya, na sanhi ng tinatawag nating 'deeply rooted and systemic corruption'.</p>
<p style="text-align: justify">With more teeth, we expect this Task Force to discharge its key mandates without fear or favor and with greater haste.  These mandates shall include the authority to initiate thorough investigation, conduct audit and lifestyle checks, recommend suspensions, prosecute and file cases, and ensure that those accountable be put in jail.</p>
<p style="text-align: justify">As chair of the Senate Committee on Health, I enjoin all agencies of government to cooperate and support the efforts of the Task Force.</p>
<p style="text-align: justify">Habang nilalabanan natin ang COVID-19, hindi rin tayo titigil hanggang mabigyan ng mabisang lunas ang malubhang sakit na dulot ng corruption sa buong sistema ng gobyerno.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
