...
<!-- file generated by WebNewsGen 100810 on 27/05/2020 9:58:19 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Sen. Leila M. de Lima's Quick Reaction to President Duterte's May 25 Address</title>
...
<span class="PRSuper"><!-- NewsTitleSuper.start -->Dispatch from Crame No. 803:<!-- NewsTitleSuper.end --></span><br />
<span class="PRTitle"><!-- NewsTitle.start -->Sen. Leila M. de Lima's Quick Reaction to President Duterte's May 25 Address<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify; text-indent: 25px">5/26/20</p>
<p style="text-align: justify; text-indent: 25px">How can we win the fight against the COVID-19 pandemic with such a reactive governance?</p>
<p style="text-align: justify; text-indent: 25px">In his latest address, Mr. Duterte just reacted to the issues. They explained why the PPEs are so expensive. He ordered the forced return of OFWs to their hometown. Then he guaranteed that schools will not open without COVID-19 vaccine.</p>
<p style="text-align: justify; text-indent: 25px">The problem with the overpriced PPEs could have been avoided if the DOH was transparent with the specification and the negotiations in the first place.</p>
<p style="text-align: justify; text-indent: 25px">The problems with schools opening and the OFW crisis could have been avoided with a systematic mass testing plan. The fears surrounding these issues are borne of uncertainty. Dahil wala tayong maayos na mass testing program, hindi alam ng mga LGU kung sino ang ligtas na puwedeng tanggapin. Hindi rin alam ng mga magulang kung anong mga paaralan ang ligtas para sa kanilang anak.</p>
<p style="text-align: justify; text-indent: 25px">If the administration prioritized the mass testing program, we could have contained the COVID-19 earlier and the fears would have been less founded. In spite of repeated guarantees, we are only capable of around 10,000 tests per day. No matter what Harry Roque says, if we are unable to do 30,000 tests a day, WE DO NOT HAVE THE CAPACITY TO DO 30,000 TESTS A DAY. It is amazing the lengths this administration will go just to hide their failure to do the critical steps towards managing the COVID-19 pandemic.</p>
<p style="text-align: justify; text-indent: 25px">The issue with the OFWs is one of unforgivable negligence. They were quarantined for two months before being tested for COVID-19. Then, in spite of being tested, the certification of their negative results took more than two weeks to get printed. The OFWs in quarantine suffered depression due to the inaction of the government. An OFW from Kuwait even committed suicide out of despair.</p>
<p style="text-align: justify; text-indent: 25px">This is absolutely unacceptable. Must we let our people suffer before we do anything?! Enough of this slow, reactive, and weak leadership. Nasaan na ang tapang at malasakit? Nasaan ang sinasabing pagbabago?</p>
<p style="text-align: justify; text-indent: 25px">(Access the handwritten copy of Dispatch from Crame No. 803 here: 
<a href="https://issuu.com/senatorleilam.delima/docs/dispatch_no._803">https://issuu.com/senatorleilam.delima/docs/dispatch_no._803</a>)</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
