...
<!-- file generated by WebNewsGen 100810 on 02/04/2020 12:00:56 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Sen. Leila M. de Lima on NBI's probe on Pasig City Mayor Vico Sotto's Alleged Violation of Bayanihan to Heal as One Act</title>
...
<span class="PRSuper"><!-- NewsTitleSuper.start -->Dispatch from Crame No. 759:<!-- NewsTitleSuper.end --></span><br />
<span class="PRTitle"><!-- NewsTitle.start -->Sen. Leila M. de Lima on NBI's probe on Pasig City Mayor Vico Sotto's Alleged Violation of Bayanihan to Heal as One Act<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify; text-indent: 25px">NBI sounds pathetic in trying to explain their action in requiring Pasig City Mayor Vico Sotto to explain an alleged violation. NBI is defending an indefensible position.</p>
<p style="text-align: justify; text-indent: 25px">Quite justified is the indignation from many netizens. There is no case here. Didn't the Mayor promptly comply when the national authorities put their foot down on the issue, re: tricycles? Mantakin ninyo: Pagpaliwanagin ba naman si Mayor Vico sa paglabag sa batas na hindi pa naman noon ipinatutupad?</p>
<p style="text-align: justify; text-indent: 25px">Pilit na pilit. Ano ba yan, NBI? For the sake of its institutional integrity, NBI should drop this case.</p>
<p style="text-align: justify; text-indent: 25px">Kung ego at kapritso lang ang paiiralin ni Duterte at ng kanyang gobyerno, lalong mapapahamak ang mga Pilipino-mula sa mga frontliners nating di-agarang nabibigyan ng tulong at proteksyon, mga kababayan nating wala nang kinikita at kumakalam ang sikmura sa gutom, hanggang sa mga di-makatarungang inaaresto at ikinukulong.</p>
<p style="text-align: justify; text-indent: 25px">Bakit kasi hindi na lang tumulong sa mga nagtatrabaho nang matino para makahanap ng solusyon at mabigyan ng sapat na ayuda ang mamamayan?</p>
<p style="text-align: justify; text-indent: 25px">#ProtectVico</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
