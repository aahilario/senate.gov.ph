...
<!-- file generated by WebNewsGen 100810 on 7/19/2020 8:16:44 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Recto: 'Sana all': Level up minimum pay of med-tech, dietitians, radiologists to nurses</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->'Sana all': Level up minimum pay of med-tech, dietitians, radiologists to nurses<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">The "sana all" principle must be applied to the salaries of health workers in government, because a pay raise for one should cause a raise for all.</p>
<p style="text-align: justify">The Salary Grade (SG) 15 entry level position of nurses should be recognized as the new benchmark for compensation for all licensed health professionals in the government.</p>
<p style="text-align: justify">If done, it would make the current monthly base pay of P32,053 of an SG-15 nurse as their new minimum wage.</p>
<p style="text-align: justify">("Current" because salary increases are scheduled on 2021 and 2022, under the Salary Standardization Law V. "Base pay" because the Magna Carta for Public Health Workers mandates other allowances such as the Hazard Pay, which is at least 25% of monthly basic pay for SG-19 and below holders and at least 5% for SG-20 and above employees, among other extra pay and bonuses.)</p>
<p style="text-align: justify">The pandemic has shown the bravery of other white coats in the trenches battling the virus and saving lives--and who deserve a pay raise.</p>
<p style="text-align: justify">For example, many medical technologists--those in hazmat suits who take samples and test them for COVID 19--are holding SG-11 items, with a monthly base pay of P22,316.</p>
<p style="text-align: justify">Many radiologic technologists and dietitian-nutritionists, PRC test passers like nurses, have also been marooned in SG-11. Mga stranded individuals din sila, denied of a ticket to a pay hike. Buti pa ang rookie na Patrolman, P30,000 kaagad ang base pay.</p>
<p style="text-align: justify">The entry level pay of government dentists, which is SG-17's P38,464 per month, should be increased, too. It contributes to the lack of dentists in the public health system, rendering it a toothless entity.</p>
<p style="text-align: justify">Isa pa ring dapat i-delete na government plantilla of positions ay ang sa mga doktor.</p>
<p style="text-align: justify">Hanggang ngayon, nakasaad pa rin doon na ang entry level item ng doktor ay Medical Officer I, na babayaran lang ng P29,277 kada buwan. Dapat at least Salary Grade 23 ang entry-level position, na halos P76,000 ang base monthy pay, hindi pa kasama ang mga allowances.</p>
<p style="text-align: justify">So that local governments can afford the increases, as health services have been devolved to them, the Supreme Court ruling on the correct computation of the Internal Revenue Allotment must be implemented immediately.</p>
<p style="text-align: justify">We must not valorize our frontliners with platitudes. They are best honored by providing them with PPEs, better pay and support services, which they have earned for themselves with their sacrifices and selflessness. Making such a grant is the duty of the government, not merely a prerogative.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
