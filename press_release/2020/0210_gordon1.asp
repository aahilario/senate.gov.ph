...
<!-- file generated by WebNewsGen 100810 on 10/02/2020 2:40:10 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Gordon: PH Red Cross ready to respond to nCoV</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->PH RED CROSS READY TO RESPOND TO NCOV<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">With the growing number of persons under investigation (PUI) for the 2019 Novel Coronavirus Acute Respiratory Disease, the Philippine Red Cross (PRC) heightened its preparation by providing personal protective equipment (PPE) to its frontline staff and volunteers to ensure their safety while handling cases of suspected Coronavirus.</p>
<p style="text-align: justify">PRC Chairman Senator Richard J. Gordon said, "The Philippine Red Cross is ready to respond to the Coronavirus scare. As it is important to us that we guarantee the protection of our staff and volunteers who are handling suspected cases of Coronavirus, we provide them with PPE sets for them to use during operations. We want our people to be protected and for us, prevention is of highest importance."</p>
<p style="text-align: justify">There are two different types of PPEs being used by the PRC. The basic set is the standard set used by frontline workers coordinating with the families of suspected patients, while the frontline set is for staff who has direct contact with confirmed cases such as those assigned in ambulances. These staff are required to wear a three-layered clothing, double masks (medical N95 and surgical masks), and double gloves for extra protection.</p>
<p style="text-align: justify">"We have prepositioned PPE sets to our key chapters with international airports and to PRC regional warehouses because we want to make sure that the PPEs are available to chapters whenever needed. We will purchase more of this equipment because we'll never know when will the spread of the virus stop. Better safe than sorry," Gordon said.</p>
<p style="text-align: justify">The PRC has been very vigilant in monitoring suspected cases of nCov in the country and has been promoting health and hygiene activities such as the proper washing of hands as part of its prevention intervention.</p>
<p style="text-align: justify">As part of its response mechanism, the PRC ensures that ambulance crew are properly trained in infection precaution. Welfare desks are also established in airports and in hospitals, while sufficient blood supply is ensured. Likewise, the PRC will be ready to provide medical tents to key hospitals in order to provide additional space to manage patients.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
