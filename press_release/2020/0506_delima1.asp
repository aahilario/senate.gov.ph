...
<!-- file generated by WebNewsGen 100810 on 06/05/2020 9:58:17 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Sen. Leila M. de Lima's Comments on President Duterte's 4 May 2020 Address; Agressive Mass Testing is Still the Key</title>
...
<span class="PRSuper"><!-- NewsTitleSuper.start -->Dispatch from Crame No. 790:<!-- NewsTitleSuper.end --></span><br />
<span class="PRTitle"><!-- NewsTitle.start -->Sen. Leila M. de Lima's Comments on President Duterte's 4 May 2020 Address; Agressive Mass Testing is Still the Key<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify; text-indent: 25px">5/5/20</p>
<p style="text-align: justify; text-indent: 25px">50 araw na ang quarantine natin, wala pa ring ideya ang ating bansa kung paano matatapos ang quarantine.</p>
<p style="text-align: justify; text-indent: 25px">The case of the repatriated OFWs provide us a glimpse of what is happening in our country right now. Some of them have been isolated for more than a month now and, still, their respective hometowns refuse to accept them back. The reason is that we still do not have a systematic testing program that would provide the LGUs with the confidence that they will not endanger public health.</p>
<p style="text-align: justify; text-indent: 25px">It has always been about mass testing. As long as we are behind on testing, we would not be able to move on. We would be bleeding money until we find a way to agressively test, contact-trace and isolate those who are infected.</p>
<p style="text-align: justify; text-indent: 25px">Ilang paalala pa po ba ang kailangan natin bago tayo umabot sa antas ng mass testing na makakatulong sa atin pong mga LGU? Konting bilis lang po sana. Naiinip na po ang sambayanan.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
