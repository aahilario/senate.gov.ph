...
<!-- file generated by WebNewsGen 100810 on 4/16/2020 2:59:51 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Gordon: PRC's COVID-19 testing center, now operational</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->PRC'S COVID-19 TESTING CENTER, NOW OPERATIONAL<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">The Philippine Red Cross (PRC) has taken another step in its campaign to help prevent the spread of the Coronavirus disease-2019 (COVID-19) after its testing center in its national headquarters located along EDSA started operations on Wednesday.</p>
<p style="text-align: justify">Senator Richard J. Gordon, PRC chairman and CEO, said the country's foremost humanitarian organization has taken on a new function with its PRC Molecular Laboratory.</p>
<p style="text-align: justify">"At present, we have two testing machines, with each one capable of conducting up to 1,500 tests per day, at makakatulong 'yan so we can test more people. Mas madali nating matatanggalan ng maskara ang kalaban, hindi natin kalaban 'yung taong maysakit kungdi 'yung taglay niyang sakit. Pag nakita na natin 'yung kalaban, at least mahihiwalay na natin iyan dun sa mga grupo ng mga taong wala at mapagamot na siya kaagad. At mababawasan 'yung human-to-human contact na mangyayari kung di natin siya aalisin sa isang barangay," he said.</p>
<p style="text-align: justify">Gordon said the PRC has already entered, or is in the process of entering into memoranda of agreement with four local government units in Metro Manila, namely Quezon City, Caloocan, Makati and Mandaluyong. The said LGUs will shoulder the testing cost for their constituents.</p>
<p style="text-align: justify">Swabbing will be conducted in the barangays by PRC or LGU personnel trained by the Research Institute for Tropical Medicine (RITM). Then the test kits will be transported to the Molecular Laboratory in Mandaluyong. There the samples will be placed inside the testing machine including the automated RNA extractor and then the PCR MA 6000 will determine whether the sample is negative or positive.</p>
<p style="text-align: justify">The PRC chairman said the public can also avail of the testing by appointment to ensure that social distancing will be strictly complied with at the testing center. They can call 1158, the PRC's COVID hotline, where trained PRC staff and volunteers, which include doctors, will interview them and schedule them for testing if needed or refer them to appropriate hospitals.</p>
<p style="text-align: justify">Gordon thanked the PRC's staff who worked hard to build the testing center and the RITM, Health Secretary Francisco T. Duque III, Foreign Affairs Secretary Teodoro Locsin, Jr. and Philippine Ambassador to China Jose Santiago "Chito" Sta. Romana for their help in setting up the facility.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
