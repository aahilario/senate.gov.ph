...
<!-- file generated by WebNewsGen 100810 on 03/04/2020 2:51:26 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Lacson: Data is Key: Flattening the Curve, Preventing a Recession, and Aiding the Poor</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Data is Key: Flattening the Curve, Preventing a Recession, and Aiding the Poor<!-- NewsTitle.end --></span>
<br /><span class="PRSub"><!-- NewsTitleSub.start -->More at: 
<a href="https://pinglacson.net/2020/04/03/data-is-key-flattening-the-curve-preventing-a-recession-and-aiding-the-poor/">https://pinglacson.net/2020/04/03/data-is-key-flattening-the-curve-preventing-a-recession-and-aiding-the-poor/<!-- NewsTitleSub.end--></a></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">It is a most difficult decision to strike a balance between flattening the curve of COVID-19 and the looming economic recession due to a wide swath of business inactivity.</p> <p style="text-align: justify">Thus, it is better left to those who have almost unlimited access to all the relevant data to decide which is the best course of action to take moving forward.</p> <p style="text-align: justify">Having said that, I am sure that if Congress is provided with all those data, we can help in the policy direction.</p> <p style="text-align: justify">On the other hand, there is no perfect system of distribution of aid considering the number of families involved in the cash dole-out, further complicated by a less efficient database due to the late implementation of the National ID system.</p> <p style="text-align: justify">Just as intelligence information can spell the difference between success and failure in my previous life in intelligence and law enforcement work, data is the key for our policy makers to make the right decisions at this critical time.</p></p>
<!-- NewsBody.end -->
</td><td id="sidepane">
