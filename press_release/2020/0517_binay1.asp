...
<!-- file generated by WebNewsGen 100810 on 5/17/2020 2:54:17 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Statement of Sen Nancy Binay</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->STATEMENT OF SEN NANCY BINAY<!-- NewsTitle.end --></span>
<br /><span class="PRSub"><!-- NewsTitleSub.start -->on reports of overcrowding in MECQ areas<!-- NewsTitleSub.end--></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">What is worrisome is that when the IATF declared some areas as GCQ and MECQ, the LGUs --and even national agencies-- are not even prepared, or even near in realizing the Covid T3 strategy which is supposed to be already in a satisfactory operational level by this time.</p>
<p style="text-align: justify">Kaya 'yong sinasabing "second wave", we all know that it's not a question of if, but when. At kung pagbabatayan natin 'yong bugso ng mga tao kahapon (May 16), well, don't expect just a second wave--prepare for a tsunami!</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
