...
<!-- file generated by WebNewsGen 100810 on 06/08/2020 11:23:24 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Sen. Leila M. de Lima's Further Comments on the renewed Push for Death Penalty</title>
...
<span class="PRSuper"><!-- NewsTitleSuper.start -->Dispatch from Crame No. 872:<!-- NewsTitleSuper.end --></span><br />
<span class="PRTitle"><!-- NewsTitle.start -->Sen. Leila M. de Lima's Further Comments on the renewed Push for Death Penalty<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify; text-indent: 25px"><p style="text-align: justify">I am in full agreement with Sens. Gordon and Pangilinan when they assert that the proposed death penalty measure should not be a priority over the COVID-19 response and recovery plans. Sen. Gordon says, "why do we have to talk about this now?" Mismo! In fact, this issue should not be tackled at all.</p> <p style="text-align: justify">To insist on taking up the proposed measure at this time is the height of insensitivity and foolhardiness. If anything, this proposal by Mr. Duterte to revive the death penalty debate betrays his utter lack of resolve in solving this COVID-19 crisis. A true leader would have nothing else in mind other than leading us through this pandemic.</p> <p style="text-align: justify">Kung hindi kaya ni Duterte na pagtuunan ng pansin ang isyu ng COVID-19 at ekonomiya, mas mabuti pa na magresign na lang siya at hayaang iba na ang mamahala sa ating bansa.</p> <p style="text-align: justify">Hinihikayat ko ang aking mga kasamahan sa Kongreso na mag-focus muna tayo sa kasalukuyang krisis. Hayaan na muna natin ang DOJ at PNP na gawin ang kanilang mandato laban sa krimen. Huwag natin ilihis ang pansin ng ating mga kababayan.</p> <p style="text-align: justify">Huwag naman sana kayong mga maging sunud-sunuran sa lahat ng kagustuhan ni Duterte. Pwede ba, i-defy niyo naman siya paminsan-minsan!</p></p>
<!-- NewsBody.end -->
</td><td id="sidepane">
