...
<!-- file generated by WebNewsGen 100810 on 21/07/2020 8:33:49 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Pangilinan: Why did imported test kits not go through rigid evaluation as local kits?</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Pangilinan: Why did imported test kits not go through rigid evaluation as local kits?<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">AFTER Minority Senators questioned the delay in the use and mass production of Filipino-made test kits, Sen. Francis "Kiko" Pangilinan on Monday welcomed the announcement of the Department of Health (DoH) on the commercial use of the GenAmplify RT-PCR test kits.</p>
<p style="text-align: justify">"After almost 6 months, magagamit na sa wakas ang mga test kit na gawang Pinoy na mahigit kalahati ang presyo kumpara sa imported. Kung hindi pa natin kinalampag nung isang araw baka umabot pa ng taon bago gamitin," he said.</p>
<p style="text-align: justify">At the same time, Pangilinan still wonders why imported test kits from China and Korea, which costs between ₱4,000 and ₱8,000, or more than double than the locally made ones, appeared to be favored than the Filipino test kits.</p>
<p style="text-align: justify">"Ang sabi sa atin ng mga insiders sa DoH, walang kahirap-hirap ang mga imported test kits, samantalang pinahirapan talaga itong gawa ng Pinoy. Dapat sagutin ng pamunuan ng DoH kung bakit natagalan bago natin nagamit itong mas abot-kaya at de kalidad na test kits. May kumikita ba at nakikinabang sa mas mahal na imported test kits?" he asked.</p>
...
<p style="text-align: justify">"Malaki ang matitipid ng gobyerno sa paggamit sa test kits na gawa ng UP. Kaya dapat mas paigtingin na ngayon ng DoH ang testing, tracing, at treatment lalo na't nangunguna tayo sa pinakamaraming active cases sa ASEAN," Pangilinan said.</p>
<p style="text-align: justify">The Reverse Transcription Polymerase Chain Reaction or RT-PCR test of UP-NIH is said to be the gold standard in testing for COVID-19. It detects the actual presence of the SARS-COV-2, which causes COVID-19, unlike in rapid antibody test kits which can only detect the presence of antibodies in an individual and not the actual virus.</p>
<p style="text-align: justify">An interim report showed that the GenAmplify RT-PCR tests kits have up to 93.96% sensitivity and up to 98.04% specificity, at a confidence interval of 95%, ranking among the world's best and performing better than some of the imported kits.</p>
<p style="text-align: justify">In the interest of transparency, Pangilinan said the public needs to know actual and projected DoH expenses for the rapid and PCR test kits as part of its response to the pandemic.</p>
<p style="text-align: justify">"How much more fund is allocated for procurement of more kits? In the budget for 2021, how much is the DoH proposing for such expense?" he asked.</p>
<p style="text-align: justify">"As concerned as we are for the health of the Filipinos, we are also keenly looking after the well-being of our state coffers. Every peso of meaningful, honest, and transparent spending and saving will go a long way, especially amid an economic crisis," he added.</p>
<p style="text-align: justify">On Sunday, the total number of COVID-19 cases in the Philippines reached 67,456, with 43,160 active cases, the highest number of active cases in the Southeast Asian region.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
