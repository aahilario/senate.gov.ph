...
<!-- file generated by WebNewsGen 100810 on 10/06/2020 2:48:03 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Sen. Leila M. de Lima on the relaxing of the strict, no visitors policy at the PNP Custodial Center</title>
...
<span class="PRSuper"><!-- NewsTitleSuper.start -->Dispatch from Crame No. 820:<!-- NewsTitleSuper.end --></span><br />
<span class="PRTitle"><!-- NewsTitle.start -->Sen. Leila M. de Lima on the relaxing of the strict, no visitors policy at the PNP Custodial Center<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">Finally, the strict no access, no visitors policy here at the PNP Custodial Center has been relaxed, by allowing scheduled visits, on specific days a week, from family members and selected staff, lawyers, personal doctors and spiritual advisers, all in limited nos. and limited time slots. No other visitors are allowed at this point.</p> <p style="text-align: justify">While far from ideal, I can live with this interim set-up. Good enough, in keeping with the avowed objective of ensuring the good health and safety of the PDLs and custodial personnel while the COVID-19 pandemic rages on.</p> <p style="text-align: justify">I just hope that there will be gradual expansion in the restoration of visitation rights, both in terms of scope and duration.</p> <p style="text-align: justify">Thank you for your prayers and support.</p></p>
<!-- NewsBody.end -->
</td><td id="sidepane">
