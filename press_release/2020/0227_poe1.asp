...
<!-- file generated by WebNewsGen 100810 on 27/02/2020 12:17:59 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Grace Poe on House letter to NTC:</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->GRACE POE ON HOUSE LETTER TO NTC:<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">We welcome the decision of the House to finally give NTC the necessary guidance on the ABS-CBN franchise. However, I share the opinion that a concurrent resolution by the Senate and the House is needed to allow the network to operate while the 18th Congress tackles its franchise renewal.</p>
<p style="text-align: justify">Kailangang malinaw ito para maisarado na rin ang isyu.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
