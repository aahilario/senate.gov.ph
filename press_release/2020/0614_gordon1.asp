...
<!-- file generated by WebNewsGen 100810 on 6/14/2020 5:24:21 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Gordon welcomes accreditation of bio-molecular labs in Subic, Clark</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->GORDON WELCOMES ACCREDITATION OF BIO-MOLECULAR LABS IN SUBIC, CLARK<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Amid the rising number of cases positive for COVID-19, Senator Richard J. Gordon, chairman and CEO of the Philippine Red Cross, welcomed the accreditation of the PRC's bio-molecular laboratories in Subic and Clark as the additional facilities will boost the PRC's testing capacity.</p>
<p style="text-align: justify">Gordon said the two laboratories will be formally opened this week since they are now ready to operate after passing the Research Institute for Tropical Medicine's proficiency test last Friday and accredited as certified COVID-19 testing centers.</p>
<p style="text-align: justify">The Subic laboratory is located at the PRC Logistics and Training Center inside the Subic Bay Freeport Zone and the swabbing will be done at the SBF's Main Gate. The facility can run up to 2,000 tests a day. Meanwhile, the Clark laboratory, located at Clark Freeport Zone, is also capable of running the same number of tests.</p>
<p style="text-align: justify">"This is a very welcome development. We can do a total of 4,000 tests per day in the two new facilities, which will enable us to run an over-all total of 16,000 tests a day. And with the hotel capabilities of both Subic and Clark, repatriation flights for overseas Filipino workers can now be directed to the airports in the two cities," the PRC chairman said.</p>
<p style="text-align: justify">Three of PRC's COVID testing centers, two in its national headquarter along EDSA and one in its former headquarters in Port Area, Manila, are already up and running. All equipped with four polymerase reaction chain machines each, the three facilities are capable of running 4,000 tests each per day.</p>
<p style="text-align: justify">Aside from the facilities in Subic and Clark, the PRC is opening up eight other testing centers in Batangas, Laguna, Mandaue City, Isabela, Cagayan de Oro, Zamboanga City, Bacolod City, and Surigao. It will also add ten more PCRs in the Port Area molecular lab, which will enable the Red Cross to conduct a total of 46,000 tests per day.</p>
