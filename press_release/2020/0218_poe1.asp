...
<!-- file generated by WebNewsGen 100810 on 18/02/2020 12:30:31 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Grace Poe on motion for gag order:</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->GRACE POE ON MOTION FOR GAG ORDER:<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Our hearing will push through according to our Constitutional mandate. It is up to the Supreme Court to act on that motion under existing laws and jurisprudence where it recognized the jurisdiction of its co-equal branch.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
