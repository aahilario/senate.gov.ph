...
<!-- file generated by WebNewsGen 100810 on 02/06/2020 2:04:35 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Lacson: Simple, Cheap and Effective: Contact Tracing Solutions from LGUs that the DOH Can Adopt</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Simple, Cheap and Effective: Contact Tracing Solutions from LGUs that the DOH Can Adopt<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">More at: 
	<a href="https://pinglacson.net/2020/06/02/simple-cheap-and-effective-contact-tracing-solutions-from-lgus-that-the-doh-can-adopt/">https://pinglacson.net/2020/06/02/simple-cheap-and-effective-contact-tracing-solutions-from-lgus-that-the-doh-can-adopt/</a></p>
	<p style="text-align: justify">Simple technologies that we now take for granted may yet be the biggest help in fighting the spread of COVID-19, as shown by the initiatives of at least two local governments.</p>
<p style="text-align: justify">In Carmona, Cavite, the local government under Mayor Roy Loyola has developed a contact tracing app - the Carmona COVID-19 Tracker. The app, which works on Android and iOS, can use the mobile phone's GPS to track users' location history.</p>
<p style="text-align: justify">The app allows users to log interactions with other people; and do self-assessment if they experience symptoms. In just a few days of implementation, the local government has already signed up 42,000 out of the municipality's 97,557 residents. For those without smartphones, the local government's barangay and police personnel can input the information for them.</p>
<p style="text-align: justify">Meanwhile, in Baguio City, the local government under Mayor Benjamin Magalong is doing contact tracing using the EndCovid-19 system, which relies on the geographical information system (GIS) platform to plot the areas where possible COVID-19 carriers live - similar to that which he introduced when he was Cordillera regional police chief.</p>
<p style="text-align: justify">Combined with cognitive interviews and analytical tools, the system has made Baguio City a model for contact tracing.</p>
<p style="text-align: justify">With these technologies, we can potentially save P11.7 billion being asked by the Department of Health for contact tracers. I share Senate President Vicente Sotto III's sentiment that there are more practical uses for the amount. These may include livelihood programs for those affected by the COVID-triggered lockdowns, among others.</p>
<p style="text-align: justify">Our national agencies, including the Department of Health, need not look far for contact tracing solutions that are effective, yet are not intrusive. Instead, they must take a cue from our LGUs. Especially given our limited resources, they can do no less.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
