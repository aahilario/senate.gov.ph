...
<!-- file generated by WebNewsGen 100810 on 5/25/2020 4:57:43 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - No reading, no billing--Recto</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->No reading, no billing--Recto<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">"No reading, no billing." The simplest of formulas in computing utility usage is the most fair.</p>
<p style="text-align: justify">This is what water utilities should also use so they can avoid the public uproar which greeted one power utility's guesstimate way of billing.</p>
<p style="text-align: justify">This must be the rule across all utilities, so that in the event of another lockdown prompted by a second or a third wave of COVID-19 infections, there is now a standard in place.</p>
<p style="text-align: justify">In the future, when a prolonged lockdown prevents actual meter reading, then with the permission of government regulators, a bill corresponding to 50 percent of estimated usage may be preliminarily billed, with the note that the full amount, based on actual meter reading will follow.  This is for the benefit of consumers who pay their bills online or are enrolled in automatic payment schemes.</p>
<p style="text-align: justify">Needless to say, overbilling must be rectified automatically, and if payments have been made, the grant of refund.</p>
<p style="text-align: justify">In the meantime, no service disconnection should be made while the bill is being disputed or has yet to be finalized.</p>
<p style="text-align: justify">The grace period for payments should also be observed pursuant to law.</p>
<p style="text-align: justify">The above are fair to all parties and are pursuant to the provisions of legislative franchises which holders must follow.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
