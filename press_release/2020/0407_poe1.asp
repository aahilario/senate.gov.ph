...
<!-- file generated by WebNewsGen 100810 on 4/7/2020 6:53:00 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Grace Poe on relief assistance to PUV drivers:</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->GRACE POE ON RELIEF ASSISTANCE TO PUV DRIVERS:<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->

<p style="text-align: justify">Setting aside and providing immediate relief assistance for our public utility drivers and operators is a step in the right direction for this sector equally hit hard by the enhanced community quarantine.</p>

<p style="text-align: justify">With the halt in the operation of mass transportation, the drivers expect no other means to earn to provide for the needs of their families.</p>

<p style="text-align: justify">An amount of P2.66 billion has been allocated for 333,000 public utility drivers and operators as part of the social amelioration package.</p>

<p style="text-align: justify">The initial list of beneficiaries has been identified by the Land Transportation Franchising Regulatory Board, and we hope that in the soonest time possible, this cash aid will reach the homes of the drivers and operators.</p>

<p style="text-align: justify">Alam naman natin na kung walang pasada, walang kita. Isang araw na hindi makabiyahe, gutom na ang kanilang pamilya.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
