...
<!-- file generated by WebNewsGen 100809 on 9/28/2015 7:41:07 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Miriam wants results from free wi-fi project</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->MIRIAM WANTS RESULTS FROM FREE WI-FI PROJECT<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Sen. Miriam Defensor Santiago urged her colleagues not to approve any additional funds for the nationwide free Wi-Fi initiative without looking into the status of the project, which the Department of Science and Technology (DOST) vowed to finish by December.</p>
<p style="text-align: justify">The nationwide free Wi-Fi project costs P3 billion. An initial P1.4 billion has been programmed this year, but the DOST is asking another P1.6 billion in its proposed P17.8-billion budget in 2016. DOST officials are set to face senators for budget deliberations on October 6.</p>
<p style="text-align: justify">Santiago, author of the Magna Carta for Internet Freedom, will file a resolution on Monday, urging a Senate inquiry on the DOST's Information and Communications Technology Office (ICTO), which, according to state auditors, underspent by P827.6 million in 2014.</p>
<p style="text-align: justify">"Was it not too ambitious for an agency to embark on a P3-billion project this year when it failed to implement several projects worth less than a billion in 2014? Of course Internet-loving Filipinos want free Wi-Fi, but can the DOST deliver on its promises?" the senator said.</p>
<p style="text-align: justify">Santiago, however, cited a recently released Commission on Audit (COA) report, which found that the ICTO faced roadblocks in two major projects in 2014, and thus spent only P65.2 million of the P892.8 million in e-Government funds programmed that year.</p>
<p style="text-align: justify">The COA said bulk of the unused funds were earmarked for the Integrated Government Philippines (iGovPhil) Project, which would have set up a shared network among offices delivering common services, and the Philippines Community eCenter (CeC) Program.</p>
<p style="text-align: justify">State auditors claimed that the underspending was the result of procurement delays, as they questioned whether the ICTO bids and awards committee for special projects was fully capable of handling high-value projects.</p>
<p style="text-align: justify">"Government efforts to pursue ICT projects are laudable. We cannot lag behind other countries on that front. But before the government can even dream of implementing big-ticket projects, it must improve the capacity of responsible agencies," Santiago said.</p>
<p style="text-align: justify">She also agreed with COA recommendations for the ICTO to carefully select members of bids and awards committees for priority projects and to improve trainings on procurement bidding to help the agency efficiently perform its functions.</p>
<p style="text-align: justify">Besides flagging procurement inefficiencies, state auditors also criticized how a total of P186.7 million in project and maintenance and operating expenses funds of the ICTO reverted to the national treasury, an indicator, they said, of poor monthly cash programming.</p>
<p style="text-align: justify">Santiago said underspending should be avoided not only in the DOST, but in all agencies. "This government cannot keep underspending and, at the last minute, force agencies to accelerate fund disbursement to buoy the economy," the senator said.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
