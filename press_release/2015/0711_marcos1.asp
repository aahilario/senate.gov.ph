...
<!-- file generated by WebNewsGen 100809 on 7/13/2015 7:22:06 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Comelec should decide now on manner of election - Marcos</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->COMELEC SHOULD DECIDE NOW ON MANNER OF ELECTION - MARCOS<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">SENATOR Ferdinand "Bongbong" R. Marcos Jr. prodded the Commission on Elections (Comelec) to make up its mind on what system to use in the 2016 national elections.</p>
<p style="text-align: justify">Marcos pointed out the urgency of the matter, noting that the Comelec is still studying its options even though the May polls are just 10 months away.</p>
<p style="text-align: justify">In a statement, Marcos reminded the poll body that a decision on the election system has to be made soon.</p>
<p style="text-align: justify">"What's it gonna be? The Comelec should make up its mind because the clock is ticking away. From the looks of it, the Comelec has not yet decided 10 months before the scheduled elections. It's already tight," he said.</p>
<p style="text-align: justify">Reports said the Comelec has abandoned the idea of the hybrid voting system or the Patas (precinct automatic tallying system) as an option after tests showed serious problems, plus the exorbitant cost it would entail.</p>
<p style="text-align: justify">Marcos noted that the Comelec is still weighing two more options, which are the refurbishment of the old precinct count optical scan (PCOS) machines and the lease of new optical mark readers (OMR).</p>
<p style="text-align: justify">"If it's PCOS or OMR, the Comelec has to pick now between the two and then proceed to the next step. I believe the Comelec knew by now the strong and weak points of the two systems, so I can't see why it's taking them so long to choose," he said.</p>
<p style="text-align: justify">He added: "I can understand that the Comelec is only very careful in making the decision on what system would be implemented. But it is stuck there and has not moved further. I think it's time now to make that judgment call so that it will have the luxury of a wider elbow room for the rest of the preparations."</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
