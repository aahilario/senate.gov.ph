...
<!-- file generated by WebNewsGen 100809 on 11/11/2015 1:47:17 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Legarda: The Necessary Alternatives: Balancing Energy, Health and the Climate Challenge</title>
...
<span class="PRSuper"><!-- NewsTitleSuper.start -->Welcome Remarks of Senator Loren Legarda<!-- NewsTitleSuper.end --></span><br />
<span class="PRTitle"><!-- NewsTitle.start -->The Necessary Alternatives: Balancing Energy, Health and the Climate Challenge<!-- NewsTitle.end --></span>
<br /><span class="PRSub"><!-- NewsTitleSub.start -->11 November 2015 | Padilla Room, Senate of the Philippines<!-- NewsTitleSub.end--></span>
</p>
<!-- NewsBody.start -->

<p style="text-align: justify">I welcome you today to this gathering of pioneers, a generation of passionate individuals that could make the future of the world livable. We are here to talk about how climate change, our health and clean energy are interconnected.</p>
<p style="text-align: justify">One way to perceive how the climate works and affects the world is to allude to it like the engineering of the human body -- complex and interconnected.  The body is an amazing creation, made of parts that are integral to making it function. Millions of pathways combine to form cells, tissues, and organs that allow us to be human.</p>
<p style="text-align: justify">It is the same way that our climate and our planet's environment are interconnected. Even a minor change in the climate creates impacts that are large and encompassing, affecting every living thing.</p>
<p style="text-align: justify">Climate change is not an overnight problem, and it has taken us super typhoons and tsunamis, sinking islands, arid, unusable land, and staggering numbers of lives displaced and perished to visualize what scientists and environmental activists have been warning us for decades -- that among other effects, "climate change will be the biggest global health threat of the 21st century."</p>
<p style="text-align: justify">As climate change alters rainfall patterns and brings deadly, intensified and frequent calamities, it will affect public health. Governments, organizations, businesses and the private sector will face conundrums that include the spreading of deadly diseases and viruses, decrease in well-being of citizens, not to mention medical relief needed with each catastrophe.</p>
<p style="text-align: justify">According to a study conducted by the World Bank, "the average global cost of adaptation in the health sector for the prevention and treatment of diarrhea and malaria alone will reach $1.3 billion to $1.6 billion per year (in 2005 dollars) over the period 2010-2050."</p>
<p style="text-align: justify">A United Nations Framework Convention on Climate Change (UNFCCC) study estimates the adaptation cost in the health sector to range from $2 billion and $14 billion over the period 2010-2030.</p>
<p style="text-align: justify">For a more relatable scenario, in the Philippines the rising cases of dengue and malaria are related to climate change. In 1998, when the Philippines experienced El Ni&ntilde;o, almost 40,000 dengue cases, 1,200 cholera cases and nearly 1,000 typhoid fever cases nationwide were recorded.</p>
<p style="text-align: justify">The state of our health as human beings is under threat but it is not a death sentence--yet. We are alive and able to address the crisis of climate change, which is related to how we access and use fossil energy. We have made energy choices that have been detrimental to the planet and to our health. There is strong scientific consensus that climate change is largely the consequence of greenhouse gas emissions.   These emissions largely come from human activities, including burning fossil fuels for electricity, heat, transportation and agriculture.</p>
<p style="text-align: justify">The world's governments, movers and shakers need to urgently, and with conscience, examine how we use energy and how to use innovation and new technologies to provide for the energy it needs in a sustainable and inclusive manner.</p>
...
<p style="text-align: justify">We already have the necessary laws to aid us towards building a healthy, resilient, sustainable and climate-adaptive nation. We have the Ecological Solid Waste Management Law, Renewable Energy Act, Rainwater Catchment Law, Climate Change Act, People's Survival Fund Law, and Disaster Risk Reduction and Management Law, among many others. We just have to take that first crucial step of actually taking action.</p>
<p style="text-align: justify">This event is an opportunity for all of us to address issues that need immediate response, and propose strategies that will help us mainstream the use of renewable energy.</p>
<p style="text-align: justify">Clean energy is not a future concept; it is the necessary alternative if we want to live a healthy life in a world that is not decimated because of climate change, but a world for the next generations to flourish in.</p>
