...
<!-- file generated by WebNewsGen 100809 on 1/23/2015 3:32:21 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Aquino: SK: Time to Reboot </title>
...
<span class="PRTitle"><!-- NewsTitle.start -->SK: Time to Reboot <!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">With the agreement from both Houses of Congress to take up much-needed reforms in the Sangguniang Kabataan, the Filipino youth can look forward to an improved system that is more relevant and responsive to their needs.</p>
<p style="text-align: justify">These reforms will be tackled side by side with the postponement of the SK elections this year.</p>
<p style="text-align: justify">At this point, there is a consensus that we need to reboot the SK. And we need more young people to participate in the discussion in the next few weeks.</p>
<p style="text-align: justify">Let's use the time before the next SK elections next year to pass these needed reforms, convince more young people to participate and run so that the SK can finally live up to its intended potential.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
