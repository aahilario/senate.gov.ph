...
<!-- file generated by WebNewsGen 100809 on 5/13/2015 4:22:12 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Grace Poe on the current MRT situation</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->GRACE POE ON THE CURRENT MRT SITUATION<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">I am dismayed with the series of technical glitches, system breakdowns and insufficient number of trains in the MRT-3 despite transport officials' promise to improve the services for the riding public.</p>
...
<p style="text-align: justify">DOTC Secretary Joseph Emilio Abaya has acknowledged that maintenance provider APT Global has only been deploying eight to 10 trains instead of the required 20 trains during rush hours. My understanding is that the DOTC should be penalizing or sanctioning APT Global based on their contract. If indeed they are penalizing APT Global, it seems that such is not enough to deter APT Global from doing a lousy job. On top of that, the maintenance provider's contract with the DOTC has been extended several times.</p>
<p style="text-align: justify">Simple lang po ito: nang manghingi ng karagdagang pondo ang DOTC, binigyan sila. Nang magtaas sila ng pamasahe, nagkumahog ang ating mga kababayan upang makapagbayad. Ngunit patuloy ang mga aberya sa mga biyahe ng tren. Papaano maseserbisyuhan ng mababa pa sa sampung tren ang higit kalahating milyong pasahero araw-araw? Ang kawalan ng malasakit ng DOTC, MRT-3 at APT Global ay hindi na maaaring ipagkibit-balikat na lamang.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
