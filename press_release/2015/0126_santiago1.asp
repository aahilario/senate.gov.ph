...
<!-- file generated by WebNewsGen 100809 on 1/26/2015 9:32:59 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Miriam uses debate format in Senate Bangsamoro Basic Law hearing</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->MIRIAM USES DEBATE FORMAT IN SENATE 
<br />
BANGSAMORO BASIC LAW HEARING<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify; text-indent: 25px">Sen. Miriam Defensor Santiago, chair of the Senate committee on constitutional amendments and revision of codes, started public hearings on the constitutionality of the Bangsamoro Basic Law (BBL) by using the debate format.             </p>
	<p style="text-align: justify; text-indent: 25px">Santiago opened the hearing by identifying four major issues on the constitutionality of the BBL: (1) legislation v. constitutional change; (2) checks and balances in the national government v. none in the BBL; (3) sovereignty v. sub-state; and (4) territorial integrity v. functional division.             </p>
	<p style="text-align: justify; text-indent: 25px">Santiago paired off the resource panel depending on whether they are in favour or against the BBL.</p>
<p style="text-align: justify; text-indent: 25px">The first debate paired off Sec. Teresita Quintos-Deles, Presidential Adviser on the Peace Process, against former Supreme Court Justice Florentino P. Feliciano on legislation v. constitutional change.            </p>
	<p style="text-align: justify; text-indent: 25px">Deles argues that the BBL can be passed as if it was an ordinary law passed by the two Houses of Congress. On the other hand, Feliciano contends that the BBL should be embodied as a proposal for constitutional amendment or revision. Those who support Feliciano's position include the Catholic Bishops' Conference of the Philippines (CBCP); former SC Justice Vicente V. Mendoza; former UP Law dean Merlin Magallona; and San Beda College Graduate School of Law dead Fr. Ranhilio C. Aquino.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
