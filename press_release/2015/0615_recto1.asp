...
<!-- file generated by WebNewsGen 100809 on 6/15/2015 3:29:35 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Recto: Decommissioning must be a real farewell to arms</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Decommissioning must be a real farewell to arms<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">One less firearm is one less instrument of death. The number of guns to be silenced may be small but it is a great leap forward in our journey for peace. All the parties involved must be congratulated.</p>
<p style="text-align: justify">Hopefully, the velocity and volume of the decommissioning of arms will increase in the months to come.</p>
<p style="text-align: justify">It is also hoped that the decommissioning will be accompanied by a total moratorium in firearm acquisition. Otherwise, any benefit from the mothballing of arms is cancelled by the procurement of more.</p>
<p style="text-align: justify">The same principle should apply to the deactivation of combatants. This should go together with a total stop in recruitment. Otherwise, there will be no reduction in troop strength when ongoing conscription replaces those who are retired.</p>
<p style="text-align: justify">It would also help the cause of peace if the nation is told of the baseline figure at the start of the decommissioning process.</p>
<p style="text-align: justify">Disclosing how many men and arms there are will allow us to track, monitor and compute if a reduction is really taking place for, after all, the whole exercise is about decreasing the armaments and manpower of war.</p>
<p style="text-align: justify">Subtraction is the only acceptable math in the decommissioning.</p>
<p style="text-align: justify">We cannot say farewell to arms while we welcome more troops and arms.</p>
<p style="text-align: justify">Finally, to institutionalize it, decommissioning should be included in the BBL in order to set a deadline and dictate the pace.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
