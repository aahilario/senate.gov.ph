...
<!-- file generated by WebNewsGen 100809 on 11/23/2015 8:53:16 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Statement of Sen. Bongbong Marcos on Mayor Rodrigo Duterte's latest political update</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->STATEMENT OF SEN. BONGBONG MARCOS ON MAYOR RODRIGO DUTERTE'S LATEST POLITICAL UPDATE<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">If this is the final word then we can all finally end the speculation.</p>
<p style="text-align: justify">Lahat ng surveys, "back to the drawing board"!</p>
<p style="text-align: justify">Talaga si Mayor Rody, laging may masayang balita!</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
