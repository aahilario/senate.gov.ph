...
<!-- file generated by WebNewsGen 100809 on 5/26/2015 4:08:19 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Sponsorship Speech of Senator Teofisto "TG" Guingona III on Senate Bill No. 2654</title>
...
<br />
ON SENATE BILL NO. 2654<!-- NewsTitle.end --></span>
<br /><span class="PRSub"><!-- NewsTitleSub.start -->"An Act Strengthening the Regulation of Health Facilities and Services in the Philippines, Repealing for the Purpose Republic Act No. 4226, Otherwise Known as the Hospital Licensure Act"<!-- NewsTitleSub.end--></span>
</p>
<!-- NewsBody.start -->

<p style="text-align: justify">In pursuit of the Universal Health Care agenda, aside from expanding health insurance coverage, it is also important to ensure that health facilities reach a standard of adequacy and that they deliver quality health services to those needing health care.</p>
<p style="text-align: justify">Changes and improvement in the field of health care during the past decades have led to the emergence and development of new types of health care facilities such as diagnostic, therapeutic and rehabilitative centers. As a result, a number of such types of facilities no longer qualify under the regulatory mandate of the Department of Health (DoH). Licensing of health facilities and services are very important functions that the DOH must seriously perform.  This is an important tool of quality assurance.</p>
<p style="text-align: justify">This bill proposes to strengthen the regulation of health facilities and services by authorizing the Bureau of Health Facilities and Services (BHFS) of the DOH to:</p>
	<ul>
		<li>
		<p style="text-align: justify">Establish and prescribe rules, regulations, standards, etc 
		</p>
		</li>
		<li>
		<p style="text-align: justify">Inspect and monitor for continued compliance 
		</p>
		</li>
		<li>
		<p style="text-align: justify">Implement a classification system </p>
		</li>
		<li>
		<p style="text-align: justify">Approve building plans and construction design 
		</p>
		</li>
		<li>
		<p style="text-align: justify">Provide advise </p>
		</li>
		<li>
		<p style="text-align: justify">Collect fees </p>
		</li>
		<li>
		<p style="text-align: justify">Conduct administrative hearing and impose penalties</p>
		</li>
	</ul>
<p style="text-align: justify">In view of the foregoing, immediate passage of this measure is earnestly sought.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
