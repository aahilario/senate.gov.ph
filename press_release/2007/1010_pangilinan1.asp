...
<!-- file generated by WebNewsGen 070821 on 10/10/2007 2:41:46 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko to NEDA: Produce NBN documents or else...</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->KIKO TO NEDA: PRODUCE NBN DOCUMENTS OR ELSE...<!-- NewsTitle.end --></span>
<br /><span class="PRSub"><!-- NewsTitleSub.start -->"We will cite NEDA officials in contempt if need be!"<!-- NewsTitleSub.end--></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">Senate Majority Leader Kiko Pangilinan today strongly criticized the National Economic Development Authority's (NEDA) refusal to submit documents related to the corruption-tainted multi-million national broadband network project.</p>

<p style="text-align: justify">"NEDA's refusal to submit official documents is totally unacceptable. It violates the constitutional right of the people to information and it impairs and undermines the Congressional power of investigation in aid of legislation under the constitution."</p>

<p style="text-align: justify">NEDA officials invoked "executive privilege" in their defiance to a Senate subpoena to submit the documents containing the minutes of a meeting wherein its former head and now Commission on Higher Education (Ched) Chairman Romulo Neri supposedly rejected the NBN ZTE project's approval.</p>

<p style="text-align: justify">"We need to know if there were laws violated in the processing of the contract and if so, who ordered these officials to violate these laws and why. Only by making these officials account for their acts can we avoid a repeat of irregularities in the other government to government transactions involving billions of taxpayers' money."</p>

<p style="text-align: justify">Kiko said the Senate Blue Ribbon committee should compel Acting NEDA Director-General Augusto Santos to produce the controversial document, and "and if they refuse, we will not hesitate to enforce our rules to ensure compliance."</p>

<p style="text-align: justify">"If need be we will cite NEDA officials in contempt and have them arrested and detained until they comply."</p>

<p style="text-align: justify">Kiko stressed that Executive 464 cannot be used by Palace officials to infringe the Constitutional duty of the Senate to act as check and balance on a wayward Executive Branch.</p>

<p style="text-align: justify">"Executive privilege most certainly cannot be used to cover up for wrongdoing most especially if the wrongdoing is committed by the officials in the highest echelons of government. No one is above the law, and this includes the President."</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
