...
<!-- file generated by WebNewsGen 070821 on 12/13/2007 3:33:53 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko hits PNP, military no-show at Senate investigation on Manila Pen media arrest</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->KIKO HITS PNP, MILITARY NO-SHOW AT SENATE 
<br />
INVESTIGATION ON MANILA PEN MEDIA ARREST<!-- NewsTitle.end --></span>
<br /><span class="PRSub"><!-- NewsTitleSub.start -->"Their absence will not stop Senate from legislating to 
<br />
protect the rights to free speech and of the press." --- KIKO<!-- NewsTitleSub.end--></span>
</p>
<!-- NewsBody.start --><p>Senate Majority Leader and Independent senator Kiko Pangilinan  criticized the PNP and military for failing to show up at the Senate probe on  the media arrest during the Manila Pen siege.</p>
<p>"Their absence today casts doubt on their sincerity, and their  willingness to account for what happened at the Manila Pen. This will not  impair Senate from acting on its duty to legislate remedial measures to stop a repeat of these intrusions to our constitutionally guaranteed rights. We will not take this matter sitting down!" Kiko said.</p>
<p>"The danger of allowing small infractions is that it may embolden the commission of bigger ones.  We need to be adamant in checking the abuses and stopping the excesses in the exercise of government. Rights are only rights when they are fought for," Kiko asserted.</p>
<p>"We were initially glad that the PNP participated in a dialogue with the media, which could've threshed out mechanics on how the government and the media could engage each other in circumstances like the Manila Pen incident. But since the dialogue ended nowhere, we wanted the PNP and the military to extend the same candidness by cooperating fully in the Senate investigation." Kiko added.</p>
<p>The Kapisanan ng mga Brodkaster sa Pilipinas initiated a dialogue among major news organizations, the DILG, PNP, and DND at the Manila Peninsula Hotel last December 5 to discuss the media arrest that occurred at the Manila Pen siege.</p>
