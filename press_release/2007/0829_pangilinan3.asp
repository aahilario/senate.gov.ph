...
<!-- file generated by WebNewsGen 070821 on 9/3/2007 7:31:45 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko calls on PNP, UP to implement Anti-hazing law, calls for crackdown on erring...</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->KIKO CALLS ON PNP, UP TO IMPLEMENT ANTI-HAZING LAW, CALLS FOR CRACKDOWN ON ERRING FRATERNITIES AND SORORITIES<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify; text-indent: 25px">Senate Majority Leader and former UP Student Council Chair and UP Student Regent Kiko Pangilinan today called on the UP administration and police to implement the Anti-hazing Law, following the death of a student leader from the College of Public Administration and Governance.</p>
<p style="text-align: justify; text-indent: 25px">"I express my sincerest condolences to the family, friends and classmates of Chris Mendez who died the other day because of hazing during initiation rites of an alleged law-based fraternity. I call on the PNP and UP administration to aggressively and proactively implement the Anti-hazing Law. RA 8049 is a law that needs to be implemented more stringently if we are to prevent unwarranted deaths. The Anti-hazing Law is supposed to regulate hazing and other forms of initiation."</p>
<p style="text-align: justify; text-indent: 25px">"We need to hold accountable the officers and members of this fraternity that caused and were witnesses to the death of Chris Mendez. We must remind sorority and fraternity leaders and the UP administration the penalty of reclusion perpetua will be imposed if death resulted from the infliction of physical harm is the initiation rites that they wish to impose on their neophytes."</p>
<p style="text-align: justify; text-indent: 25px">"The Anti-hazing Law is all encompassing in scope and the PNP should be ready to crackdown on those sororities and fraternities that plan to disobey this law. The seemingly uncurtailed and pervasive proliferation of hazing can only mean that there is poor implementation of the law. Officials of these fraternities and sororities should have in the first place submitted required prior notice to UP of the planned initiation activity. The law also states that the schools administration of the organization must have a representative present during the initiation rites. Had the authorities and the officials f this fraternity followed the Anti-hazing Law then the death of Chris Mendez and the anguish of his family could have been prevented.###</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
