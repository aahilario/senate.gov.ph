...
<!-- file generated by WebNewsGen 070710 XHTML on 7/17/2007 3:21:26 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko: Increase conviction rate to stop extrajudicial killings</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->KIKO: INCREASE CONVICTION RATE TO STOP EXTRAJUDICIAL KILLINGS<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify; text-indent: 25px">Senate Majority Leader Kiko Pangilinan today pushed for the increase of the conviction rate in courts to stop the spate of extra-judicial killings. Sen. Kiko, who was the Senate's representative in the Supreme Court's Summit on Extra-judicial Killings stressed the need to ensure that the respect for the rule of law in the country remains steadfast.</p>
<p style="text-align: justify; text-indent: 25px">"Firstly, we must look at how we can increase the conviction rates of our courts. Only when we punish more and punish swiftly will there be genuine respect for the rule of law and obedience to the same.  Today the battle cry of would be criminals and syndicates is 'we can get away with it anyway' and hence are emboldened to transgress the law at will.  We must raise for example the conviction rates in the Ombusdman and Sandiganbayan from some 20 percent where it is today to 70 to 80 percent (HK level) in the next 5 to 7 years.  When only 2 or 3 out of ten cases end up in conviction then many are able to go scot free while only a few are punished.  We must punish more and convict swiftly," Kiko said.</p>
<p style="text-align: justify; text-indent: 25px">"Apart from punishing more, we likewise need to look at resolving cases more swiftly.  Data from the Ofiice of the Court Administrator reveals that the average lifespan of a case pending in our courts is 6 years. The period is too long. We must find ways to reduce the length of time that a case is filed and resolved. We must find a way to reduce the average case life from 6 years to say 2 to 3 years in the next 5 to 7 years," Kiko added.</p>
<p style="text-align: justify; text-indent: 25px">"We must also reduce even further the lack of judges and the vacancies in the courts to single digit levels so as to ensure a swifter disposition of cases throughout the country. To date, the vacancy rate hovers anywhere between 16 to 18 percent.  This is down from over 30 percent in 2001 thanks to the tireless efforts of the JBC. We must reduce the vacancy even further in order to make access to the courts more real in the grassroots," Kiko ended.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
