...
<!-- file generated by WebNewsGen 070201 on 5/15/2007 6:58:47 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko on the fire in a Batangas school</title>
...
<td>&nbsp;<a href="http://www.newsenatebuilding.com">Bagong Senado</a></td></tr></table></div></div>
   ...
   <table id="container">
      <tr>
         <td id="content">
Press Release<br /><!-- NewsDate.start -->May 15, 2007<!-- NewsDate.end --><p>
<span class="PRTitle"><!-- NewsTitle.start -->KIKO ON THE FIRE IN A BATANGAS SCHOOL<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start --><p style="text-align: justify">"We condemn this brazen act of still unidentified men that razed a school building in Batangas, killing two innocent individuals and injuring others. We are appalled by the audacity of these criminals to trample on the rule of law and we know that the reason why they are able to commit such a felony with impunity is because the justice system doesn't punish swiftly, and that it punishes only a few."</p>

<p style="text-align: justify">"The PNP and COMELEC should get to the bottom of this attack immediately to assert control over the situation and to show that our authorities will not tolerate aggression in our polls."</p>

<p style="text-align: justify">"We need to move away from an election culture mired by violence and dishonesty. We believe that our people as voters are now more discerning, but we have to ensure that their choices are translated in election results. We need to find the perpetrators of this crime and punish all those behind it. We need to up the conviction rate of these cases if we are to deter ill-intentioned elements from following suit."</p>
<!-- NewsBody.end -->
         </td>
         <td id="sidepane">
