...
<!-- file generated by WebNewsGen 070201 on 6/4/2007 12:49:06 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko: Senate ready to return to work</title>
...
<p style="text-align: center"><span class="PRTitle"><!-- NewsTitle.start -->KIKO: SENATE READY TO RETURN TO WORK<!-- NewsTitle.end -->
</span></p>
<!-- NewsBody.start --><p style="text-align: justify; text-indent: 25px">Senate Majority Leader Kiko Pangilinan today expressed optimism as the Senate   resumes session after the 2007 senatorial elections.</p>

<p style="text-align: justify; text-indent: 25px">"The Senate is ready to hit the ground running now that the elections are almost officially over. We are very much looking forward to passing measures that respond to the pressing needs of our people," Kiko said.</p>

<p style="text-align: justify; text-indent: 25px">The Senate is poised to tackle the New Central Bank Act, the Epira Bill, the Fiscal and Non-fiscal Incentives Bill, the NLRC measure, providing for effective health services with the bill addressing the use of government ambulances, addressing the speedy dispensation of justice with bills creating new courts, as well as environmental bills that seek to create protected areas, and other pending local bills.</p>

<p style="text-align: justify; text-indent: 25px">"After the rigors of the campaign, we would like to channel our attention now to these measures. The members of the 13 th Congress remain eager to return to work. We will remain an efficient, relevant, responsive and independent branch of government ready to champion the cause of our citizens," Kiko ended.</p>
<!-- NewsBody.end -->
         </td>
         <td id="sidepane">
