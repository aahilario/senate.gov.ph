...
<!-- file generated by WebNewsGen 070201 on 5/7/2007 1:09:07 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Sen. Recto's statement on the bugging of President Corys phone</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Sen. Recto's statement on the <br />bugging of President Corys phone<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start --><p>Bugging is bad whether done on a former president or a sitting one, and one must not be selective in condemning it, simply based on who the target is.</p>
<p>We cannot treat wiretapping victims differently, one with disdain and the other with sympathy.</p>
<p>We should be consistent in condemning illegal eavesdropping whenever and to whoever that   is employed.</p>
<p>However, at a time when a how-to manual in making a nuclear bomb can be downloaded from the  Internet, it is unfair to point to the  military  as not only  the usual suspect but the only one.</p>
<p>I base my doubts on this :  For all the billions we give to the military yearly,  is this   the only thing they are capable of  : an easy-to-detect, crude gadget that looks like a high school science experiment?</p>
<p>My point is,  we  may  not  be  able  to  find  the  real  culprits if we only focus on the usual suspects.</p>
<!-- NewsBody.end -->
         </td>
         <td id="sidepane">
