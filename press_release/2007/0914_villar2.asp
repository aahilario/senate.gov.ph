...
<!-- file generated by WebNewsGen 070821 on 9/17/2007 7:18:21 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Villar pushes RP's S&amp;T</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->VILLAR PUSHES RP'S S&amp;T<!-- NewsTitle.end --></span>
<br /><span class="PRSub"><!-- NewsTitleSub.start -->New bill seeks robotics inclusion in high school curriculum<!-- NewsTitleSub.end--></span>
</p>
<!-- NewsBody.start -->
<p>An interesting subject, "Robotics," may soon become the most popular preoccupation among high school students if a bill introduced in the Senate is eventually passed.</p>
<p>Senate President Manny Villar filed a pioneering bill seeking to modernize Philippine education by integrating robotics application in the secondary science curriculum.</p>
<p>The Senate President said, "Science and technology has undeniably become one of the most significant tools in economic growth and a defining source of competitive advantage."</p>
<p>Villar's Senate Bill 1579 is entitled, "An Act integrating robotics application in the teaching of secondary science education in the Philippines, appropriating funds therefor and for other purposes."</p>
<p>The proposed measure provides, "Robotics application shall be integrated in the teaching of physics and other science subjects."</p>
<p>"Robots shall be utilized as technology tools that will allow students to perform experimental applications in designing, building and testing gadgets for instructional purposes," the bill stated.</p>
<p>The Department of Science and Technology and the Department of Education (DepEd), in consultation with all concerned sectors, shall issue the implementing rules and regulations on the said program.</p>
<p>The Philippine Science High School and other selected high schools under the DepEd shall be the first to be introduced to the implementation of robotics application.</p>
<p>The bill mandates an appropriation of P100 million to support the implementation of the program, which shall include designing of the course, teacher training, and development of tools and instructional materials.</p>
<p>"The Philippines has been silently reaping laurels in science and technology. In the World Robotics Olympiad in Nanning, China, the country's representatives Kim Marco Perez, Dann Joseph Garcia and Francisco Gabriel Nunez of the First Asia Institute of Technology and Humanities bagged the Gold Medal in the Open Category with the theme, "Humanoids" in 2006. Filipino students also won in the Intel International Science and Engineering Fair last year," the explanatory note on the bill cited, underscoring the important role of science and technology in attaining progress.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
