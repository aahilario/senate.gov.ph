...
<!-- file generated by WebNewsGen 070201 on 3/12/2007 3:33:30 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Recto: Palace lobbyists in US must help RP present case</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Recto : Palace lobbyists in US must help RP present case<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start --><p style="text-align: justify; text-indent: 25px">Its the job of embedded Malaca&ntilde;ang
 lobbyists in the US Capitol, if there are any, to make sure that the side of the government is heard.</p>
<p style="text-align: justify; text-indent: 25px">If the lobby firm Venable is still engaged, then I presume that the terms of reference include assistance and representation in presenting the Philippine case.</p>
<p style="text-align: justify; text-indent: 25px">The aim is to install a firewall between the inquiry and US aid and trade concessions to the country which should not be jeopardized by any adverse publicity.</p>
<p style="text-align: justify; text-indent: 25px">With its awful record in Iraq, the United States may not be in the best position to pontificate on human rights, given one reputable and uncontested British estimate that 100,000 Iraqi civilians had died since the US invasion.</p>
<p style="text-align: justify; text-indent: 25px">This is not to condone the killings here, which I have consistently condemned, but US politicians should be more concerned about the holocaust in Iraq, some committed by their own forces, than poking their nose here.</p>
<p style="text-align: justify; text-indent: 25px">But if we want our own internal business not ending up as a Washington sideshow, then something convincing must be done from our end, such as implementing the recommendations of the Melo Commission.</p>
<p style="text-align: justify; text-indent: 25px">When the killings stop, the investigations do too.</p>
<!-- NewsBody.end -->
         </td>
         <td id="sidepane">
