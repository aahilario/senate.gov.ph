...
<!-- file generated by WebNewsGen 070801 2005 on 8/9/2007 6:01:55 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko: Support mandatory testing if results remain confidential and if parents give...</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->KIKO: SUPPORT MANDATORY TESTING IF RESULTS REMAIN CONFIDENTIAL AND IF PARENTS GIVE THEIR CONSENT<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">"Mandatory drug testing will contribute to the fight against the proliferation of illegal drugs and will prevent the rise of crime and gangsterism in our cities. But drug testing in our schools should be done only if the results remain confidential and if parents give their consent to have their children engage in this testing," Kiko said.</p>

<p style="text-align: justify">"I see no reason why it shouldn't be allowed. I also think that this isn't a violation of our children's rights. It will in fact be beneficial to their well-being and it will discourage them from giving in to peer pressure and experimenting with these life-threatening drugs. What's crucial here is to really have the active participation of school officials and parents so that testings will not be mishandled or manipulated," Kiko ended.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
