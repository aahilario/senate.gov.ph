...
<!-- file generated by WebNewsGen 070201 on 6/17/2007 6:25:40 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko on JDV's new position on charter change...</title>
...
<p><span class="PRTitle"><!-- NewsTitle.start -->KIKO ON JDV'S NEW POSITION ON CHARTER CHANGE...<!-- NewsTitle.end -->
</span></p><!-- NewsBody.start --><p style="text-align: justify; text-indent: 25px">"We welcome the position taken by JDV calling for a moratorium on ChaCha! We are gladdened by his concern that ChaCha at this time shall create a divisiveness that can adversely affect the economic gains now being felt by the nation. This position should be supported by the entire nation."</p>
<!-- NewsBody.end -->
         </td>
         <td id="sidepane">
