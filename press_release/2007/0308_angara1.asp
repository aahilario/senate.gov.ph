...
<!-- file generated by WebNewsGen 070201 on 3/7/2007 6:27:01 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Angara backs bigger role of LGUs in building schools</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->ANGARA BACKS BIGGER ROLE OF LGUs IN BUILDING SCHOOLS<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start --><p style="text-indent: 25px">Reelectionist Sen. Edgardo J. Angara has expressed his full support for a bigger role of qualified local government units in building classrooms.</p>
<p style="text-indent: 25px">Angara, a senatorial candidate of Team Unity, made the declaration after hearing the proposals of  Negros Oriental Gov. George Arnaiz and Dumaguete City Mayor Agustin Perdices.</p>
<p style="text-indent: 25px">"If the LGUs are capable of building classrooms, then they should be allowed to do so by all means," he said.</p>
<p style="text-indent: 25px">Perdices and Arnaiz said that they could build three classrooms for every two classrooms if the funds are given directly to them instead of to the Department of Public Works and Highways or the Department of Education.</p>
<p style="text-indent: 25px">They assured Angara that the classrooms would be built according to the specifications of the DPWH or DepEd.</p>
<p style="text-indent: 25px">"If DPWH can build only two classrooms while the LGUs can build three at the same cost and with the same specifications, then we should encourage the LGUs to build classrooms," Angara said.</p>
<p style="text-indent: 25px">He said that this scheme would save the government billions of pesos, which could be used to hire more teachers or build more classrooms.</p>
<p style="text-indent: 25px">He noted that rich LGUs like Dumaguete City and Negros Oriental have the capability to undertake public works projects usually assigned to the DPWH.</p>
<!-- NewsBody.end -->
         </td>
         <td id="sidepane">
