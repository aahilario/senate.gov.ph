...
<!-- file generated by WebNewsGen 070201 on 3/26/2007 3:08:15 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Villar: Stop-gap measures will not solve poverty and hunger problems in the country</title>
...
<td>&nbsp;<a href="http://www.newsenatebuilding.com">Bagong Senado</a></td></tr></table></div></div>
   ...
   <table id="container">
      <tr>
         <td id="content">
Press Release<br /><!-- NewsDate.start -->March 26, 2007<!-- NewsDate.end --><p style="text-align: center">
<span class="PRTitle"><!-- NewsTitle.start -->VILLAR: STOP-GAP MEASURES WILL NOT SOLVE POVERTY 
<br />AND HUNGER PROBLEMS IN THE COUNTRY<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start --><p style="text-align: justify; text-indent: 25px">	Senate President Manny Villar, President of the Nacionalista Party, says that short-term solutions such as releasing a P1-billion hunger fund is not the way to go if the goal is to solve long-term problems of poverty and hunger in the country.</p>
<p style="text-align: justify; text-indent: 25px">	These are just stop-gap measures that will not really solve the problem at its roots. If at all, solutions like this can misconstrued as desperate attempts to immediately appease the hunger pangs of the Filipinos. But how many Filipinos and for how long only can P1 billion feed? cites Villar.</p>
<p style="text-align: justify; text-indent: 25px">	According to Villar, this recent move of the government is no different from the band-aid solutions tried before but eventually failed because they do not provide long-terms solutions and do not address the problem at its roots.</p>
<p style="text-align: justify; text-indent: 25px">	Given that one billion pesos can feed a number of Filipinos. But the release alone is already subject to speculations and doubts especially in the area of transparency and accountability. Are we sure that the money and the food will reach the targeted people? further cites Villar.</p>
...
<p style="text-align: justify; text-indent: 25px">	According to Villar, as long as the so-called economic gains have not resulted into the creation of new jobs; have not attracted more investments or alleviated povertythe hunger problem will persist.</p>
<p style="text-align: justify; text-indent: 25px">	How long and far can one billion pesos go? This is a temporary relief. It may not even last until the next hunger survey. I believe in the saying that we should not give people fish but teach them how to fish instead. These are dole-outs and past experience should have taught us these dont work over the long-term, adds. Villar.</p>
<p style="text-align: justify; text-indent: 25px">	Villar has a three-pronged approach to ease poverty and hunger problems in the countryinstitute reforms in the agriculture, education and investment sectors. Support the development of agriculture, guide students to employable courses and provide adequate perks to labor-intensive investmentsthese would eventually help in easing the problems of our countrymen.</p>
<!-- NewsBody.end -->
         </td>
         <td id="sidepane">
