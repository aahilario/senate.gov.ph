...
<!-- file generated by WebNewsGen 070821 on 12/17/2007 8:50:40 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko calls on Comelec chairman search committee to make public the list of...</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->KIKO CALLS ON COMELEC CHAIRMAN SEARCH COMMITTEE TO MAKE PUBLIC THE LIST OF NOMINEES; CALLS FOR PUBLIC INTERVIEWS 
<br />
FOR THEM<!-- NewsTitle.end --></span>
<br /><span class="PRSub"><!-- NewsTitleSub.start -->"We urge PGMA to issue marching orders for the search committee of the next Comelec chairman to make the process more transparent, ensuring the broadest participation of citizens in the search."--KIKO<!-- NewsTitleSub.end--></span>
</p>
<!-- NewsBody.start -->

<p style="text-align: justify">Senate Majority Leader and Independent senator Kiko Pangilinan today urged President Gloria Arroyo to direct that the search committee for the next Commission on Elections (Comelec) chairman be made public and transparent, including the disclosure of the final list of nominees.</p>
<p style="text-align: justify">"We urge PGMA to issue marching orders for the search committee of the next Comelec chairman to make the process more transparent, ensuring the broadest participation of citizens in the search," Kiko said.</p>
<p style="text-align: justify">Kiko stressed, "The public should be informed of the names of the nominees submitted, and these candidates should be strictly scrutinized. The public must be asked to submit position papers for or against the nominees. Not only will it encourage participatory government, but it will likewise help the committee arrive at a credible decision."</p>
<p style="text-align: justify">Kiko added, "The prospective nominees should be subjected to public interviews for the purpose of determining the fitness and qualifications of the candidates. These nominees must make known their vision for the Comelec, their plans and proposals to modernize the election process, their stand regarding Lintang Bedol and cheating in Maguindanao and other crucial issues that affect the Comelec today. I for one would like to know what the future chair plans to do with the rotting counting machines from the illegal Mega Pacific deal. These are valid issues that need to be answered by those who seek the post of Comelec chair."</p>
...
<p style="text-align: justify">Kiko, likewise urged the media to participate in the process, "because we know how much more comprehensive information dissemination becomes when media organizations are involved."</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
