...
<!-- file generated by WebNewsGen 070201 on 3/19/2007 1:29:17 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Villar on charter change</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->VILLAR ON CHARTER CHANGE<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start --><p style="text-align: justify; text-indent: 25px">As long as we do it through legal means or process, I have no problem with it. We cannot do anything about it because we have a Constitution. The procedure should be right and approved by our countrymen. On the peoples initiative, it didnt come form the people but from the government.	</p>
<!-- NewsBody.end -->
         </td>
         <td id="sidepane">
