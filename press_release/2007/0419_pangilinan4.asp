...
<!-- file generated by WebNewsGen 070201 on 4/19/2007 6:44:14 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko on the decision to suspend CHED's 10% cap on tution fee increases</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Kiko on the decision to suspend CHED' s 10% cap on tution fee increases<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start --><p style="text-align: justify">"The 10% tuition fee hike ceiling was meant to protect parents and students from practices of private schools. Tuition fee increase can never be conducted haphazardly, so schools must openly and regularly conduct consultations with parents and students.</p>

<p style="text-align: justify">Additional income derived from such hikes must be used only for the purpose of the improvement of infrastructure and curriculum development.</p>

<p style="text-align: justify">Now that CHED memo order 14 has been lifted, we call on our parents and students, who could be on the losing end of this issue to be vigilant and to participate actively in dialogues with school administration.</p>

<p style="text-align: justify">We need to reach a compromise that does not further increase the already immense burden of tuition hikes on parents and students while not sacrificing the quality of education either.</p>

<p style="text-align: justify">Rest assured we are working hard to find ways to provide affordable access to quality education. The Senate, for example, is working on Senate Bill 302 which aims to rationalize tuition fee increases in all educational institutions and will hopefully institute an effective and rational mechanism for fixing tuition fee rate. It also proposes the creation of a Tuition Fee Rationalization Council which can serve as the highest policy making body on matters pertaining to tuition fee rates and other increases and adjustments in school fees."</p>
<!-- NewsBody.end -->
         </td>
         <td id="sidepane">
