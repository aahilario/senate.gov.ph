...
<!-- file generated by WebNewsGen 070821 on 9/18/2007 9:22:43 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko asks DepEd to explain P26B cyber education broadband deal in light of ...</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->KIKO ASKS DEPED TO EXPLAIN P26B CYBER EDUCATION 
<br />
BROADBAND DEAL IN LIGHT OF EXISTING CLASSROOM, <br />
TEACHER, TEXTBOOK SHORTAGES ...<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->

<p style="text-align: justify">"There seems to be a contradiction of sorts between the current budgetary limitations experienced by the DepEd and the proposal to implement a cyber-education project to cost PhP 26B. Our own rough estimates show that it would take some P25B just to addresss the shortages of school buildings, desks and chairs and teachers. This does not include upgrading of school facilities and infrastructure, expanding GASTPE, placing more funding for teacher training and other key areas needed for uplifting the quality of education in the country. It's about identifying priorities given the limited resources and focusing on these urgent matters first. It is about distinguishing the important from the urgent and ensuring that we do not bite off more than we can chew."</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
