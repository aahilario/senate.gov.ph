...
<!-- file generated by WebNewsGen 070201 on 4/2/2007 1:40:15 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko on Sen. Santiagos criteria for senatoriables</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->KIKO ON SEN. SANTIAGOS CRITERIA FOR SENATORIABLES<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start --><p style="text-align: justify; text-indent: 25px">We value Senator Miriam Defensor-Santiagos opinion that we are among her top three candidates running for Senate. We, too, believe that educational background should be given merit by our electorate, especially in the Senatorial race. But it isnt the only characteristic that should be considered when voting our public servants into office. Even a well-meaning candidate can do disservice to our people if he or she does not have the ability to translate his or her advocacy into law.</p>
<p style="text-align: justify; text-indent: 25px">A good educational background should be anchored also on other crucial standards such as track record, objectivity and principles. These benchmarks should be on top of our voters list this coming election, because if we are to move the country forward, we need to find new ways of doing things, we need to think out of the box, and we need to guarantee that only the most deserving candidates will be elected to office. Mahalaga sa pagpili ng mga maninilbihan sa gobyerno ang mga taong may isang salita, tapat at mahal ang taumbayan bago ang sarili.</p>
