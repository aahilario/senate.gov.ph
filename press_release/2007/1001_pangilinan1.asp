...
<!-- file generated by WebNewsGen 070821 on 10/1/2007 5:32:23 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko on Abalos resignation: It doesn't stop here</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->KIKO ON ABALOS RESIGNATION: IT DOESN'T STOP HERE<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">Following the surprise resignation of COMELEC Chair Benjamin Abalos, Senate Majority Kiko Pangilinan today said that this move will not hinder the Senate's pursuit of punishing the guilty in the controversial NBN ZTE deal.</p>

<p style="text-align: justify">"Chair Abalos committed to returning to the Senate for the ZTE NBN hearings should the committee see the need that he testify. We expect him to follow through on his commitment to be present," Kiko said.</p>

<p style="text-align: justify">"We welcome his resignation, nonetheless, as it will spare the COMELEC as an institution from being dragged into yet another controversy. We will continue with the hearings and we hope that he will make himself available despite having resigned should we need him to be present," Kiko said.</p>

<p style="text-align: justify">"His resignation should serve as an example to other public officials and it should be a reminder that all public officials only hold office on behalf of the people we serve, and when this public trust has been diminished or compromised that we should all be open to giving up our posts to serve a higher public interest," Kiko added.</p>

<p style="text-align: justify">"Chairman Abalos is just one player in this issue. The big picture is an anomalous, high-scale contract participated in by Cabinet officials, and if we are to follow the testimonies in the Senate hearings, possibly by the President and the FG as well. Let's not allow ourselves to be distracted from the real issue. There are still crucial questions that are waiting to be answered: Sino ang dapat managot sa NBN ZTE controversy? Bakit sa kabila ng mga alegasyon ng anomalya at kickback, ipinagpatuloy pa rin ito ng gobyerno?</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
