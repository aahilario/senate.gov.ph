...
<!-- file generated by WebNewsGen 070201 on 4/23/2007 2:27:22 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko urges Comelec to allow immediate announcements of Senate election results...</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->KIKO URGES COMELEC TO ALLOW IMMEDIATE ANNOUNCEMENTS OF SENATE ELECTION RESULTS IN THE PROVINCIAL/MUNICIPAL LEVEL<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start --><p style="text-align: justify">"To prevent dagdag-bawas in the national level, the immediate official announcement by COMELEC at the municipal level and provincial registrars level of the results of the Senate elections this coming May 14 will prevent those who wish to manipulate the vote from going ahead and accomplishing their dirty tricks.</p>

<p style="text-align: justify">Hence, the early release by COMELEC provincial registrars of the results in their level of the Senate tally coupled with the media announcing the results immediately will render dagdag-bawas obsolete.</p>

<p style="text-align: justify">This procedure makes the election process more transparent. Greater transparency will certainly make it difficult for wrong doers to do their trade. In the past elections, the entire nation has been prevented from immediately knowing the official results per provinces and have has been made to rely on the slow official canvass, thereby allowing vote manipulation pending the release of the official results. This practice must come to an end.</p>

<p style="text-align: justify">It should be of interest to note, for example, how NCR or Cebu province or Iloilo will vote, where 12-0 will be achieved if at all and which provinces will be dominated by the administration and which provinces will not."</p>
<!-- NewsBody.end -->
         </td>
         <td id="sidepane">
