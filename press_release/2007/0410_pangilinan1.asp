...
<!-- file generated by WebNewsGen 070201 on 4/10/2007 4:40:41 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko on the surgery of First Gentleman...</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->KIKO ON THE SURGERY OF FIRST GENTLEMAN<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start --><p>"We hope and pray for a speedy recovery for the First Gentleman. His medical condition should serve as a reminder to everyone that life is fleeting, that we are all mortal and that we all live on borrowed time."</p>
<!-- NewsBody.end -->
         </td>
         <td id="sidepane">
