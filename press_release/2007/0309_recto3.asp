...
<!-- file generated by WebNewsGen 070201 on 3/11/2007 12:56:40 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Recto backs state Us for Quezon, Bataan, Bukidnon and Laguna</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Recto Backs State Us for Quezon, Bataan, Bukidnon and Laguna<!-- NewsTitle.end --></span></p>
<!-- NewsBody.start --><p style="text-indent: 25px">Senator Ralph Recto backed moves to strengthen the educational systems in Quezon, Bukidnon and Bataan by converting their existing polytechnic colleges into universities.</p>
<p style="text-indent: 25px">Recto said these state universities would serve as training ground for agricultural engineers, agronomists, civil engineers, mathematicians, physicists and biologists that the economies of these provinces need.</p>
<p style="text-indent: 25px">He noted in particular that Quezon, which has rich human and natural resources, has no state university of its own. Recto said he supported the plea of three Quezon congressmen to convert the Southern Luzon Polytechnic College (SLPC) in Lucban, Quezon into a state university to be known as the Southern Luzon State University (SLSU).</p>
<p style="text-indent: 25px">SLPCs main campus is in Lucban, with six satellite campuses in three districts of the province. District 1 includes the Sampaloc Campus, Infanta Campus, and Polillo Campus.  The Lucena Dual-Tech Livelihood and Training Center is the lone campus in District 2, while Alabat Campus Alabat, Quezon and SLPC-JGEPC campus in Tagkawayan, Quezon are the campuses in District 4.</p>
<p style="text-indent: 25px">Recto batted for strengthening SLPC, which notched a passing rate of 91 percent for nursing in the last five years based on records of the Professional Regulatory Commission (PRC).</p>
<p style="text-indent: 25px">SLPCs electronics and communication engineering (ECE) program ranked 9th in the entire country in 2004. Other engineering programs are doing well, he added, along with the elementary and secondary programs.</p>
<p style="text-indent: 25px">Recto also backed the elevation of Bataan Polytechnic State College in Balanga, Bataan into a state university, along with the transformation of the Bukidnon State College in Malaybalay City into the Bukidnon State University.</p>
<p style="text-indent: 25px">He also supported the conversion of the Laguna State Polytechnic College (LSPC) into the Laguna State University.</p>
<p style="text-indent: 25px">He noted that LSPC also had a good performance in the licensure examinations for civil, electrical and mechanical engineering.  The educational programs for both the elementary and secondary have also recorded good standing in the licensure examination.</p>
<p style="text-indent: 25px">He said with the conversion of these colleges into state universities, better curricula could be designed for specialized disciplines that are appropriate to the needs of these provinces.</p>
<p style="text-indent: 25px">Recto also stressed that the money for these educational institutions would be used judiciously to promote the intellectual growth of young Filipinos and harness their capabilities to promote local economic development.</p>
<p style="text-indent: 25px">The funds would also be utilized to enhance the educational skills of the faculty of these institutions.</p>
<!-- NewsBody.end -->
         </td>
         <td id="sidepane">
