...
<!-- file generated by WebNewsGen 070201 on 6/19/2007 11:55:05 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko on the secret voting for Senate presidency...</title>
...
<td>&nbsp;<a href="http://www.newsenatebuilding.com">Bagong Senado</a></td></tr></table></div></div>
   ...
   <table id="container">
      <tr>
         <td id="content">
Press Release<br /><!-- NewsDate.start -->June 19, 2007<!-- NewsDate.end -->
<p><span class="PRTitle"><!-- NewsTitle.start -->KIKO ON THE SECRET VOTING FOR SENATE PRESIDENCY...<!-- NewsTitle.end -->
</span></p><!-- NewsBody.start --><p style="text-align: justify; text-indent: 25px">"Sa aking pagkakaintindi, ang secret balloting ay bagay na internal sa GO kung kayat mas mainam na hintayin na lang natin bilang independent ang magiging resulta nito sa halip na tayo ay makibahagi."</p>

<p style="text-align: justify; text-indent: 25px">"Nakarating din sa atin ang impormasyon na hindi lahat ng GO senators ay sumasang-ayon sa partisipasyon ng mga independent sa secret balloting kung kayat mabuti na magkaisa muna sila sa kanilang common stand kung sino sa palagay nila ang dapat kasali o 'di kasali sa proseso bago tayo magpapasya kung magpapasailalim tayo sa nasabing proseso bilang independent. Ganunpaman, nagpapasalamat din tayo sa GO na isali tayo sa nasabing proseso."</p>
<!-- NewsBody.end -->
         </td>
         <td id="sidepane">
