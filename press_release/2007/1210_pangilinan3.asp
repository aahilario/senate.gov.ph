...
<!-- file generated by WebNewsGen 070821 on 12/11/2007 11:19:49 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko applauds Judicial and Bar Council on 20th Anniversary, reiterates much work...</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->KIKO APPLAUDS JUDICIAL AND BAR COUNCIL ON 20TH 
<br />
ANNIVERSARY, REITERATES MUCH WORK REMAINS TO BE DONE<!-- NewsTitle.end --></span>
<br /><span class="PRSub"><!-- NewsTitleSub.start -->"A sound and efficient judicial system would ultimately translate 
<br />
into an expeditious dispensation of justice..." --- KIKO<!-- NewsTitleSub.end--></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">On the 20th Anniversary of the Judicial and Bar Council (JBC), Senate Majority Leader and independent senator Kiko Pangilinan is optimistic that it would continue the initiatives that they have started in improving the legal system, particularly the judiciary.</p>
<p style="text-align: justify">Pangilinan, an ex-officio member of the JBC, has always pushed for judicial reforms, including among others better compensation packages for judges, filling the vacancies in court and opening the judges' selection process to the public.</p>
<p style="text-align: justify">"A sound and efficient judicial system would ultimately translate into an expeditious dispensation of justice.   If the citizens would only espouse confidence in the legal system through a competent judiciary, then this would definitely be a step further to a more productive and law-abiding society," Pangilinan said.</p>
<p style="text-align: justify">With the coordination of the JBC and Senator Pangilinan, the salary of judges was significantly raised, encouraging more applications for vacant positions.   Also, public participation is instituted in the selection of judges to ensure that they are scrutinized, fit and capable for the position.</p>
<p style="text-align: justify">"We have long worked on confronting the perceived exclusivity of the JBC's selection process, as clearly, the appointment of our public officials is a matter of public interest. Our Constitution guarantees our people the right to information on the matters of public interest. In 2001, I also proposed for the amendment of the JBC Rules to make mandatory public interviews of candidates to key positions in the Judiciary. This is our continued thrust to not just promote transparency, but also to encourage our citizens to participate in these democratic processes," Pangilinan ended.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
