...
<!-- file generated by WebNewsGen 100809 on 11/28/2012 5:06:08 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - "Cayetano on government's goal for Education Sector: K12 is only one method of basic education enhancement"</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->"Cayetano on government's goal for Education Sector: K12 is only one method of basic education enhancement"<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->

<p style="text-align: justify">I don't think that with the present resources and the present timeframe it's possible to have those extra years. I think there has to be either a delay in the implementation, longer timeframe or a different model that we'll use.</p>
<p style="text-align: justify">If we insist on the K12 as it is now then there will be more dropouts and the quality of education for the whole education cycle will be affected.</p>
<p style="text-align: justify">The question right now is: Yes, we want the P50-60 billion additional to our budget but where do we want it to go? Do we want to focus it on certain projects and grade levels or do we want it to be just a shotgun approach?</p>
<p style="text-align: justify">Reporter: So anong tingin niyo po?</p>
<p style="text-align: justify">I think that there's growing support. Many people think that it's a done deal and that they won't be able to do anything about it. But I've been going around talking to teachers' associations, parents and even private schools and also consulting. Everyone is for Basic Education enhancement. But that's different from K12. K12 is only one method of basic education enhancement.</p>
<p style="text-align: justify">It's only one model. For example, yesterday I was in a meeting with public school teachers in Pangasinan. Two weeks ago I was in Pampanga with some teachers' groups. Last week, I was in talks with private schools models. So what are the other models that we can use? I think the alternatives have not yet been fully explored.</p>
<p style="text-align: justify">Reporter: Diba sir, other senators are pushing for the measure to become a law?</p>
<p style="text-align: justify">Yes but that's assuming that everyone supports it. That's why I'm insisting on an interpellation that will address these issues one by one.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
