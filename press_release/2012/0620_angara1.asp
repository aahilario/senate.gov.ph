...
<!-- file generated by WebNewsGen 100809 on 6/20/2012 2:31:07 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Angara calls for responsible mining practices</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->ANGARA CALLS FOR RESPONSIBLE MINING PRACTICES<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify"><p style="text-align: justify">Senator Edgardo J. Angara urged state universities and colleges (SUC's) to help promote responsible mining practices through an intensive public information program as Malacanang prepares an Executive Order  defining the administration's mining policy.</p> <p style="text-align: justify">"Mindanao is known to have an inexhaustible wealth of natural minerals. Unfortunately, harmful mining activities that employ crude practices will not only deplete the country's rich mineral resources, but can also diminish development prospects," Angara said in a radio interview.</p> <p style="text-align: justify">Angara, chair of the Senate Committee on Science and Technology also called on universities and experts to help in establishing guidelines on responsible mining and improving certain provisions on local and national mining regulations.</p> <p style="text-align: justify">"Mining presents a huge potential for economic growth and development. According to a recent study from the Philippine Institute for Development Studies (PIDS), the country stands to gain more economic benefit from mining by focusing on value-addition, particularly in terms of downstream processing and manufacturing activities.</p> <p style="text-align: justify">"However, the report also shows that the sector is faced with issues well beyond questions of returns on investment," said Angara. "We can't limit ourselves to just looking at how much monetary gain can be made. Further studies must examine the social and environmental impacts of mining, and do so in a meaningful way."</p></p>
<!-- NewsBody.end -->
</td><td id="sidepane">
