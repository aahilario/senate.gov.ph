...
<!-- file generated by WebNewsGen 100809 on 8/4/2012 8:38:40 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko lauds SC ruling allowing two representations from congress in JBC  </title>
...
<span class="PRTitle"><!-- NewsTitle.start -->KIKO LAUDS SC RULING ALLOWING TWO REPRESENTATIONS<br />
&nbsp;FROM CONGRESS IN JBC <!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">Senator Francis "Kiko" Pangilinan today lauds the Supreme Court's swift resolution to the impasse confronting the Judicial and Bar Council with regard to the number of votes in the council which are allowed from the legislative branch of government.</p>
<p style="text-align: justify">"We laud the SC in recognizing the need to swiftly resolve this current impasse. While it may not have been the long-term remedy we are hoping for, this will serve our need to move on with the selection and voting process," says Pangilinan.</p>

<p style="text-align: justify">The Supreme Court issued a resolution suspending its prior decision to "immediately execute" the prohibition of allowing one representative from the House and one representative from the Senate in the JBC, saying that it is unconstitutional. Pangilinan, a former ex-officio member of the JBC and former Chairman of the Senate Committee on Justice, has been lobbying for allowing two representatives from Congress. He also has filed two resolutions in the Senate expressing the same.</p>

<p style="text-align: justify">"Now that the issue has been temporarily resolved, we hope that the ruling is made final should the full court convene at some future time."</p>
