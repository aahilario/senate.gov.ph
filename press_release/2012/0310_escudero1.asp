...
<!-- file generated by WebNewsGen 100809 on 3/12/2012 7:27:07 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Chiz pushes for equal tax sharing for LGUs</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->CHIZ PUSHES FOR EQUAL TAX SHARING FOR LGUs<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator Chiz Escudero is pressing for a more equitable distribution of tax under a proposal that will give a 100- percent tax share to local government units (LGUs) from all revenues derived from sales or transactions where the principal place of business is located.</p>
<p style="text-align: justify">"We seek to modify the present situs rule on taxation, which is already recognized and imposed by the Local Government Code. We want a fair tax sharing for our local governments," Escudero explained.</p>
...
<p style="text-align: justify">This basic rule of taxation has been a dispute among local government units especially since most principal places of business are located in highly urbanized cities in the country like those in Metro Manila.</p>
<p style="text-align: justify">"Majority of the big businesses build their factories or project offices in provincial areas but maintain head offices in the cities. This bill wants to equally distribute the revenues among towns and municipalities so that they can get their right share of the pie," the senator said.</p>
<p style="text-align: justify">Escudero's Senate Bill No. 105, or to be known as Rationalizing Local Taxation Act, expunges the present 30-percent share of the LGU where the principal place of business is located.</p>
...
<p style="text-align: justify">"There is a constitutional mandate of making our LGUs autonomous and self-sustaining government bodies. SBN 105 is in consonance with this," Escudero said.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
