...
<!-- file generated by WebNewsGen 100809 on 8/9/2012 8:05:26 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Lessons and hope for change from Senator Loren Legarda</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Lessons and hope for change from Senator Loren Legarda<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">"Soon the heavy rains will cease and the floods will subside. The victims will have to rebuild their lives from the tragedy and devastation. This flood is worse than Ondoy. I hope serious government and private sector efforts to build back better the affected communities would start immediately. We must learn the lessons of Ondoy which this recent widespread flooding brings to fore once again.</p>

<p style="text-align: justify">"One lesson is clear: We must realize that heavy and excessive rainfall is part of the 'new norm.' We must implement immediately our new laws that promote disaster and climate risk reduction. We must endeavor to prevent or reduce flood disaster. As the old adage goes, prevention is always better than cure.</p>

<p style="text-align: justify">"The nation's capital needs a comprehensive recovery and rehabilitation plan that will reduce people's vulnerability and increase the resilience of all sectors to floods. Such plan should be developed and implemented together with key stakeholders and must not be abandoned like the recovery and rehabilitation efforts following Ondoy.</p>

<p style="text-align: justify">"More importantly, we must assess our respective work in reducing flood risk, if we are really making any headway amid the 'new norm' we experience in this era of climate change.  Are we working on preventing and mitigating the floods or merely responding to their onslaught? Pursuant to our new laws, we must put greater emphasis and invest more (70-30) on disaster prevention and mitigation and risk reduction measures (which bring cost benefit returns as much as: $1 invested in prevention yields $7-14 saved in response cost according to United Nations and World Bank studies) over disaster response (which is costly and unsustainable). This is the new paradigm shift. However, it seems the shift still has to take place. And our wish for local governments &amp; communities to know the risk and protect lives and property way before any natural hazard strikes remains a goal.</p>

<p style="text-align: justify">"Are LGUs aware of communities at risk of landslide? How many families have been relocated to safer areas?</p>

<p style="text-align: justify">"Have Metro Manila LGUs dredged or cleaned up regularly their esteros and strictly prohibited and monitored garbage dumping in them?</p>

<p style="text-align: justify">"What is MMDA doing with the missing esteros and those with structures on them?</p>

<p style="text-align: justify">"What improvement in the protocol for dam water releases is required in view of the recent widespread flooding?</p>

<p style="text-align: justify">"Let's aim at preventing natural hazards (typhoon, strong wind, heavy rains, storm surges, quake, etc.)  from becoming disaster situations through effective risk reduction and management. While disaster response preparedness is important, it is never enough for saving lives and reducing socio-economic losses substantially. This action is last of five priorities set by the Hyogo Framework for Action (HFA) for disaster risk reduction (DRR).</p>

<p style="text-align: justify">"The Philippines is reputed as model for implementing the first HFA priority which is policy legislation and governance for DRR. Let's implement well our laws and deliver the benefits the Filipino people long deserve. Strong political will at national and local levels can help bring about the big change we want to see.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
