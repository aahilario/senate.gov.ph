...
<!-- file generated by WebNewsGen 100809 on 7/30/2012 1:28:44 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - 'PPP' vs flooding needed - Chiz</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->'PPP' VS FLOODING NEEDED - CHIZ<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">SENATOR Chiz Escudero has proposed a "PPP" solution to the worsening flood problem in Metro Manila and other parts of the country.</p>
<p style="text-align: justify">"We need to clean up our waterways, and we need to make sure that our waterways stay clean. Otherwise, we will continue to suffer flooding forever," Escudero said.</p>
<p style="text-align: justify">The senator chairs the Committee on Environment and Natural Resources.</p>
<p style="text-align: justify">"The best approach is a massive joint government-private sector initiative to address the perennial flood problem all over the country. This is the only way. Wala na dapat turuan o batuhan ng sisi. We have to get our acts together," he said.</p>
<p style="text-align: justify">Escudero made the call in the wake of heavy rains dumped by tropical storm "Gener" on Metro Manila and nearby areas on Sunday that forced local governments to conduct rescue operations in flooded areas.</p>
<p style="text-align: justify">The Department of Education and some LGUs also suspended classes and work.</p>
<p style="text-align: justify">"The task of solving the flood problem cannot be the responsibility of just one entity. We can earmark billions of pesos for dredging and other anti-flood activities, but it will not solve the problem. Ginawa na 'yan dati, at ilang administrasyon na ang nagdaan, pero andyan pa din ang baha," Escudero said.</p>
<p style="text-align: justify">"The components of massive flooding are really interconnected. So there has to be a comprehensive solution, whatever it will be," he noted.</p>
<p style="text-align: justify">Escudero said government agencies such as the DENR, MMDA and DPWH will have to work more closely with the private sector, including individuals, companies and NGOs, in hammering out an action plan to address flooding.</p>
