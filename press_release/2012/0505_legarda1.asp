...
<!-- file generated by WebNewsGen 100809 on 5/6/2012 9:54:51 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Legarda urges LGUs to fast-track disaster risk reduction action plans </title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Legarda Urges LGUs to Fast-track Disaster Risk Reduction Action Plans <!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">Senator Loren Legarda today urged local government units (LGUs) to prioritize the crafting of their respective local action plans for disaster risk reduction to be endorsed to the President for funding and immediate implementation.</p>
<p style="text-align: justify">Legarda made the statement at the Peer-to-Peer Learning Exchange on Reducing Vulnerabilities and Adapting to Climate Change workshop in Albay, which focused on building a resilient Mindanao in light of the Sendong disaster.</p>
<p style="text-align: justify">"I am glad that our exchange participants today have devoted their time for this learning visit, fully aware of the opportunity to learn, to build back better communities and to make the right choices for our people in Mindanao. Our visiting LGUs can learn much from the many pioneering initiatives that effectively address the challenge of reducing risk, reducing poverty, and rebuilding communities without engendering new vulnerabilities," Legarda stressed.</p>
<p style="text-align: justify">"The important starting point is political commitment, and our measure for success is more disaster-resilient investments and, fundamentally, better and greater quality of life for our long-suffering people," she added.</p>
<p style="text-align: justify">The Senator pointed out that the government has the financial resources needed to rebuild from the previous disaster and prepare for the next hazard, noting that the government has downloaded US$ 500 Million from the World Bank, from its Catastrophe Deferred Drawdown Option (CAT-DDO).</p>
<p style="text-align: justify">Moreover, Legarda said that 70% of the PhP7.5 Billion allocation for the National Disaster Risk Reduction and Management (NDRRM) Fund this year should also be tapped for post-Sendong reconstruction efforts.</p>
<p style="text-align: justify">"I believe our technical agencies, the NDRRM Council, Department of Budget and Management (DBM) and Department of Finance (DOF), can shed light on this because it is not enough that resources are available. Those who are in need of it should be guided on how to access it properly," she stressed.</p>
<p style="text-align: justify">"I hope that through this workshop, our LGUs could draw up an action plan with proposed projects that the NDRRMC could endorse to the President for possible funding from the NDRRM Fund," said Legarda.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
