...
<!-- file generated by WebNewsGen 100809 on 8/9/2012 7:20:15 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko: government agencies must offer public free short courses on safety training</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->KIKO: GOVERNMENT AGENCIES MUST OFFER PUBLIC FREE SHORT COURSES ON SAFETY TRAINING<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">Senator Francis "Kiko" Pangilinan urges government agencies such as the Metropolitan Manila Development Authority (MMDA), the Department of Interior and Local Government (DILG), the Department of Social Welfare and Development (DSWD), and the National Disaster Risk Reduction and Management Council (NDRRMC) to offer the public basic safety training courses for free.</p>

<p style="text-align: justify">Pangilinan adds that doing so will not only equip citizens with skills needed in cases of emergency but will also beef up the government's volunteer reserves.</p>

<p style="text-align: justify">"We have seen that with the recent flooding that hit Metro Manila, we are severely lacking in manpower that could help in rescue operations. Even if our countrymen heed the call to volunteer during rescue operations, they are ill-equipped to deal with emergency situations. It would be very much like deploying troops to a gun battle without the necessary firearms."</p>

<p style="text-align: justify">Pangilinan earlier called for a nationwide rehabilitation of the country's sewerage and drainage systems.</p>

<p style="text-align: justify">"Alam na nga natin na bawat taon ay tinatamaan tayo ng napakaraming bagyo, ganito pa rin ang nangyayari taun-taon--at palala pa nang palala ang sitwasyon. We should invest a significant amount of resources on beefing up our infrastructure and equipping our people with life-saving skills so that more lives will be saved when disasters and emergencies strike."</p>

<p style="text-align: justify">"Hindi natin puwedeng sabihin na 'ganyan na talaga' dahil hindi tama na taun-taon na lang ay nalalagay sa panganib ang mga tao dahil lang sa pag-ulan na ni hindi pa nga 'supertyphoon.' For drastic change to happen, then we must also do drastic actions and do things differently. In this case, doing things differently can be literally a matter of life and death," the senator points out.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
