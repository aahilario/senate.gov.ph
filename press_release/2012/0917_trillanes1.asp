...
<!-- file generated by WebNewsGen 100809 on 9/17/2012 10:25:19 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Trillanes backs 'reasonable' sin tax</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Trillanes backs 'reasonable' sin tax<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator Antonio "Sonny" F. Trillanes IV on Friday said he is supporting the proposed legislation that will increase the excise tax imposed on liquor and tobacco products as long as the rates are reasonable.</p>
<p style="text-align: justify">"I am supporting the sin tax bill as a revenue measure since the rates will be indexed on the country's inflation rate, provided, however, that the rates of increase should be reasonable," Trillanes said.</p>

<p style="text-align: justify">According to Trillanes, the proposal to increase the sin taxes should be within the parameters of realistic revenue targets and based on the current classification system of liquor and tobacco products.</p>

<p style="text-align: justify">Trillanes, who is a member of the Senate Committee on Ways and Means, explained that the proposed increase should "not kill the source of livelihood of our tobacco farmers."</p>

<p style="text-align: justify">"We have to ensure that the system to be implemented should be equitable and the rate should not be too high that it could cause the market to collapse and encourage smuggling of tobacco products," Trillanes added.</p>

<p style="text-align: justify">Under the House version of the sin tax bill, imposition of tax will be based on a single classification system which is unitary and the tax rate will be uniform, regardless of the quality of the products.</p>
<p style="text-align: justify">"This system is discriminatory against the lower-tier products and would favor the imported brands," Trillanes said.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
