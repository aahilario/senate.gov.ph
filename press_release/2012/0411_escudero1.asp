...
<!-- file generated by WebNewsGen 100809 on 4/11/2012 11:23:04 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Escudero: On the earth-balling of pine trees by SM in Baguio city</title>
...
<span class="PRSuper"><!-- NewsTitleSuper.start -->SENATOR CHIZ ESCUDERO <br />
CHAIRMAN OF THE SENATE COMMITTEE <br />
ON ENVIRONMENT AND NATURAL RESOURCES<!-- NewsTitleSuper.end --></span><br />
<span class="PRTitle"><!-- NewsTitle.start -->ON THE EARTH-BALLING OF PINE TREES BY SM IN BAGUIO CITY<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->

<p style="text-align: justify">It must have taken about several number of years to grow pine trees that size. Why should it take only a few weeks to cut or "ball" it down? What's a few more weeks to look deeper in the issues involved. I welcome the environmental protection order issued by the court against SM management. While temporary as it may, it will enable all the stakeholders enough breathing space to take stock and study their respective options BEFORE making any permanent actions that might unduly affect our fragile ecosystem and environment.  In the meantime, I urge SM and other parties to obey and respect the court.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
