...
<!-- file generated by WebNewsGen 100809 on 6/27/2012 10:17:59 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko: Psychological tests, other additional requirements "to determine fitness, Competence, Integrity and probity is consistent with constitution", "Necessary for JBC to do its job"</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->KIKO: PSYCHOLOGICAL TESTS, OTHER ADDITIONAL REQUIREMENTS
<br />
"TO DETERMINE FITNESS, COMPETENCE, INTEGRITY, <br />
AND PROBITY IS CONSISTENT WITH CONSTITUTION", <br />
"NECESSARY FOR JBC TO DO ITS JOB"<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->


<p style="text-align: justify">Senator Francis "Kiko" Pangilinan, former ex-oficio of the JBC, defends the JBC practice of conducting psychological tests, and reacts to statements that nominees to the post of Chief Justice should object to this and other additional requirements because these are "unconstitutional."</p>

<p style="text-align: justify">"The mandate of the JBC is to ensure that those shortlisted are qualified and meet the requirements laid down by the Constitution," Pangilinan says. "I disagree with those who say that these additional requirements are unconstitutional."</p>

<p style="text-align: justify">He cites: "The public interviews required by the JBC is not found in the Constitution. Does this mean that the interviews are also unconstitutional? How can the JBC fulfill its duty to ensure that only the qualified are nominated if it cannot even interview a nominee because the Constitution does not say that interviews are required?"</p>

<p style="text-align: justify">"Clearly, this is not the intent of the framers of our Constitution," he concludes.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
