...
<!-- file generated by WebNewsGen 100809 on 3/14/2012 7:11:20 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko takes exception to SC's decision on who may and may not appear in the impeachment court</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->KIKO TAKES EXCEPTION TO SC'S DECISION ON WHO MAY 
<br />
AND MAY NOT APPEAR IN THE IMPEACHMENT COURT<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator-Judge Francis "Kiko" Pangilinan manifests in the impeachment court that he is wary of the Supreme Court's arbitrary selection of witnesses it allows to appear in the impeachment court.</p>

<p style="text-align: justify">"We now have an issue where the Supreme Court, whose Chief Justice is on trial in the impeachment court, can decide who can or cannot appear in the proceedings. Araceli Bayuga, an employee of the SC, was allowed to testify in defense of the Chief Justice, yet the driver, process server and security guard subpoenaed have not been allowed to appear."</p>

<p style="text-align: justify">"This impeachment court must assert its authority in uncovering the truth, and it should not allow even the SC to stop it from performing its function, and it should not be prevented from fulfilling its constitutional duty. In the United States, the impeachment court can subpoena even the sitting President. Sadly, in our case, we are unable to subpoena a driver, a security guard because the Supreme Courts says we cannot do so."</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
