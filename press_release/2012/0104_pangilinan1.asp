...
<!-- file generated by WebNewsGen 100809 on 1/4/2012 3:05:08 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko urges LGUs to utilize idle lands for agri to ensure food security</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->KIKO URGES LGUs TO UTILIZE IDLE LANDS FOR AGRI 
<br />
TO ENSURE FOOD SECURITY<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->

<p style="text-align: justify">Chairman of the Senate Committee on Agriculture and Food Senator Francis "Kiko" Pangilinan urges local government officials to utilize idle lands within their jurisdiction for agriculture to ensure food supply in their localities.</p>

<p style="text-align: justify">"In light of the havoc wreaked by typhoon 'Sendong', where officials were scrambling for food sources, it would be wise for LGUs to utilize idle lands for crops that could be used as buffer for such eventualities."</p>

<p style="text-align: justify">Pangilinan also urges returning OFWs to invest in the agriculture and fisheries sector, saying there are a lot to be optimistic about these sectors for the New Year.</p>

<p style="text-align: justify">"The Department of Agriculture has been given a major boost with the biggest budget allocation hike among all agencies. The Aquino administration is committed to modernizing agriculture sector and this is enough to boost the confidence of our countrymen in investing in the agriculture and fisheries sector."</p>

<p style="text-align: justify">"The LGUs must create an enabling environment and encourage these investments as they look to uplift their communities. While it isn't wrong to use land for factories, malls, or housing, we should prioritize land for food, more so if said lands are irrigable. The lessons we have learned through such disasters as typhoons and other calamities should be taken to heart--that we must, first and foremost, secure the needs of our people, especially when hunger is on the rise."</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
