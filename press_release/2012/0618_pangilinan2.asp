...
<!-- file generated by WebNewsGen 100809 on 6/18/2012 5:08:13 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko lauds JBC decision allowing media access for CJ selection process</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->KIKO LAUDS JBC DECISION ALLOWING 
<br />
MEDIA ACCESS FOR CJ SELECTION PROCESS<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify"><p style="text-align: justify">Former Chairman of the Senate Committee on Justice, and former ex-oficio of the Judicial and Bar Council, Senator Francis "Kiko" Pangilinan, lauds the JBC's ruling allowing media access for the selection process of the next Chief Justice of the country.</p> <p style="text-align: justify">"We congratulate the JBC for choosing transparency in selecting the next Chief Justice. We believe that this decision will lead to greater accountability and better governance of our courts. It's a step in the right direction towards reforming the Judiciary."</p> <p style="text-align: justify">Pangilinan has been advocating for transparency in the selection and voting process for the next Chief Justice, calling for an amendment in JBC rules in order to allow media coverage of the proceedings despite the current rules saying otherwise.</p> <p style="text-align: justify">"We've always said that if we want real change, we must be willing to dare and do things differently We believe that changing the process by which the court's leaders are selected may also change the kind of leader that will emerge from this process."</p> <p style="text-align: justify">The lawyer-lawmaker also points out, "We saw in the impeachment trial how decisions of the judiciary can affect the lives and livelihood of our people. We have a lot at stake here, so it's important for the public to be equally aware of and involved in selecting the next Chief Justice, as is the JBC."</p></p>
<!-- NewsBody.end -->
</td><td id="sidepane">
