...
<!-- file generated by WebNewsGen 100809 on 3/1/2012 11:01:08 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Sen. Guingona pushes for additional Sandiganbayan Associate Justices</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->SEN. GUINGONA PUSHES FOR ADDITIONAL SANDIGANBAYAN 
<br />
ASSOCIATE JUSTICES <!-- NewsTitle.end --></span>
<br /><span class="PRSub"><!-- NewsTitleSub.start -->MORE JUSTICES TO EXPEDITE RESOLUTION OF CASES<!-- NewsTitleSub.end--></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">To fast-track the resolution of cases pending before the anti-graft court, Senator Teofisto "TG" Guingona III has filed Senate Bill No. 3111 which seeks to increase the number of associate justices in the Sandiganbayan from 14 to 44, thus allowing faster resolution of cases.</p>
<p style="text-align: justify">"We want to ensure that justice will be implemented fairly, equitably and with the highest level of integrity. With the additional associate justices in Sandiganbayan, the need to extract accountability in a timely and relevant manner will no longer suffer," Sen. Guingona said.</p>
<p style="text-align: justify">In a study jointly sponsored by the Supreme Court and the World Bank entitled "Philippines: Formulation of Case Decongestion and Delay Reduction Strategy Project-Phase I," it is  revealed that each division handles approximately 1,000 cases per year, with each case taking an average of seven years to be disposed of by the Court. The Guingona amendment seeks to address such a heavy workload.</p>
<p style="text-align: justify">To increase the efficiency of the Sandiganbayan, Sen. Guingona's bill also seeks to allow one justice, instead of three, to hear and receive evidence of a case thus resulting to more cases being heard by the court at the same time.</p>
...
<p style="text-align: justify">Sen. Guingona's bill proposes to sit 15 divisions in Sandiganbayan, instead of the current five, with three justices in each division. The first seven divisions shall be stationed in the Metro Manila, four divisions will be stationed in Visayas, and another four divisions to be stationed in Mindanao.</p>
