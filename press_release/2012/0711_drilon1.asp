...
<!-- file generated by WebNewsGen 100809 on 7/11/2012 11:31:13 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - CCT to undergo scrutiny before Palace submits 2013 budget, says Drilon</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->CCT to undergo scrutiny before Palace submits 2013 budget, says Drilon<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">An oversight committee will review the Aquino administration's P39-billion flagship poverty alleviation program in preparation for the upcoming deliberation on the 2013 proposed national budget, according to Senate Finance Committee Chairman Franklin M. Drilon.    Drilon said he and House Committee on Appropriations chairman Joseph Emilio A. Abaya have scheduled a briefing from the Department of Social Welfare and Development (DSWD) for Thursday, 2 o'clock in the afternoon, to discuss the developments in the implementation of the conditional cash transfer (CCT) program or the Pantawid Pamilyang Pilipino Program (4Ps).</p>
<p style="text-align: justify">Both Drilon and Abaya chair the Joint Congressional Oversight Committee on Public Expenditures which is created to review and evaluate expenditure programs of all government agencies and assess effectiveness and impact of government activities, programs and projects.</p>
<p style="text-align: justify">"It is pertinent that we conduct a review of the effectiveness and efficiency of the conditional cash transfer program that is primarily conceptualized to uplift the lives of the poorest Filipino families," said Drilon.</p>
<p style="text-align: justify">Drilon noted that the CCT was allocated P39 billion this year from P21 billion in 2011 to provide assistance to three million household beneficiaries identified trough the National Household Targeting System.</p>
<p style="text-align: justify">"We would like to hear from Social Welfare Secretary Dinky Soliman if her agency has successfully plugged in some of the loopholes that we and some concerned sectors have identified," added Drilon.</p>
<p style="text-align: justify">In particular, Drilon will look into issues confronting the integrity of the program including the cleaning up of the list of beneficiaries to ensure that those in the list are only the poorest families and the assurance that it will not be used by politicians in the 2013 elections.    Also, Drilon said he will find out from the DSWD and the Department of Budget and Management how much fund the government will continue to provide in the coming years to ensure the program's successful implementation.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
