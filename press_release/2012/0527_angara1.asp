...
<!-- file generated by WebNewsGen 100809 on 5/28/2012 7:19:27 AM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Angara: ICT helps provide wider, cheaper access to quality healthcare</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->ICT HELPS PROVIDE WIDER, CHEAPER ACCESS 
<br />
TO QUALITY HEALTHCARE<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->


<p style="text-align: justify">Senator Edgardo J. Angara expressed his support for the expansion of Wireless Access to Health (WAH) in Tarlac province which uses information and communication technology (ICT) in improving healthcare using 3G technology.</p>

<p style="text-align: justify">Angara, Chair of the Congressional Commission on Science, Technology and Engineering (COMSTE), lauded the Tarlac Provincial Health Office and the Department of Health (DOH) for successfully implementing the WAH and adding Mobile Midwife and SPASMS (Synchronized Patient Alert via SMS) applications.</p>

<p style="text-align: justify">"Scaling up WAH can help ensure quality, affordable and accessible healthcare in the Philippines. I hope that these projects will all be successful," Angara said.</p>

<p style="text-align: justify">The WAH is a collaborated public-private partnership established to modernize the access of health workers and doctors to accurate and updated patient information by using 3G wireless technology. It also strengthens the current Community Health Information Tracking System (CHITS) which is an electronic medical record system developed by the University of the Philippines Manila.</p>

<p style="text-align: justify">Mobile Midwife enables patient data to be captured and updated electronically to the CHITS system during patient visits via smart phones, tablets or laptop while SPASMS is an alert and health promotion system which sends patient information on prenatal care and child immunization.</p>

<p style="text-align: justify">These programs address problems in inequities in access, cost, inefficiency and maldistribution of healthcare providers and public health systems managers in far-flung communities. They also aim to be standard tools in the health arena.</p>

<p style="text-align: justify">"This is another reason why we should all support ICT-enabled initiatives. Such a program, if successful, must be replicated across the country. It will boost our efforts to widen access to quality healthcare facilities even though we cannot yet build the necessary physical infrastructure or hire medical personnel," said Angara, also chair of Senate Committee for Science and Technology.</p>

<p style="text-align: justify">"ICT is an enabler in many ways. We should maximize its utility especially in delivering social services," added Angara, author and sponsor of the Data Privacy Prevention Act, Cybercrime Prevention Act and the bill institutionalizing the Department of Information and Communications Technology (DICT).</p>

<p style="text-align: justify">He added that a similar telehealth system is being pioneered by the provincial government of Aurora, his home province, with the help of the National Telehealth Center at UP Manila. "Aurora and Tarlac are pioneers and models of telehealth for other LGU's."</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
