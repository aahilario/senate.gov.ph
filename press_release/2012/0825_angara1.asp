...
<!-- file generated by WebNewsGen 100809 on 8/25/2012 6:29:11 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Angara pushes for mandatory arbitration to declog courts</title>
...
Press Release<br />
<!-- NewsDate.start -->August 25, 2012<!-- NewsDate.end -->
...
<span class="PRTitle"><!-- NewsTitle.start -->ANGARA PUSHES FOR MANDATORY ARBITRATION TO DECLOG COURTS<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start --><p style="text-align: justify">Following the historic appointment of the new Supreme Court Chief Justice Ma. Lourdes Sereno, Senator Edgardo J. Angara urged the judiciary to implement mandatory arbitration to resolve disputes quickly and unclog the courts.</p>

<p style="text-align: justify">Under Republic Act 9285 enacted in 2004, it is the country's policy to encourage the use of alternative dispute resolution to achieve speedy and impartial justice, and declog court dockets.</p>

<p style="text-align: justify">However, Angara, a veteran lawmaker and lawyer, suggested that instead of just promoting and giving the parties the option to resort to alternative dispute resolution, the judiciary should make it compulsory.</p>

<p style="text-align: justify">"Maybe we can require parties to put a mandatory arbitration provision in their contracts. If you go to court directly, the court can dismiss the case and ask you to go to arbitration," said Angara, who made the same recommendation during the recent hearing on the budget of the judiciary.</p>

<p style="text-align: justify">Under RA 9285, alternative dispute resolution system includes arbitration, mediation, conciliation, early neutral evaluation, or mini-trial involving a neutral third party to help resolve the dispute out of court.</p>

<p style="text-align: justify">"Arbitration is more advantageous than court litigation, especially in our case where it usually takes several years for the trial courts to hear and resolve the cases filed with them," said Angara, co-founder of ACCRALaw, one of the biggest law firms in the Philippines.</p>

<p style="text-align: justify">The senator explained that in the United States, mandatory arbitration is not required by law. But a Supreme Court decision in the 1960s made arbitration of labor disputes mandatory. He explained that the judiciary adopted a system of labor arbitrators that took over labor relations disputes from the courts.</p>

<p style="text-align: justify">"I think we ought to do here in the Philippines too. It requires a decision of the Supreme Court. Then it would have taken away so many contractual disputes out of the jurisdiction of the judiciary. It will take away so many of these small cases which waste the time of our justices," he said.</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
