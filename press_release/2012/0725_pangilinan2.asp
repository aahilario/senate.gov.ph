...
<!-- file generated by WebNewsGen 100809 on 7/25/2012 1:20:52 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Kiko welcomes media coverage of JBC selection process, believes it increases quality of public debate</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->KIKO WELCOMES MEDIA COVERAGE OF JBC SELECTION 
<br />
PROCESS, BELIEVES IT INCREASES QUALITY OF PUBLIC DEBATE <!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator Francis "Kiko" Pangilinan, who had pushed for the live coverage of the Judicial and Bar Council's selection process for the next Chief Justice, states his satisfaction over the live interviews that began on Tuesday, saying that the media coverage increases the quality of public debate.</p>
<p style="text-align: justify">"Politically, we have long been hung up on personalities instead of issues and platforms. The live coverage of the JBC interviews gives our countrymen a deeper understanding of the pressing issues in our justice system and allows us all to look deeper beyond names and first impressions. The quality of public debate is improving, and this should put the needed pressure on our government to wisely select the next leader of the judiciary."</p>
<p style="text-align: justify">Pangilinan earlier wrote the JBC requesting that the selection process be made available to the public. He also wrote the JBC suggesting the body ask nominees difficult questions regarding increasing conviction rates, filling up vacancies, and curbing corruption.</p>
<p style="text-align: justify">"Now that we have achieved a small but crucial victory in making the JBC process and interviews more transparent to the public, hard part begins. We must make judicial reform a top priority and choose a Chief Justice based on competence, moral ascendancy, and the determination to institute much needed-reforms on an antiquated and slugging justice system."</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
