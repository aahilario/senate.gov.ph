...
<!-- file generated by WebNewsGen 100809 on 1/31/2012 1:18:07 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Engineering crucial to solving nat'l challenges - Angara</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->ENGINEERING CRUCIAL TO SOLVING NAT'L CHALLENGES - ANGARA<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->
<p style="text-align: justify">Senator Edgardo J. Angara said that the field of engineering is important in finding solutions to such cross-cutting issues as climate change, disaster preparedness, abject poverty, inadequate energy access, food insecurity and environmental degradation.</p>
<p style="text-align: justify">Angara made the statement during his keynote speech at the 2ndEngineering Summit organized by the Philippine Technological Council (PTC) and the ASEAN Academy of Engineering and Technology (AAET).</p>
<p style="text-align: justify">"Engineering--it's so obvious--underpins the human condition. This is the engine by which science is transformed into technology, the mechanism through which knowledge is harnessed into innovation," said Angara, who is Chair of the Congressional Commission on Science &amp; Technology and Engineering (COMSTE).</p>
<p style="text-align: justify">He continued, "So complex are the technical challenges which today's many issues pose that our solutions have to be interdisciplinary and sustainable in implementation. Traditionally, engineering has been the harvester of material resources--food, energy, water, minerals. Today, it must be seen and employed for resource conservation and waste management."</p>
<p style="text-align: justify">The former UP President added that engineering must also help address urbanization, especially in light of recent natural disasters brought about by climate change.</p>
<p style="text-align: justify">"Many of us see the congestion and unplanned growth of Metro Manila and our suburbs. Clearly, our losses will be great if one or two of the disasters that struck Japan last year, hit our area. Just look at what happened in Cagayan de Oro and Iligan.</p>
<p style="text-align: justify">"This is where, I think, our engineers can make a big contribution to our society. Engineers can help make our country more resilient," explained Angara.</p>
<p style="text-align: justify">He then pointed to the importance of engineering in assuring energy access throughout the country.</p>
<p style="text-align: justify">"Cleaner and greener energy systems is clearly the future of power generation. The Philippines is quite fortunate because if we exploit our renewable energy resources, we can replace our imported crude oil and make our country cleaner, greener and our people healthier.</p>
<p style="text-align: justify">"But it takes some political will and time to do all these. But the engineers can expedite and facilitate the process, especially in renewable energy," said Angara, who is also Chair of the Senate Committee on Science and Technology.</p>
<p style="text-align: justify">The veteran lawmaker concluded, "I'm just suggesting that there are many engineering solutions to many of the problems we are now encountering--it just takes a little inventiveness and creativity. I have no doubt that with enough support our engineers will be able to provide some answers."</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
