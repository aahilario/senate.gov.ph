...
<!-- file generated by WebNewsGen 100809 on 2/7/2012 2:33:34 PM -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Press Release - Sen. Miriam Defensor Santiago's Motion for Reconsideration</title>
...
<span class="PRTitle"><!-- NewsTitle.start -->Sen. Miriam Defensor Santiago's Motion for Reconsideration<!-- NewsTitle.end --></span>
</p>
<!-- NewsBody.start -->

<p style="text-align: justify">Dear Mr. Senate President:</p>

<p style="text-align: justify">This is to respectfully and humbly propose the procedure to be followed on the defense counsel's pending motion for reconsideration.  I refer to this Court's resolution yesterday, which approved the prosecution's request for subpoena to certain bank officials.</p>

<p style="text-align: justify">At today's hearing, counsel from both panels should be allowed to argue the motion for reconsideration for not more than one hour for each side, unless the Senate orders otherwise.  (Impeachment Rules, Rule 5.)</p>

<p style="text-align: justify">After this debate, the Senate President could then give time for each panel to submit its written memorandum.  After both memoranda have been filed, then the Court could go into closed session (caucus) to resolve the pending motion.  If necessary, I shall, despite ill health, attend this caucus, if give advance notice of at least three hours.</p>
...
<p style="text-align: justify">In any event, if it is your judgment that only a senator can file a motion for reconsideration, then I respectfully request that this letter should be considered, ex abundanti cautela, as a motion for reconsideration from a senator-judge, on the following grounds:</p>
...
<p style="text-align: justify">I cite these grounds, without prejudice to my final vote, after the motion for reconsideration has been properly debated.</p>

<p style="text-align: justify">Thank you.</p>

<p style="text-align: justify">Sincerely yours,</p>
<p style="text-align: justify">MIRIAM DEFENSOR SANTIAGO</p>
<!-- NewsBody.end -->
</td><td id="sidepane">
