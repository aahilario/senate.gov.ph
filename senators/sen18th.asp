		...
		<div class="officerdiv">
			...
			<table width="90%">
				<tr>
					...
					<p class="officername">Franklin M. Drilon</p>
					Senate President<br /><br />
					<div>--><table width="98%" cellpadding="2">
							<tr>
								<td rowspan="2" style="width: 32px">
				...
				<tr>
					...
					<div>-->
						<table width="98%" cellpadding="2">
							<tr>
								<td rowspan="2" style="width: 32px">
								<img height="158" src="images/zubiri17th.jpg" width="120" />
								</td>
								<td width="350"><span class="h1_sub">
								<strong>
				...
				<tr>
					...
					<div>-->
						<table width="98%" cellpadding="2">
							<tr>
								<td rowspan="2" style="width: 32px">
								<img height="158" src="images/binay_nancy17th.jpg" width="120" />
								</td>
								<td width="350" class="auto-style2">
								<strong><span class="h1_sub">
					...
					<div>-->
						<table width="98%" cellpadding="2">
							<tr>
								...
								<img height="158" src="images/pacquiao17th.jpg" width="120" />
								</td>
								<td width="350"><span class="h1_sub">
				...
				<tr>
					...
					<div>-->
						<table width="98%" cellpadding="2">
							<tr>
								<td rowspan="2" style="width: 32px">
								<img height="158" src="images/pangilinan17th.jpg" width="120" />
								</td>
								<td width="350"><span class="h1_sub">
				...
				<tr>
					...
					<div>-->
						<table width="98%" cellpadding="2">
							<tr>
								<td rowspan="2" style="width: 32px">
								<img height="158" src="images/pimentel_koko17th.jpg" width="120" />
								</td>
								<td width="350"><span class="h1_sub">
								<strong>
				...
				<tr>
					...
					<div>-->
						<table width="98%" cellpadding="2">
							<tr>
								<td rowspan="2" style="width: 32px">
								<img height="158" src="images/villanueva17th.jpg" width="120" />
								</td>
								<td width="350"><span class="h1_sub">
					...
					<div>-->
						<table width="98%" cellpadding="2">
							<tr>
								...
								<img height="158" src="images/villar_cynthia17th.jpg" width="120" />
								</td>
								<td width="350"><span class="h1_sub">
								<strong>
