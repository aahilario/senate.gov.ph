...
<title>Legislative Agenda of Senator Defensor-Santiago - Senate of the 
Philippines</title>
...
<br />
			        ...
			        <br />
											<hr /><p><b>
			        						<a href="santiago_bio.asp">
											Biography</a> |  
			<a href="santiago_cvitae.asp">Curriculum Vitae</a>  |
											Agenda</b></p><p align="center">
						<b>(2004-2010)</b></p>
			        <p><b>EDUCATION</b></p>
			        <ul class="style1">
			          <li>
			        Improvement of the quality of primary and secondary 
			        ...
			        Advancement of science and technology education
			          ...
			          <li>
			        Strengthening of the recruitment process of Filipino 
					teachers
			          </li>
			        </ul>
			        <p><b>JOB CREATION AND SUPPORT TO ENTREPRENEURS</b></p>
			        <ul class="style1">
			          <li>
			        Promotion of entrepreneurship by allowing disposal of unused 
					public lands to deserving persons for use by them as 
					collateral for bank loans
			          </li>
			          <li>
			        Provision of more jobs to the unemployed population by 
					helping small and medium sized entrepreneurs establish their 
					businesses
			          </li>
			        </ul>
			        <p><b>PUBLIC ORDER AND ILLEGAL DRUGS</b></p>
			        <ul class="style1">
			          <li>
			        Strengthening of the criminal laws by providing for 
					punishment of crimes committed through the use of modem 
					technology
			          </li>
			          <li>
			        Strengthening of the criminal laws by providing stiffer 
					penalties for gambling
			          </li>
			          <li>
			        Strengthening of the prohibition against entry of illegal 
					drugs
			          </li>
			          <li>
			        ...
			        <p><b>YOUTH, WOMEN AND FAMILY RELATIONS</b></p>
			        <ul class="style1">
			          <li>
			        Promotion of school safety
			          </li>
			          <li>Protection of children&#39;s welfare against tobacco, illegal 
					drugs, violent programming, and firearms
			          </li>
			          <li>
			        ...
			        <p><b>HEALTH AND DEMOGRAPHY</b>
			        <ul class="style1">
			          <li>
			        Promotion of health programs and health products in order to 
					combat diseases like cancer, fertility, hepatitis C, 
					dystonia and lead poisoning, by enacting and strengthening 
					laws relating to anti-tobacco campaigns, reduction of metals 
					in packaging, a national folic acid education program, 
					research program regarding birth defects, health care cost 
					reduction programs, poison prevention and control programs
			          </li>
			        </ul>
			        <p><b>JUSTICE AND HUMAN RIGHTS</b></p>
			        <ul class="style1">
			          <li>
			        Protection of basic 
					constitutional rights - to privacy, to information, to free 
					exercise of religion, to travel, and to equal protection
			          </li>
			          <li>
			        Improvement of the corrections 
					system
			        </li>
			          <li>
			        Strengthening of laws against 
					child abuse
			          </li>
			          <li>
			        Promotion of support programs 
					for victims of torture
			          </li>
			        </ul>
			        <p><b>REVISION OF CODES AND LAWS</b></p>
			        <ul class="style1">
			          <li>
			        Preservation of the integrity 
					of election results and other aspects of the electoral 
					process
			          </li>
			          <li>
			        Improvement of election laws 
					on party list and polling for the disabled and the elderly
			          </li>
			          <li>
			        Promotion of transparency of 
					election procedures by the Comelec
			          </li>
			          <li>
			        Strengthening of criminal laws 
					by increasing penalties to deter crimes, degenderizing the 
					laws, and improving the probation and indeterminate sentence 
					laws
			          </li>
			          <li>
			        Strengthening the laws on 
					succession, family relations, obligations and contracts, and 
					torts and damages
			          </li>
			        </ul>						<p class="backtotop"><img src="/images/backtotop.gif" /> 
