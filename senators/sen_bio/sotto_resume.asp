...
<title>Resume of Senator Vicente C. Sotto III  - Senate of the Philippines</title>
	...
	<tr>
		...
		<table>
			<tr>
				<td>
				<span class="h1_sub">
									Senate Office: Rm. 603 &amp; 24 (New Wing 5/F) GSIS Bldg., Financial Center, 
				Diokno Blvd., Pasay City<br />
								...
								Telefax No.: &nbsp;(632) 552-6601 loc. 6501<br />
									...
									os_sotto@yahoo.com</a></td>
			</tr>
		</table>
		<br />		
		<hr />
		<p><b><a href="sotto_bio.asp">Biography</a> | Resume </b></p>
		&nbsp;<p>PERSONAL</p>
		<table style="width: 100%" class="style1">
			<tr>
				<td style="width: 151px; height: 16px;">Date of Birth:</td>
				<td style="height: 16px">August 24, 1948</td>
			</tr>
			<tr>
				<td style="width: 151px">Hometown:</td>
				<td>Manila</td>
			</tr>
			<tr>
				<td style="width: 151px">Spouse:</td>
				<td>Helen Gamboa Sotto</td>
			</tr>
			<tr>
				<td style="width: 151px">Children:</td>
				<td>Romina Frances<br />
				Diorella Maria
							<br />
				Gian Carlo
							<br />
			...
			<tr>
				<td style="width: 151px">Languages and <br />
				dialects spoken:</td>
				<td>English, Pilipino </td>
			</tr>
			<tr>
				<td style="width: 151px">Father : </td>
				<td>Marcelino O. Sotto</td>
			</tr>
			<tr>
				<td style="width: 151px">Mother :</td>
				<td>Herminia Castelo Sotto, M. D. <br />
				U.P. College of Medicine Class 1935 </td>
			</tr>
			<tr>
				<td style="width: 151px">Religion :</td>
				<td>Catholic </td>
			</tr>
			</tr>
		</table>
		...
		<table style="width: 100%" class="style1">
			<tr>
				<td style="width: 151px; height: 16px;">Elementary:</td>
				<td style="height: 16px">Colegio de San Juan de Letran<br />
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td style="width: 151px">Secondary:</td>
				<td>Colegio de San Juan de Letran, Manila<br />
				</td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
			...
			<tr>
				<td style="width: 151px">College:</td>
				<td>A.B. English
					<br />
				Colegio de San Juan de Letran, Manila<br />
				</td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
		...
		<p>SPECIAL TRAINING, SEMINARS, CONFERENCES</p>
		<table style="width: 100%" class="style1">
			<tr>
				<td style="width: 151px; height: 16px;">March 2009 </td>
				<td style="height: 16px">High Level Segment and 					
			...
			<tr>
				<td style="width: 151px">June 2000 </td>
				<td>Executive Program for Leaders in Development		<br />
				Harvard University <br />
				Cambridge, Massachusetts, U.S.A. </td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td style="width: 151px">April 2000 </td>
				<td>Microsoft Government Leaders’ Conference 2000 <br />
				Seattle, Washington, U.S.A. </td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td style="width: 151px">Oct. 1994 </td>
				<td>INEOA Conference <br />
				New York, USA </td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
			...
			<tr>
				<td style="width: 151px">Nov. 1996 </td>
				<td>INEOA Conference <br />
			...
			<tr>
				<td style="width: 151px">June -July 1994 </td>
				<td>Implementing Decentralization				with the Aim of Strengthening		               
				<br />
				Local Self Administration <br />
				Berlin, Germany
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
		...
		<p>GOVERNMENT POSITIONS HELD</p>
		<table style="width: 100%" class="style1">
			<tr>
				<td style="width: 151px; height: 16px;">(July 1, 2010 to 
				<br />
				June 30, 2016)</td>
				<td style="height: 16px">Senator, Republic of the Philippines<br />
	     ...
	     <br />
			...
			<tr>
				<td style="width: 151px">(2008 July to <br />
				2009 November)
				<td>Chairman, Dangerous Drugs Board, Office of the President</td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td style="width: 151px">(1992 to 1998) <br />
				(1998 to 2004) </td>
				<td>Senator, Republic of the Philippines	
				Majority Floor Leader, <br />
				Senate of the Philippines 12th Congress&nbsp; (2002 – 2004)</td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>Minority Floor Leader, Senate of the Philippines 12th 
				Congress (2002)</td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>Asst. Minority Floor Leader, Senate of the Philippines <br />
				12th Congress (2002) </td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>Majority Floor Leader, Commission on Appointments (1998 - 
				2002)</td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>Assistant Majority Floor Leader, Senate of the Philippines 
				(1992 to 1998) </td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>Chairman, Senate Committee on Public Services (1998 - 2001) </td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>Chairman, Senate Committee on Science and Technology (1999 
				- 2001) Chairman, Senate Committee on Local Government (1992 to 
				1998) <br />
				Chairman, Senate Committee on Tourism (1992 to 1998) <br />
			...
			<tr>
				<td style="width: 151px">(1988 to 1992) </td>
				<td>Vice-Mayor, Quezon City </td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>Presiding Officer, Quezon City Council (1988 – 1992) </td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>Chairman, 
				Quezon City Anti-Drug Abuse Council (1988 – 1992) </td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>&nbsp;</td>
		...
		<p>AWARDS AND COMMEMDATIONS </p>
		<table style="width: 100%" class="style1">
			<tr>
				<td style="width: 41px; height: 16px;">&nbsp;</td>
				<td style="height: 16px">International Award of Honor <br />
				International Narcotics Enforcement Officers Association <br />
				(Sept. 2, 1991 - Fort Lauderdale, Florida, U. S. A.) <br />
				<br />
				2nd International Award of Honor (Hall of Fame) <br />
				International Narcotics Enforcement Officers Association <br />
				(Nov. 18, 1996 - Bahia Hotel, San Diego, Calif., U. S. A.) <br />
				<br />
				Catholic Mass Media Radio Award <br />
				Archdiocese of Manila <br />
				For composing the song “Magkaisa” <br />
				<br />
				International Gold Medalist <br />
				Ten Pin Bowling <br />
				<br />
				7 Time National Team Member <br />
				Philippine Bowling Congress <br />
				<br />
				2 Time World Cupper <br />
				Ten Pin Bowling ( 1978 and 1984) <br />
				<br />
				and other various awards, medals and commendations <br />
				for music composition, local and international <br />
...
<br />
			...
			<p>MEMBERSHIP IN CIVIC / PROFESSIONAL ORGANIZATIONS</p>
		<table style="width: 100%" class="style1">
			<tr>
				<td style="width: 151px; height: 16px;">President Emeritus 
				Founder / 1st Elected President</td>
				<td style="height: 16px">&nbsp;Vice-Mayors' League of the Philippines&nbsp;
				<br />
<br />
				</td>
			</tr>
			<tr>
				<td style="width: 151px">Member </td>
				<td>International Narcotic Enforcement Officers Association</td>
			</tr>
			<tr>
				<td style="width: 151px">Member </td>
				<td>International Association of Chiefs of Police <br />
				</td>
			</tr>
			<tr>
				<td style="width: 151px">Vice Chairman </td>
				<td>Citizens' Drugwatch Foundation </td>
			</tr>
			<tr>
				<td style="width: 151px">Vice President </td>
				<td>Vicor Music Corporation </td>
			</tr>
			<tr>
				<td style="width: 151px">Former Board Member </td>
				<td>Araullo University, Nueva Ecija </td>
			</tr>
			<tr>
				<td style="width: 151px">Former President</td>
				<td>Ham Radio Philippines </td>
			</tr>

			</table>

		<p>PUBLICATIONS / DISSERTATIONS / SCHOLARLY WORKS</p>
		<ul>
			<li>A Vision for A Drug-Free Philippines,  April 1994

		</li>
			<li>Drug Free Philippines,  A Film Documentary, February 1996

		</li>
			<li>The Filipino:  Values and Visions, January  1997
</li>
		</ul>
