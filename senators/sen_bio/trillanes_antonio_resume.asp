...
<title>Resume of Senator Trillanes - Senate of the Philippines</title>
	...
	<tr>
		...
		<table>
			<tr>
				...
				<br />
				Website: <a href="http://www.trillanes.com.ph">www.trillanes.com.ph</td>
			</tr>
		</table>
		<br />		
		<hr />
		<p><b><a href="trillanes_antonio_bio.asp">Biography</a> | Resume</b></p>
		<p>PERSONAL</p>
		<table style="width: 100%" class="style1">
			<tr>
				<td style="width: 151px; height: 16px;">Date of Birth:</td>
				<td style="height: 16px">06 August 1971</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>Arlene Orejana Trillanes</td>
			</tr>
			<tr>
				<td style="width: 151px">Children:</td>
				<td>Francis Seth O. Trillanes<br />
				Thea Estelle O. Trillanes<br />
				Alan Andrew O. Trillanes (deceased)</td>
			</tr>
		</table>
		<p>EDUCATION</p>
		<table style="width: 100%" class="style1">
			<tr>
				...
				<td style="height: 16px">Sienna College, Quezon City<br />
				1975-1983</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>Angelicum School, Quezon City<br />
				1983-1987</td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
			...
			<tr>
				...
				<td>BS ECE (4th Year); De La Salle University, Manila <br />
				1987-1991</td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
			...
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>BS Naval Systems Engineering; Philippine Military Academy
				<br />
				1991-1995<br />
				<br />
				Awards:
				<ul>
					<li>Cum Laude</li>
					<li>Mathematics Plaque</li>
					<li>Physical Sciences Plaque</li>
					<li>Tambuli Award (Electrical/Electronics Engineering)</li>
				</ul>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td style="width: 151px">Graduate:</td>
				<td>Master in Public Administration major in Public Policy and Program 
				Management; University of the Philippines, Diliman<br />
				2000-2005<br />
				<br />
				Awards:
				<ul>
					<li>two (2) University Scholar Awards (GPA 1.0-1.25)</li>
					<li>College Scholar Award (GPA 1.25-1.50)</li>
				</ul>
				</td>
			</tr>
		</table>
		...
		<table style="width: 100%" class="style1">
			<tr>
				<td style="width: 151px; height: 16px;">Sea Duty Profile:</td>
				<td style="height: 16px">Mess &amp; Supply Officer<br />
				April 1995-May 1996</td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>Deck &amp; Gunnery Officer<br />
				May 1996-January 1998</td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>Engineering &amp; Damage Control Officer<br />
				January 1998-February 1999</td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>Executive Officer<br />
				February 1999-January 2000</td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>Acting Commanding Officer<br />
				June 1999-January 2000</td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td style="width: 151px">Shore Duty:</td>
				<td>Administrative/Personnel Officer (P1), HQ Patrol Force<br />
				June 1999-January 2000</td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
			...
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>Procurement Officer/Instructor, Naval Education &amp; Training Command<br />
				January 2000-June 2001</td>
			</tr>
		</table>
		<p>PROFESSIONAL ACHIEVEMENTS</p>
		<ul>
			<li>He was one of the Navy personnel who risked their lives to rescue 
			thirty-two (32) persons during a daring search and rescue operation 
			for the survivors of the ill-fated M/V Princess of the Orient at the 
			height of a super typhoon in 1998.</li>
			<li>He has a five-year sea duty experience logging-in a Total Steaming 
			Time (TST) of 2,593 hrs and 47 min and Total Miles Covered (TMC) of 
			35, 316.78 nautical miles. During which time, his unit was responsible 
			for the apprehension of dozens of smugglers, illegal loggers, poachers, 
			human smugglers and illegal fishermen in numerous maritime law enforcement 
			operations conducted in the waters off Batanes, Ilocos, Cagayan, Isabela, 
			Zambales, Scarborough, Quezon, Bicol, Palawan, Mindoro, Romblon, Iloilo, 
			Cebu, Zamboanga Peninsula, Basilan, Sulu, Tawi-Tawi, Davao and Maguindanao.</li>
			<li>He was involved in numerous naval operations in support of ground 
			operations directed against the Abu Sayyaf and other lawless elements.</li>
			<li>As procurement officer of the Naval Training and Education Command, 
			Philippine Navy, he reformed the procurement system, which resulted 
			to the accumulated savings of more than four million pesos in favor 
			of the government.</li>
			<li>He has participated in 22 naval exercises conducted with local and 
			foreign navies.</li>
			<li>He is a recipient of 23 assorted merit medals, campaign ribbons 
			and badges.</li>
		</ul>
		<p class="backtotop"><img src="../../images/backtotop.gif" /> <a href="trillanes_antonio_resume.asp#top">
		back to top</a> </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
