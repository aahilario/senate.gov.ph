...
<title>Resume of Senator Aquino - Senate of the Philippines</title>
...
<table id="container">
	<tr>
		<td id="content">
		<p class="h1_bold">Senator Benigno S. Aquino III</p>
		<br />
		<table>
			<tr>
				<td>
				Senate Office:<br />
				Rm. 526 5th Flr., GSIS Bldg., Financial Center, Roxas Blvd., Pasay City<br />
				Trunk Lines: (632) 552-6601 to 70 loc. 5541 <br />
				Direct Lines: (632) 833-6383<br />
				Telefax No.: (632) 552-6601 loc. 5540<br />
				Email: <a href="mailto:sbsa_iii@yahoo.com">sbsa_iii@yahoo.com</a><br />
				Website: <a href="http://www.noynoy.ph">www.noynoy.ph</a>
				</td>
			</tr>
		</table>				
		<br />
		<hr />
		<p><b><a href="aquino_noynoy_bio.asp">Biography</a> | Resume</b></p>
		<p>GOVERNMENT SERVICE</p>
		<table style="width: 100%" class="style1">
			<tr>
				<td style="width: 151px">Senator</td>
				<td>Senate of the Philippines<br />
				14th Congress of the Republic of the Philippines</td>
			</tr>
			<tr>
			...
			<tr>
				...
				(1998-2001; 2001-2004; 2004-2007)</td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td style="width: 151px">Deputy Speaker</td>
				<td>House of Representatives<br />
				13th Congress of the Philippines<br />
				(November 8, 2004-February 21, 2006)</td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				...
				<td>Liberal Party of the Philippines<br />
				(March 17, 2006 to present)</td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td style="width: 151px">Secretary General</td>
				<td>Liberal Party of the Philippines<br />
				(2004 to March 16, 2006)</td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td style="width: 151px">Vice-Pres. for Luzon</td>
				<td>Liberal Party of the Philippines<br />
				(2002-2004)</td>
			</tr>
			<tr>
			...
			<tr>
				<td style="width: 151px">Chairman of the Board</td>
				<td>Central Luzon Congressional Caucus</td>
			</tr>
		</table>
		<p>HOUSE COMMITTEE MEMBERSHIP</p>
		<p class="style1">13th Congress</p>
		<ul class="style2">
			<li>Banks &amp; Financial Intermediaries</li>
			<li>Energy</li>
			<li>Export Promotion</li>
			<li>Public Order &amp; Safety</li>
		</ul>
		<p class="style1">12th Congress</p>
		<ul class="style2">
			<li>Civil</li>
			<li>Political &amp; Human Rights</li>
			<li>Good Government</li>
			<li>Public Order &amp; Security</li>
			<li>Inter-Parliamentary Relations &amp; Diplomacy</li>
		</ul>
		<p class="style1">11th Congress</p>
		<ul class="style2">
			<li>Civil</li>
			<li>Political &amp; Human Rights (Vice-Chairman)</li>
			<li>Public Order &amp; Security</li>
			<li>Transportation &amp; Communications</li>
			<li>Agriculture</li>
			<li>Banks &amp; Financial Intermediaries</li>
			<li>Peoples’ Participation</li>
			<li>Suffrage and Electoral Reforms</li>
			<li>Appropriations</li>
			<li>Natural Resources</li>
			<li>Trade &amp; Industry</li>
		</ul>
		<p>SELECTED HOUSE BILLS AND RESOLUTIONS</p>
		<ul class="style2">
			<li>House Bill No. 4251 – granting annual productivity incentives to 
			all workers in the private sector</li>
			<li>House Bill No. 4397 – strengthening the regulatory power of the 
			Department of Trade and Industry (DTI) to effectively enforce 
			consumer laws</li>
			<li>House Bill No. 4252 – increasing the penalties for 
			non-compliance of the prescribed increases and adjustments in the 
			wage rates of workers</li>
			<li>House Bill No. 3616 – extending the reglementary period for the 
			educational qualification for PNP members</li>
			<li>House Bill No. 1842 – providing for the codification of criminal 
			laws</li>
			<li>House Resolution No. 65 – inquiry in aid of legislation into the 
			policies and processes of the Energy Regulatory Commission (ERC) in 
			granting rate increases to electric utilities</li>
			<li>House Resolution No. 788 – creating a select Congressional 
			...
			allocated therefor are utilized for the purpose they are intended</li>
		</ul>
		<p>LEGISLATIVE INITIATIVE</p>
		<p class="style1">Made the procurement of the petroleum, oil and 
		lubricant (POL) requirements of the Armed Forces of the Philippines 
		transparent by requiring public bidding.</p>
		<p>EDUCATION</p>
		<table style="width: 100%" class="style1">
			<tr>
				<td style="width: 151px; height: 16px;">AB Economics</td>
				<td style="height: 16px">Ateneo de Manila University<br />
				(1977-1981)</td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
			...
			<tr>
				<td style="width: 151px">Secondary Education</td>
				<td>Ateneo de Manila University<br />
				(1973-1977)</td>
			</tr>
			<tr>
				<td style="width: 151px">&nbsp;</td>
			...
			<tr>
				<td style="width: 151px">Primary Education</td>
				<td>Ateneo de Manila University<br />
				(1965-1973)</td>
			</tr>
			</table>
