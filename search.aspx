...
<title>Search - Senate of the Philippines</title>
...
<link rel="stylesheet" type="text/css" href="http://senate.gov.ph/scripts_web/lis.css" media="all" />
   ...
   <table id="container">
      <tr>
         <td id="content">
            ...
            <br />     
            <span id="DescShort">
               Search retrieves all pages from the site including senator profiles, secretariat offices, press releases, photo captions, 
               and publications. However, this does not include the legislative documents...
            </span>

            <span id="DescComplete">
               Search retrieves all pages from the site including senator profiles, secretariat offices, press releases, photo captions, 
               and publications.
               <br /><br />

               However, this does not include the legislative documents.
                              To search these documents, you may use the in-page document number and title search for
               <a href="lis/leg_sys.aspx?congress=14&amp;type=bill">Bills</a>, 
               <a href="lis/leg_sys.aspx?congress=14&amp;type=resolution">Resolutions</a>, 
               <a href="lis/leg_sys.aspx?congress=14&amp;type=journal">Journals</a>, 
               <a href="lis/leg_sys.aspx?congress=14&amp;type=committee_rpt">Committee Reports</a>, 
               <a href="lis/pdf_sys.aspx?congress=14&amp;type=republic_act">Republic Acts</a> and
               <a href="lis/pdf_sys.aspx?congress=14&amp;type=adopted_res">Adopted Resolutions</a>
               by going to its page.
               <br /><br />
               If you don't know the document number and/or title, or want to search the content (PDF) of these legislative
               documents, you may use the more advanced <a href="lis.aspx">Legislative Information System</a>.
               <hr />
            </span>

            <span id="DescExpand"><small><a href="search.aspx#" onclick="showDesc('DescComplete'); hideDesc('DescShort'); hideDesc('DescExpand'); showDesc('DescCollapse'); return false;"
               rel="nofollow">&raquo;</a></small></span><!-- <span id="DescCollapse"><small><a href="#"
                  onclick="hideDesc('DescComplete'); showDesc('DescShort'); hideDesc('DescCollapse'); showDesc('DescExpand'); return false;"
                  rel="nofollow">Â«</a></small></span>-->

            <div id="lis_optionssearch_panel">

            <p class="lis_instructions">Enter your keyword(s) in the textbox provided. 
Enclose keywords in quotation marks (" ") to search an exact phrase. 
To exclude pages containing a keyword, prefix it with a dash (-). 
</p>

            
               <form name="frmSearch" method="post" action="search.aspx" onkeypress="javascript:return WebForm_FireDefaultButton(event, 'imgGo')" id="frmSearch">
<div>
<input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="imgGo" />
<input type="hidden" name="__LASTFOCUS" id="__LASTFOCUS" value="" />
<input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTIxMzU5ODAzOTZkGAEFHl9fQ29udHJvbHNSZXF1aXJlUG9zdEJhY2tLZXlfXxYBBQVpbWdHb5vFvtEiBPaRm5vKhOLClOJzsNu1" />
</div>
...
<script src="WebResource.axd?d=1XKpfJwXHH7IgZHUQvx3XHf6mBj4l__XljmYdWXEZ_QyaRlw2S_mPaxI2aVpGLRA7uDLbB1UOAXdO7bz4LvIAc8A-OY1&amp;t=635671739464172500" type="text/javascript"></script>


<script src="WebResource.axd?d=e4H1t6JbHSz_L2jouIC7tTeZZrD66UYjYGfHPPONjZ0N5vrrc8ldZteuk9ylOIm_CqOgI3ruSUcYyw31ZBkXFu2D-Qg1&amp;t=635671739464172500" type="text/javascript"></script>
<div>

	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="BBBC20B8" />
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWCwKK9+HqAwKZ7YzdCgKE0sbYBgLygonvCwKV7MuVAgLK1s/5AwKU9amTCwL4oJxgArTT+qAOAq//5P4MAqvJ4esG7JUNx36swaWaI9uIGgcK+5ybt0w=" />
</div>
               <p class="p15_bottom">
               Keyword(s): 
                           <input name="txtSearch" type="text" maxlength="150" id="txtSearch" style="border-color:#7F9DB9;border-width:1px;border-style:solid;width:250px;" />

                           <select name="dwnScope" id="dwnScope">
	<option selected="selected" value="/">All Documents</option>
	<option value="/photo_release/">Photos</option>
	<option value="/press_release/">News</option>
	<option value="/about/">About the Senate</option>
	<option value="/senators/">Senators</option>
	<option value="/committee/">Committees</option>
	<option value="/secretariat/">Secretariat</option>
	<option value="/publications/">SEPO Publications</option>

</select>
                           <input type="image" name="imgGo" id="imgGo" src="images/go2_small.png" align="top" style="border-width:0px;" />
                              <a href="search.aspx">Clear</a>
               </p>
