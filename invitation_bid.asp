...
<title>Invitation to Bid - Senate of the Philippines</title>
...
<table id="container">
	<tr>
		...
		<p class="h1_bold">Bids and Awards Committee (BAC)</p>
		<p class="auto-style1">Bid Bulletin / Invitation to Bid</p>
		<div class="pubitem">
			<div class="alight">
				<p>
				<br />
...
<!--		<p class="h1_bold">Bid Bulletin</p>
			...
			<p class="h3_uline">March 22, 2018</p>
				...
				<ul>
					<li>
					<a href="bac_bid/SKM_364e18032209501.pdf">
					<span>Supply and installation of Multimedia System for the Session Hall and committee rooms </span>
					</a></li>
					
					<li>
					<a href="bac_bid/SKM_364e18032209500.pdf">
					<span>Supply, delivery, installation, testing and 
					commissioning of chiller system, cooling tower, etc.</span>
					</a></li>
			...
			<p class="h3_uline">March 5, 2018</p>
				...
				<ul>
					<li>
					<a href="bac_bid/BID%20BULLETIN%20FOR%20THE%20100MBPS%20INTERNET.pdf">
					<span>100Mbps Internet  Connection</span></a></li>
				</ul>
			...
			<p class="h3_uline">February 15, 2018</p>
				<div class="pubitem"><div class="alight">
				<ul>
					<li>
					<a href="bac_bid/BB%20021418.pdf">
					<span>Generator Sets  </span></a></li>
				</ul>
		...
		<p class="h1_bold">&nbsp;</p>
			<p class="h1_bold">Invitation to Bid</p>
		
		<p class="h3_uline">October 15, 2018</p>
				<div class="pubitem"><div class="alight">
				<ul>
					<li>
					<a href="bac_bid/ITB%20Hosp%20Benefit%20&%20EAR%20Renov.pdf">
					<span>Hospitalization benefit for Senate employees from January 1 to December 2019 &amp; Renovation of offices of External Affairs and Relations</span>
					</a></li>
					
					<li>
					<a href="bac_bid/ITB2019N&Metc.pdf">
					<span>Subscription to local/international newspapers &amp; magazines for CY 2019, Hiring of security guards, Shuttle bus service, etc.</span>
					</a></li>
	...
	<!--	<p class="h3_uline">February 21, 2018</p>
				...
				<ul>
					<li>
					<a href="bac_bid/100MBPS%20INTERNET.pdf"><span>Internet Service Provider (ISP)  
		...
		<p class="h3_uline">January 31, 2018</p>
				<div class="pubitem"><div class="alight">
				<ul>
					<li>
					<a href="bac_bid/Generator%20Sets.pdf"><span>Diesel Generator Sets  
					  </span></a></li>
