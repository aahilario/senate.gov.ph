...
<title>DND budget hearing</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1113_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->DND budget hearing:</strong>
		<!-- PhotoCaption.start -->
	  	MANILA - Minority Senator Francis “Kiko” Pangilinan on Wednesday raised espionage and data privacy questions on the entry of third telco Dito Telecommunity Corp., a consortium which includes a China-owned company, into Philippine military camps.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
