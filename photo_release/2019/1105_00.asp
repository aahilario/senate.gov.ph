...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1105_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Raising sin taxes:</strong>
		<!-- PhotoCaption.start -->
	  	Senator Pia S. Cayetano answers questions raised by fellow Senator and co-author Manny Pacquiao at the resumption of interpellations on Senate Bill No. 1074, which seeks to raise taxes on sin products.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
