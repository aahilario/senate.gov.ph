...
<table id="container">
	<tr>
		...
		<img src="../2019/1218_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Bicam meeting:</strong>
		<!-- PhotoCaption.start -->
		Senate Ways and Means Chair Pia Cayetano stresses a point during the bicameral conference committee meeting on Wednesday to reconcile disagreeing provisions of the Sin Tax Bill.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
