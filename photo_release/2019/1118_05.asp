...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1118_05.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->DICT budget:</strong>
		<!-- PhotoCaption.start -->
	  	Senator Nancy Binay congratulates Department of Information and Communications Technology (DICT) Secretary Gringo Honasan after the Senate approved the 2020 budget of the DICT.(Erwin Cudiamt/OS Nancy Binay)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
