...
<title>Taasan teaching supplies allowance</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1111_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Taasan teaching supplies allowance:</strong>
		<!-- PhotoCaption.start -->
	  	"Sabi nga ng ating mga guro, mabuti pa ang mga sundalo, binibigyan ng bala para sa kanilang baril, pero ang mga guro, hindi binibigyan ng chalk para sa kanilang blackboard," ito ang mariing sinabi ni Sen. Bong Revilla sa kanyang sponsorship speech para sa S. No. 1092 na nagsusulong na taasan ang teaching supplies allowance ng bawat guro sa pampublikong paaralan sa buong bansa.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
