...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 19, 2019<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2019/1119_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->PSC 2020 budget:</strong>
		<!-- PhotoCaption.start -->
	  	Senate President Vicente C. Sotto III (4th from left) and Senate Minority Leader Franklin M. Drilon (left), together with (from left) Senators Nancy Binay, Pia Cayetano, Senate President Pro-Tempore Ralph Recto, Majority Leader Migz Zubiri and Bong Go congratulate House Speaker Alan Peter Cayetano (4th from right), chairman of the Philippine Southeast Asian (SEA) Games Organizing Committee (Phisgoc), after the agency's proposed budget was submitted in plenary, Tuesday, November 19, 2019. (PRIB Photo by Cesar Tomambo/ 19 November 2019)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
