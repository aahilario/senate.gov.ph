...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1015_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->141st IPU Day-2:</strong>
		<!-- PhotoCaption.start -->
	  	Philippine delegation headed by Senate President Tito Sotto participates in the discussion of the provisional agenda of the 205th session of the IPU Governing Council here in Belgrade, Serbia.(Office of Sen. Nancy Binay/Photo)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
