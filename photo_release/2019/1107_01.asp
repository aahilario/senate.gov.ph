...
<title>Tourism legislative agenda</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1107_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Tourism legislative agenda:</strong>
		<!-- PhotoCaption.start -->
	  	Senator Nancy Binay leads the organizational meeting with the Department of Tourism discussing the agency's Legislative Agenda in the 18th Congress.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
