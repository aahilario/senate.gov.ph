...
<title>Laban, Se Jung workers</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 30, 2019<p style="text-align: center;">
		<img src="../2019/1230_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Laban, Se Jung workers:</strong>
		<!-- PhotoCaption.start -->
		On Rizal Day, Akbayan Senator Risa Hontiveros visited the striking 
		workers of Se Jung Apparel in Dasmariñas, Cavite to express support and 
		extend assistance. The workers have been on strike since December 14, 
		protesting Se Jung's alleged unjust labor practices such as non-payment 
		of 13th month pay. Hontiveros said that she will look into the filing of 
		a Senate resolution to probe the plight of workers, especially women, in 
		special economic zones. <td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
