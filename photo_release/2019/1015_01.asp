...
<title>Philippines represent</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1015_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Philippines represent:</strong>
		<!-- PhotoCaption.start -->
	  	Senate President Tito Sotto addresses fellow parliamentarians at the 141st Inter-Parliamentary Union (IPU) Assembly in Belgrade, Serbia. SP Sotto spoke on the continuation of the general debate and decision on IPU's emergency item on its agenda.(Office of Sen. Nancy Binay/Photo)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
