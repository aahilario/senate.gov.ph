...
<title>Sotto presides over ASEAN + 3 Meeting</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1018_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Sotto presides over ASEAN + 3 Meeting:</strong>
		<!-- PhotoCaption.start -->
	  	Senate President Vicente C. Sotto III on Thursday presided over the ASEAN + 3 meeting, which is part of the Asia-Pacific Group, to select the nominees who would replace the outgoing parliamentarians during the 141st Assembly of the Interparliamentary Union (IPU) Assembly held in Belgrade, Serbia. Also in photo are (from left) Senator Imee R. Marcos, Senate Minority Leader Franklin M. Drilon, and Senator Panfilo M. Lacson. (OSP Photo)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
