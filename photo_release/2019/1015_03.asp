...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1015_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Happening now:</strong>
		<!-- PhotoCaption.start -->
	  	Senate President Vicente Tito Sotto III is the first Philippine Senate President and Philippine Senator to preside an IPU General Debate On An Emergency Item in Belgrade, Serbia. (OSP Photo) <td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
