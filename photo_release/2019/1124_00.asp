...
<title>69th Foundation Anniversary</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 24, 2019<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2019/1124_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->69th Foundation Anniversary:</strong>
		<!-- PhotoCaption.start -->
	  	Senator Manny marches and gives a salute during the opening ceremony of the 69th Foundation Anniversary of the First Scout Ranger Regiment of the Philippine Army at Camp Tecson in Bulakan on Friday. The fighting senator was the event's guest of honor and speaker. (Photo by Wendell Alinea/OSMP)
<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
