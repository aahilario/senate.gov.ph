...
<title>Health care for underserved and unserved areas</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1010_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Health care for underserved and unserved areas:</strong>
		<!-- PhotoCaption.start -->
	  	Senator Sonny Angara urges DOH to provide Congress with an inventory of all its medical staff to determine if there are enough doctors, dentists, nurses and midwives to serve the Filipino people, especially the poor. <td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
