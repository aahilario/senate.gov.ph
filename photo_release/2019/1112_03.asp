...
<title>Budget deliberations light moment</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1112_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Budget deliberations light moment:</strong>
		<!-- PhotoCaption.start -->
	  	Senator Manny Pacquiao shares a light moment with Senate finance committee chair Senator Sonny Angara during the budget deliberations on Tuesday.  (* Photo by Wendell Alinea/OSMP)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
