...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1120_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->COA budget:</strong>
		<!-- PhotoCaption.start -->
	  	Commission on Audit chair Michael Aguinaldo (3rd from left) poses with Senate  President Vicente C. Sotto III (2nd from left) along with (from left) Sen. Juan Edgardo Angara, Majority Leader Juan Miguel Zubiri, Sen. Nancy Binay and Sen. Grace Poe  after the agency’s proposed P12.463 billion budget for 2020 was submitted for approval Wednesday morning. (PRIB Photo by Alex Nuevaespaña/ 20 November 2019)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
