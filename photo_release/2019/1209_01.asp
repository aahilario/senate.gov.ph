...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1209_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SEA Games:</strong>
		<!-- PhotoCaption.start -->
		Senator Pia S. Cayetano with SEA Games pole vault gold medalist EJ Obiena, who is set to represent the Philippines in the upcoming 2020 Tokyo Olympics.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
