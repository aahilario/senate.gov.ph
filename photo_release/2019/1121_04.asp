...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1121_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->New Clark City:</strong>
		<!-- PhotoCaption.start -->
	  	Senator Pia Cayetano trains with members of the national heptathlon team at the indoor warm-up track of the New Clark City Athletics Stadium.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
