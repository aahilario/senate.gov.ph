...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1114_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->DOLE Budget:</strong>
		<!-- PhotoCaption.start -->
	  	Sen. Joel Villanueva listens to interpellations during Thursday’s deliberations on the proposed 2020 budget of the Department of Labor and Employment (DOLE) amounting to P15.7 billion. (PRIB Photo by Albert Calvelo/14 November 2019)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
