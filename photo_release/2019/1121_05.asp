...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1121_05.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->New Clark City:</strong>
		<!-- PhotoCaption.start -->
	  	Senator and triathlete Pia Cayetano trains with members of the Philippine national triathlon pool at the Athletics Stadium in New Clark City. <td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
