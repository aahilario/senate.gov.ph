...
<title>Sen. Pacquiao dinner with PCL-Albay members</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1120_11.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Sen. Pacquiao dinner with PCL-Albay members:</strong>
		<!-- PhotoCaption.start -->
	  	Senator Manny Pacquiao hosts a dinner gathering for the members of the Philippine Councilors League (PCL) Albay at the Shangri-La Hotel in Makati City on Wednesday. (Photo by Wendell Alinea/OSMP)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
