...
<title>Seatmates at the IPU</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 16, 2019<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2019/1016_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Seatmates at the IPU:</strong>
		<!-- PhotoCaption.start -->
	  	Seatmate Senators Sonny Angara, Joel Villanueva, Sherwin Gatchalian and Majority Leader Juan Miguel Zubiri join the contingent led by Senate President Vicente "Tito" Sotto III at the 141st Assembly of the International Parliamentary Union (IPU) in Belgrade, Serbia.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
