...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1108_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Sin Tax Law:</strong>
		<!-- PhotoCaption.start -->
	  	Senate Ways and Means Chair Pia Cayetano prepares to answer during the interpellation of Majority Leader Juan Miguel Zubiri (foreground) on SB 1074, the Senate's version of the Sin Tax Law.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
