...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1018_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Sotto presides over ASEAN + 3 Meeting:</strong>
		<!-- PhotoCaption.start -->
	  Senate President Vicente C. Sotto III on Thursday presided over the ASEAN + 3 meeting to select the nominees who will replace the outgoing parliamentarians during the 141st Assembly of the Interparliamentary Union (IPU) Assembly held in Belgrade, Serbia. Sotto, who headed the Philippine delegation in the just-concluded assembly, will replace Pakistani lawmaker Asad Qaiser. (OSP Photo)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
