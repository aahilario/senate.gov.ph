...
<title>PRRD certifying SB 1074 as urgent</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1112_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->PRRD certifying SB 1074 as urgent:</strong>
		<!-- PhotoCaption.start -->
	  	Senate Ways and Means Committee Chair Pia S. Cayetano shows samples of alcopops to fellow senators during her sponsorship speech on Senate Bill No. 1074, <td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
