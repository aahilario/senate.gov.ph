...
<title>Technical Working Group Meeting</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1018_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Technical Working Group Meeting:</strong>
		<!-- PhotoCaption.start -->
	  	 Bong Go lauds barangay officials as government frontliners; seeks regular salary and benefits for them<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
