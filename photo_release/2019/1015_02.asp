...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 15, 2019<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2019/1015_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->141st IPU Day-3:</strong>
		<!-- PhotoCaption.start -->
	  	In today's agenda is the parliament's role in ensuring the right to health. In 2018, the Senate took a critical step in ensuring that every Filipino family will have access the universal health services. Isang napakalaking karangalan po na makasama ang higit sa 700 mambabatas mula sa iba't ibang bansa na kalahok sa 141st Inter-Parliamentary Union (IPU) Assembly dito sa Belgrade, Serbia.
		<p>Mabuhay ang Pilipinas! PH <br />
		#IPU141 #InterParliamentaryUnion #IPU #BeNice<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
