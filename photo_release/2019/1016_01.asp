...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1016_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->103rd anniversary:</strong>
		<!-- PhotoCaption.start -->
	  	Message of Senate President Vicente Tito Sotto III on the 103rd anniversary of the Senate of the Philippines.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
