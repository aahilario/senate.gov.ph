...
<title>Swiss Ambassador visits Sen. Drilon</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1120_09.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Swiss Ambassador visits Sen. Drilon:</strong>
		<!-- PhotoCaption.start -->
	  	Senate Minority Leader Franklin Drilon (right) gifts Swiss Ambassador Alain Gaschen with a copy of the Senate Centennial memorabilia during the latter’s courtesy call at the Senate Wednesday, November 20, 2019. (PRIB Photo by Cesar Tomambo/20 November 2019).<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
