...
<title>Dagdag benepisyo sa mga Senior Citizen</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2019/1106_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Dagdag benepisyo sa mga Senior Citizen:</strong>
		<!-- PhotoCaption.start -->
	  	PINAGSABIHAN ni Sen. Ramon Bong Revilla, Jr. ang representante ng Department of Social Welfare and Development (DSWD) matapos na dumalo ng pagdinig na hindi nakahanda at walang dalang datos, kasalukuyang dinidinig ang karagdagang pasilidad para sa mga Senior Citizen na ilalagak sa home for the aged sa ilalim ng pamamahala ng DSWD.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
