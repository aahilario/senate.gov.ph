...
<table id="container">
	<tr>
		...
		<img src="../2020/0617_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->PH education system’s future under COVID-19:</strong>
		<!-- PhotoCaption.start -->
		Sen. Pia Cayetano presides over the continuation of the Committee on Sustainable Development Goals, Innovation and Futures Thinking virtual hearing Wednesday, June 17, 2020, on the country’s education system under the COVID-19 pandemic. (Screen grab/Senate PRIB) <td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
