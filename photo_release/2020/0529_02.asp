...
<table id="container">
	<tr>
		...
		<img src="../2020/0529_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Bicycle loop:</strong>
		<!-- PhotoCaption.start -->
       	The 6-kilometer hospital bicycle loop proposed by Dr. Tony Dans.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
