...
<table id="container">
	<tr>
		...
		<img src="../2020/0603_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Plenary session:</strong>
		<!-- PhotoCaption.start -->
       	Senator Nancy Binay attends the 67th session of the Philippine Senate. She is one of nine senators who are physically present during the session on Tuesday.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
