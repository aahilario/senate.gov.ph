...
<title>‘Compressed classes?’</title>
...
<table id="container">
	<tr>
		...
		<img src="../2020/0527_09.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->‘Compressed classes?’:</strong>
		<!-- PhotoCaption.start -->
       	Sen. Francis Tolentino proposes ‘compressed classes’ instead of increasing the number of school days from 200 to 220 days since the delivery of learning competency has already evolved with the advent of advanced technology. Tolentino made the proposal during Wednesday’s hybrid plenary session, May 27, 2020, while interpellating Sen. Win Gatchalian, sponsor of Senate Bill 1541, authorizing the President to adjust the opening of school year beyond August of every year. (Henzberg Austria/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
