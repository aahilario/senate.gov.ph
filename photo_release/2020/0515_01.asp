...
<title>Senator Pia S. Cayetano</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->May 15, 2020<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2020/0515_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Senator Pia S. Cayetano: </strong>
		<!-- PhotoCaption.start -->
		The COVID-19 crisis should prompt policymakers to start thinking how to make adjustments with foresight for the benefit of future generations.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
