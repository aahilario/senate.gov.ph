...
<title>Adjust, innovate under the new normal</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->May 29, 2020<p style="text-align: center;">
		<img src="../2020/0529_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Adjust, innovate under the new normal:</strong>
		<!-- PhotoCaption.start -->
       	Sen. Francis “Tol” Tolentino urges the Metro Manila Development Authority (MMDA) to revive the programs he introduced when he was still at the helm of the agency such as bike lanes and bike-riding traffic enforcers to help address the concerns of motorists under the new normal. Tolentino, during Thursday’s virtual hearing, May 28, 2020, also bares his plans to write the Philippine National Police (PNP) to consider having its members on bike patrol and the Department of Trade and Industry (DTI) to look into consumer concerns following an abrupt in the sale of bicycles. (Screen grab/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
