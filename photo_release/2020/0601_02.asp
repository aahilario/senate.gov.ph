...
<table id="container">
	<tr>
		...
		<img src="../2020/0601_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Electoral Reforms:</strong>
		<!-- PhotoCaption.start -->
       	Sen. Imee Marcos, chair of the Senate Committee on Electoral Reforms and People’s Participation, presides over a virtual hearing Monday, June 1, 2020, on proposals allowing early voting for qualified senior citizens and persons with disabilities in elections, authorizing the Commission on Elections to use and implement an automated and online system for voter registrations and other measures related to the holding of elections in the country. (Screen grab/ Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
