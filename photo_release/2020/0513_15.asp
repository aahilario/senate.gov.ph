...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2020/0513_15.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Committee hearing:</strong>
		<!-- PhotoCaption.start -->
		Senator Pia S. Cayetano, chairperson of the Senate Committee on SDGs, Innovation, and Futures Thinking, presides over the panel's virtual hearing on the necessary innovations and strategies in adapting to the ‘new normal’ following the COVID-19 pandemic.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
