...
<title>Drilon goes online</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2020/0505_07.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Drilon goes online:</strong>
		<!-- PhotoCaption.start -->
		Senate Majority Leader Franklin Drilon participates in Tuesday’s session, May 5, 2020, via teleconference. Senators on Monday, May 4, 2020, approved a resolution allowing them to conduct sessions and hearings through teleconference or videoconference during national emergencies. (Henzberg Austria/ Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
