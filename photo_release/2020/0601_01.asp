...
<title>Senator Pia Cayetano</title>
...
<table id="container">
	<tr>
		...
		<img src="../2020/0601_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Senator Pia Cayetano:</strong>
		<!-- PhotoCaption.start -->
       	"Beyond the delivery of education is [the need to] reach every single child with the help of tools available to us, so we can optimize learning for each child.”<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
