...
<table id="container">
	<tr>
		...
		<img src="../2020/0604_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Safe Pathways Bill:</strong>
		<!-- PhotoCaption.start -->
		Senate Committee on SDGs, Innovation, and Futures Thinking Chair Pia S. Cayetano sponsors the 'Safe Pathways Bill' to create pop-up bike lanes and emergency pathways for COVID-19 frontliners and essential workers.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
