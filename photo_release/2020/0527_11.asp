...
<title>Plenary session resumes</title>
...
<table id="container">
	<tr>
		...
		<img src="../2020/0527_11.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Plenary session resumes:</strong>
		<!-- PhotoCaption.start -->
       	Senate President Vicente Sotto III (right) chats with Senator Francis Tolentino before the start of the plenary session held at the Philippine Senate in Pasay City, Metro Manila on Wednesday, May 27, 2020. Other senators join the session via video conference. (Henzberg Austria/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
