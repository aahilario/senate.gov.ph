...
<table id="container">
	<tr>
		...
		<img src="../2020/0602_14.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Plenary session resumes:</strong>
		<!-- PhotoCaption.start -->
       	Senate President Vicente C. Sotto III resumes session to continue the deliberations on the proposed Bayanihan to Recover as One Act during Tuesday’s hybrid plenary proceedings, June 2, 2020. (Henzberg Austria/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
