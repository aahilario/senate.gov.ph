...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2020/0504_07.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Keep safe:</strong>
		<!-- PhotoCaption.start -->
		Senators Ramon “Bong” Revilla Jr. (left) and Joel Villanueva (right) observe proper protocol by wearing face shield and masks while exchanging pleasantries before the start of the session Monday, May 4, 2020, after a two-month break. (Henzberg Austria/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
