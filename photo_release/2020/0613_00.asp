...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->June 13, 2020<p style="text-align: center;">
		<img src="../2020/0613_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Pasay City:</strong>
		<!-- PhotoCaption.start -->
		Senator Win Gatchalian at the Senate Session Hall, 26 May 2020. Photo by Mark Cayabyab/OS WIN GATCHALIAN<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
