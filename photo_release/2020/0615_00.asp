...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->June 15, 2020<p style="text-align: center;">
		<img src="../2020/0615_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Pasay City:</strong>
		<!-- PhotoCaption.start -->
		 Senator Win Gatchalian presides the Joint Congressional Energy Commission Public Hearing and organizational meeting at the Senate via video teleconferencing over the impact of COVID-19 pandemic to the energy sector, 22 May 2020. Photo by Mark Cayabyab/OS WIN GATCHALIAN<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
