...
<table id="container">
	<tr>
		...
		<img src="../2020/0620_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Committee hearing:</strong>
		<!-- PhotoCaption.start -->
		 Senate Committee on Local Government Chairman Senator Francis “Tol” Tolentino during yesterday’s hearing told Department of Tourism to expedite their accreditation process for local hotels to jumpstart the tourism industry.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
