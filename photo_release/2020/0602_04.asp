...
<title>Lapid attends session</title>
...
<table id="container">
	<tr>
		...
		<img src="../2020/0602_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Lapid attends session:</strong>
		<!-- PhotoCaption.start -->
       	Sen. Lito Lapid physically attends the plenary session Tuesday, June 2, 2020. The Senate resumes deliberations on Senate Bill No. 1564 or Bayanihan to Recover as One Act, which seeks to extend the power of the President until Sept. 30, 2020 to carry out national policies set by the government in response to the Covid-19 crisis. (Henzberg Austria/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
