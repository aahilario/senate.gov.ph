...
<title>Wednesday's session</title>
...
<table id="container">
	<tr>
		...
		<img src="../2020/0603_12.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Wednesday's session:</strong>
		<!-- PhotoCaption.start -->
		Senate President Vicente C. Sotto III bangs the gavel to end/suspend Wednesday’s session, June 3, 2020. The Senate tackled amendments to Bayanihan to Recover as One Act, among other bills, and will resume tomorrow, Thursday, June 4, 2020, before its sine die adjournment on June 5, 2020. (Albert Calvelo/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
