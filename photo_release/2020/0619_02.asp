...
<table id="container">
	<tr>
		...
		<img src="../2020/0619_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Local Government Committee hearing:</strong>
		<!-- PhotoCaption.start -->
		Sen. Win Gatchalian (left) engages Sen. Francis Tolentino in a brief discussion at the Senate plenary hall before the Committee on Local Government starts its hybrid hearing Friday, June 19, 2020, on several measures such as strengthening the involvement of local communities and local government units in basic education governance,  expanding the purposes and application of the Special Education Fund; creating permanent positions for tourism, education and other officers in LGUs. (Albert Calvelo/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
