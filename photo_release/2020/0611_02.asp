...
<title>Learning Continuity Plan</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->June 11, 2020<p style="text-align: center;">
		<img src="../2020/0611_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Learning Continuity Plan: </strong>
		<!-- PhotoCaption.start -->
		Sen. Win Gatchalian, chairman of the Senate Committee on Basic Education, Arts and Culture, presides over the resumption of the virtual hearing, Thursday, June 11, 2020, to determine the impact of the COVID-19 pandemic on the country's basic education system, the rollout of the learning continuity plan and the status of the implementation of the Free Internet Access in Public Places Act. (Albert Calvelo/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
