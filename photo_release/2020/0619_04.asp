...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->June 19, 2020<p style="text-align: center;">
		<img src="../2020/0619_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->PH to use blended learning:</strong>
		<!-- PhotoCaption.start -->
		Sen. Nancy Binay, during Friday’s hybrid hearing of the Local Government Committee, June 19, 2020, seeks clarification from education officials on the proposed blended learning system when schools open in August. Binay raised this concern to shed light on the local government units’ (LGUs) notion that the Department of Education (DepEd) will implement online distance learning as the only modality of teaching. (Screen grab/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
