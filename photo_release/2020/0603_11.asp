...
<title>Gordon commends PCG men, women</title>
...
<table id="container">
	<tr>
		...
		<img src="../2020/0603_11.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Gordon commends PCG men, women:</strong>
		<!-- PhotoCaption.start -->
		Sen. Richard Gordon sponsors Senate Resolution No. 436, commending the heroic services of the men and women of the Philippine Coast Guard (PCG) under the leadership of newly-retired Admiral Joel Sarsiban Garcia in the fight against Covid-19. At the same time, the resolution congratulated Garcia for his "valor and dedication" as PCG commandant. (Screen Grab/ Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
