...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->June 20, 2020<p style="text-align: center;">
		<img src="../2020/0620_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Quezon City:</strong>
		<!-- PhotoCaption.start -->
		Senator Win Gatchalian speaks at the Philippine Statistics Authority office in Diliman during the singing of the Community-based Monitoring System (CBMS) Act Implementing Rules and Regulations, 20 May 2020. Photo by Mark Cayabyab/OS WIN GATCHALIAN<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
