...
<table id="container">
	<tr>
		...
		<img src="../2020/0602_07.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->A Great Challenge:</strong>
		<!-- PhotoCaption.start -->
       	Sen. Joel Villanueva reveals during Tuesday’s plenary, June 2, 2020 that the Bureau of Internal Revenue (BIR) is having a hard time collecting the unpaid taxes from the Philippine Offshore Gaming Operators (POGOs) amounting to P50 billion. (Screen Grab/ Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
