...
<table id="container">
	<tr>
		...
		<img src="../2020/0529_06.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->What about ROROs?:</strong>
		<!-- PhotoCaption.start -->
       	Sen. Lito Lapid during the joint virtual hearing of the Senate committees on finance and economic affairs asks about the kind of assistance the government is providing to the RORO (Roll-on/roll-off) operators who were also affected by the COVID-19 pandemic. Lapid noted that RORO has been a big help to people especially those living in remote islands in the country that do not have airports. (Screen grab/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
