...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2020/0514_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Virtual hearing:</strong>
		<!-- PhotoCaption.start -->
		Senator Pia S. Cayetano presides over a virtual hearing that invited acknowledged futures thinking experts to talk about post-COVID scenarios and trends for the Philippines and the world.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
