...
<title>Gordon recommends opening of other airports for homebound OFWs</title>
...
<table id="container">
	<tr>
		...
		<img src="0520_10.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Gordon recommends opening of other airports for homebound OFWs: </strong>
		<!-- PhotoCaption.start -->
