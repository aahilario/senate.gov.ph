...
<title>Include other affected sectors in SAP</title>
...
<table id="container">
	<tr>
		...
		<img src="../2020/0602_13.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Include other affected sectors in SAP:</strong>
		<!-- PhotoCaption.start -->
       	Sen. Ramon “Bong” Revilla Jr. manifests during plenary session Tuesday, June 2, 2020 that other affected sectors such as those in the entertainment, agricultural and fishery, transportation and tourism industries be included in the continuing provision of Social Amelioration Program (SAP) under the proposed Bayanihan to Recover as One bill. (Screen grab/ Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
