...
<title>Tolentino on automated and online voter registration</title>
...
<table id="container">
	<tr>
		...
		<img src="../2020/0601_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Tolentino on automated and online voter registration:</strong>
		<!-- PhotoCaption.start -->
       	Sen. Francis Tolentino asks Commission on Elections (Comelec) officials to determine the budget for the implementation of an automated and online system for voter registration during a public hearing via video conference Monday, June 1, 2020. (Screen grab/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
