...
<title>Hontiveros on changing the school calendar</title>
...
<table id="container">
	<tr>
		...
		<img src="../2020/0527_08.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Hontiveros on changing the school calendar:</strong>
		<!-- PhotoCaption.start -->
       	Sen. Risa Hontiveros, during the hybrid session Wednesday, May 27, 2020, calls on her colleagues to look carefully at possibly reducing the number of school days as it might inadvertently limit the irreplaceable value of face to face encounters between and among students and teachers in a classroom setting. (Screen grab/ Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
