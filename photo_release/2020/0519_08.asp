...
<title>Recto on health department budget</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->May 19, 2020<p style="text-align: center;">
		<img src="0519_08.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Recto on health department budget: </strong>
		<!-- PhotoCaption.start -->
		Senate President Pro-Tempore Ralph Recto asks Health Secretary Francisco Duque whether the current budget of the health department is enough for the anticipated second wave of coronavirus infections due to the modified lifting of the enhanced community quarantine. (Screen grab/Senate PRIB)
