...
<table id="container">
	<tr>
		...
		<img src="../2020/0604_07.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Sotto thanks colleagues:</strong>
		<!-- PhotoCaption.start -->
		Senate President Vicente C. Sotto III expresses his gratitude for the cooperation of his fellow senators in shepherding and shaping the legislative outputs of the Senate.  In his sine die speech Thursday, June 4, 2020, Sotto assured that the "Senate is here to ensure that government continues to serve the public interest." (Cesar Tomambo/ Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
