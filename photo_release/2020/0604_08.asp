...
<table id="container">
	<tr>
		...
		<img src="../2020/0604_08.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Sine die adjournment:</strong>
		<!-- PhotoCaption.start -->
		Senators physically present in today’s hybrid session, June 4, 2020, pose for a souvenir photo after Senate President Vicente C. Sotto III (3rd from left) banged the gavel marking the sine die adjournment of the First Regular Session of the 18th Congress. Also in photo are (from left) Senators Win Gatchalian, Sonny Angara, Grace Poe, Ronald dela Rosa and Francis Tolentino. (Albert Calvelo/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
