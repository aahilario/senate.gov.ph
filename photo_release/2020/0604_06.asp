...
<table id="container">
	<tr>
		...
		<img src="../2020/0604_06.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Deep conversation: </strong>
		<!-- PhotoCaption.start -->
		(From left) Senators Ronald “Bato” dela Rosa, Francis “Tol” Tolentino and Juan Edgardo “Sonny” Angara are shown in deep conversation before the start of the session Thursday, June 4, 2020. (Alex Nueva España/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
