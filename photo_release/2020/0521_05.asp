...
<table id="container">
	<tr>
		...
		<img src="0521_05.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Unintended consequences: </strong>
		<!-- PhotoCaption.start -->
		Sen. Win Gatchalian, in a hearing conducted on Thursday, May 21, 2020,  through videoconferencing, warns of possible disruption of the entire power supply chain if banking system and power sector industry will not be considered in the proposed moratorium of payment of bills. (Screen grab/ Senate PRIB)
<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
