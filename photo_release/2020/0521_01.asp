...
<table id="container">
	<tr>
		...
		<img src="0521_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Sen. Pia Cayetano</strong>
		<!-- PhotoCaption.start -->
		The COVID-19 crisis as a ‘golden opportunity’ to push for a shift to sustainable forms of mobility and transportation, including biking, walking, and other non-motorized means.
<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
