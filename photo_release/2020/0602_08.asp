...
<table id="container">
	<tr>
		...
		<img src="../2020/0602_08.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Work from home:</strong>
		<!-- PhotoCaption.start -->
       	Senate Majority Leader Migz Zubiri manages legislative affairs remotely as the Senate continues its hybrid session Tuesday, June 2, 2020, the last week of the first regular session of the 18th Congress. (Screen grab/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
