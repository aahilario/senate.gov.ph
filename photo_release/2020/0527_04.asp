...
<title>PH Red Cross ramps up efforts in getting the work done</title>
...
<table id="container">
	<tr>
		...
		<img src="../2020/0527_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->PH Red Cross ramps up efforts in getting the work done:</strong>
		<!-- PhotoCaption.start -->
       	Philippine Red Cross (PRC) Chairman and Chief Executive Officer (CEO) Senator Richard J. Gordon met with Secretary Vince Dizon (center), President and CEO of the Bases Conversion Development Authority (BCDA) and the deputy chief implementer of the government’s response to COVID-19 on May 27, 2020 at the PRC’s headquarters in Mandaluyong City. Among the matters discussed were finetuning PRC’s data management for its COVID testing, as well as the proper protocols and plans for the testing of about 300,000 overseas Filipino workers (OFW) who are expected to arrive within the year. Also present during the meeting are officials from the Philippine Coast Guard (PCG), Bureau of Quarantine, and Safer Philippines.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
