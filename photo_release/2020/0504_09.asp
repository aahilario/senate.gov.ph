...
<title>Quorum at the Senate</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2020/0504_09.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Quorum at the Senate:</strong>
		<!-- PhotoCaption.start -->
		Fifteen senators attend the resumption of plenary session Monday, May 4, 2020 while seven senators participate through videoconference the approval of the passage of Alternative Learning System and the adoption of two resolutions on use of teleconference and the commendation of the late Sen. Heherson Alvarez. (Henzberg Austria/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
