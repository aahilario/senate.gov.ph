...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2020/0504_06.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Business as usual:</strong>
		<!-- PhotoCaption.start -->
		Sen. Grace Poe is among 15 senators who were physically present during the resumption of the Senate's regular session on Monday, May 4, 2020. (Henzberg Austria/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
