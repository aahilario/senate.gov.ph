...
<title>Virtual plenary session</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2020/0505_06.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Virtual plenary session:</strong>
		<!-- PhotoCaption.start -->
		Senate President Vicente C. Sotto III presides over the second day of the regular session Tuesday, May 5, 2020 with only Senators Win Gatchalian and Francis “Tol” Tolentino in the plenary hall. Eighteen senators, including Majority Leader Migz Zubiri and Minority Leader Franklin Drilon participated through teleconferencing. (Henzberg Austria/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
