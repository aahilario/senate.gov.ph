...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2020/0505_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Tuloy ang trabaho:</strong>
		<!-- PhotoCaption.start -->
		Sa kabila ng COVID-19 pandemic, nagpulong ang Senado sa kauna-unahan at makasaysayang regular session nito na isinagawa sa pamamagitan ng teleconferencing.

		<p>Nagbigay si Sen. Ramon Bong Revilla, Jr. ng co-sponsorship speech para sa pagsasabatas ng Expanded Solo Parents Welfare Act of 2020.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
