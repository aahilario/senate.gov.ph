...
<title>Polling places for senior citizens, PWDs</title>
...
<table id="container">
	<tr>
		...
		<img src="../2020/0601_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Polling places for senior citizens, PWDs:</strong>
		<!-- PhotoCaption.start -->
       	Sen. Nancy Binay raises concerns over the availability of emergency polling places and accessible polling places in the coming elections for senior citizens and persons with disabilities (PWDs) during Monday’s hearing of the Senate Committee on Electoral Reforms and People’s -Participation, June 1, 2020. (Screen grab/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
