...
<title>Conflict in extending school calendar</title>
...
<table id="container">
	<tr>
		...
		<img src="../2020/0527_05.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Conflict in extending school calendar:</strong>
		<!-- PhotoCaption.start -->
       	Senate Minority Leader Franklin Drilon raises some possible legal concerns in the passage of a bill extending and changing the start of the school calendar in interpellating Sen. Win Gatchalian, sponsor of Senate Bill No. 1541, during Wednesday’s hybrid session, May 27, 2020. (Screen grab/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
