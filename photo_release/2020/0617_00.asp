...
<title>Finding ways to support and protect online sellers</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->June 17, 2020<p style="text-align: center;">
		<img src="../2020/0617_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Finding ways to support and protect online sellers:</strong>
		<!-- PhotoCaption.start -->
		Senator Risa Hontiveros hosted a webinar on Wednesday to seek ways on how to support the growing sector of small online sellers in the time of Covid-19. The event was facilitated by DJ Chacha (MOR-FM) with online sellers Bernie Bernal and Michael Adina as resource persons.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
