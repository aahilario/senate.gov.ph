...
<title>Young and promising public servant</title>
...
<table id="container">
	<tr>
		...
		<img src="../2020/0601_13.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Young and promising public servant:</strong>
		<!-- PhotoCaption.start -->
       	Senator Minority Leader Franklin M. Drilon, during hybrid plenary session Monday, June 1, 2020, hailed the late Bocaue, Bulacan Mayor Eleanor Villanueva-Tugna, as a “young and promising public servant.”(Screen grab/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
