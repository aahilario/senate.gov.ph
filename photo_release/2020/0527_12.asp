...
<title>Improving Government Hospitals</title>
...
<table id="container">
	<tr>
		...
		<img src="../2020/0527_12.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Improving Government Hospitals:</strong>
		<!-- PhotoCaption.start -->
       	Sen. Christopher Lawrence “Bong” Go, chairman of the Committee on Health and Demography, on Wednesday, May 27, 2020 sponsors several local bills which seeks to capacitate and improve some government hospitals in the country by increasing their bed capacity and medical personnel. (Screen grab/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
