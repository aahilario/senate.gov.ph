...
<title>End illegal drug use and alcohol abuse </title>
...
<table id="container">
	<tr>
		...
		<img src="../2020/0603_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->End illegal drug use and alcohol abuse: </strong>
		<!-- PhotoCaption.start -->
       	Sen. Ronald “Bato” Dela Rosa delivers on Wednesday, June 3, 2020, his sponsorship speech on Senate Resolution No. 325 under Committee Report No. 99. In his speech, Dela Rosa recommended remedial measures to ensure road safety and end the proliferation of illegal drug use and alcohol abuse particularly in the public transport sector. (Albert Calvelo/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
