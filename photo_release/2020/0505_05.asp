...
<title>Additional support for solo parents</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2020/0505_05.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Additional support for solo parents:</strong>
		<!-- PhotoCaption.start -->
		Sen. Christopher Lawrence “Bong” Go delivers his co-sponsorship speech on the additional benefits and privileges of solo parents and their children via teleconference on the second day of the resumption of the regular session Tuesday, May 5, 2020. (Henzberg Austria/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
