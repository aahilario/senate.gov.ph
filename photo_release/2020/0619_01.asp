...
<table id="container">
	<tr>
		...
		<img src="../2020/0619_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Better coordination between DepEd and LGUs:</strong>
		<!-- PhotoCaption.start -->
		  Sen. Imee Marcos, during a hybrid hearing of the Committee on Local Government Friday, June 19, 2020, says that appointing a permanent education officer by the local government unit (LGU) will help ensure better coordination between LGUs and the education department’s district offices, especially with the implementation of the distance learning alternative. (Screen grab/Senate PRIB)
