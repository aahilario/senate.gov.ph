...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->May 17, 2020<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2020/0517_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Tanauan City, Batangas:</strong>
		<!-- PhotoCaption.start -->
		Senator Win Gatchalian holds a baby as the mother laughs on to the delight of other people at an evacuation center in Bernardo Lirio Elementary School during the recent Taal Volcano eruption, 18 Jan 2020. Photo by Mark Cayabyab/OS WIN GATCHALIAN<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
