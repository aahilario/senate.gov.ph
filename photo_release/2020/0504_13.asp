...
<title>Senators attend plenary via teleconference</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2020/0504_13.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Senators attend plenary via teleconference:</strong>
		<!-- PhotoCaption.start -->
		Senators participate in Monday’s plenary session, May 4, 2020 via teleconference. The Senate approved a bill on alternative learning system and adopted two resolutions on teleconferencing and honoring the late Sen. Heherson Alvarez who succumbed to COVID-19 last April 20. (Henzberg Austria/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
