...
<title>Lowering height requirement</title>
...
<table id="container">
	<tr>
		...
		<img src="../2020/0601_17.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Lowering height requirement:</strong>
		<!-- PhotoCaption.start -->
       	Sen. Grace Poe during the hybrid session Monday, June 1, 2020, thanks Sen. Ronald “Bato” dela Rosa for sponsoring Senate Bill No. 1563 which seeks to lower the minimum height requirement for policemen, firemen and jail guards. Poe urged her colleagues to support the bill since the police force needs more personnel to help the Filipino people. (Screen Grab/ Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
