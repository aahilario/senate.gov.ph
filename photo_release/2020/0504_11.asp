...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2020/0504_11.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Senators at work:</strong>
		<!-- PhotoCaption.start -->
		Sen. Christopher Lawrence “Bong” Go (left) is in a huddle with Senators Ronald “Bato” dela Rosa and Francis “Tol” Tolentino (right) before the start of Monday’s plenary session, May 4, 2020. (Henzberg Austria/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
