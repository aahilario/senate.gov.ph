...
<title>More senators via teleconferencing</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2020/0505_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->More senators via teleconferencing:</strong>
		<!-- PhotoCaption.start -->
		Senate President Vicente Sotto III presides the second session day, May 5, 2020, amid COVID-19, with two senators present at the plenary and 18 others via teleconferencing. At the plenary were Senators Sherwin Gatchalian and Francis Tolentino. (Henzberg Austria/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
