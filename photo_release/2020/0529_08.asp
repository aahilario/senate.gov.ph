...
<title>Zubiri on Bayanihan to Heal as One Act</title>
...
<table id="container">
	<tr>
		...
		<img src="../2020/0529_08.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Zubiri on Bayanihan to Heal as One Act:</strong>
		<!-- PhotoCaption.start -->
       	Senate Majority Leader Migz Zubiri informs Senate Minority Leader Franklin Drilon during Friday’s virtual hearing, May 29, 2020, that Malacanang will certify as urgent Senate Bill No. 1546, which seeks to amend Sec. 9 of Republic Act No. 11469 (Bayanihan to Heal as One Act) so it can be approved next week before the Senate adjourns sine die on June 5. Zubiri has authored SBN 1546. (Screen grab/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
