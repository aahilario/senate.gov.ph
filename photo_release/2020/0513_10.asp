...
<title>Lacson on Revised Penal Code</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2020/0513_10.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Lacson on Revised Penal Code:</strong>
		<!-- PhotoCaption.start -->
		Sen. Panfilo “Ping” Lacson introduces his individual amendments Wednesday, May 13, 2020 for Senate Bill No. 1354, otherwise known as the Revised Penal Code. (Joseph Vidal/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
