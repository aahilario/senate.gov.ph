...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2020/0511_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Senator Pia Cayetano:</strong>
		<!-- PhotoCaption.start -->
		"Biking and walking are bound to become an integral part of the ‘new normal’ to keep more people safe from COVID-19."<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
