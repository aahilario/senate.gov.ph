...
<table id="container">
	<tr>
		...
		<img src="../2020/0529_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Sen. Pia Cayetano:</strong>
		<!-- PhotoCaption.start -->
       	"We need to protect the people who protect us. I want to help address this need to establish safe pathways for our frontline workers."<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
