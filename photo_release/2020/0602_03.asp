...
<title>Senators before start of plenary</title>
...
<table id="container">
	<tr>
		...
		<img src="../2020/0602_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Senators before start of plenary:</strong>
		<!-- PhotoCaption.start -->
       	Sen. Juan Edgardo Angara (2nd from left) shares a light moment with Senators Panfilo Lacson, Aquilino “Koko” Pimentel III (3rd from left) and Sherwin Gatchalian (right) before the start of the plenary session, Tuesday, June 2, 2020 (Joseph Vidal/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
