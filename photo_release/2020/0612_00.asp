...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->June 12, 2020<p style="text-align: center;">
		<img src="../2020/0612_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Quezon City:</strong>
		<!-- PhotoCaption.start -->
		Senator Win Gatchalian attends the signing of Memorandum of Agreement between the Commission on Higher education (CHED) Unified Student Financial Assistance System for Tertiary Education (UniFAST) and private higher education institutions (HEIs) with enrolled students selected as tertiary education subsidy grantees for academic year 2018-2019, at UP Diliman Bahay ng Alumni, 17 Dec 2018. Photo by Mark Cayabyab/OS WIN GATCHALIAN<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
