...
<title>Non-expiration of license or franchise hearing</title>
...
<table id="container">
	<tr>
		...
		<img src="../2020/0527_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Non-expiration of license or franchise hearing:</strong>
		<!-- PhotoCaption.start -->
       	Sen. Francis “Kiko” Pangilinan presides a hearing through videoconference Wednesday, May 27, 2020, on a bill amending an existing provision under the Revised Administrative Code to include franchises and makes it incumbent upon the issuing authority to act on an application and avoid situations where inaction could effectively bar the operations of an enterprise. (Screen grab/ Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
