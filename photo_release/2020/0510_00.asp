...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->May 10, 2020<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2020/0510_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Pasay City:</strong>
		<!-- PhotoCaption.start -->
		Senator Win Gatchalian at the session hall of the Senate, 5 May 2020. Photo by Mark Cayabyab/OS WIN GATCHALIAN<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
