...
<table id="container">
	<tr>
		...
		<img src="../2020/0526_07.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Senators at work:</strong>
		<!-- PhotoCaption.start -->
       	Senators Francis “Tol” Tolentino (left) and Win Gatchalian physically attend Tuesday’s session, May 26, 2020. Gatchalian delivers a sponsorship speech on a bill proposing to lengthen the school calendar from 200 to 220 class days while Tolentino takes part in the deliberations by introducing amendments to the Organic Agricultural Act of 2010. (Cesar Tomambo/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
