...
<title>Gordon sponsors resolution via teleconference</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->May 5, 2020<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2020/0505_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Gordon sponsors resolution via teleconference:</strong>
		<!-- PhotoCaption.start -->
		Sen. Richard Gordon on Tuesday, May 5, 2020, delivers his sponsorship speech honoring the late Sen. Heherson Alvarez by conducting blood donation drive every October 26 and April 
		20 in partnership with the Philippine Red Cross. Gordon, along with 17 other senators, attended the session via teleconferencing. (Henzberg Austria/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
