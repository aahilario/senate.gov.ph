...
<title>Sen. Pia Cayetano to DOT</title>
...
<table id="container">
	<tr>
		...
		<img src="0521_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Sen. Pia Cayetano to DOT: </strong>
		<!-- PhotoCaption.start -->
		"Come up with strict guidelines early on so that when the time comes [to open up tourism], we will be ready."
<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
