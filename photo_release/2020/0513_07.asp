...
<title>‘Medical profession more than a privilege.’</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2020/0513_07.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->‘Medical profession more than a privilege.’:</strong>
		<!-- PhotoCaption.start -->
		Senate President Pro-tempore Ralph Recto, in his sponsorship speech on Senate Bill No. 1520, says medical profession in the country remains a privilege that only the sons and daughters on the top of the economic pyramid can afford. “A medical diploma carries a hefty price tag in the country… (that) leads parents remaining in a financial ICU while their child is in school,” Recto said, stressing that the measure “allows the best and the brightest from the lower social rungs to become doctors. (Screen grab/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
