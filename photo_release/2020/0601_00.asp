...
<table id="container">
	<tr>
		...
		<img src="../2020/0601_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Sen. Pia Cayetano:</strong>
		<!-- PhotoCaption.start -->
       	"I’d like to instill in the minds of every educator out there that truly, the Bayanihan Spirit is called upon now more than ever to make education effective for our young children."<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
