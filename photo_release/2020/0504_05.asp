...
<title>Recto attends plenary session</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2020/0504_05.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Recto attends plenary session:</strong>
		<!-- PhotoCaption.start -->
		Senate President Pro-Tempore Ralph Recto attends Senate's session Monday, May 4, 2020, after a two-month break. (Henzberg Austria/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
