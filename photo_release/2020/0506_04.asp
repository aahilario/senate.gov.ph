...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2020/0506_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Light moment: </strong>
		<!-- PhotoCaption.start -->
	  Senate President Vicente C. Sotto III cracks a joke in the middle of a teleconference with colleagues during Wednesday’s plenary session, May 6, 2020. Sotto uses a tablet to monitor his colleague’s participation in the online conduct of their proceedings. (Henzberg Austria/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
