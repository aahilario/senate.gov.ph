...
<title>Migz backs postponing opening of classes</title>
...
<table id="container">
	<tr>
		...
		<img src="../2020/0526_08.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Migz backs postponing opening of classes:</strong>
		<!-- PhotoCaption.start -->
       	Senate Majority Leader Migz Zubiri delivers his co-sponsorship speech on allowing the President to set a different date of the start of the school year. According to Zubiri, there is a need to give the government flexibility to postpone the opening of classes at a later date for the safety and welfare of the children. (Screen grab/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
