...
<title>Amending the Price Act</title>
...
<table id="container">
	<tr>
		...
		<img src="../2020/0528_09.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Amending the Price Act:</strong>
		<!-- PhotoCaption.start -->
       	Sen. Imee Marcos asks the Department of Trade and Industry (DTI) during the hybrid hearing of the Senate Committee on Trade, Commerce and Entrepreneurship its opinion on the proposal to amend the Price Act, and to provide the committee a list of apprehensions the department has made in implementing the Price Act. According to her, it appears that the DTI only managed to apprehend a small number of violators of the Price Act. (Screen Grab/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
