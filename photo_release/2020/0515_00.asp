...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2020/0515_00_t.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->PE classes:</strong>
		<!-- PhotoCaption.start -->
		Senator Pia S. Cayetano leads an exercise session with young kids at a child-minding center in Davao City<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
