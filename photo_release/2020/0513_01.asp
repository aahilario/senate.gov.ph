...
<title>Better healthcare system in PH</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2020/0513_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Better healthcare system in PH:</strong>
		<!-- PhotoCaption.start -->
		Sen. Christopher Lawrence “Bong” Go co-sponsors on Wednesday, May 13, 2020, a bill institutionalizing a scholarship program for medicine students. Go says this will increase the number of doctors in provinces or regions they belong as scholars are mandated to serve in government hospitals equivalent to the years they have been assisted by the program. (Screen grab/ Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
