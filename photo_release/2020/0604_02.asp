...
<table id="container">
	<tr>
		...
		<img src="../2020/0604_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->A walk down memory lane: </strong>
		<!-- PhotoCaption.start -->
		Sen. Pia Cayetano, during Thursday's virtual session, June 4, 2020, holds fond memories of the late Sen. Miriam Defensor-Santiago, recalling the time when they took turns in defending the Reproductive Health (RH) law on the Senate floor. (Screen grab/Senate PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
