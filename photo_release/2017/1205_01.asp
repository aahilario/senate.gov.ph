...
<title>Senate commends WBO featherweight champ</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 5, 2017<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2017/1205_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SENATE COMMENDS WBO FEATHERWEIGHT CHAMP:</strong>
		<!-- PhotoCaption.start -->
		Senators led by Senate President Aquilino “Koko” Pimentel III (3rd from right) join World Boxing Organization (WBO) international featherweight champion Mark Magsayo (middle) in a photo taken during Tuesday’s plenary session, December 5, 2017. The Senate had earlier adopted proposed Senate Resolution No. 562, which commended Magsayo for his victory over Shota Hayashi of Japan last November 25, 2017 in Tagbilaran, Bohol. Also in photos are (from left to right) Senators Sherwin Gatchalian, Joel Villanueva, Emmanuel Pacquiao, Antonio Trillanes IV and Joseph Victor Ejercito, along with Magsayo’s wife (3rd from left) and Jane Yap (4th from right), wife of Tagbilaran, Bohol City Mayor John Geesnell Yap. (PRIB Photo by Albert Calvelo/JC/ 5 December 2017)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
