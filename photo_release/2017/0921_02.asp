...
<title>Budget for state universities and colleges</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->September 21, 2017<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2017/0921_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BUDGET FOR STATE UNIVERSITIES AND COLLEGES:</strong>
		<!-- PhotoCaption.start -->
		Senator Juan Edgardo Angara (middle), chair of the Subcommittee “C” of the Senate Finance Committee, fields questions to officials from the Commission on Higher Education (CHED) during the hearing on the commission’s proposed P12.41 billion budget for 2018 on Thursday, September 21, 2017. The committee eventually added P1.2 billion to the CHED budget to fund the infrastructure and equipment expenses or capital outlay of state universities and colleges throughout the country. Also in photo are (from left to right) Senators Joseph Victor Ejercito and Juan Miguel Zubiri. (PRIB Photo by Alexis Nueva España)              
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
