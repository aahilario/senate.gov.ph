...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2017/1004_09.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->COMMITTEE HEARING:</strong>
		<!-- PhotoCaption.start -->
		Senator Vicente C. Sotto III was vindicated after the Senator Francis "Kiko" Pangilinan admits that the news is incorrect and the seven senators did not refused to sign the resolution that urged to stop killing of children and minors. Sotto stressed that the word "refuse" is not appropriate to use since the resolution really did not reached his office and they are victims of disinformation and fake news.  (photo by Ramon A. Lopez)   
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
