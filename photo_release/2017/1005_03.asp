...
<title>Tax Reform for Acceleration and Inclusion Act</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2017/1005_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->TAX REFORM FOR ACCELERATION AND INCLUSION ACT:</strong>
		<!-- PhotoCaption.start -->
		Akbayan Senator Risa Hontiveros and Senate Committee on Ways and Means Chairperson Senator Sonny Angara discussed on Wednesday the proposed Tax Reform for Acceleration and Inclusion Act (TRAIN) to find ways on how to make the proposed measure more responsive to the interests of poor people.   
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
