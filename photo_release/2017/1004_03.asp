...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2017/1004_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->COMMITTEE HEARING:</strong>
		<!-- PhotoCaption.start -->
		Sen Nancy Binay participates in today's hearing of the Senate Public Information and Mass Media Committee, which tackled manifestations of several senators and proposed bills on fake news.  
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
