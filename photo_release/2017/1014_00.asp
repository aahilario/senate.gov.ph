...
<title>Sen. Cynthia A. Villar expresses her support to CREBA's vision of "A Home for Every filipino"</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 14, 2017<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2017/1014_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SEN. CYNTHIA A. VILLAR EXPRESSES HER SUPPORT TO CREBA's VISION OF "A Home for Every filipino":</strong>
		<!-- PhotoCaption.start -->
		Senator Cynthia A. Villar diligently listens and answers all the questions from the audience during the 6th Monthly Business Meeting of the Chamber of Real Estate and Builders' Association (CREBA). The senator says she shares the position of CREBA not to remove VAT exemption on housing as she supports the housing agenda to produce 500,000 units per year to address homelessness.
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
