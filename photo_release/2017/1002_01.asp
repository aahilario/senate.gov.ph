...
<title>Senate sympathizes with Aytona family</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2017/1002_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SENATE SYMPATHIZES WITH AYTONA FAMILY:</strong>
		<!-- PhotoCaption.start -->
		Senate President Aquilino “Koko” Pimentel III (3rd from right), on Monday, October 02, 2017, present Resolution 519 expressing the Senate’s sympathy to the family of former Senator Dominador Aytona, who passed away Tuesday, September 26, at the age of 99. Also in photo are together with Senators Cynthia Villar (4th from right) and Gregorio Honasan (extreme right). (PRIB Photo by Romeo Bugante) 
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
