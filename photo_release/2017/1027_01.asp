...
<title>Sen. Cynthia Villar shows to foreign delegates the last MM migratory bird sanctuary</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 27, 2017<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2017/1027_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SEN. CYNTHIA VILLAR SHOWS TO FOREIGN DELEGATES THE LAST MM MIGRATORY BIRD SANCTUARY:</strong>
		<!-- PhotoCaption.start -->
		Sen. Cynthia Villar, chair of the Senate environment committee, leads foreign delegates to the 12th Session of the Conference of Parties to the Convention on the Conservation of Migratory Species of Wild Animals, to a bird watching as they toured LPPCHEA. After successfully protecting LPPCHEA, included in the Ramsar List of Wetlands of International Importance, from various threats, including reclamation, Villar said they are now working to let other people see and experience its natural biodiversity as an eco-tourism destination. Also in the photo with the senator are (L-R) are Stefan Leiner, Head of delegation of the European Union;  Mark Lu - President, Wild Bird Club of the Philippines; Lucinda Mangue - Mozambique; Redae Tecclai - Eritrea and Anselmo Gaspar - Mozambique.
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
