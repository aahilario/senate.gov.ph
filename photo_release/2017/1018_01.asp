...
<title>Senate probe on hazing death continues</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2017/1018_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SENATE PROBE ON HAZING DEATH CONTINUES:</strong>
		<!-- PhotoCaption.start -->
		Senator Panfilo Lacson (3rd from right), chair of the Senate Committee on Public Order and Dangerous Drugs, along with (from right to left) Senators Grace Poe, Juan Miguel Zubiri, and Sherwin Gatchalian, listens to a presentation made during the Senate inquiry Wednesday, October 18, 2017, on the death of University of Santo Tomas law student Horacio Castillo III. Castillo died last September 17, 2017 from injuries allegedly sustained during a hazing rite by members of the Aegis Juris fraternity. (Photo by Cesar Tomambo/JDC/18 October 2017)
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
