...
<title>Fighting the cannabis</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2017/1127_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->FIGHTING THE CANNABIS:</strong>
		<!-- PhotoCaption.start -->
		Senator Vicente C. Sotto III meets the officers of Philippine Medical Association, UP Manila National Institute of Health and other medical community headed by Dr. Anthony Leachon (wearing white) to fight the legalization of so-called medical marijuana. (Photo By Ramon A. Lopez)   <td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
