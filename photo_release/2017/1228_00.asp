...
<title>Sen. Cynthia Villar joins the "Paskuhan sa Barangay Pro Pork.”</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 28, 2017<p style="text-align: center;">
		<img src="../2017/1228_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SEN. CYNTHIA VILLAR JOINS THE "PASKUHAN SA BARANGAY PRO PORK.”:</strong>
		<!-- PhotoCaption.start -->
		 Sen. Cynthia Villar lauded the Pork Producers Federation of the Philippines for being a very active partner of the Committee on Agriculture & Food, which she chaired. The senator joined them during their pre-Christmas event “Paskuhan sa Barangay Pro Pork” at the Wack Wack Golf and Country Club in Mandaluyong City.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
