...
<title>Philippine Army GAD event</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2017/1127_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->PHILIPPINE ARMY GAD EVENT:</strong>
		<!-- PhotoCaption.start -->
		Akbayan Senator Risa Hontiveros on Monday attended the Philippine Army Gender Based Violence (GBV) Referral System Meeting and Memorandum of Agreement (MOA) signing with the Combat Stress Management Support Partners at the Philippine Army Officers Clubhouse. 
		<p>Hontiveros, who was the keynote speaker of the event, delivered a speech on the importance of gender and development (GAD), women empowerment and family relations in the uniformed services. She also discussed the significance of mental health services for soldiers, especially those who were involved in armed conflicts. 
	<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
