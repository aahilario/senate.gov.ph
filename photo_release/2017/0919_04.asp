...
<title>More budget for intercropping</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2017/0919_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->MORE BUDGET FOR INTERCROPPING:</strong>
		<!-- PhotoCaption.start -->
		Sen. Cynthia Villar, chair of the Committee on Agriculture and Food, favored a bigger allocation for the Coconut Intercropping Project during the hearing on the proposed P1.4 billion budget of the Philippine Coconut Authority (PCA). Villar said intercropping of cacao and coffee has the potential of providing coconut farmers with as much as P350 a day from their usual income of only P50 a day. Photo also shows PCA Administrator Romulo dela Rosa and PCA Manager for Operations Dennis Andres.  
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
