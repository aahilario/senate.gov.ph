...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2017/1022_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->OSLO, NORWAY:</strong>
		<!-- PhotoCaption.start -->
		Senator Franklin Drilon went to Oslo, Norway, after participating in the 137th Inter-Parliamentary Union (IPU) Assembly held in St. Petersburg, Russia, and met with Elisabeth Slåttum and Idun Tvedt of the Section for Peace and Reconciliation, Norwegian Ministry of Foreign Affairs, where they discussed Norway’s efforts to peacebuilding in the Philippines.
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
