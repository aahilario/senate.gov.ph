...
<title>Senate congratulates Senate’s basketball team</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2017/1004_07.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SENATE CONGRATULATES SENATE’S BASKETBALL TEAM:</strong>
		<!-- PhotoCaption.start -->
		Senate President Aquilino “Koko” Pimentel III (first row, 5th from left), together with Senate President Pro-Tempore and Advocates Team Manager Ralph Recto (2nd row, 3rd from left) and Senator Manny Pacquiao (4th from left),  present Senate Resolution 65 congratulating the basketball team for winning the first Makabansa Basketball League (MBL) championship against the Philstar Troopers last September 24, 2017 at the Meralco Gym in Pasig City. The Advocates were led by Senators Sonny Angara (1st row, 4th from right), Joel Villanueva (1st row, 3rd from left) and Senate Secretariat officials Atty. Rodelio Dascil (1st row, 3rd from left) and Ronald Golding (2nd row, 4th from left). (PRIB Photo by Romeo Bugante/ OIC 04 October 2017)   
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
