...
<title>Tackling amnesty and stiffer penalties to tax evader</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 16, 2017<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2017/1116_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->TACKLING AMNESTY AND STIFFER PENALTIES TO TAX EVADER:</strong>
		Senator Sonny Angara will push for tight rules on the grant of general tax amnesty accompanied by strict enforcement of tax laws that will impose stiffer penalties to tax evaders who opt not to avail of the amnesty.
		<p>The senator explained that a tax amnesty program can increase compliance by encouraging taxpayers to declare and pay previously undeclared tax, file tax returns or register to pay taxes.  The program should give the impression that it a sort of last chance for erring taxpayers to have a clean slate after which the government will prosecute them to the fullest extent of the law.
		<p>The lawmaker added that the tax amnesty should also be open to all even to those with pending cases in court provided they pay a higher premium.
<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
