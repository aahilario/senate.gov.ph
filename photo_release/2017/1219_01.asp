...
<title>Increasing the coconut farmer's income</title>
...
<table id="container">
	<tr>
		...
		<img src="../2017/1219_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->INCREASING THE COCONUT FARMER'S INCOME:</strong>
		<!-- PhotoCaption.start -->
		 
Sen. Cynthia Villar, chair of the Committee on Agriculture and Food, discussed with Philippine Coconut Authority (PCA) Administrator Romulo dela Rosa and Deputy Admin Glenn Santos her proposal to include in the Coconut Industry Development Act a provision that will require the earmarking of the PCA budget and the coconut levy trust fund interest to sufficiently fund the programs that will increase the income of 3.5 million coconut farmers and beneficiaries.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
