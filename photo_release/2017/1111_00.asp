...
<title>Sen. Cynthia A. Villar leads harvesting of tilapia</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 11, 2017<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2017/1111_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SEN. CYNTHIA A. VILLAR LEADS HARVESTING OF TILAPIA:</strong>
		<!-- PhotoCaption.start -->
		Senator Cynthia A. Villar shows off the tilapia harvested from the fishpond provided by the BFAR to Tondo residents who have been beneficiaries of the livelihood and clean-up caravan led by the senator together with BFAR and DENR representatives. BFAR representatives also conducted a demo on smoke fish making. Photo also shows Sonia Salguero (in pink blouse), Director III, Bureau of Soils and Water Management. 
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
