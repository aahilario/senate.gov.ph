...
<title>Tackling Anti-Fake News Bill</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 4, 2017<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2017/1004_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->TACKLING ANTI-FAKE NEWS BILL:</strong>
		<!-- PhotoCaption.start -->
		Sen. Joel Villanueva on Wednesday clarified that in Senate Bill No. 1492 or the Anti-Fake News Bill, truth can be an absolute defense. In libel, even if a statement is true, a person can still be held liable if there are no good motives or justifiable ends for making it are shown. Villanueva also pointed out that the passage of the measure will encourage citizens, especially public officials, to be more responsible in creating and distributing information. "The frequency of fake news that are being circulated today is worrisome. It is high time for the legislative body to pass a bill that will curb the spread of false news, especially when it is intended to cause panic, division, violence, hate, and used to blacken and discredit one’s reputation," Villanueva said.  
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
