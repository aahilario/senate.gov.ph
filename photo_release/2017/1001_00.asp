...
<title>Sen. Cynthia A. Villar leads the clean-up month at LPPCHEA</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 1, 2017<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2017/1001_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SEN. CYNTHIA A. VILLAR LEADS THE CLEAN-UP MONTH AT LPPCHEA:</strong>
		<!-- PhotoCaption.start -->
		In observance of the National Clean-Up Month, Senator Cynthia A. Villar leads the cleaning of the coastal shores of Manila Bay at the LPPCHEA, included in the Ramsar List of Wetlands of International Importance. The senator, chair of the senate committee on environment and natural resources, also leads the Nature Exposure Walk in the mangrove forest and marine habitat serving as sanctuary to different bird species and migratory birds. Hundreds of volunteers from both private and public, including those from the PNP and DPWH, joined these activities.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
