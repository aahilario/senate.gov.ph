...
<title>Empowering future educators</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2017/1106_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->EMPOWERING FUTURE EDUCATORS:</strong>
		<!-- PhotoCaption.start -->
		Sen. Nancy Binay vows to push for the full implementation of free tuition in the tertiary level and to   increase the salaries of teachers in state universities and colleges (SUCs). The senator encouraged the students, faculty and the BSU administration to do their best to adapt and keep up with the challenges of modern technology. 
		<p>Binay on Monday graced the 50th Founding Anniversary of the Bulacan State University College of Education (BulSU CoEd) in Malolos, Bulacan. 
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
