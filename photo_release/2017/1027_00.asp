...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2017/1027_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->LONDON:</strong>
		<!-- PhotoCaption.start -->
		Senator Loren Legarda with Ambassador Antonio Lagdameo, Philippine Ambassador to London, and Baroness Valerie Amos, Director of the School of African and Oriental Studies (SOAS) in the University of London, during the signing of the agreement for the development of the Philippine Studies Program in SOAS. (24 October 2017, SOAS-University of London/ Photo by Mr. Eric Ricafort, Philippine Embassy in London)
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
