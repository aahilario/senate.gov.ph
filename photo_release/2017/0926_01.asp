...
<title>Looking at HUDCC’s budget</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2017/0926_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->LOOKING AT HUDCC’S BUDGET:</strong>
		<!-- PhotoCaption.start -->
		Senator JV Ejercito 2nd from right), chair of the Senate Finance Subcommittee F, chats with Marcelino Escalada, Jr. (left), General Manager of the National Housing Authority, and Acmad Rizaldy Moti (right), Chief Executive Officer of Pag-Ibig, before the start of the Senate budget hearing looking into the proposed 2018 budget of the Housing and Urban Development Coordinating Council (HUDCC) and its attached agencies Tuesday, September 26, 2017.  (PRIB Photo by Romeo Bugante)  
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
