...
<title>Sotto criticizes fake news</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2017/0927_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SOTTO CRITICIZES FAKE NEWS:</strong>
		<!-- PhotoCaption.start -->
		 Senate Majority Leader Vicente C. Sotto III denounces the fake news that branded seven senators as Malacanang Dogs and asks the Senate Secretariat to coordinate to the National Bureau of Investigation cybercrime division to investigate. The fake news alleged that the seven senators (Pimentel, Sotto, Gordon, Villar, Zubiri, Honasan and Pacquiao) did not signed the resolution urging the government to stop the killing of children and minors. (photo by Ramon A. Lopez)  
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
