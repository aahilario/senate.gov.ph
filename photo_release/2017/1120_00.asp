...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 20, 2017<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2017/1120_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->MEETING OF THE MINDS:</strong>
		<!-- PhotoCaption.start -->
		Senate Majority Leader Vicente C. Sotto III with Senators Manny Pacquiao and Gregorio Honasan welcome the delegation from Ethics Council of Regional Representatives of Indonesia. The three senators, as members of Senate Ethics Committee, exchanged ideas and best practices with the Indonesian representatives. (Photo By Ramon A. Lopez) 
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
