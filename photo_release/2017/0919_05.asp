...
<title>Senate committee approves SBMA’s budget</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2017/0919_05.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SENATE COMMITTEE APPROVES SBMA’S BUDGET:</strong>
		<!-- PhotoCaption.start -->
		Senator JV Ejercito, chair of the Senate Finance Subcommittee F, and Senator Richard Gordon (left) congratulate Subic Bay Metropolitan Authority (SBMA) Chief Executive Officer and Administrator Wilma Eisma (right) after the committee approved the proposed 2018 budget of agency, Tuesday, September 19, 2017. (PRIB Photo by Cesar Tomambo)  
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
