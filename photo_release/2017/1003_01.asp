...
<title>T.R.A.I.N. Bill tackled in Senate plenary</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2017/1003_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->T.R.A.I.N. BILL TACKLED IN SENATE PLENARY:</strong>
		<!-- PhotoCaption.start -->
		The tax reform for acceleration and inclusion (T.R.A.I.N.) Bill  Package 1 undergoes interpellation among senators. T.R.A.I.N. aims to redesign the tax system to be simpler, fairer and more efficient, while also raising the revenues needed to invest in infrastructure and deliver essential services to the Filipino people.  
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
