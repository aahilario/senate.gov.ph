...
<title>CA confirms Cimatu, Valderosa</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2017/1004_05.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->CA CONFIRMS CIMATU, VALDEROSA:</strong>
		<!-- PhotoCaption.start -->
		Senate President and Commission on Appointments (CA) chair Aquilino “Koko” Pimentel III pose for a photo with Department of Environment and Natural Resources Secretary Roy Cimatu (left) and Civil Service Commissioner Leopoldo Valderosa, Jr. (right), whose ad interim appointments were confirmed during the CA’s plenary session, Wednesday, October 4, 2017. (OSP Photo by Ariel Cagadas)   
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
