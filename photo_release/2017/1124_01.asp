...
<title>Senate employees join Sen. Cynthia Villar at the wetland park</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 24, 2017<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2017/1124_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SENATE EMPLOYEES JOIN SEN. CYNTHIA VILLAR AT THE WETLAND PARK:</strong>
		<!-- PhotoCaption.start -->
		Together with Sen. Cynthia A. Villar, Senate employees participated in the coastal clean-up at the Las Pinas-Paranaque Critical Habitat and Eco-Tourism Area (LPPCHEA) in Manila Bay. They also enjoyed watching migratory birds at the wetland park recognized by the Ramsar Convention as a Wetland of International Importance. Villar, chair of the Committee on Environment and Natural Resources, has been leading efforts to protect and conserve this nature reserve which has a mangrove forest and sanctuary to wild bird and endangered or vulnerable bird species. 
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
