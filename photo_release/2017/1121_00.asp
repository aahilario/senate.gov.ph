...
<title>Student fare discount</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2017/1121_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->STUDENT FARE DISCOUNT:</strong>
		<!-- PhotoCaption.start -->
		...
		<p>Under the bill, all students enrolled in basic and tertiary education institutions, including technical-vocational institutions, will be entitled to a 20% discount on regular domestic travel fares—including jeepneys, buses, UV Express vans, taxis and transport network vehicle services Grab and Uber, MRT, LRT, domestic flights—upon presentation of their duly issued school ID or current validated enrollment forms. 
		<p>Such discount will be effective throughout the year including weekends, summer breaks and holidays. 
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
