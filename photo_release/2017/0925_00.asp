...
<title>Witness presents call logs during Senate inquiry on shabu shipment</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->September 25, 2017<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2017/0925_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->WITNESS PRESENTS CALL LOGS DURING SENATE INQUIRY ON SHABU SHIPMENT:</strong>
		<!-- PhotoCaption.start -->
		Senator Richard Gordon, chair of the Senate Blue Ribbon Committee, and Senator Panfilo Lacson on Monday, September 25, 2017, watch a power point presentation made by Customs fixer Mark Taguba during the continuation of the Senate inquiry on the smuggling of P6.4 billion worth of illegal drugs into the country last May. Taguba’s presentation included call logs, bank statements, and text messages showing the alleged ‘tara system’ in the Bureau of Customs (BOC). (PRIB Photo by Cesar Tomambo)  
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
