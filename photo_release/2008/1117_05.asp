...
<title>Photo Release - Change of Leadership</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1117_05.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->CHANGE OF LEADERSHIP<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Newly installed Senate President Juan Ponce Enrile talks with Majority Floorleader Officer-in-Charge Juan Miguel Zubiri talks with each other during the session Monday afternoon of November 17, 2008 after Senate President Manny Villar resigned from his post following reports that he (Villar) will be ousted soon and did not have the backing most of his colleagues anymore.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
