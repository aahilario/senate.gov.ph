...
<title>Photo Release - Sangunian Kabataan</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 4, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2008/1104_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SANGUNIAN KABATAAN<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Benigno S. Aquino III delivers his inspirational speech before the participants of the Sangunian Kabataan (SK) National Congress 2008 held at the Waterfront Hotel in Cebu City.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
