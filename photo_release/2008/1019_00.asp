...
<title>Photo Release - 3rd Global Congress of Women in Politics and Governance</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 19, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2008/1019_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->3RD GLOBAL CONGRESS OF WOMEN IN POLITICS AND GOVERNANCE<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator  Loren Legarda, Center for Asia Pacific Women in Politics (CAPWIP) President Dr. Jung Sook Kim (left), United Nations Conference on Trade and Development (UNCTAD) Secretary-General Dr. Supachai Panitchpakdi and United Nations International Strategy for Disaster Reduction (UNISDR) Dr. Salvano Briceno, with children from PINASAMA Pre-School of Quezon City, open the Third Global Congress of Women in Politics and Governance on gender in climate change adaptation and disaster risk reduction held in Dusit Thani Hotel, Sunday morning.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
