...
<title>Photo Release - Bikers' vow</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 10, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2008/1110_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BIKERS’ VOW<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Bong Revilla presides over the oath taking ceremonies of the Bacolod riders to formalize their membership to the Motorcycle Philippines Federation (MCPF). Road Safety is among the advocacies of Revilla, who had earlier filed the Mandatory Helmet Bill to oblige all motorcycle riders, including backriders, to wear standard quality helmet. The lawmaker also filed the Kids’ Off Motorcycles Bill to ban children seven years old and below from riding in motorcycles in national highways.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
