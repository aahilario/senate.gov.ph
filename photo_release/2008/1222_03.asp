...
<title>Photo Release - Kap Scholars</title>
...
<table id="container">
	<tr>
		...
		<img src="1222_03.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->KAP SCHOLARS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Bong Revilla gives a check for the educational expenses of one of his scholars in a casual ceremony held recently in the lawmaker’s office in the Senate. Revilla provides educational opportunities to numerous poor but deserving students all over the country through his “Karunungan Ating Pangalagaan” (KAP) Program.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
