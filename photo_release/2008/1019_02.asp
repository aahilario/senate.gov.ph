...
<title>Photo Release - Filipino - American scientists</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1019_02.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->FILIPINO - AMERICAN SCIENTISTS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Edgardo J. Angara meets Dr. Josefino Comiso with a group of Filipino - American scientists in Maryland. They discussed on how the Filipino community in Maryland will be able to help enhance public awareness on science and technology as well as how they will be able to help boost the projects of Congressional Commission on Science, Technology and Engineering (COMSTE).</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
