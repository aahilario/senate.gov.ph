...
<title>Photo Release - Nobel Laureate</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1127_03.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->NOVEL LAUREATE<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Sen. Loren Legarda with the Nobel Laureate Michael Spence at the 8th Annual Conference of the Parliamentary Network on the World Bank (PNoWB) held in Paris, France on November 20-22, 2008. The Conference tackled issues on the global financial crisis and climate change.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
