...
<title>Photo Release - Warm welcome</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 10, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2008/1210_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->WARM WELCOME<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Loren B. Legarda and former President Joseph Ejercito Estrada recieves a warm welcome to the residents of  Sampaloc Manila during the Christmas Gift Giving held at the Antonio Maceda Integrated School Wednesday morning.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
