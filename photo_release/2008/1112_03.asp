...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1112_03.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BUDGET HEARING<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Juan Ponce  Enrile gestures while Senator Juan Miguel Zubiri waits for his turn during the budget committee hearing of Bureau of Customs (BoC) and the Department of Finance (DOF) at the senate on Wednesday afternoon of November 12, 2008.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
