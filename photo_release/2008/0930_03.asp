...
<title>Photo Release - Climate change keynote speaker</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/0930_03.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->CLIMATE CHANGE KEYNOTE SPEAKER<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Sen. Loren Legarda received a Certificate of Appreciation from the Environmental Leadership &amp; Training Initiative (ELTI) and the World Agroforestry Centre (ICRAF-Philippines) for giving the keynote address in the National Conference and Training Needs Assessment on Forest and Climate Change, September 30, 2008 Crown Plaza Hotel, Quezon City, Philippines.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
