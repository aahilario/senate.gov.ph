...
<title>Photo Release - Bong with Vi</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 25, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2008/1125_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BONG WITH VI<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senador Bong Revilla accompanies Batangas Governor Vilma Santos during the 2008 Walk for a Cause held recently in Batangas City.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
