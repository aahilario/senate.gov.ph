...
<title>Photo Release - C-5 Extension Road Project, original and rerouted</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1014_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->C-5 EXTENSION ROAD PROJECT, ORIGINAL AND REROUTED<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		The blue line shows the original plan of the C-5 Extension Road, from South Luzon Expressway to Sucat Road in Parañaque City. The red line shows the rerouted road plan for the same project.    
		<!-- PhotoCaption.end -->		
