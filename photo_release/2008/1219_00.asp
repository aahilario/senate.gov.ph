...
<title>Photo Release - Loren with Senate Photogs</title>
...
<table id="container">
	<tr>
		...
		<img src="1219_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->LOREN WITH SENATE PHOTOGS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Loren B. Legarda poses for a souvineer photo with the Senate Beat Photographers during the Media Christmas Party held at  the Senate  Thursday night.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
