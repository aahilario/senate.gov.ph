...
<title>Photo Release - Budget deliberation</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 3, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2008/1203_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BUDGET DELIBERATION<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Independent Senator Richard J. Gordon confers with Majority Floor Leader Juan Miguel F. Zubiri as he presided over the Senate deliberations on the proposed P1.415 trillion national budget for 2009. The Senate is acting double time, holding morning and afternoon sessions even on Thursdays, to have the budget approved before the Christmas break.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
