...
<title>Photo Release - Boodle fight</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1208_05.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BOODLE FIGHT<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Liberal President Senator Mar Roxas engages Marine soldiers from the AFP Western Mindanao Command (Wesmincom) in the traditional "boodle fight" in the Wesmincom headquarterrs in Zamboanga City right after the victory of Filipino boxer-hero Manny Pacquiao over Oscar de la Hoya last Sunday.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
