...
<title>Photo Release - Loren report</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 20, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2008/1020_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->LOREN REPORT<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Loren Legarda reports on the Manila Call for Action adopted by Parliamentarians,  the outcome of the two-day Consultative Meeting on Making Disaster Risk Reduction a Tool for Climate Change Adaptation organized by the UN International Strategy for Disaster Reduction, during the Third Global Congress of Women in Politics on Gender and Climate Change held in Dusit Thani Hotel in Makati Monday morning.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
