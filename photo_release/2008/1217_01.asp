...
<title>Photo Release - Health assistance</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 17, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="1217_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->HEALTH ASSISTANCE<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		In line with his “Kalusugan Ating Pangalagaan” (KAP) Program, Senator Bong Revilla signs a Memorandum of Agreement with the Gov. Celestino Gallares Provincial Hospital in Tagbilaran City and the Provincial Government of Bohol where he gave a portion of his Priority Development Assistance Fund (PDAF) as health assistance for the indigent patients of the whole province. Also signing the MOA are (from left to right) Bohol 1st District Rep. Edgar Chatto, Gov. Erico Aumentado and Dr. Nenita Po.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
