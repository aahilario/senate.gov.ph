...
<title>Photo Release - Budget hearing</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1030_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BUDGET HEARING<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Juan Miguel Zubiri (right) gave reactions while Chairman on Committee on Finance Sub-Committee C Senator Edgardo Angara listens keenly during the deliberations on the proposed FY 2009 budget of the Commission on Higher Education (CHED) held at the Claro Recto Room on Thursday morning, October 30, 2008.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
