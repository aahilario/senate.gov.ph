...
<title>Photo Release - Clean Energy Asia Conference in Singapore</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 26, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2008/1126_06.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->CLEAN ENERGY ASIA CONFERENCE IN SINGAPORE<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Clean Energy Asia Conference in Singapore : Senate Majority Leader Juan Miguel F. Zubiri speaks before the recently concluded Clean Energy Asia Conference in Singapore. The Senator spoke about the need to convert to renewable fuels and energy to help mitigate climate change and global warming. He briefed the participants on the measures he had authored particularly the Renewable Fuels (Biofuels) Act and the Renewable Enery Act which were internationally lauded and set as models for other countries in pursuit of Green Energy Options. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
