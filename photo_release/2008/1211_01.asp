...
<title>Photo Release - Loren welcomed OFW</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1211_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->LOREN WELCOMED OFW<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Loren B. Legarda  welcomed  the arrival of  9 Filipina Overseas Worker whom she saved from illegal trafficking who were forced into prostitution in Malaysia  Wednesday evening at Naia 3 in Pasay City. Legarda said that full force of the law should be applied against the recruiter of the 9 Overseas Filipino Workers (OFWs).</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
