...
<title>Photo Release - An Old Tradition</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 5, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2008/1205_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->AN OLD TRADITION<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Sen. Manny Villar drinks from a coconut shell the rice wine made by the residents of Benguet as Gov. Nestor Fongwan looks on. Villar was invited to be the guest of honor and speaker during the 108th Founding Anniversary of Tublay, Benguet.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
