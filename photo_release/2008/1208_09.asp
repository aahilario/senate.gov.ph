...
<title>Photo Release - Closed caption bill</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 8, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2008/1208_09.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->CLOSED CAPTION BILL<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Bong Revilla, together with the representatives of the Special Training, Employment, Advocacy and Management for Deaf Persons Foundation Incorporated (STEAMDPFI) and the Department of Labor and Employment (DOLE), express commitment to uplift the marginalized sector of the deaf in the country through a Memorandum of Agreement signed during the National Conference on Sustainable Partnership for Deaf Transformation held at the Ople Hall of DOLE . To ensure equal access of deaf Filipinos to public information, Revilla filed a bill that would require all television networks to put closed captions in their news programs.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
