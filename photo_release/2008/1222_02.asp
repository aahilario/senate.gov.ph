...
<title>Photo Release - Medical Aid</title>
...
<table id="container">
	<tr>
		...
		<img src="1222_02.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->MEDICAL AID<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Bong Revilla gives his Kalusugan Ating Pangalagaan (KAP) guaranty letter to an indigent resident of Bohol .  Through the Gov. Celestino Gallares Provincial Hospital in Tagbilaran City and the Provincial Government of Bohol, Revilla gave a portion of his Priority Development Assistance Fund (PDAF) as health assistance for the poor patients of the whole province.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
