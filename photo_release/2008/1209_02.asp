...
<title>Photo Release - Climate change adoptation in photos</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 9, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2008/1209_02.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->CLIMATE CHANGE ADAPTATION IN PHOTOS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Sen. Pia Cayetano (middle) points to a graphic presentation showing climate change adaptation strategies being implemented for the country's coasts and oceans at the opening of a photo exhibit on climate change at the Senate, December 9. Joining the lady senator in the activity are (L-R): Prof. Raphael PM Lotilla, Executive Director of PEMSEA (Partnerships in Environmental Management for the Seas of East Asia); Atty. Lucille Sering, Undersecretary, DENR; Renaud Meyer, UNDP (United Nations Development Programme) Country Director; and Senate Majority Leader Juan Miguel Zubiri.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
