...
<title>Photo Release - Run against fake drugs</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 17, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2008/1117_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->RUN AGAINST FAKE DRUGS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Pia S. Cayetano (sporting no.1) dashes to the finish line of the very first "Lakad-takbo laban sa pekeng gamot" held at the Mall of Asia grounds in Pasay last Sunday (Nov.16). She is joined by triathletes Ani De Leon (no.2) and Joey Torres (no.20). The run, which aims to raise awareness on the dangers of counterfeit drugs entering the local market, was organized by the Samahan Laban sa Pekeng Gamot and the Triathlon Association of the Philippines.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
