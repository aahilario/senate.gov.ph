...
<title>Photo Release - US Library of Congress</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1022_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->US LIBRARY OF CONGRESS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Edgardo J. Angara exchanges business card with Dr. Anchi Ho (Asian Division Friends Society) and Librarian Reme Grefalda (Asian Pacific American Collection) during his visit at the US Library of Congress. Angara donated his book 'Seer of Sea & Sierra' written by National Artist Nick Joaquin.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
