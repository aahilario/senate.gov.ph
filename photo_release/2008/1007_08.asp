...
<title>Photo Release - The National Library of the Phils. "Its New Name"</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 7, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2008/1007_08.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->THE NATIONAL LIBRARY OF THE PHILS. "IT'S NEW NAME"<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Sen. Alan Peter "Compañero" S. Cayetano, Chairman of Commitee on Education, Arts and Culture with (r) Dir. Prudenciana Cruz-National Library (l-r) Mr. Maximo Jose Luspo-COS of Cong. Edgar Chatto, Atty. Nicolas Pichay-NCCA Chief Legal Division, and Ms. Flora Valmonte- Asst. Div. National Library posed happily after the successful approval of the National Library's new name at the Committee level and now ready for second reading at the Plenary. 
		<!-- PhotoCaption.end -->		
