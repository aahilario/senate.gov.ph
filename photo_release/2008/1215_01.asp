...
<title>Photo Release - Anti-ChaCha Rally</title>
...
<table id="container">
	<tr>
		...
		<img src="1215_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->ANTI CHACHA RALLY<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Liberal Party stalwarts led by former DECS Secretary Butch Abad (third fr left), Former Senate President Frank Drilon, party president, Senator Mar Roxas, Senator Benigno "Noynoy" S. Aquino III, Cong. Ruffy Biazon, Sen. Rodolfo Biazon and Cavite Rep. Jun Abaya, march along Ayala Avenue in Makati City during the Anti-ChaCha Rally held Friday (Dec. 12,2008) last week. Around 30,000 protesters attended the occasion.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
