...
<title>Photo Release - PSSPA convention</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1126_02.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->PSSPA CONVENTION<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Liberal Party (LP) Senator Benigno "Noynoy" S. Aquino III shares some jokes with the audience as he delivers his speech before hundreds of representatives from the entire Region III on the occassion of the Department of Education's Bi-Annual Public Secondary School Principals Association (PSSPA-III) convention, held at the Aquino Center, Tarlac City.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
