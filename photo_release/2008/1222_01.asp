...
<title>Photo Release - Villar Played Santa to OFWs</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 22, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="1222_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->VILLAR PLAYED SANTA TO OFWs<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Sen. Manny Villar checked on the condition of Overseas Filipino Workers (OFWs) who are staying at the Overseas Workers Welfare Administration’s dormitory in Pasay City and shared with them Christmas gifts, including baskets of groceries and cash so they can go home and celebrate Christmas with their own families.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
