...
<title>Photo Release - Gordon checks master plan of Maestranza wall</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1007_04.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->GORDON CHECKS MASTER PLAN OF MAESTRANZA WALL<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Independent Senator Richard J. Gordon inspects the master plan for the restoration of the Maestranza Curtain Wall in Intramuros, Manila during Monday’s cornerstone-laying ceremony of the ruined portion of the wall. Looking on are Japanese Minister for Economic Affairs Tomochika Oyama, and Tourism Secretary Ace Durano. 
		<!-- PhotoCaption.end -->		
