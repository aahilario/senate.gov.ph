...
<title>Photo Release - Valenzuela City Cooperatives Awarding</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1108_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->VALENZUELA CITY COOPERATIVES AWARDING<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate Cooperative Committee Chairman Senator Juan Miguel Zubiri gestures and pointed to the winner while Mayor Sherwin Gatchalian looks on during the awarding of 12th Valenzuela Cooperative Congress & 11th Dangal ng Valenzuela and Val-Koop Awards held at Valenzuela Convention Center on November 8, 2008.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
