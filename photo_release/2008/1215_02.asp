...
<title>Photo Release - Big icon awardee</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 15, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="1215_02.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BIG ICON AWARDEE<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Sen. Manny Villar receives the BizNews Asia’s Business Icon Gold (BIG) Award for having contributed immensely to the growth of the Philippines and become icon or inspirational symbol of success and corporate social responsibility. Villar, who became the first Filipino brown billionaire, began as a fish vendor in Novaotas and Tondo. As a young boy, he helped his mother peddle fish and other seafood and later parlayed P10, 000 capital into a multi-billion conglomerate. Handing over the award are President Gloria Macapagal-Arroyo and Mr. Antonio Lopez, publisher and editor-in-chief of BizNews Asia.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
