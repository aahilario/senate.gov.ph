...
<title>Photo Release - Faces of dismay</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1023_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->FACES OF DISMAY<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate Committee Chairperson on Foreign Relations Senator Mirriam Santiago gestures of dismay and castigated the "Euro Generals" wherein retired Director General Eliseo dela Paz did not appear yesterday morning while Senators Francis Pangilinan and Juan Miguel Zubiri wait for their turn. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
