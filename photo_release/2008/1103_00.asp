...
<title>Photo Release - Media briefing</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 3, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2008/1103_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->MEDIA BRIEFING<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Alan Peter Cayetano responds to questions from the media in relation to the reopening of the Senate investigation on the Fertilizer Fund Scam allegedly engineered by former Department of Agriculture Undersecretary Jocelyn Bolante. The Blue Ribbon Committee which Cayetano chairs is currently preparing for the resumption of the probe scheduled next week.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
