...
<title>Photo Release - Sultan Kudarat Salamat</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1208_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SULTAN KUDARAT SALAMAT<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Bong Revilla receives a plaque of appreciation from Sultan Kudarat 1st District Representative Datu Pax Mangudadatu and the congressman’s son, Sultan Kudarat Governor Datu Suharto Mangudadatu during the program of the Kalimudan Festival, the annual gathering of different tribal groups in the province.   Revilla lauded the people of Sultan Kudarat for exercising unity, as well as promoting tourism and their products, through a cultural festivity.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
