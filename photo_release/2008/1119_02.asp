...
<title>Photo Release - Laughing delight</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1119_02.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->LAUGHING DELIGHT<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		(standing, left-right) Senate Pro-Tempore Jinggoy Estrada along with Senator Alan Peter Cayetano, Majority Floorleader Juan Miguel Zubiri and Minority Floorleader Aquilino Pimentel (seated) shares a light moment during a minute break at the session hall on Wednesday afternoon of November 19, 2008.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
