...
<title>Photo Release - Credit Information System Act Signing</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 31, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2008/1031_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->CREDIT INFORMATION SYSTEM ACT SIGNING<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Philippine President Gloria Macapagal Arroyo signed the Republic Act No. 9510 (Credit Information System Act) during the ceremonial signing held at the Rizal Hall, Malacanang Palace on October 31, 2008. Witnessing the rite were (L-R) Senator Juan Miguel Zubiri, Senator Edgardo Angara, Deputy Speaker Amelita Villarosa and Majority Leader Arthur Defensor.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
