...
<title>Photo Release - Mar with Ulingan workers</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 24, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="1224_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->MAR WITH ULINGAN WORKERS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Liberal President Senator Mar Roxas shares a
light moment with charcoal makers during his visit to Ulingan, Tondo,
Manila to distribute gifts on Christmas Eve. Roxas urged Filipinos to
continue to hope and look forward to a better future for the country.
"In a nation ravaged by the selfishness and greed of a few, we
celebrate as a people: poor in wealth and power but rich in hope."</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
