...
<title>Photo Release - Its unfair and its a lie</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 13, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2008/1113_07.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->ITS UNFAIR AND ITS A LIE<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		This was the words of Senator Juan Miguel Zubiri showing a copy of a national broadsheet newspaper where he was tagged as a conspirator in a plot to stiple the truth and trying to maneuver a friendly closure to the P728 fertilizer fund scam during the Senate Blue Ribbon Committee investigation on former Agriculture Undersecretary Jocelyn 'Jocjoc' Bolante on Thursday morning of November 13, 2008.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
