...
<title>Photo Release - Regatta de Zamboanga</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 28, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2008/1028_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->REGATTA DE ZAMBOANGA<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate President Manny Villar happily congratulates one of the oldest vinta sailors who participated in the regatta, a sailboat race in Zamboanga City .  Regatta de Zamboanga, which features the ingenuity and creativity of local boat operators, is an activity that has become the trademark of Zamboanga.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
