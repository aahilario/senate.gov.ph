...
<title>Photo Release - Gordon Laughs with Automated Voting Machine Exhibitor</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 20, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2008/1120_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->GORDON LAUGHS WITH AUTOMATED VOTING MACHINE EXHIBITOR<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Independent Senator Richard J. Gordon takes a hearty laugh as a Korean vendor demonstrates an automated voting machine displayed at the first-ever Election Technology Conference and Vendor Exhibition held recently at the Dusit Thani Hotel, Makati City. During his speech at the opening of the three-day event, Gordon, author of the Amended Automated Elections Law, called on the government to fix the electoral process by implementing the law and have fully automated presidential elections in 2010. He said with the modernization of elections, there would be closure, stability and continuity in our country.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
