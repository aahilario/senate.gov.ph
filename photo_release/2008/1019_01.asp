...
<title>Photo Release - Global Congress</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1019_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->GLOBAL CONGRESS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Dr. Salvano Briceno, Director, United Nations International Strategy for Disaster Reduction (UNISDR) secretariat shows to Senator Loren B. Legarda a headline story on a leading newspaper on Global Warming during the opening of 3rd Global Congress of Women in Politics and Governance on Gender in climate change adaptation and disaster risk reduction held in Dusit hotel, Makati Sunday morning.    
		<!-- PhotoCaption.end -->		
