...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1112_05.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->MEDICAL AID<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Bong Revilla signs the Memorandum of Agreement (MOA) he had entered with the Corazon Locsin Montelibano Memorial Regional Hospital in Bacolod. The lawmaker gave a portion of his Priority Development Assistance Fund (FUND) for medical assistance of the indigent patients in the whole province of Negros Occidental.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
