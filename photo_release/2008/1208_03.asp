...
<title>Photo Release - 36th APEC Energy Working Group Forum</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1208_03.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->36TH APEC ENERGY WORKING GROUP FORUM<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate Majority Leader Juan Miguel Zubiri gestures as one of the foreign delegates throw question regarding benefits on renewable energy act and biofuels law during the 36th Asia-Pacific Economic Cooperation's Energy Working Group and Associated Meetings held at the Shangrila Edsa Hotel on Wednesday morning of December 3, 2008.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
