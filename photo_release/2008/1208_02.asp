...
<title>Photo Release - Asia Pacific Forum on Sustainable Production of Biofuels</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1208_02.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->ASIA PACIFIC FORUM ON SUSTAINABLE PRODUCTION OF BIOFUELS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate Majority Leader Juan Miguel Zubiri (center) posed for a photo opp along with the foreign delegates of Asia Pacific Forum on Sustainable Production of Biofuels held at the Crowne Plaza Hotel in Quezon City on November 26, 2008.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
