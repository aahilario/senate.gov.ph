...
<title>Photo Release - Pia with young runners</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1117_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->PIA WITH YOUNG RUNNERS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Pia S. Cayetano (center, sporting no.1) is flanked by young participants at the very first "Lakad-takbo laban sa pekeng gamot" held at the Mall of Asia grounds in Pasay City last Sunday (Nov.16).</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
