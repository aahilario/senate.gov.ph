...
<title>Photo Release - Order of release</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1211_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->ORDER OF RELEASE<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Independent Senator Richard J. Gordon, chairman of the blue ribbon committee, shows a copy of the order of release for former agriculture undersecretary Jocelyn “Joc-Joc” Bolante from the Senate custody pursuant to the contempt order issued by the committee last Dec. 3. Bolante assured Sen. Gordon that he will attend to the next Senate hearing scheduled on Dec. 17, 2008.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
