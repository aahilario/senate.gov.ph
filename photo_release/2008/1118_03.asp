...
<title>Photo Release - New Majority Floorleader</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1118_03.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->NEW MAJORITY FLOORLEADER<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Juan Miguel Zubiri (left) swears before Senate President Juan Ponce Enrile who administers the oath of office as the newly elected Committee on Rules Chair and Majority Floorleader at the Senate on Tuesday afternoon of November 18, 2008.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
