...
<title>Photo Release - Barangay Expo</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1126_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BARANGAY EXPO<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Opposition Senator Benigno "Noynoy" S. Aquino III speaks before the Liga ng mga Barangay - Metropolitan Manila Chapter during an event tagged as "Barangay Expo" held at the Manila HotelTent City on November 24. Around 1600 Punong Barangay (Barangay Chairmen) attended the program.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
