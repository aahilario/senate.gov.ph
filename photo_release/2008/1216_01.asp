...
<title>Photo Release - NPC nights</title>
...
<table id="container">
	<tr>
		...
		<img src="1216_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->NPC NIGHT<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Nationalist People's Coalition  Chairman Danding Cojuangco makes a toast 
		to NPC President Faustino Dy, Jr., Senator Loren B. Legarda and Rep. 
		Luis Villafuerte during the NPC Christmas Party held at Wack Wack Mandaluyong Monday night.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
