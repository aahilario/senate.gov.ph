...
<title>Photo Release - Renewable Energy Bill with the Congressmen</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1008_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->RENEWABLE ENERGY BILL WITH THE CONGRESSMAN<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		(L_R) Congressmen Danilo Suarez, Elpidio Barzaga Jr, Luis Villafuerte, Juan Miguel Arroyo, Maria Milagros Magsaysay and Teofisto Guingona lll listens keenly as they wait for their turn to Congressman Exequiel Javier (2nd from right) during the bicameral conference committee meeting of Renewable Energy Bill held at the Hotel Sofitel in Pasay City yesterday afternoon.    
		<!-- PhotoCaption.end -->		
