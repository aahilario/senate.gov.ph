...
<title>Photo Release - Commemoration of the modern hero's</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1127_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->COMMEMORATION OF THE MODERN HERO'S<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		LP Stalwart Sen. Benigno "Noynoy" S. Aquino III relays to thousands of the City of Malabon University (CMU) students how he remembers the shining moments he shared with his father Ninoy, during a program set by school organizers held inside its campus in commemoration of the modern hero's  76th birth anniversary.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
