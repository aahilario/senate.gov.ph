...
<title>Photo Release - Dialogues on Federalism</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 28, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2008/1128_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->DIALOGUES ON FEDERALISM<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Pia S. Cayetano (2nd from left) gives her reaction to the input of Manitoba Senator Sharon Carstairs of Canada (center) at the leaders' forum of "Dialogues on Federalism" held at the National College of Public Administration and Governance (NCPAG) in the Univesity of the Philippines campus in Diliman Friday (Nov.28). Also in the panel are (L-R): Dr. Alex Brillantes Jr., UP NCPAG Dean; Senate Minority Leader Aquilino Pimentel Jr.; and Rep. Antonio Cuenco (Cebu City, 2D).</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
