...
<title>Photo Release - New Senate Minority</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 24, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2008/1124_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->NEW SENATE MINORITY<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Pia Cayetano (third from left) confers with Minority Leader Aquilino Pimentel Jr. (third from right) at the Senate plenary session Monday (Nov. 24).  Also in the picture are other members of the opposition in the Upper Chamber (L-R): Senators Alan Peter Cayetano, Joker Arroyo, Francis Pangilinan and Manny Villar. The group's seventh member is Sen. Antonio Trillanes IV.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
