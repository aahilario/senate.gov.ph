...
<title>Photo Release - Pia addresses mayors</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1120_03.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->PIA ADDRESSES MAYORS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Pia S. Cayetano gives an update on the status of the proposed "Land Administration Reform Act" (LARA) at the General Assembly of the Leagues of Municipalities of the Philippines (LMP) held at the Manila Hotel Tent City last November 19. With her in the panel are: Dir. Carmencita Delantar of the Department of Budget and Management, Rep. Antonio Cerilles of Zamboanga Del Sur and Rep. Eduardo Zialcita of Paranaque (not in picture).</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
