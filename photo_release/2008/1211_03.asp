...
<title>Photo Release - Mati, Davao Oriental</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1211_03.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->MATI, DAVAO ORIENTAL<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Young members of the marching band of Mati, Davao Oriental crowded around Sen. Chiz Escudero who served as guest speaker of the Mati sportsfest held recently.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
