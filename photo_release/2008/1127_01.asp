...
<title>Photo Release - General Appropriations Bill on Budget</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1127_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->GENERAL APPROPRIATIONS BILL ON BUDGET<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate Majority Leader Juan Miguel Zubiri (center) shares a light moment with (L-R) Lito Lapid, Senate President Juan Ponce Enrile and Senators Mar Roxas, Ping Lacson and Gregorio Honasan showing a good mood while in a minute suspension during the general appropriations bill on budget deliberations on Thursday of November 28, 2008. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
