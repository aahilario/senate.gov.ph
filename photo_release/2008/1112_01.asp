...
<title>Photo Release - Gordon shows “Victory Sword” of Philippine Revolution</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 12, 2008<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2008/1112_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->GORDON SHOWS “VICTORY SWORD” OF PHILIPPINE REVOLUTION<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Independent Senator Richard J. Gordon shows a replica of the sable del mando (sword of command) of Spanish General Ernesto de Aguirre to Israeli Ambassador to the Philippines Zvi Vapni during a courtesy call at the Senate last Tuesday, Nov. 11. Gordon narrated how Colonel Jose Tagle, a hero of the Philippine revolution and the senator’s great grandfather, led 1,000 guerilla volunteers in defeating the Spanish forces. Tagle’s successful feat, known as the 1896 Battle of Imus, is considered as the “first victory” of the Philippine revolution.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
