...
<title>Photo Release - Cracking jokes with Energy Secretary Reyes</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1208_04.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->CRACKING JOKES WITH ENERGY SECRETARY REYES<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate Majority Leader Juan Miguel Zubiri (2nd from left) shares a light moment with colleagues Senators Noynoy Aquino (left) and Edgardo Angara (seated) while Department of  Energy Secretary Angelo Reyes (right, standing) listens keenly in a minute break on the budget hearing on Wednesday afternoon of December 3, 2008 at the Senate.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
