...
<title>Photo Release - Mar at home</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1207_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->MAR AT HOME<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Liberal President Senator Mar Roxas met with his kasimanwas in Capiz to celebrate with them in the Sinadya sa Halaran Festival where he was guest of honor.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
