...
<title>Photo Release - Walking points</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2008/1117_02.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->WALKING POINTS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senador Bong Revilla joyfully addresses the thrilled Bulacan crowd during the recent program of the Bulacan Provincial Government’s Alay Lakad 2008. The senator spoke about Alay Lakad as a show of force or united stand to alleviate the plight our underprivileged countrymen.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
