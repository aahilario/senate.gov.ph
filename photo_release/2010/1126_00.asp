...
<title>Explaining the DOTC Budget</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1126_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->EXPLAINING THE DOTC BUDGET:</strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile is seen in a huddle with Department of Transportation and Communications (DOTC) Sec. Jose de Jesus, Sen. Ralph Recto and Sen. Francis Escudero during yesterday’s budget hearing. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
