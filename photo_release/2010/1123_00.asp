...
<title>1st National Anti-Smuggling Summit</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 23, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/1123_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->1st NATIONAL ANTI-SMUGGLING SUMMIT:</strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile gives participants of the 1st National Anti-Smuggling summit some pointers on how to eliminate smuggling in the Department of Customs. Enrile served as a customs commissioner from 1966 to 1968 before he became Secretary of the Department of Justice during Marcos’ time. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
