...
<title>Zubiri welcomes GOPAC participants</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1004_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->ZUBIRI WELCOMES GOPAC PARTICIPANTS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Juan Miguel “Migz” Zubiri welcomes this year’s participants of the Organization of Parliamentarians against Corruption (GOPAC) conference in Hotel Sofitel on Thursday, 30 September 2010. In his introductory remarks, Zubiri underscored the importance of global action to “effectively arrest” corruption.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
