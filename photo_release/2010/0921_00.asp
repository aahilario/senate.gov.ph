...
<title>Senate hearing on the "Lemon Law"</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->September 21, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/0921_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SENATE HEARING ON THE "LEMON LAW"<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Sen. Manny Villar discussed with Department of Trade and Industry (DTI) Sec. Gregory Domingo and DTI Usec. Zenaida Maglaya the provisions of the bill which will protect buyers of substandard vehicles. The bill gives car buyers the right to either demand from a seller or manufacturer a prompt refund of full purchase price or replacement of the vehicle found to be defective.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
