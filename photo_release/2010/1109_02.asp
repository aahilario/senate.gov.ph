...
<title>Strengthening RP-EU ties</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1109_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->STRENGTHENING RP-EU TIES:</strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile is seen exchanging business cards with Werner Langen, member of the conservative Christian Democratic Union and delegation head of the European Parliament during a courtesy call at the Sofitel Philippine Plaza Hotel. Both leaders discussed common concerns and possible areas of cooperation that may pave the way in strengthening relations between the Philippines and the European Union.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
