...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1127_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->UNISDR CONSULTATIVE MEETING:</strong>
		<!-- PhotoCaption.start -->
		Sen. Loren Legarda, presents the "Manila Call for Action of Parliamentarians on Applying Disaster Risk Reduction as an Instrument for Achieving the Millennium Development Goals",  with (L-R) Mr. Ali Mardan-Rahoojo of Pakistan, Hon. Rida Azimi of Afghanistan, Special Rep. of the UN Sec.-Gen for DRR, Margareta Wahlstrom, Hon. Saber Chowdhury of Bangladesh.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
