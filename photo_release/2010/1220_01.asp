...
<title>Christmas Gift Giving</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 20, 2010<p style="text-align: center;">
		<img src="1220_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->CHRISTMAS GIFT GIVING:</strong>
		<!-- PhotoCaption.start -->
		Senate President Pro Tempore Jinggoy Ejercito Estrada celebrates the holidays with the masses and gives away gifts and grocery items to indigent constituents and families of San Rafael and Bulacan, Bulacan.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
