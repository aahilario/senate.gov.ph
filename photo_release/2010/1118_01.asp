...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1118_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->KAPIHAN SA SENADO:</strong>
		<!-- PhotoCaption.start -->
		Senator Francis “Chiz” Escudero answers questions from Senate media during the weekly Kapihan sa Senado.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
