...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->September 9, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/0909_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->DENGUE STRANGLERS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate Health Committee Chair Senator Pia Cayetano and Health Undersecretary Eric Tayag team up to "strangle" Aedes, the health department's mascot representing the aedes aegypti mosquito which spreads dengue fever. Cayetano led a public hearing on the dengue problem amid reports that the number of dengue cases this year has doubled compared to last year.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
