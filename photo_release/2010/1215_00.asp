...
<title>Green transport initiatives</title>
...
<table id="container">
	<tr>
		...
		<p><strong>
		<!-- PhotoTitle.start -->GREEN TRANSPORT INITIATIVES:</strong>
		<!-- PhotoCaption.start -->
		Senator Edgardo J. Angara, COMSTE Exec. Dir. Dr. Gregory L. Tangonan, Rep. Joseph Emilio A. Abaya, Rep. Angelo B. Palmones, DOST Sec. Mario Montejo, and Rep. Juan Edgardo M. Angara with the Bambike, a hybrid, electric bike built from bamboo and rattan.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
