...
<title>International climate negotiations</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/0908_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->INTERNATIONAL CLIMATE NEGOTIATIONS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile asks Ms. Bernarditas Muller, Lead Negotiator of G77 and China, on the financing and technology transfer during the International Climate Negotiations briefing conducted by the Committee on Climate Change and Foreign Relations today at the Senate.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
