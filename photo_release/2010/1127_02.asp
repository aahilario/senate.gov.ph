...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1127_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->UNISDR CONSULTATIVE MEETING:</strong>
		<!-- PhotoCaption.start -->
		Sen. Loren Legarda delivers her message to close the UNISDR consultative meeting for asian parliamentarians on "Disaster Risk Reduction as an Instrument for Achieving the Millennium Development Goals".</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
