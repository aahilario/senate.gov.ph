...
<table id="container">
	<tr>
		...
		<p><strong>
		<!-- PhotoTitle.start -->PASKO SA SENADO:</strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile proves that he can still cut a mean boogie on the dance floor during the Senate’s Pasko sa Senado Christmas celebration at the SM Mall of Asia’s SMX Convention Center. (Photo by Joe Arazas)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
