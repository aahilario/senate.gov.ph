...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 09, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/1209_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Engaging in Reforms for Effective Public Governance:</strong>
		<!-- PhotoCaption.start -->
		Senate Majority Floor Leader Vicente C. Sotto III speaks before the members of Personnel Officers Association of the Philippines, Incorporated (POAP) during its 35th National Conference on Public Personnel Administration at the Imperial Palace Suites in Quezon City on Thursday, December 9, 2010.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
