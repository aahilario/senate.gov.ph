...
<title>Commission on Appointments</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/0915_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->COMMISSION ON APPOINTMENTS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		SENATOR Ramon Bong Revilla Jr. takes his oath with Senators Alan Peter Cayetano, Tito Sotto and Gringo Honasan (L-R) as members of 25-man Commission on Appointments. Bong Revilla was subsequently elected chairman of the CA Sub-committee on Health and vice-chairman of the CA Sub-committee on Public Works.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
