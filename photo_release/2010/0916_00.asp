...
<title>Welcoming Bulakenyos</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/0916_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->WELCOMING BULAKENYOS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate President Pro Tempore Jinggoy Ejercito Estrada is greeted by delighted Bulakenyos, as he walks towards Barasoain Church to lead the commemorative ceremonies of the 112th Anniversary of the opening of the Malolos Congress, Wednesday morning. Apart from the historical occasion, Bulakenyos also celebrate Singkaban (Sining at Kalinangan ng Bulacan) Festival and “Linggo ng Bulacan.”</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
