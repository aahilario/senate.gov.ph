...
<title>Filipino family can win the battle vs illegal drugs</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1122_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->FILIPINO FAMILY CAN WIN THE BATTLE VS ILLEGAL DRUGS:</strong>
		<!-- PhotoCaption.start -->
		 Senate Majority Floor Leader Vicente C. Sotto III delivers a message in front of anti-illegal drugs advocates during the 38th Anniversary of the Dangerous Drugs Board (DDB) held at the Occupational Safety and 
		Health Center on Agham Street corner North Avenue, Quezon City on November 19, 2010.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
