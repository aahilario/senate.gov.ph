...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1130_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->CEBU CITY:</strong>
		<!-- PhotoCaption.start -->
		Senate Majority Leader  Vicente C. Sotto  III wants to provide  additional funding for the Kythe Foundation Children stricken with cancer from ages 02 to 12. Sotto is in Cebu for the Christmas tree lighting and switching on of the miniature train of hope at the lobby of the Marco Polo hotel. (photo shows: sister Lucilla Perpinan, Director of the Kythe Foundation and the children patients at left).</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
