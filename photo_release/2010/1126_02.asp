...
<title>DOTC budget deliberations</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1126_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->DOTC BUDGET DELIBERATIONS:</strong>
		<!-- PhotoCaption.start -->
		Senator Ralph G. Recto reacts to a question raised by Sen. Alan Peter Cayetano regarding the Department of Transportation and Communications’ (DOTC) proposed budget for year 2011. The Senate hopes to finish budget deliberations before Congress adjourns on Dec. 18, 2010 for the holiday season.  </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
