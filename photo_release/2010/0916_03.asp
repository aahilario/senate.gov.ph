...
<title>Committee on Finance hearing</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/0916_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->COMMITTEE ON FINANCE HEARING<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senators Bonbong Marcos and Allan Peter Cayetano at the hearing of the Committee on Finance on the budget of the Ombudsman.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
