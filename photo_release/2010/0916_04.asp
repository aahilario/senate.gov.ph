...
<title>Malampaya Sound Protected Areas</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/0916_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->MALAMPAYA SOUND PROTECTED AREAS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Sen. Bongbong Marcos examines the map with NAMRIA Jesus Gerardo during the hearing of the Committee on Environment and Natural Resouces on the on SB 739 on the Malampaya Sound Protected Areas.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
