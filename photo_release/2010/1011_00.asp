...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1011_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->CONFIRMATION<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate Majority Leader Vicente C. Sotto III congratulates the first batch of Armed Forces of the Philippines (AFP) high ranking officials to be confirmed for promotion to next rank by the Commission on Appointments (CA).</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
