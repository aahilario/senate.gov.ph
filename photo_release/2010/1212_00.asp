...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1212_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SYMBOLIC KEY:</strong>
		<!-- PhotoCaption.start -->
		Senator Loren Legarda received a symbolic key from (left to right) Bohol Governor Edgar Chatto, Vice Governor Concepcion Lim and Third District Rep. Arthur Yap during the Bohol Prosperity Fair 2010.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
