...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 20, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/1120_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->CATTLE FARM VISIT:</strong>
		<!-- PhotoCaption.start -->
		Senate committee on  Agriculture and Food chairman Kiko Pangilinan visits a cattle farm in San Simon, Pampanga.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
