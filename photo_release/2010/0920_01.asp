...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/0920_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BRIDGING SMILES<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Pia S. Cayetano pose with cleft lip and palate children and their parents at the 8th annual Gabriel Symphony Multi-Sport Celebration held in Alabang, Muntilupa recently. The kids received free surgical operation from the foundation named after the senator's son Gabriel, who passed away in 2001 from a rare chromosomal condition.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
