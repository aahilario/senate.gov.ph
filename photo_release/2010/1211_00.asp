...
<title>Philippine National Red Cross</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 11, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/1211_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->PHILIPPINE NATIONAL RED CROSS:</strong>
		<!-- PhotoCaption.start -->
		Senator Juan Miguel "Migz" Zubiri addresses the delegates of the 4th biennial convention of the Philippine National Red Cross Valenzuela City Chapter as keynote speaker. Zubiri is a member of the Philippine National Red Cross' Board of Governors. In his speech, Zubiri discussed the importance of disaster awareness preparedness during these uncertain climatic conditions due to global warming.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
