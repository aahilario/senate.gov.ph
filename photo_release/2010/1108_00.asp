...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 8, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/1108_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->PUTIK PARE!:</strong>
		<!-- PhotoCaption.start -->
		Senator Pia Cayetano navigates through the muddy terrain at the very first XTerra 'Putik Pare' off-road biathlon held in Nuvali, Sta. Rosa, Laguna. More than 160 mountain bike and trail run enthusiasts joined this unique race of skill, strength and endurance.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
