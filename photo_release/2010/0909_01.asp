...
<title>Country's housing program</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/0909_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->COUNTRY'S HOUSING PROGRAM<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Bongbong Marcos, chairman of the Senate Committee on Housing and Urban Development getting the status of the country's housing program during the organizational meeting.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
