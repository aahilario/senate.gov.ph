...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/0920_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->KAPIHAN SA SENADO<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		SEN. TEOFISTO ‘TG’GUINGONA III explains to members of the press the reasons and dynamics of the upcoming Senate Blue Ribbon Committee investigation on the controversial jueteng expose disclosed by retired Lingayen-Dagupan Archbishop Oscar Cruz at the weekly Kapihan sa Senado.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
