...
<title>And the winnder is</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 16, 2010<p style="text-align: center;">
		<img src="1216_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->AND THE WINNER IS:</strong>
		<!-- PhotoCaption.start -->
		Senator Bong Revilla presents a picture of the Suzuki Thunder 125 to Senate Office of the Sergeant-At-Arms (OSAA) personnel Remedios Base, as a symbolic proof that she is the winner of the said motorcycle unit.  Bong Revilla, main author of the Mandatory Helmet Act, donated one Suzuki Thunder 125 with a standard quality helmet as one of the major raffle prizes for the Senate Christmas Party.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
