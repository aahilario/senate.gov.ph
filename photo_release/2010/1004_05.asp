...
<title>Finance Committee tackles tourism budget</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1004_05.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->FINANCE COMMITTEE TACKLES TOURISM BUDGET<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate Government Corporations and Public Enterprises Committee Chairman Sen. Ralph G. Recto, together with Sen. Franklin M. Drilon, Chair of the Senate Committee on Finance, review the proposed budget of the Department of Tourism during today’s budget hearing at the Senate.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
