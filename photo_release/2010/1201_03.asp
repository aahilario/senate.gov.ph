...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1201_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SOMETHING TO SMILE ABOUT:</strong>
		<!-- PhotoCaption.start -->
		Senator Juan Miguel “Migz” Zubiri, Chairman of the Joint Congressional Oversight Committee on Cooperatives (JCOCC), extends a handshake to BIR Commissioner Kim Henares (4th from left) after their recent meeting in the Senate where they agreed to ease the BIR requirements on cooperatives seeking certificate of tax exemption from the revenue agency with them are (L-R) CDA Executive Director Atty. Niel Santillan, Congresswoman Emmeline Aglipat and Congressman Jose Ping-ay, co-chair of the JCOCC.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
