...
<title>DSWD budget deliberations</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1201_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->DSWD BUDGET DELIBERATIONS:</strong>
		<!-- PhotoCaption.start -->
		Senator Ralph G. Recto question Senator Franklin M. Drilon, Chairman of the Senate Committee on Finance, and Department of Social Welfare and Development (DSWD) Secretary Dinky Soliman about the agency’s Conditional Cash Transfer Program (CCT) during yesterday’s budget deliberations. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
