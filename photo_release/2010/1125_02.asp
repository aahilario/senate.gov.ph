...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1125_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->DEPED BUDGET:</strong>
		<!-- PhotoCaption.start -->
		Senator Edgardo J. Angara, Chairman of the Senate Committee on Education, answers questions from colleagues questioning the proposed P207.270 billion budget of the Department of Education for the year 2011. The Senate hopes to finish budget deliberations before the start of the Christmas break. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
