...
<title>Trillanes on his first Senate appearance</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 22, 2010<p style="text-align: center;">
		<img src="1222_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->TRILLANES ON HIS FIRST SENATE APPEARANCE:</strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile (right) welcomes Senator Antonio “Sonny” Trillanes IV at the Senate building today after he was turned over to the custody of Enrile. Trillanes, who was charged with mutiny for joining the Oakwood Siege and the Peninsula Incident in 2003 and 2007 respectively, spent the last seven years in prison. PRIB photo by ALBERTO CALVELO</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
