...
<title>Housing for teachers</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/0916_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->HOUSING FOR TEACHERS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Sen. Bongbong Marcos talks with NHA's Froilan Kapitan after the hearing Committee on Housing and Urban Development on the proposed Senate Bills 700 and 1203 providing housing for teachers.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
