...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1205_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->PANABO, DAVAO:</strong>
		<!-- PhotoCaption.start -->
		Senate Committee on Agriculture and Food Chairman Francis 'Kiko' Pangilinan visits a mariculture park in Panabo, Davao.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
