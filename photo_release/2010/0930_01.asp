...
<title>Office of the President 2011 budget</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/0930_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->OFFICE OF THE PRESIDENT 2011 BUDGET<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile, Sen. Franklin Drilon and Exec. Sec. Paquito Ochoa huddles during the Committee on Finance hearing on the proposed 2011 budget of the Office of the President (OP) today, September 30.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
