...
<title>Angara hosts anti-corruption conference</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->September 30, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/0930_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->ANGARA HOSTS TWO-DAY ANTI-CORRUPTION CONFERENCE<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Edgardo J. Angara (center), founding member of the South East Asian Parliamentarians Against Corruption (SEAPAC), welcomes member parliamentarians attending the two-day conference of the Global Organization of Parliamentarians Against Corruption (GOPAC), held at Hotel Sofitel, Philippine Plaza, Pasay City. The event highlights the expected full ratification of the UN Convention Against Corruption (UNCAC) by all GOPAC member-countries. Seen in photo are (L-R) Rep. Juan Edgardo Angara, former House Speaker Jose De Venecia, GOPAC chairman Dr. Naser Al-Sane, Justice Sec. Leila De Lima, Sen. Juan Miguel Zubiri, Rep. Bernadette Hererra-Dy, and Solicitor-General Joel Cadiz.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
