...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1110_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->MADRID, SPAIN:</strong>
		<!-- PhotoCaption.start -->
		 Senator Edgardo J. Angara and Senator Juan Miguel Zubiri meet Mr. Fernando Delage, Director General of International Relations of the City Government of Madrid to discuss ways to boost tourism and seek Spain's help in Philippine heritage conservation.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
