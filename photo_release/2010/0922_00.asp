...
<title>At Home with fellow Ilonggos</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->September 22, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/0922_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->AT HOME WITH FELLOW ILONGGOS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Juan Miguel “Migz” Zubiri, chairman of the Senate committee on environment and natural resources, shares a light moment with the Sangguniang Kabataan Federation of Iloilo City yesterday (21 September 2010) at the Senate. Speaking in Ilonggo, Sen. Zubiri told the young leaders to take an active part in nation building. Zubiri is the youngest elected Majority Floor Leader of the Senate at the age of 39.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
