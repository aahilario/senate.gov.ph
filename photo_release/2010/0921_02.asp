...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/0921_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->JUETENG PROBE<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		 Senate President Juan Ponce Enrile carefully reads the list of 7 gambling lords submitted by Archbishop Oscar Cruz to the Committees on Accountability of Public Officers and Investigations, Local Government and Rules during today’s Senate hearing on jueteng.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
