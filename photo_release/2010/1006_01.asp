...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1006_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->ON K+12<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate Majority Floor Leader Vicente C. Sotto III delivers his speech during the regular session of the Senate, opposing the plan of Department of Education to include additional school years for basic education dubbed K+12.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
