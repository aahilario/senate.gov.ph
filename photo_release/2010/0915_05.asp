...
<title>Citizens' shadow report</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/0915_05.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->CITIZENS’ SHADOW REPORT<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile and Speaker Feliciano Belmonte Jr. receive the book  entitled, “Winning the Numbers, Losing the War on Poverty” from Prof. Leonor M. Briones and Mr. Isagani Serrano, convenor and co-convenor respectively of Social Watch Philippines (SWP), during the press launch of the citizens’ shadow report on the Millennium Development Goals at the Batasan Complex. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
