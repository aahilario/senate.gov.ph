...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1201_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->VISIT FROM THE VP:</strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile welcomes Vice President Jejomar Binay in his Senate office today, December 1.  </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
