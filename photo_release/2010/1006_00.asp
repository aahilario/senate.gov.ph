...
<title>Newly appointed AFP Chief-of-Staff</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 6, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/1006_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->JPE CONGRATULATES NEWLY APPOINTED AFP CHIEF-OF-STAFF<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile congratulates Armed Forces Chief-of-Staff Ricardo David Jr., who was confirmed by the Commission on Appointments (CA) to the rank of Lieutenant General, during the CA hearing at the Senate.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
