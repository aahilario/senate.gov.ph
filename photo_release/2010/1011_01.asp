...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1011_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BUDGET HEARING<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile, together with Sen. Ralph Recto and Sen. Serge Osmeña, view the presentation of the Department of Energy during today's hearing on the department's proposed FY 2011 budget.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
