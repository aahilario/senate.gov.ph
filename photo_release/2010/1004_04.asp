...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1004_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->PINOY VISIONARIES<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Pia Cayetano meets the "Filipino Bill Gates," Diosdado Banatao (4th from left), at the forum of the Phil. Dev't. Foundation-USA (PhilDevUSA) held recently in San Jose, California. A technology engineer and entrepreneur, Banatao is credited for developing key semiconductor technologies in Silicon Valley. With them are (L-R): PhilDev-USA trustees Fernando Zobel de Ayala, Maria Banatao and Sheila Lim Marcelo.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
