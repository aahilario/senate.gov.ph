...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 02, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/1202_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->DSWD BUDGET:</strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile questions Senator Franklin M. Drilon about the beneficiaries of the Conditional Cash Transfer Program (CCT) of the Department of Social Welfare and Development (DSWD), headed by Secretary Dinky Soliman. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
