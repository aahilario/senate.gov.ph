...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1110_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->MADRID, SPAIN:</strong>
		<!-- PhotoCaption.start -->
		Senator Edgardo J. Angara and Senator Juan Miguel Zubiri greet Secretary General Luis Cuesta of the Spanish Ministry of Defense to discuss Spain's foreign defense policy and mutual cooperation between Spain and the Philippines for security and disaster response.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
