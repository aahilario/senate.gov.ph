...
<title>Blessings for the Senate President</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 14, 2010<p style="text-align: center;">
		<img src="1214_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BLESSINGS FOR THE SENATE PRESIDENT:</strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile listens to a prayer being offered by Archbishop Ricardo Cardinal Vidal of Cebu. The Chamber recently adopted Senate Resolution No. 30, honoring the Archbishop for his 25 years of service to the Cebuano people. (PRIB Photo by Joe Arazas)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
