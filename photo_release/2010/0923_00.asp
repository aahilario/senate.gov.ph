...
<title>Kapihan sa Senado with Senator Honasan</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->September 23, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/0923_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->KAPIHAN SA SENADO WITH SENATOR HONASAN<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Sen. Gringo Honasan answers questions from Senate beat reporters about the IIRC report on the hostage-taking incident and the recent privilege speech of Senator Santiago on the subject of jueteng. Kapihan sa Senado is a project of the Senate’s Public Relations and Information Bureau giving, Senators a chance to interact with Senate reporters every Thursday.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
