...
<title>MIC Forum, Seoul, Korea</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 28, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/1128_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->MIC FORUM, SEOUL, KOREA:</strong>
		<!-- PhotoCaption.start -->
		Senator Edgardo J. Angara keynotes the Korea-Philippines MIC Development Cooperation Forum. Over 200 Korean investors, members of the academe, government ministries, organizations, Senator Juan Miguel Zubiri, Governors Junie Cua, Moreno, and Mitra, Congressman Dakila Carlo Cua, Korean Ambassador to the Philippines Hye Min Lee and Korea Senior Economic Adviser Choi, Joong Kyung gathered  together to discuss business opportunities as part of the feasibility study on the establishment of Multi-Industry Clusters (MIC) in the Philippines.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
