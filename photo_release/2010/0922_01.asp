...
<title>Smuggled onions uncovered</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/0922_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SMUGGLED ONIONS UNCOVERED<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate Committee on Agriculture and Food Chair Kiko Pangilinan, Buereau of Customs commissioner Angelito Alvarez and Alyansa Agricultura Chair Ernesto Ordonez uncover eight containers of smuggled onions valued at P9 million at the Port of Manila, South Harbor.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
