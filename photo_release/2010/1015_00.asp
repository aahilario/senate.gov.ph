...
<title>Community Hospital inauguration</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 15, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/1015_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->COMMUNITY HOSPITAL INAUGURATION<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Sen. Manny Villar hands the wine to Pampanga Archbishop Paciano Aniceto during the mass offered in the occasion of the inauguration of the Mexico Community Hospital in Bgy San Carlos, Mexico, Pampanga.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
