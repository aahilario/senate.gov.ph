...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 5, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/1005_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->GREEN CLASSROOMS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Juan Miguel “Migz” Zubiri shows to DPWH and DECS officials at the joint hearing of Senate Committees on Climate Change and on Environment and Natural Resources yesterday a photo of a school building project which he recently turned over in Dumaguete City. Zubiri appealed to the government officials to make the constructions of school buildings more affordable noting the huge difference between government construction projects amounting to P630,000 per classroom as against private corporations of about P500,000 only. He said that aside from updating the design and adding an eco-friendly feature such as rain water collection system, school buildings should also consider using recycled materials to make it more affordable.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
