...
<title>The Philippine Poultry Show</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->September 26, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/0926_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->THE PHILIPPINE POULTRY SHOW<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate Committee on Agriculture and Food Committee chairman Kiko Pangilinan looks at broiler chicks at the opening of Philippine Poultry Show held at Mega Trade Hall where he was keynote speaker.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
