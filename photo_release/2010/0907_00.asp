...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/0907_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->CHEERS FROM ALBAY<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Sentor Juan Miguel "Migz" Zubiri is greeted with cheers from Barangay leaders of Albay at the Senate session hall yesterday. Zubiri is set to visit the province of Albay this week to meet with local executives. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
