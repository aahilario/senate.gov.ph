...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 05, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/1205_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->UP LOSA BAÑOS:</strong>
		<!-- PhotoCaption.start -->
		Senate Committee on Agriculture and Food chairman Francis 'Kiko' Pangilinan visits the Animal and Dairy Sciences Cluster of the College of Agriculture, UP Los Baños.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
