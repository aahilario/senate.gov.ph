...
<title>UNISDR Consultative Meeting</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 27, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/1127_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->UNISDR CONSULTATIVE MEETING:</strong>
		<!-- PhotoCaption.start -->
		Sen. Loren Legarda and Special Rep. of the UN Sec.-Gen for DRR, Margareta Wahlstrom  present the "Manila Call for Action of Parliamentarians  on Applying Disaster Risk Reduction as an Instrument for Achieving the Millennium Development Goals",with parliamentarians and representatives from Thailand, Afghanistan, Pakistan, Bangladesh, Laos and Indonesia.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
