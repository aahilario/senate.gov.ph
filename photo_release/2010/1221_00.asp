...
<title>Senate celebrates Christmas</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 21, 2010<p style="text-align: center;">
		<img src="1221_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SENATE CELEBRATES CHRISTMAS:</strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile starts the Pasko sa Senado Christmas celebration by calling out the first round of winners during the night’s raffle portion. Assisting Enrile is Ms. Soledad Tioseco, Service Chief of the Senate’s Human Resource and Management Service. (Photo by Joe Arazas)  </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
