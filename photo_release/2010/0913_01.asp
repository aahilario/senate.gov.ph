...
<title>Democracy and its deformities</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->September 13, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/0913_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->DEMOCRACY AND ITS DEFORMITIES<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Former Sen. Francisco S. Tatad graces the Senate Flag Raising Ceremony to kick off the celebration of the 3rd International Day of Democracy. In his speech entitled "Democracy and its Deformities", he explained that the problems associated with our democracy is basic --- they have nothing to do with how we deal with the democracies or non-democracies but on how the citizens deal with one another, and how the State deals with its citizens. Presenting the Certificate of Appreciation to the Senator is Senate Secretary Emma Lirio-Reyes assisted by Director-General Antonio De Guzman of the Office of International Relations and Protocol.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
