...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 19, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/1019_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->GENEVA, SWITZERLAND:</strong>
		<!-- PhotoCaption.start -->
		Senator Pia S. Cayetano attends a Panel Discussion on “Providing a Sound Legislative Framework Aimed at Preventing Electoral Violence, Improving Election Monitoring and Ensuring the Smooth Transition of Power” on October 5, 2010, during the 123rd Assembly of the Inter-Parliamentary Union (IPU) in Geneva, Switzerland.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
