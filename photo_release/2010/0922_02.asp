...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/0922_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->PRIVILEGE SPEECH<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Miriam Defensor-Santiago delivers her privilege speech on the subject of jueteng during today’s session at the Plenary Hall.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
