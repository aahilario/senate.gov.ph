...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 21, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/1021_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->TIANGGE SA SENADO:</strong>
		<!-- PhotoCaption.start -->
		Senate Secretary Emma Lirio-Reyes officially opens the Senate Employee’s Multi-Purpose Cooperative (SEMCO) Tiangge which will run until next week. The SEMCO Tiangge is part of the month-long, activity-filled celebration of the Senate’s 94th Anniversary.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
