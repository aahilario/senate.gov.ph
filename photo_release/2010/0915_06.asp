...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/0915_06.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BOOK LAUNCHING<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile and House Speaker Sonny Belmonte join the youth in declaring their fight to alleviate poverty during the press launch and ceremonial handover of the book “Winning the Numbers, Losing the War on Poverty,” which is a compilation of Social Watch Philippines’ (SWP) report on the Millennium Development Goals. The book launching was held at the Batasang Pambansa.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
