...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1005_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->DND BUDGET HEARING<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile huddle with Department of National Defense (DND) Secretary Voltaire Gazmin after a public hearing on the proposed 2011 budget of the DND, its attached bureaus and agencies. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
