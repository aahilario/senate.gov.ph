...
<title>Agricultural concerns</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->September 20, 2010<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2010/0920_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->AGRICULTURAL CONCERNS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Sen. Bongbong Marcos convey his concerns to Agriculture Secretary Prospero Alcala regarding the building of more farm to market roads, irrigation system, Massive training for farmers and propagation of high breed rice seedlings. Senator Bongbong believes these issues are needed to make our country be self-sufficient in rice.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
