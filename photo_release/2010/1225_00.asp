...
<title>Erap, Jinggoy give joy</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 25, 2010<p style="text-align: center;">
		<img src="1225_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->ERAP, JINGGOY GIVE JOY:</strong>
		<!-- PhotoCaption.start -->
		Senate President Pro Tempore Jinggoy Ejercito Estrada joins his father former President Joseph Estrada in a pre-Christmas gift giving activity in Barangay Pag-asa, Quezon City. 
</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
