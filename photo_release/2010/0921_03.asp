...
<title>Senate Blue Ribbon Committee starts jueteng investigation</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/0921_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SENATE BLUE RIBBON COMMITTEE STARTS JUETENG INVESTIGATION<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senators Vicente “Tito” Sotto III and Ferdinand “Bongbong” Marcos, Jr., talk to Archbishop Oscar Cruz and Undersecretary for Peace and Order Ricardo M. Puno before the start today’s Senate Blue Ribbon Committee’s hearing investigating recent reports of Archbishop Oscar Cruz, alleging that high government officials in the Aquino administration are receiving payoffs from jueteng.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
