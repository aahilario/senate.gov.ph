...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/1130_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->FEEDING PROGRAM:</strong>
		<!-- PhotoCaption.start -->
		Sen. Manny Villar brought the Villar Foundation's Merienda Caravan to his mother's hometown in Orani, Bataan recently. Soup, pandesal and refreshment were distributed to over 1,500 school children of the Orani North Elementary School. Villar's mother, Curita Bamba, started selling seafood in Orani.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
