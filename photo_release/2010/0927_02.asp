...
<title>Amazing KAP at KAPPT</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2010/0927_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->AMAZING KAP AT KAPPT<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Newly-elected officers of the Katipunan ng mga Artistang Pilipino sa Pelikula at Telebisyon (KAPPT) take their oath before Senator Bong Revilla during its induction ceremony held recently at the Quezon City Sports Club. In his message, the lawmaker vowed to continue to exert efforts to help the entertainment industry and further raise the standard of film-making in the country.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
