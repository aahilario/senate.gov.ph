...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1124_08.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->DISCUSSING THE DILG’s BUDGET:</strong>
		<!-- PhotoCaption.start -->
		(From left) Senate President Franklin M. Drilon (second from right) huddles with (from left) Senators Bam Aquino, Sonny Angara, Nancy Binay, JV Ejercito and Senate Minority Leader Juan Ponce Enrile (seated) before the start of budget deliberations for the Department of Interior and Local Government (DILG), Tuesday morning. The DILG and its attached agencies are set to receive P124.15 billion in 2016, which is 19% higher than its 2015 budget of P104.47 billion. (PRIB photo by Albert Calvelo/24 November 2015)
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
