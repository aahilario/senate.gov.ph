...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1012_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->AGRI DEVELOPMENT:</strong>
		<!-- PhotoCaption.start -->	 	
		Senator Cynthia A. Villar poses with the participants in the workshop on "Strategic Management in Agricultural Development for Poverty Reduction: Enhancing Roles of Farmers' Organizations" spearheaded by Villar SIPAG. The senator, chair of the Senate Agriculture and Food Committee, sponsors various seminars and training in coordination with agricultural organizations, to help Filipino farmers and other stakeholders in the agricultural sector boost their earnings.
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
