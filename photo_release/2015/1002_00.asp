...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1002_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->LISTENING TO LUMAD'S PLEAS:</strong>
		<!-- PhotoCaption.start -->	 	
		Sen. Teofisto "TG" Guingona III , Governor Johnny Pimentel and Administrator Ayek Pimentel of Tandag City pays the Lumads a visit to their tent city at the Tandag Sports Complex and listens to their appeals for swift justice 
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
