...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1119_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->MARIVELES, BATAAN:</strong>
		<!-- PhotoCaption.start -->
		Guest of Honor and Speaker Senator Bongbong Marcos troops the line at the Maritime Academy of Asia and the Pacific in Mariveles, Bataan.   
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
