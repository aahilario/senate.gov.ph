...
<title>5th Philippine Cooperative TEAMshop</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 13, 2015<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2015/1113_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->5TH PHILIPPINE COOPERATIVE TEAMSHOP:</strong>
		<!-- PhotoCaption.start -->
		Senator Bongbong Marcos was fetched by boat from the port of Caticlan by Pandan, Antique Mayor Jonathan Tan (in red) and Malay, Aklan Mayor John Yap (in light blue). Both attended the Coop event where Senator Marcos was Keynote Speaker.  
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
