...
<title>Housing and Urban Development hearing</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 5, 015<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2015/1005_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->HOUSING AND URBAN DEVELOPMENT HEARING:</strong>
		<!-- PhotoCaption.start -->	 	
		Sen. JV Ejercito, chair of the Senate Committee on Urban Planning, Housing and Resettlement, talks to Sen. Lito Lapid before the start of an inquiry on the rehabilitation efforts and construction of decent shelter for the victims of Super Typhoon Yolanda.  “A proper investigation should be done to know why despite huge donations and relief efforts from various organizations and individuals, no permanent relocation sites were constructed for the typhoon victims,” Ejercito said during the hearing, Monday, October 5, 2015. (PRIB Photo by Romeo Bugante/5 October 2015)  
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
