...
<title>Continued Public Service for the Marcoses</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 16, 015<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2015/1016_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->CONTINUED PUBLIC SERVICE FOR THE MARCOSES</strong>
		<!-- PhotoCaption.start -->	Senator Bongbong Marcos joined his mother Ilocos Norte 2nd District Rep. Imelda Romualdez Marcos and sister Governor Imee Marcos as they filed their certificates of candidacy for re-election today
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
