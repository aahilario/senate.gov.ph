...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1119_01.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->MARIVELES, BATAAN:</strong>
		<!-- PhotoCaption.start -->
		Senator Bongbong Marcos acknowledges with a salute the honors given to him by the cadet corps  of the Maritime Academy of Asia and the Pacific in Mariveles, Bataan.   
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
