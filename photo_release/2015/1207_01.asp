...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1207_01.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->GIFT-GIVING AT CROSSWINDS:</strong>
		<!-- PhotoCaption.start -->
		The children beam with joy due to the annual Christmas party and gift-giving of Villar SIPAG led by Senator Cynthia Villar and Vista Land chairman Manny Villar, also former Senate President. The children from Tondo, Manila ang Brgy. Iruhin, Tagaytay City, went home with various gifts from Santa Claus aside from raffle prizes. Las Pinas Rep. Mark Villar also attended the Christmas party held at Crosswinds, a Swiss luxury sanctuary along the mountainsides of Tagaytay City.    
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
