...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1110_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->GCG ANNIVERSARY:</strong>
		<!-- PhotoCaption.start -->
		  Senator Cynthia A. Villar, chairperson of the Senate Committee on Government Corporations and Public Enterprises joins  the fourth anniversary celebration of the Governance Commission for GOCCs (GCG). The GCG, created in June 2011 by virtue of Republic Act 10149 or the GOCC Governance Act of 2011, is the central advisory body that monitors and oversees government-owned or controlled corporations (GOCCs).
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
