...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1012_04.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->INT’L DAY FOR DRR:</strong>
		<!-- PhotoCaption.start -->	 	
		Following the UNISDR’s citation of the Ifugao community as Champion of Resilience, a group of Ifugaos performed the Hudhud Chants, one of UNESCO’s Masterpieces of the Oral and Intangible Heritage of Humanity, which symbolize special episodes in the life of the Ifugaos such as sowing and harvesting of rice, funeral wakes, and bone-washing rituals.		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
