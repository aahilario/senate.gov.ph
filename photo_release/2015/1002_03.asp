...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1002_03.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->YOUTH FORUM:</strong>
		<!-- PhotoCaption.start -->	 	
		Sen. Bongbong Marcos joins students of Universidad de Manila for a group selfie during a youth forum held recently. Marcos discussed the important role of public servants in addressing the problems of the country. UDM President Atty. Ernest Maceda also joined the group selfie. 
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
