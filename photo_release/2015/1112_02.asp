...
<title>Drilon at 6th APRU Law Deans Meet</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1112_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->DRILON at 6th APRU LAW DEANS MEET:</strong>
		<!-- PhotoCaption.start -->
		Senate President Franklin M. Drilon (7th from right, front row) joins and meets the local and international law deans from the Asia-Pacific region attending the 6th Law Deans Meeting of the Association of Pacific Rim Universities (APRU) hosted by University of the Philippines (UP), on Thursday, November 12, 2015 at the EDSA Shangri-La Hotel, Mandaluyong City. Also in photo is UP President Alfredo Pascual (8th from right, front row), UP College of Law Dean Danilo Concepcion (7th from left, back row), and APRU Program Director Jacquelline Heng (6th from left, front row). (PRIB Photo by Cesar Tomambo/ November 12, 2015)     
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
