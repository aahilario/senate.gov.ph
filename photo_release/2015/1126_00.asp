...
<title>Association of Young Filipino-Chinese Entrepreneurs</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 26, 2015<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2015/1126_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->ASSOCIATION OF YOUNG FILIPINO-CHINESE ENTREPRENEURS:</strong>
		<!-- PhotoCaption.start -->
		Listening intently to Senator Bongbong Marcos are President Reginald Yu and Chairman Peter Mangasing. 
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
