...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 31, 015<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2015/1031_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->BREAST CANCER:</strong>
		<!-- PhotoCaption.start -->
		Senator Cynthia A. Villar joins the Philippine Foundation for Breast Cancer Inc. in celebration of the Pink October Breast Cancer Awareness Month held at East Avenue Medical Center in Quezon City.  The senator calls on women to take the necessary steps to detect the disease in early stages for early treatment.
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
