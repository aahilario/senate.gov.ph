...
<table id="container">
	<tr>
		...
		<img src="1214_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->FLAG RAISING CEREMONY:</strong>
		<!-- PhotoCaption.start -->
		Bayan Muna Partylist Neri Colmenares delivers a speech during the Senate’s flag raising ceremony, Monday, December 14, 2015. Colmenares is the principal author of House Bill 5401 or the Personal Income Tax Reform bill, which seeks to slash the income taxes of the middle class and exempt low-income families earning a maximum of P396,000 ($8,510) annually from income tax. (PRIB Photo by Albert Calvelo/14 December 2015)
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
