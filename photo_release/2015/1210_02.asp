...
<title>Bill granting retirement benefits to barangay execs, workers</title>
...
<table id="container">
	<tr>
		...
		<p><strong>
		<!-- PhotoTitle.start -->BILL GRANTING RETIREMENT BENEFITS TO BARANGAY EXECS, WORKERS:</strong>
		<!-- PhotoCaption.start -->
