...
<title>Hog farmers xmas party</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 16, 2015<p style="text-align: center;">
		<img src="1216_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->HOG FARMERS XMAS PARTY:</strong>
		<!-- PhotoCaption.start -->
		Senator Cynthia Villar, chairperson of the Senate Committee on Agriculture &amp; Food, exhorted hog farmers to join hands to spur further agricultural growth as we enter the regional integration towards the end of the year. The senator was guest of honor at the Christmas party and induction ceremony of the National Federation of Hog Farmers, Inc. (NFHFI), Swine Development Council (SDC) and Samahang Industriya ng Agrikultura (SINAG) held at Club Filipino.		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
