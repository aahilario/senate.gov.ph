...
<title>Waste Management Talk</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 2, 2015<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2015/1002_01.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->WASTE MANAGEMENT TALK:</strong>
		<!-- PhotoCaption.start -->	 	
		Senator Cynthia A. Villar, a staunch environmental advocate, stresses the importance of waste management and the role of ‪recycling in protecting the environment. She cited the livelihood programs she has created using wastes  in her speech during the Adamson University Biology Society & Psychological Society environmental activity with the theme,  “Yes to Waste: The Good, the Bad, and the Money." 
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
