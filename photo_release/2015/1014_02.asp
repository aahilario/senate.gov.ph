...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 14, 015<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2015/1014_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->DEFENSE BUDGET:</strong>
		<!-- PhotoCaption.start -->	 	
		 Senate Minority Leader Juan Ponce Enrile studies documents detailing the proposed  2016 budget of the Department of National Defense during a public hearing, Wednesday, October 14, 2015. (Photo by Joe Arazas)     
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
