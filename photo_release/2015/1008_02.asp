...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1008_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->BUDGET HEARING:</strong>
		<!-- PhotoCaption.start -->	 	
		Senator Paolo Benigno "Bam" Aquino, chair of the Senate Finance Subcommittee G, listens to the presentation of Secretary Sonny Coloma on the proposed 2016 Budget of the Presidential Communications Operations Office and its attached agencies during a public hearing, Thursday, October 8. (PRIB Photo by Cesar Tomambo/08 October 2015)  
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
