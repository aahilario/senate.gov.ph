...
<title>Enrile seeks justification on 2016 budget</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1123_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->ENRILE SEEKS JUSTIFICATION ON 2016 BUDGET:</strong>
		<!-- PhotoCaption.start -->
		Senate Minority Leader Juan Ponce Enrile (right) asks Senate Finance Committee chairperson Sen. Loren Legarda (left) for a justification of the proposed P3 Trillion 2016 national budget during a break at Monday morning’s plenary session. Also in photo are Senators Sonny Angara (center), Koko Pimentel (seated), Tito Sotto, and JV Ejercito. (Photo by Joe Arazas)     
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
