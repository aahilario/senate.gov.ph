...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1112_03.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->TANIM BALA:</strong>
		<!-- PhotoCaption.start -->
		Manila International Airport Authority General Manager Jose Honrado (third from right) explains to Senators attending the Senate Blue Ribbon investigation into the alleged “Tanim-Bala” scheme at the Ninoy Aquino International Airport that his main job is to ensure smooth flow at the airport, and that the cases of bullet-planting does not fall under his responsibility. (PRIB Photo by Alex Nuevaespaña/12 November 2015)     
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
