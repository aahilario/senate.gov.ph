...
<title>Sen. Marcos vows to help ‘Buddy’ Scout Rangers</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 27, 2015<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2015/1127_01.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->SEN. MARCOS VOWS TO HELP ‘BUDDY’ SCOUT RANGERS:</strong>
		<!-- PhotoCaption.start -->
		Thank you for visiting us Sir "Buddy" Scout Rangers expressed to Sen. Bongbong Marcos.    
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
