...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1124_06.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->COMMISSION ON HUMAN RIGHTS:</strong>
		<!-- PhotoCaption.start -->
		Senator Sonny Angara is assisted by Commission on Human Rights Undersecretary Chito Gascon as he defends the proposed 2016 budget of the agency amounting to P428.526 million. (PRIB photo by Romeo Bugante/24 November 2015)
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
