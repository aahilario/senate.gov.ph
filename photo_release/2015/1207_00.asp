...
<title>Flag raising ceremony</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 7, 2015<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2015/1207_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->FLAG RAISING CEREMONY:</strong>
		<!-- PhotoCaption.start -->
		Former Tourism Infrastructure and Enterprise Zone Authority (TIEZA) General Manager and guest of honor Mark Lapid (3rd from right) poses for a souvenir photo with Senate officials led by Senate Secretary Oscar Yabes (3rd from left) after Monday’s flag raising ceremony, December 7. Lapid mentioned that there are around 5 million tourist arrivals in the Philippines based on the latest statistics. Also in photo are (left to right) Senate Economic Planning Office Director General Ronald Golding, Legislation Deputy Secretary Edwin Bellen, Senate Legal Counsel Ma. Valentina Cruz, and Administrative and Financial Services Deputy Secretary Arnel Jose Bañas. (PRIB Photo by Albert Calvelo / 07 December 2015)    
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
