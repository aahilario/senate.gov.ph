...
<title>National Research Council of the Philippines</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 21, 2015<p style="text-align: center;">
		<img src="1221_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->NATIONAL RESEARCH COUNCIL OF THE PHILIPPINES:</strong>
		<!-- PhotoCaption.start -->
		Senator Cynthia Villar was the keynote speaker of the policy forum of the National Research Council of the Philippines (NCRP)
on Research-Based Policy Making Towards Environmental Protection and Food Safety, with the theme: “Role of Basic Research in Innovations and Inclusive Growth”.  Being a staunch advocate of environmental protection, the senator has been turning wastes into useful products. 
NCRP is part of the Department of Science and Technology (DOST).<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
