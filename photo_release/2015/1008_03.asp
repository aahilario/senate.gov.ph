...
<title>Budget of the Labor Department</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1008_03.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->BUDGET OF THE LABOR DEPARTMENT:</strong>
		<!-- PhotoCaption.start -->	 	
		Sen. Sonny Angara, chair of the Senate Finance Subcommittee F, points to a PowerPoint presentation during a committee hearing on the proposed P15.8 billion budget of the Department of Labor and Employment (DOLE) Thursday, October 08, 2015. (PRIB Photo by Romeo Bugante/08 October 2015)  
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
