...
<title>Hosts from Umagang Kay Ganda asks both private and political questions...</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 19, 015<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2015/1019_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->HOST FROM UMAGANG KAY GANDA ASKS BOTH PRIVATE AND POLITICAL QUESTIONS WHICH THE PUBLIC ARE EAGER TO KNOW FROM SEN. BONGBONG MARCOS:</strong>
		<!-- PhotoCaption.start -->Personal and political questions were answered this morning by Senator Bongbong Marcos at Umagang Kay Ganda TV show.
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
