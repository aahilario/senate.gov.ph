...
<title>APEC Leaders Welcome Reception</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1119_03.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->APEC LEADERS WELCOME RECEPTION:</strong>
		<!-- PhotoCaption.start -->
		Senator Loren Legarda with President Benigno Aquino III and US President Barack Obama at the APEC Leaders Welcome Reception. Legarda, Chairperson of the Senate Committee on Climate Change, lauded Obama for urging the private sector to mainstream climate change adaptation and mitigation in their business plans and operations during the APEC CEO Summit.   
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
