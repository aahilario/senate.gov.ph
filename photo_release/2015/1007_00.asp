...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 7, 015<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2015/1007_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->PRAYERS TO HEAVEN:</strong>
		<!-- PhotoCaption.start -->	 	
		Senate employees prepare to release an enormous balloon rosary to celebrate the month of the Holy Rosary in honor of the Blessed Virgin Mary. (PRIB Photo by Albert Calvelo / October 7, 2015)  
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
