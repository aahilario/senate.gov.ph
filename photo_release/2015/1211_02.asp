...
<title>Norzagaray, Bulacan</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 11, 2015<p style="text-align: center;">
		<img src="1211_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->NORZAGARAY, BULACAN:</strong>
		<!-- PhotoCaption.start -->
		Before a multi-sectoral crowd in Norzagaray, Bulacan who expressed their full support to his 2016 Vice Presidential bid, Senator Marcos expressed his dismay over the 5.5 Million housing backlog due to the unfunded housing programs of government, "A complete relocation program does not only entail building of housing units but also the provision of basic needs like water, electric connection, schools, markets, access to transportation and jobs in the relocation areas, which the government failed to accomplish."     
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
