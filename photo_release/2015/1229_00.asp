...
<title>Agri mechanization</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 29, 2015<p style="text-align: center;">
		<img src="1229_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->AGRI MECHANIZATION:</strong>
		<!-- PhotoCaption.start -->
		Sen. Cynthia A. Villar, chair of the Senate Agriculture &amp; Food Committee, notes the country needs a lot of catching up in  farm mechanization  as we started only five years ago while our Asian neighbors began mechanizing their farms in the 1970s. In her speech, she told the Board of Agricultural  Engineering 3rd Regional Forum on Sustainable Agricultural Mechanization that with their concerted efforts, our standing that would be beneficial to all is improved.
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
