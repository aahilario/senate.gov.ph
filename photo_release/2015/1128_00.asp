...
<title>Sarangani Province</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 28, 2015<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2015/1128_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->SARANGANI PROVINCE:</strong>
		<!-- PhotoCaption.start -->
		Sarangani Governor Steve Solon and Senator Bongbong Marcos answered questions on various economic and political issues from both the local and national media during the press briefing at the Sarangani Provincial Capitol.    
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
