...
<title>ABAKADA Party List Leaders Assembly</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 17, 2015<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2015/1117_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->ABAKADA PARTY LIST LEADERS ASSEMBLY:</strong>
		<!-- PhotoCaption.start -->
		Swarm of ABAKADA educators warmly greeted Senator Bongbong Marcos during the ABAKADA Party List NCR/R Leaders Assembly held at the Lyceum of the Philippines last Sunday.   
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
