...
<title>Marcos will not abandon BLBAR despite vice presidential bid</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 15, 015<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2015/1015_01.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->MARCOS WILL NOT ABANDON BLBAR DESPITE VICE PRESIDENTIAL BID:</strong>
		<!-- PhotoCaption.start -->	Sen. Bongbong Marcos, Chair of the Senate Committee on Local Government listened intently to the sentiments of a representative of the Sultanates during one of the many BBL hearing conducted at the Senate.
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
