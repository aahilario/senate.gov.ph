...
<title>Discussing the DILG’s budget</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1124_05.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->DISCUSSING THE DILG’s BUDGET:</strong>
		<!-- PhotoCaption.start -->
		Senator Loren Legarda, chairperson of the Senate Committee on Finance, is briefed by Department of Interior and Local Government (DILG) officials led by Secretary Mel Senen-Sarmiento (right) and Undersecretary Austere A. Panadero (center) on the proposed P124.5 billion budget allocation of their agency for next year during plenary deliberations, Tuesday morning. (PRIB photo by Romeo Bugante/24 November 2015)
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
