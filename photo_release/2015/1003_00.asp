...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 3, 015<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2015/1003_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->FOREIGN CHAMBERS:</strong>
		<!-- PhotoCaption.start -->	 	
		Sen. Cynthia A. Villar attended the 12th Joint Foreign Chambers (JFC) Networking Night held at Ballroom 2, Fairmont Makati. About 400 guests- top executives from chambers’ partners, affiliates, and other business sectors participated in the event. The 12th JFC Networking Night is a strategic venue to expand business network and showcase and highlight a company’s capabilities in both the international and local market. 
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
