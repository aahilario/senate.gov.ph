...
<title>Drilon joins Senate Christmas party</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 15, 2015<p style="text-align: center;">
		<img src="1215_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->DRILON JOINS SENATE CHRISTMAS PARTY:</strong>
		<!-- PhotoCaption.start -->
		Senate President Franklin M. Drilon gives his thanks to all employees of the Senate for their hard work and dedication to the institution during the Senate Christmas party which was held last night at One Esplanade, Mall of Asia Complex in Pasay City.  (PRIB Photo by Cesar Tomambo/15 December 2015)
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
