...
<title>Drilon leads fun run</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1012_10.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->DRILON LEADS FUN RUN:</strong>
		<!-- PhotoCaption.start -->	 	
		Senate President Franklin M. Drilon leads Senate officials and employees in a 3-K fun run during kick-off activities at the start of the Senate’s centennial anniversary Monday, October 12. The Senate is marking 100 years of policy making from October 2015 to October 2016. (PRIB Photo by Cesar Tomambo/13 October 2015)    
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
