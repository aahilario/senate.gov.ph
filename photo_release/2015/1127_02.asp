...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1127_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->SEN. MARCOS VOWS TO HELP ‘BUDDY’ SCOUT RANGERS:</strong>
		<!-- PhotoCaption.start -->
		"Buddy" ritual, Senator Bongbong Marcos drank wine and did push-ups as a camaraderie gesture.   
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
