...
<title>Respect Miriam’s right to privacy</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1021_05.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->RESPECT MIRIAM'S RIGHT TO PRIVACY:</strong>
		<!-- PhotoCaption.start --> Senator Bongbong Marcos defended the privacy of non-disclosure of the medical records of Senator Miriam Defensor-Santiago during his guesting this morning at Unang Hirit with Arnold Clavio and Rhea Santos. 		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
