...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1001_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->DISTRACTED DRIVING:</strong>
		<!-- PhotoCaption.start -->	 	
		Sen. Sergio R. Osmeña III, acting chairman of the Senate Committee on Public Services, shows a mobile phone during Thursday’s hearing on proposed measures prohibiting the use of mobile phones while driving to avoid road accidents. Present during the hearing were officials from the Metropolitan Manila Development Authority (MMDA) and the National Telecommunications Commission (NTC) led by Commisioner Gamaliel Cordoba.  (PRIB Photo by Romeo Bugante / 01 October 2015) 
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
