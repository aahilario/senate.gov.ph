...
<title>Lighting the fire of change</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1125_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->LIGHTING THE FIRE OF CHANGE:</strong>
		<!-- PhotoCaption.start -->
		Senate Majority Leader Alan Peter Cayetano, at the UP campus in Cebu City, holds a torch symbolizing the Filipinos' clamor for the "light" that will guide them towards real change. The senator joined over 5,000 people who celebrated Davao City Mayor Rodrigo Duterte's decision to finally run for president. 
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
