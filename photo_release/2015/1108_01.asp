...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 8, 015<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2015/1108_01.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->TACLOBAN CITY:</strong>
		<!-- PhotoCaption.start -->
		Senator Bongbong Marcos and Tacloban City Mayor Alfred Romualdez deplore the still unfurnished promises of government rehabilitation.
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
