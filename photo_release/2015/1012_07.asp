...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1012_07.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->BUDGET HEARING:</strong>
		<!-- PhotoCaption.start -->	 	
		Senate Minority Leader Juan Ponce Enrile questions Undersecretary Luisito Montalbo about the proposed 2016 budget of the Office of the Presidential Adviser on the Peace Process during a public hearing, Monday afternoon. (Photo by Joe Arazas)   
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
