...
<title>Bongbong ‘adopts’ Isko</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 22, 015<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2015/1022_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->BONGBONG 'ADOPTS' ISKO:</strong>
		<!-- PhotoCaption.start -->
		Senator Bongbong Marcos was Guest of Honor and Speaker during the 23rd Annual National Convention of the Vice Mayor's League of the Philippines held October 21, 2015 at the Marriott Hotel, Manila themed "Positioning the Local Government Units in the ASEAN Economic Integration." Manila Vice Mayor Isko Moreno is the VMLP National President.  		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
