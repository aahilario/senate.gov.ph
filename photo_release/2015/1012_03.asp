...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1012_03.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->INT’L DAY FOR DRR:</strong>
		<!-- PhotoCaption.start -->	 	
		Senator Loren Legarda with children from Banaue, Ifugao. In celebration of the International Day for Disaster Reduction, the UNISDR recognized the Ifugao people as Champion of Resilience for utilizing indigenous knowledge in building resilience.
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
