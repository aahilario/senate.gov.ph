...
<title>Senate submits DOST budget</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2015/1125_03.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->SENATE SUBMITS DOST BUDGET:</strong>
		<!-- PhotoCaption.start -->
		Senate President Pro-Tempore Ralph Recto shakes hands with Science and Technology Secretary Mario Montejo after the deliberation of the department’s proposed 2016 budget amounting to P 19.1 billion, Wednesday afternoon. (PRIB PHOTO by Cesar Tomambo/ 25 November 2015) 
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
