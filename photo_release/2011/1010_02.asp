...
<title>Villar helps Tondo residents</title>
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1010_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">Villar helps Tondo residents:</span></strong>
		<!-- PhotoCaption.start -->
		Sen. Manny Villar led the Villar Foundation's feeding program and medical mission at Tondo High School Covered Court  in Moriones, Tondo last Saturday (October 8). More than 600 residents were given free medical consultation, medicines and vitamins.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
