...
<title>Kapihan with Senate President</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 1, 2011
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1201_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">KAPIHAN WITH THE SENATE PRESIDENT:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile answers questions from the media regarding the plot to assassinate former President Gloria Macapagal Arroyo, the Reproductive Health Bill, Charter Change and the execution of a Pinoy in China during the Kapihan sa Senado today, December 1. On the issue of Charter Change, Enrile says, "I’m doing it in my honest belief that we have to review the economic provisions of the country in order to hasten the economic development of this land because of our growing population so that we can create jobs."(PRIB Photo by JOSEPH VIDAL)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
