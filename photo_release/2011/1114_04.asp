...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1114_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">BLUE RIBBON HEARING:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile, together with Sen. Teofisto "TG" Guingona III, chairman of the Blue Ribbon Committee, question resource persons on allegations that the Development Bank of the Philippines (DBP) granted several anomalous behest loans during previous government administrations, Monday, November 14, 2011. (PHOTO by JOE ARAZAS)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
