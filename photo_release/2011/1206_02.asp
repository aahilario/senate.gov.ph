...
<title>Hearing on Election Laws</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 6, 2011
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1206_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">HEARING ON ELECTION LAWS:</span></strong>
		<!-- PhotoCaption.start -->
		Senator Koko Pimentel, chair of the Committee on Electoral Reforms and People's Participation, discuss laws concerning electoral reforms such as proposed amendments to the Omnibus Election Code, the Synchronized Election Law of 1992, and the Fair Election Act during a public hearing, Tuesday, December 6, 2011. (PRIB Photo by ALEX NUEVAESPAÑA)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
