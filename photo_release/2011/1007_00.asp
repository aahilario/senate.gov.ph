...
<title>Blue Ribbon Hearing</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 7, 2011
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1007_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">BLUE RIBBON HEARING:</span></strong>
		<!-- PhotoCaption.start -->
		The Blue Ribbon Committee, headed by Sen. Teofisto “TG” Guingona, together with the Committee on Banks, Financial Institutions & Currencies, hold its initial investigation Friday, October 7, 2011, into alleged anomalous large scale financial transactions involving behest loans and sweetheart deals done under a cloak of confidentiality during the previous administrations of government bank and financial institutions, particularly in light of the circumstances surrounding the tragic death of Development Bank of the Philippines (DBP) assistant legal counsel Benjamin Pinpin. (PRIB Photo by Albert Calvelo)
</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
