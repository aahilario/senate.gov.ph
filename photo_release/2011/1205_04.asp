...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1205_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">150th Jose Rizal Anniversary Conference:</span></strong>
		<!-- PhotoCaption.start -->
		Senator Edgardo J. Angara and the rest of the delegates surprise National Artist for Literature F. Sionil Jose with a cake for his birthday, which was on the day of the conference itself.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
