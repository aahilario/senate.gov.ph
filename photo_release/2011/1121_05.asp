...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1121_05.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">7th National Biotechnology Week:</span></strong>
		<!-- PhotoCaption.start -->
		DENR Secretary Ramon Paje presents a special token to Senator Edgardo J. Angara during the opening ceremonies of the 7th National Biotechnology Week.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
