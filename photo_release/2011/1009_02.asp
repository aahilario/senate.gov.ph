...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1009_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">Tagum:</span></strong>
		<!-- PhotoCaption.start -->
		Senator Loren Legarda takes a look at the artworks, handicrafts and other products of various indigenous peoples groups that were showcased during the Mindanao IP Assembly on September 21-22, 2011. The assembly was convened by Legarda, chair of the Senate Committee on Cultural Communities, to consult IPs in Mindanao on the various concerns that they face.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
