...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 18, 2011
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1118_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">BUDGET DEBATES:</span></strong>
		<!-- PhotoCaption.start -->
		Commission on Elections chair Sixto Brillantes Jr. listens intently to Finance chair Senator Franklin Drilon as he defends the proposed 2012 budget of the Commission on Elections Friday, November 18, 2011. (PRIB Photo by Albert Calvelo) </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
