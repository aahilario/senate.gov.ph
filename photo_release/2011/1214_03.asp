...
<!-- AddThis Button END -->
        ...
        <img src="1214_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">OATH TAKING:</span></strong>
		<!-- PhotoCaption.start -->
		Senator Antonio Trillanes IV, being the youngest Senator, administers the oath to Senate President Juan Ponce Enrile, who will sit as the presiding officer during the impeachment trial of Chief Justice Renato Corona, Wednesday, December 14, 2011. (PRIB Photo by JOSEPH VIDAL)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
