...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1012_08.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">COCCAAP HEARING:</span></strong>
		<!-- PhotoCaption.start -->
		Congressional Oversight Committee on Civil Aviation Authority of the Philippines (COCCAAP) Chairman Ramon Bong Revilla, Jr. questions CAAP officials on their efforts to regain the country’s Category 1 aviation safety status during the committee hearing conducted recently. Also in photo is COCCAAP Co- Chairman and Southern Leyte Rep. Roger Mercado (beside the senator).</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
