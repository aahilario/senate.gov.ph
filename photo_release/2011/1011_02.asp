...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1011_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">VOTER'S REGISTRATION:</span></strong>
		<!-- PhotoCaption.start -->
		Sen. Koko Pimentel, chair of the Committee on Electoral Reforms and People’s Participation, conduct a hearing on several bills aimed at cleaning the country’s list of registered voters Tuesday, October 11, 2011. Also discussed was a bill requiring all registered voters whose biometrics have not been captured, to appear before the election officer of their place of registration, for purpose of having their photographs, fingerprints and signatures captured through the biometric system. (PRIB Photo by Alex Nueva España)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
