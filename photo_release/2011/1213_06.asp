...
<!-- AddThis Button END -->
        ...
        <img src="1213_06.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">COMMUNICATION EXPO 2011:</span></strong>
		<!-- PhotoCaption.start -->
		Event organizers and delegates of the Communications Expo 2011 pose for a souvenir photo with Senator Edgardo J. Angara after the Fellowship Dinner.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
