...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1012_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">CONFIRMED:</span></strong>
		<!-- PhotoCaption.start -->
		The Commission on Appointments confirmed on Wednesday, October 12, 2011, the appointment of former Senator Manuel "Mar" Roxas II as Secretary of the Department of Transportation and Communications (DOTC). Also in photo are Senators Jinggoy Ejercito Estrada, Franklin Drilon, Vicente Sotto III, and Alan Peter Cayetano (standing). (PRIB Photo by Alex Nuevaespaña)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
