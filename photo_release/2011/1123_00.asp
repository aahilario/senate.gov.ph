...
<title>Nomination Deferred</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 23, 2011
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1123_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">NOMINATION DEFERRED:</span></strong>
		<!-- PhotoCaption.start -->
		Sen. Miriam Defensor Santiago, chair of Committee on Foreign Relations, together with (from left) Rep. Roilo Golez, Rep. Rodolfo Antonio and Senate President Juan Ponce Enrile, chair of the Commission on Appointments, listen to Philippine Ambassador to China Domingo Lee during deliberations held Wednesday, November 23, 2011. Lee failed to get the confirmation of the powerful Commission on Appointments (CA) even after under intense questioning from a Sen. Serge Osmeña, who expressed concern over  his  alleged “lack of experience and training” in the field of diplomacy. (PRIB Photo by Joseph Vidal)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
