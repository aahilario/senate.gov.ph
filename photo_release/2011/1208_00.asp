...
<title>Angara keynotes forum on Renewable Energy</title>
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1208_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">ANGARA KEYNOTES FORUM ON RENEWABLE ENERGY:</span></strong>
		<!-- PhotoCaption.start -->
		(L-R) Bronze Oak Philippines President Jose Ma. Zabaleta greets Senator Edgardo J. Angara, European Chamber of Commerce of the Philippines (ECCP) President Hubert d’Aboville and Dr. Guenter Matschuck, President of Maschinen & Technik (MASTEC).</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
