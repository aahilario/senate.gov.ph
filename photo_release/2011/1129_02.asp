...
<title>Swift justice for every San Juan</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 29, 2011
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1129_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">SWIFT JUSTICE FOR EVERY JUAN:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Pro Tempore Jinggoy Ejercito Estrada delivers a speech as Keynote Speaker during the 18th National Convention Seminar and Election of Officers of the Philippine Trial Judges League, Inc. held in Negros Oriental Convention Center in Dumaguete City. In his speech, Sen. Estrada calls on the organization to forge an agenda that will reform the justice system so as to fast track the resolution and termination of cases before the courts. This, he says, is to pursue a new culture of swift and uncompromising justice and to tear down the prevailing culture of impunity. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
