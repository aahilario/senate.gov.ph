...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1129_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">A WOMAN'S DREAM:</span></strong>
		<!-- PhotoCaption.start -->
		Committee on Youth, Women and family Relations Chair Sen. Pia Cayetano (3rd from left) leads the opening of a photo exhibit on women's rights as part of the 18-day national campaign to end violence against women. Also in the photo: Teresita Bagasao, country-representative of the Joint UN HIV-AIDS program, veteran lensman Mike Alquinto and Senate Secretary Emma Lirio-Reyes.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
