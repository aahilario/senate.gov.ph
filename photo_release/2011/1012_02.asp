...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1012_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">ALL SMILES:</span></strong>
		<!-- PhotoCaption.start -->
		Flashing bright smiles and happy faces, Pampagueños gathered around Senate President Pro Tempore Jinggoy Ejercito Estrada to express gratitude for the assistance he extended to the municipality. Sen. Estrada recently visited Macabebe, Pampanga to distribute more than 1,000 relief bags to the flood-stricken residents. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
