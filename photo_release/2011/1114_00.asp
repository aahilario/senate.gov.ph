...
<title>Sen. Kiko Pangilinan meets farmers in China</title>
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1114_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">SEN. KIKO PANGILINAN MEETS FARMERS IN CHINA:</span></strong>
		<!-- PhotoCaption.start -->
		Farmer Li Hai Xian from Yin Cheng town looks at Senator Kiko Pangilinan's newly-harvested Chinese yam. Pangilinan who chairs the Senate Committee on Agriculture and Food visited Xian's farm in Huantai County, Zibo City in Shandong Province to see how enterprise organizations impacts farmers' productivity in China.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
