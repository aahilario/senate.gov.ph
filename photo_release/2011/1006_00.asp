...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 6, 2011
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1006_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">DARK KNIGHT:</span></strong>
		<!-- PhotoCaption.start -->
		Senator Ramon Bong Revilla Jr. braves the dangerous torrents and strong currents in Hagonoy, Bulacan to proceed with his Kaagapay sa Araw ng Pangangailangan (KAP) relief operations. The lawmaker has relentlessly conducted relief efforts in different flood-affected areas nationwide. He went on to inspect the condition of government infrastructures damaged by typhoons Pedring and Quiel, being the chairman of the Senate Committee on Public Works.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
