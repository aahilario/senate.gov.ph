...
<title>National Convention of the Philippine Judges Association in Makati City</title>
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1013_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">National Convention of the Philippine Judges Association in Makati City:</span></strong>
		<!-- PhotoCaption.start -->
		Sen. Escudero speaks before the judge members at the National Convention of the Philippine Judges Association in Makati City. October 13, 2011. Thursday</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
