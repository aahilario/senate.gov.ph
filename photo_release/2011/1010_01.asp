...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1010_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">DOTC BUDGET HEARING:</span></strong>
		<!-- PhotoCaption.start -->
		Senator Ralph Recto together with Senate President Juan Ponce Enrile and Senator Panfilo Lacson listen as Department of Transportation and Communication (DOTC) Secretary Mar Roxas presents the proposed 2012 budget of the agency during the hearing, Monday, October 10, 2011. (PRIB Photo by Albert Calvelo)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
