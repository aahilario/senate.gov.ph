...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 10, 2011
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1110_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">KAPIHAN SA SENADO:</span></strong>
		<!-- PhotoCaption.start -->
		Sen. Edgardo Angara answers questions from the Senate media on the future of the Reproductive Health Bill and the hold departure order against former President Gloria Macapagal-Arroyo during the Kapihan sa Senado, November 10, 2011. (PRIB Photo by ALEX NUEVAESPAÑA)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
