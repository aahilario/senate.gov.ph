...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1024_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">Manila Peninsula:</span></strong>
		<!-- PhotoCaption.start -->
		DOF Secretary Cesar Purisima, Senator Franklin M. Drilon, Korea Eximbank President Young Hwan Kim, Ambassador Hye Min Lee of Korea, NEDA Director-General Cayetano Paderanga Jr., Senator Edgardo J. Angara and DPWH Secretary Rogelio Singson formally open the first representative branch of the Import-Export Bank of Korea in the Philippines on Oct. 13.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
