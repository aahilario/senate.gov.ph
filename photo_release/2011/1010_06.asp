...
<title>Senate Kapepiktyur Camera Group</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 10, 2011
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1010_06.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">SENATE KAPEPIKTYUR CAMERA GROUP:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile and Senate Secretary Emma Reyes lead the ceremonial opening of the Senate Kapepiktyur Camera Group Photo Exhibit, which will run during the month long celebration of the Senate's 95th Anniversary. The camera club is open to all senate employees who love the art of photography. Also in photo are Alex Nuevaespaña of the Public Relations and Information Bureau, and Gil Valdez of the Office of the Senate Sergeant-at-Arms. (PRIB Photo by Joseph Vidal)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
