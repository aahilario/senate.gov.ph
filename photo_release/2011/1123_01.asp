...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1123_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">COURTESY CALL:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile meets with a delegation from  Isabela province led by Mayor Fernando Cumigad of Gamu, Isabela, Wednesday, November 23, 2011. (PRIB Photo by ALBERT CALVELO)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
