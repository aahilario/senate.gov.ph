...
<title>Students welcome JPE</title>
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1010_08.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">STUDENTS WELCOME JPE:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile is welcomed by elementary school students at the Poblacion Plaza of Lubang, Occidental Mindoro, during the second launching of the One Laptop Per Child (OLPC) project Friday, October 7, 2011.  The OLPC project aims to provide children of developing countries access to education by providing one connected laptop to every school-age child.  (Photo by Joe Arazas)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
