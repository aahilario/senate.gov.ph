...
<title>Corona impeachment</title>
...
<!-- AddThis Button END -->
		...
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">CORONA IMPEACHMENT:</span></strong>
		<!-- PhotoCaption.start -->
		Senate Secretary Emma Lirio Reyes receives the articles of impeachment that will be used against Supreme Court Chief Justice Renato Corona from Representatives Niel Tupas of Iloilo and Rey Umali of Oriental Mindoro Tuesday, December 13, 2011. The 84 page document, which was signed by 188 members of the House of Representatives, was transmitted to the Senate at exactly 10:00 am. (PRIB Photo by Joseph Vidal)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
