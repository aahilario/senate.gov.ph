...
<title>Enrile receives award as outstanding Senate President</title>
...
<!-- AddThis Button END -->
		...
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">ENRILE RECEIVES AWARD AS OUTSTANDING SENATE PRESIDENT:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile was given high honors during the 4th Mandatory Continuing Legal Education (MCLE) accredited National Convention of Public Attorneys as an Outstanding Senate President held at the Manila Hotel, Tuesday, December 13, 2011. (PHOTO by JOE ARAZAS)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
