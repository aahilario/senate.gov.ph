...
<!-- AddThis Button END -->
        ...
        <img src="1213_05.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">COMMUNICATION EXPO 2011:</span></strong>
		<!-- PhotoCaption.start -->
		Senator Edgardo J. Angara receives the Plaque of Appreciation from Dr. Cecilia Dy, Head of the National Committee on Communications of the NCCA, and Mr. Juan Dayang, President of the Publishers Associations of the Philippines, Inc. (PAPI).</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
