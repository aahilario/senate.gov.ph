...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1205_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">150th Jose Rizal Anniversary Conference:</span></strong>
		<!-- PhotoCaption.start -->
		The second plenary session, focusing on culture and society, was highlighted by prominent names such as (L-R) Dr. Melba P. Magay, Mr. Jaime Antonio Jr., Mr. Lourd de Veyra, Senator Edgardo J. Angara as moderator, former Defense Sec. Gilbert Teodoro Jr., and Mr. Mario Miclat.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
