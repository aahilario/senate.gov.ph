...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1012_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">BUDGET HEARING:</span></strong>
		<!-- PhotoCaption.start -->
		Senators Edgardo Angara, Ralph Recto and Finance Committee chair, Senator Franklin Drilon review the written report submitted by officials of the Department of Budget and Management led by Secretary Florencio B. Abad, detailing the agency’s proposed 2012 budget during a hearing Wednesday, October 12, 2011. Also discussed during the hearing were the budget proposals of the Development Budget Coordinating Committee and the Philippine Center for Economic Development. (PRIB Photo by Alex Nuevaespaña)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
