...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 30, 2011
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1030_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">State Visit:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Pro Tempore Jinggoy Ejercito Estrada (right) meets the President of the Socialist Republic of Vietnam H.E. Truong Tan Sang (left) during a courtesy call in Sofitel Philippine Plaza. President Sang is in the country for a three-day state visit. This year marks the 35th Anniversary of the Philippines-Vietnam diplomatic relations.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
