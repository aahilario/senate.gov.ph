...
<title>Enrile visits Occidental Mindoro</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 19, 2011
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1019_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">ENRILE VISITS OCCIDENTAL MINDORO:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile meets with elementary school students from Tangal Elementary School and Kusang Loob Elementary School in Barangays Tangal and Tagbac, Lubang, Occidental  Mindoro, last October 7, 2011. Enrile was recently in Occidental Mindoro to witness the second launching of the One Laptop Per Child project, which aims to empower children of developing countries to learn by providing one connected laptop to every school-age child. (Photo by Joe Arazas)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
