...
<title>Agriculture budget submitted</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 17, 2011
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1117_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">AGRICULTURE BUDGET SUBMITTED:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile congratulates Agriculture Secretary Proceso Alcala after the department’s budget was submitted for consideration during plenary session, Thursday, November 17, 2011. Senate Finance Committee Chairman Franklin Drilon said that the department's proposed budget is more than ready for calamities and natural disasters. (PRIB Photo by ALBERT CALVELO)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
