...
<title>Miss World First Princess</title>
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1121_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">MISS WORLD FIRST PRINCESS:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Pro Tempore Jinggoy Ejercito Estrada receives a courtesy call from Ms. Gwendoline Ruais who bagged the First Princess title from the recently concluded 2011 Miss World pageant in London, England. Sen. Estrada authored a Senate resolution commending Ms. Ruais for giving honor to the country and for showcasing “stunning beauty, commendable personality and exceptional intelligence.”</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
