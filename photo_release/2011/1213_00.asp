...
<title>Senate continues to investigate alleged DBP behest loans</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 13, 2011
...
<!-- AddThis Button END -->
		...
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">SENATE CONTINUES TO INVESTIGATE ALLEGED DBP BEHEST LOANS:</span></strong>
		<!-- PhotoCaption.start -->
		Senator Serge Osmeña, chair of the Committee on banks and Financial Institutions, questions former Development Bank of the Philippines (DBP) President Reynaldo David about the bank’s activities during the continuation of a hearing investigating DBP for alleged behest loans and anomalous transactions Tuesday, December 13, 2011. (PRIB Photo by ALBERT CALVELO)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
