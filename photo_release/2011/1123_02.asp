...
<title>Senators Answer Pressing Issues</title>
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1123_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">SENATORS ANSWER PRESSING ISSUES:</span></strong>
		<!-- PhotoCaption.start -->
		Senators TG Guingona and Kiko Pangilinan face the Senate press, Wednesday, November 23, 2011 on the 2nd year anniversary of the Maguindanao massacre. The Senate today adopted Senate Resolution no. 642, filed by Pangilinan, declaring November 23 as a national day to end impunity. (PRIB Photo by ALEX NUEVAESPAÑA)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
