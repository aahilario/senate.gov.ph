...
<title>Enrile attends Criminal Justice Summit</title>
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1206_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">ENRILE ATTENDS CRIMINAL JUSTICE SUMMIT:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile greets President Benigno Aquino III before the start of the first National Criminal Justice Summit, which was held at Manila Hotel last Monday, December 5, 2011. (Photo by Joe Arazas)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
