...
<title>COMELEC Commissioner confirmed</title>
...
<!-- AddThis Button END -->
		...
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">COMELEC COMMISSIONER CONFIRMED:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile, chair of the Commission on Appointments (CA), congratulates newly confirmed COMELEC Commissioner Atty. Christian Robert S. Lim during the CA Meeting, Wednesday, December 14, 2011. Lim, former lawyer of the Noy-Mar tandem, will hold office until February 2, 2018. (PRIB Photo by ALBERT CALVELO)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
