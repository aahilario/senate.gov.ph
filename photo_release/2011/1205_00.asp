...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1205_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">Forum on RH Bill:</span></strong>
		<!-- PhotoCaption.start -->
		Open Forum on RH Bill held at the St. Michael Retreat House in Antipolo City.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
