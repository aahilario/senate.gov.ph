...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1111_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">TESDA Brick Plaza, Taguig City:</span></strong>
		<!-- PhotoCaption.start -->
		Sen. Escudero and TESDA Sec. Joel Villanueva did the ceremonial cutting of "competition chain" to officially start the ‘2011 Regional Skills Competition’ at TESDA, Taguig City.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
