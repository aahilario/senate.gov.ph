...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1126_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">Cultural Gala:</span></strong>
		<!-- PhotoCaption.start -->
		Mexican Amb. Tomas Javier Calvillo Unna presents special Dia del Galeon commemorative lottery tickets from Mexico to the leaders behind the cultural gala: Sen. Edgardo J. Angara, Education Sec. Armin Luistro, Social Welfare Sec. Corazon Soliman, Health Secretary Enrique Ona and PhilPost Postmaster Gen. Josefina dela Cruz.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
