...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 8, 2011
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1208_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">COURTESY CALL:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile chats with Israeli Ambassador to the Philippines Menashe Bar-On who called on him at the Senate Thursday morning, December 8, 2011. During their brief meeting, Enrile and Bar-On discussed the latest political developments in Middle East countries in the wake of the so-called Arab Spring. They are vowed to work together in improving the diplomatic, trade and cultural relations between their two countries. (PRIB Photo by Albert Calvelo)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
