...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1020_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">PIDS-DOST FORUM:</span></strong>
		<!-- PhotoCaption.start -->
		Senator Edgardo J. Angara and Secretary Mario Montejo of the Department of Science and Technology at the Understanding Innovations: A Benchmark for Economic Growth and Competitiveness forum.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
