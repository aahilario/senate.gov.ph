...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1128_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">Educational tour:</span></strong>
		<!-- PhotoCaption.start -->
		Senate Majority Leader Vicente C. Sotto III and Senator Gregorio B. Honasan II together with the students of Immaculate Conception Academy Greenhills, San Juan City, who visited the Senate as part of their educational tour.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
