...
<title>Blue Ribbon Committee investigates DBP behest loans</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 14, 2011
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1114_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">BLUE RIBBON COMMITTEE INVESTIGATES DBP BEHEST LOANS:</span></strong>
		<!-- PhotoCaption.start -->
		Sen. Teofisto “TG” Guingona, chair of the Senate Blue Ribbon Committee, together with Senate President Juan Ponce Enrile, and Senators Ferdinand Marcos, Jr., Panfilo Lacson and Sergio Osmeña investigate the controversial behest loans granted by the Development Bank of the Philippines to certain businessmen in the country during the previous administration, Monday, November 14, 2011. (PRIB PHOTO by JOSEPH VIDAL)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
