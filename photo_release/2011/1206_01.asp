...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1206_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">BLUE RIBBON HEARING:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile chats with former Finance Secretary Margarito Teves during the continuation of the Blue Ribbon hearing on alleged anomalous transactions entered into by the Development Bank of the Philippines (DBP) Tuesday, December 6, 2011. (PRIB PHOTO by ALBERT CALVELO)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
