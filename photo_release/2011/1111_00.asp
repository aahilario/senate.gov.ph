...
<title>TESDA Brick Plaza, Taguig City</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 11, 2011
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1111_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">TESDA Brick Plaza, Taguig City:</span></strong>
		<!-- PhotoCaption.start -->
		Sen. Chiz Escudero attended the TESDA ‘2011 Regional Skills Competition at Araw ng Magsasanay’ in Taguig City. With him is Sec. Joel Villanueva of the Technical Education and Skills Development Authority.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
