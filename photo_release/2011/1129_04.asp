...
<title>Farewell Courtesy Call</title>
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1129_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">FAREWELL COURTESY CALL:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile shakes the hand of outgoing Australian Ambassador to the Philippines Rod Smith during a courtesy call today, November 29, at the Senate. Smith served as Australian Ambassador to the Philippines since March 2008 and will be replaced by Bill Tweddell starting January 2012. (Photo by JOE ARAZAS)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
