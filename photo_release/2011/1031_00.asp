...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 31, 2011
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1031_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">Courtesy Call:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile shakes the hand of His Exellency Truong Tan Sang, President of the Socialist Republic of Vietnam during a courtesy call at Hotel Sofitel recently. (Photo by JOE ARAZAS)
</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
