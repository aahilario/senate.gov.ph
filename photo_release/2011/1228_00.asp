...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 28, 2011
...
<!-- AddThis Button END -->
        ...
        <img src="1228_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">Courtesy Call:</span></strong>
		<!-- PhotoCaption.start -->
		Senator Loren Legarda, Chairperson of the Senate Committee on Foreign Relations, greets Ambassador Guy Ledoux, Head of the European Union Delegation in the Philippines, during the courtesy call of Hon. Viorel Isticioaia Budura, Managing Director for Asia and Pacific of the European External Action Service (EEAS), who received from the Senator a copy of her book, Redefining Development.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
