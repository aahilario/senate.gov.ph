...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1124_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">BOOK LAUNCH:</span></strong>
		<!-- PhotoCaption.start -->
		Senator Pia S. Cayetano (3rd from left) is joined by friends and family at the launching of her first book, 'My Daily Race.' Also in photo are (L-R): Sen. Alan Peter Cayetano, Ren Cayetano, Sen. Miriam Defensor-Santiago, Presidential Adviser Neric Acosta and Lino Cayetano.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
