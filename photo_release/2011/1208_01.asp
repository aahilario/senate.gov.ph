...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1208_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">ANGARA KEYNOTES FORUM ON RENEWABLE ENERGY:</span></strong>
		<!-- PhotoCaption.start -->
		Senator Edgardo J. Angara, chair of the Senate Committee on Science and Technology, delivers the keynote address at the European Chamber of Commerce of the Philippines’ (ECCP) forum entitled “Moving Forward with Renewable Energy: Challenges and Opportunities”.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
