...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1011_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">APECO HEARING:</span></strong>
		<!-- PhotoCaption.start -->
		Senator Franklin Drilon, Chairman of the Senate Committee on Finance, questions representatives from the Aurora Pacific Economic Zone and Freeport Authority (APECO) during their presentation on the proposed 2012 budget of the agency during the public hearing, Tuesday, October 11, 2011. (PRIB Photo by Joseph Vidal)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
