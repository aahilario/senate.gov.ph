...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1010_07.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">BUDGET HEARING:</span></strong>
		<!-- PhotoCaption.start -->
		Senator Ralph Recto listens intently as officials of the Department of Transportation and Communications (DOTC), led by Sec. Mar Roxas, explain their agency’s proposed 2012 budget in detail in a hearing Monday, October 10, 2011. (PRIB Photo by Edward Ganal)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
