...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1014_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">National Indigenous Peoples Cultural Summit:</span></strong>
		<!-- PhotoCaption.start -->
		Senator Loren Legarda, Chair of the Senate Committee on Cultural Communities, proudly introduces Federico Caballero, awarded Gawad Manlilikha ng Bayan 2000 for his work in documenting the oral literature, particularly the epics of Panay Bukidnon.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
