...
<title>KAP medical assistance reaches Isabela</title>
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1010_05.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">KAP MEDICAL ASSISTANCE REACHES ISABELA:</span></strong>
		<!-- PhotoCaption.start -->
		Senator Ramon Bong Revilla, Jr., poses with Governor Faustino “Bodjie” Dy III (right) and Vice Governor Rodito Albano III (left) during the launch of his Kalusugan Ating Pangalagaan (KAP) medical assistance program in Isabela. The lawmaker’s KAP medical assistance program in the province was formalized through the signing of a Memorandum of Agreement recently at the provincial capitol.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
