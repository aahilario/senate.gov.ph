...
<title>Angara calls for Filipinnovation</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 20, 2011
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1020_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">ANGARA CALLS FOR FILIPINNOVATION:</span></strong>
		<!-- PhotoCaption.start -->
		Senator Edgardo J. Angara delivers the keynote speech at a forum held earlier this week entitled "Understanding Innovations: A Benchmark for Economic Growth and Competitiveness". The event was organized by the Department of Science and Technology (DOST), the Philippine Institute for Development Studies (PIDS) and the International Development Research Center (IDRC).</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
