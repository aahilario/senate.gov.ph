...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1010_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">ONE LAPTOP PER CHILD:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile joins Mayor Juan Sanchez of Lubang, Mindoro, and Occidental Mindoro Governor Josephine Ramirez-Sato as elementary school students demonstrate how to use their newly-acquired XO Laptops during the second launching of the One Laptop Per Child (OLPC) project, which was held Friday, October 7, 2011 at the Poblacion Plaza in Lubang, Occidental Mindoro. XO Laptops are developed by the OLPC non-profit organization, which aims to empower children of developing countries to learn by providing one connected laptop to every school-age child. (Photo by Joe Arazas)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
