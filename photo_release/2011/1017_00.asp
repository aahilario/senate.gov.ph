...
<title>Hearing on the Keppel Subic Shipyard accident</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 17, 2011
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1017_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">HEARING ON THE KEPPEL SHIPYARD ACCIDENT:</span></strong>
		<!-- PhotoCaption.start -->
		Senator Jinggoy Estrada, chair of the Senate Committee on Labor, Employment and Human Resources Development, conduct a public hearing, Monday, October 17, 2011, on the Keppel Subic Shipyard accident based on the privilege speech he delivered last October 10, 2011. Sen. Estrada shows a picture of the scene to representatives of the Department of Labor and Employment (DOLE) headed by Undersecretary Lourdes Transmonte after the tragic accident happened. (PRIB Photo by Edward Ganal)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
