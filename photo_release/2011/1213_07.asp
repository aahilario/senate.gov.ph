...
<!-- AddThis Button END -->
        ...
        <img src="1213_07.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">COMMUNICATION EXPO 2011:</span></strong>
		<!-- PhotoCaption.start -->
		Senator Edgardo J. Angara delivers the keynote address at the Communications Expo 2011 held at Boracay Regency last December 8. Angara talks about how the free market is killing press freedom, and how new technology is providing solutions to save it.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
