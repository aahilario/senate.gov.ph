...
<title>Call to modernize the country’s criminal code</title>
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1207_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">CALL TO MODERNIZE THE COUNTRY’s CRIMINAL CODE:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile delivers a speech at the first National Criminal Justice Summit recently held at the Manila Hotel in Roxas Boulevard. In his speech, Enrile appealed to members of the Criminal Code Committee to be meticulous in defining crimes and their corresponding penalties. According to Enrile, current penalties do not match the gravity of the crimes committed, encouraging people to circumvent the law. (Photo by Joe Arazas)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
