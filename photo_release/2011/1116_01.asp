...
<title>DoJ budget deliberations</title>
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1116_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">DOJ BUDGET DELIBERATIONS:</span></strong>
		<!-- PhotoCaption.start -->
		Finance Chairman Senator Franklin Drilon discusses with Justice Secretary Leila de Lima the proposed budget of the department for FY 2012, Tuesday, November 15, 2011. The DOJ budget was submitted for consideration Tuesday afternoon. (PRIB Photo by Joseph Vidal)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
