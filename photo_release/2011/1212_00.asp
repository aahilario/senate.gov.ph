...
<title>RH Bill is unnecessary</title>
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1212_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">RH Bill Is Unnecessary:</span></strong>
		<!-- PhotoCaption.start -->
		Senate Majority Leader Vicente C. Sotto III speaks before the participants of National Marian Pilgrimage last Sunday at the Luneta Grandstand, Manila.    </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
