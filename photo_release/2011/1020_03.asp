...
<title>Kapihan with former Sen. Nene Pimentel</title>
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1020_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">KAPIHAN WITH FORMER SEN. NENE PIMENTEL:</span></strong>
		<!-- PhotoCaption.start -->
		Former Senator Aquilino Pimentel talks about the Supreme Court decision on the postponement of the ARMM elections, the appointment of ARMM Officers-in-Charge and the cease fire agreement between the goverment and the MILF during the Kapihan sa Senado, Thursday, October 20, 2011. (PRIB Photo by Albert Calvelo)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
