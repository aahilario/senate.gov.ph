...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1108_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">Provincial Capitol of Aklan, Kalibo:</span></strong>
		<!-- PhotoCaption.start -->
		Sen. Chiz Escudero leads the unveiling of the statue of the Father of Aklan during the Centennial Celebration of the birth of Godofredo P. Ramos.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
