...
<title>Kapihan sa Senado with Sen. Franklin Drilon</title>
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1124_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">KAPIHAN SA SENADO WITH SEN. FRANKLIN DRILON:</span></strong>
		<!-- PhotoCaption.start -->
		Senate Finance Committee Chairman Franklin Drilon celebrates his 66th birthday with Senate Media Reporters during the Kapihan sa Senado, Thursday, November 24, 2011. (PRIB Photo by Joseph Vidal)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
