...
<title>Senate starts Impeachment trial</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 14, 2011
...
<!-- AddThis Button END -->
		...
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">SENATE STARTS IMPEACHMENT TRIAL:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile administers the oath to the 22 Senators before officially starting the impeachment proceedings of Chief Justice Renato Corona. Part of the oath states that the Senator Judges "will do impartial justice according to the Constitution and the laws of the Philippines." (PRIB Photo by JOE ARAZAS)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
