...
<title>Loren leads road inauguration rites</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 20, 2011
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1120_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">Loren Leads Road Inauguration Rites:</span></strong>
		<!-- PhotoCaption.start -->
		“One of the primary roles of LGUs is the efficient and immediate delivery of basic services—food, medical needs, livelihood projects, and the provision of basic goods and relief services in times of disasters. This road which we are now inaugurating will be of great help to the local officials of Barangay Sideg, the Municipality of Paoay, and the Province of Ilocos Norte in carrying out the mandate of serving your constituents,” said Senator Loren Legarda during the inauguration of the Barangay Sideg Road in Paoay, Ilocos Norte. In this photo, the Senator is joined by residents of Barangay Sideg in Paoay, Ilocos Norte, led by Paoay Mayor Bonifacio Clemente Jr. (seventh from left, on top row), Association of Barangay Captains (ABC) President Jessie Galano (sixth from left, on top row), and Sangguniang Bayan Members. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
