...
<title>Senate spokesperson</title>
...
<!-- AddThis Button END -->
		...
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">SENATE SPOKESPERSON:</span></strong>
		<!-- PhotoCaption.start -->
		Senate Legal Counsel Atty. Maria Valentina Cruz, designated spokesperson of the Senate Impeachment Court, holds a press briefing today, December 13, on the possible schedule of the Impeachment trial against Chief Justice Renato Corona. (PRIB Photo by JOSEPH VIDAL)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
