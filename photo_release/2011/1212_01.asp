...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1212_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">EMPOWERED WOMEN:</span></strong>
		<!-- PhotoCaption.start -->
		Senator Pia Cayetano, Cebu Governor Gwen Garcia, and Rep. Rachel 'Cutie' Del Mar (Cebu City, North District) at the launch of Sen Cayetano's first book, 'My Daily Race,' at the Ayala Center in Cebu City.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
