...
<title>From Mabalacat town to a city</title>
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1020_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">FROM MABALACAT TOWN TO A CITY:</span></strong>
		<!-- PhotoCaption.start -->
		Sen. Lito Lapid, former Pampanga governor, joins Local Government Committee Chairman Sen. Bongbong Marcos in a consultative hearing on a bill converting the Municipality of Mabalacat in the Province of Pampanga into a component city to be known as Mabalacat City on Wednesday, October 19. (PRIB Photo by Albert Calvelo)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
