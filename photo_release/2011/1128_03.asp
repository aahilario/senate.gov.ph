...
<title>Retiring employees recognized</title>
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1128_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">RETIRING EMPLOYEES RECOGNIZED:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile, together with Senate Secretary Emma Lirio Reyes, award Morito Naong from the General Services Department a Certificate of Appreciation for his years of service in the Senate. One of three employees who received the award, Naong is slated to retire from the service by the end of the year. (PRIB Photo by Albert Calvelo)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
