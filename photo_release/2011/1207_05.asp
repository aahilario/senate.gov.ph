...
<title>Judicial and Bar Council members confirmed</title>
...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1207_05.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">JUDICIAL AND BAR COUNCIL MEMBERS CONFIRMED:</span></strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile, chair of the Commission on Appointments (CA), together with CA members Paranaque Representative Roilo Golez and Nueva Ecija Representative Rodolfo Antonino, pose with newly confirmed Judicial and Bar Council members Atty. Ma. Milagros N. Fernan-Cayosa and Atty. Jose V. Mejia after the CA Hearing, Wednesday, December 7, 2011. (PRIB Photo by Albert Calvelo)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
