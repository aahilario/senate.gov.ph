...
<!-- AddThis Button END -->
        ...
        <img src="http://senate.gov.ph/photo_release/2011/1208_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><span class="style2">ANGARA KEYNOTES FORUM ON RENEWABLE ENERGY:</span></strong>
		<!-- PhotoCaption.start -->
		ECCP President Hubert d’Aboville presents Senator Edgardo J. Angara with a special gift as the guest of honor at the recently held forum on renewable energy.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
