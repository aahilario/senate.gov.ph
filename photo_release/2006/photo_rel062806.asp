...
<title>Photo Release - Hospital Visit</title>
...
<td>&nbsp;<a href="http://www.newsenatebuilding.com">Bagong Senado</a></td></tr></table></div></div>
   <table id="container">
      <tr>
         <td id="content">
Photo Release<br />
<!-- PhotoDate.start -->June 28, 2006<!-- PhotoDate.end --><p style="text-align: center;">
<img src="http://senate.gov.ph/photo_release/2006/photo_rel062806.jpg" /></p>
			<p>
<strong>
<!-- PhotoTitle.start -->HOSPITAL VISIT<!-- PhotoTitle.end -->:</strong>
<!-- PhotoCaption.start -->Health and Demography Committee Chair Sen. Pia Cayetano (middle) inspecting facilities at the nursery room of the Northern Mindanao Medical Center in a recent visit to Cagayan de Oro City. She is accompanied by Dr. Patricia Gait (left), Pediatrics Department Head, and Dr. Ma. Evelyn Clarete (right), Medical Center Chief. <!-- PhotoCaption.end -->
			<strong>
<!-- PhotoBy.start -->(Photo courtesy of Joey Nacalaban)<!-- PhotoBy.end -->			</strong></p>
         </td>
<td id="sidepane">
