...
<title>Photo Release - Finance committee hears judiciary budget</title>
...
<td>&nbsp;<a href="http://www.newsenatebuilding.com">Bagong Senado</a></td></tr></table></div></div>
   <table id="container">
      <tr>
         <td id="content">
Photo Release<br />
<!-- PhotoDate.start -->October 6, 2006<!-- PhotoDate.end --><p style="text-align: center;">
<img src="http://senate.gov.ph/photo_release/2006/photo_rel100606.jpg" /></p>
			<p>
<strong>
<!-- PhotoTitle.start -->FINANCE COMMITTEE HEARS JUDICIARY BUDGET<!-- PhotoTitle.end -->:</strong>
<!-- PhotoCaption.start -->Finance committee Chairman Franklin M. Drilon and Justice Committee Chairman Juan Ponce Enrile discussed with judiciary officials the proposed P9.675 billion budget for 2007 that includes a funding to establish more courts in the country. Defending the budget of the judiciary are Court Adm. Christopher Lock, Supreme Court; Justice Teresita de Castro, Sandiganbayan; and Justice Ernesto Acosta, Court of Tax Appeals. <!-- PhotoCaption.end -->
			<strong>
<!-- PhotoBy.start -->(Senate Photo by Joseph Vidal)<!-- PhotoBy.end -->			</strong></p>
         </td>
<td id="sidepane">
