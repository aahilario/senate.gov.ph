...
<title>Photo Release - Senators visit Tagaytay 5 detainees</title>
...
<td>&nbsp;<a href="http://www.newsenatebuilding.com">Bagong Senado</a></td></tr></table></div></div>
   <table id="container">
      <tr>
         <td id="content">
Photo Release<br />
<!-- PhotoDate.start -->August 23, 2006<!-- PhotoDate.end --><p style="text-align: center;">
<img src="http://senate.gov.ph/photo_release/2006/photo_rel082306d.jpg" /></p>
			<p>
<strong>
<!-- PhotoTitle.start -->SENATORS VISIT TAGAYTAY 5 DETAINEES<!-- PhotoTitle.end -->:</strong>
<!-- PhotoCaption.start -->Sens. Ramon Magsaysay (left) and Jamby Madrigal (center) held a dialogue with the Tagaytay 5 detainees at Camp Vicente Lim in Laguna yesterday.  The senators vowed to appeal to President Macapagal-Arroyo to seek an immediate review of the cases filed against them. <!-- PhotoCaption.end -->
</p>
&nbsp;<!-- double release -->
								<hr />
<p style="text-align: center;">
<img src="http://senate.gov.ph/photo_release/2006/photo_rel082306d1.jpg" /></p>
<p>
<!-- PhotoCaption.start -->Senator Ramon Magsaysay Jr., Chairman of the Senate Committee on Agriculture, inspects the detention cell at the Camp Vicente Lim in Laguna where the Tagaytay 5 farmers are confined. <!-- PhotoCaption.end -->
			<strong>
<!-- PhotoBy.start -->(Photos by Albert Calvelo, PRIB)<!-- PhotoBy.end -->
			</strong></p>
</td>
			<td class="sidecell"><div class="header_pane">
Photos 
</div>
