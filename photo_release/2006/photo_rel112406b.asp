...
<title>Photo Release - Discussing issues of common interest</title>
...
<img src="http://senate.gov.ph/photo_release/2006/photo_rel112406b.jpg" /></p>
			<p>
<strong>
<!-- PhotoTitle.start -->DISCUSSING ISSUES OF COMMON INTEREST<!-- PhotoTitle.end -->:</strong>
<!-- PhotoCaption.start -->Senate President Manny Villar (right) discusses with US Ambassador Kristie Kenny a number of issues of common interest to the Philippines and the United States that include further improving the two countries friendly relations during a courtesy call at the Senate Ceremonial Hall. <!-- PhotoCaption.end -->
			<strong>
