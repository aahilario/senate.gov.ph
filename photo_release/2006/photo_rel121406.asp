...
<title>Photo Release - Fundamental issues on Chacha</title>
...
<td>&nbsp;<a href="http://www.newsenatebuilding.com">Bagong Senado</a></td></tr></table></div></div>
   <table id="container">
      <tr>
         <td id="content">
Photo Release<br />
<!-- PhotoDate.start -->December 14, 2006<!-- PhotoDate.end --><p style="text-align: center;">
<img src="photo_rel121406.jpg" /></p>
			<p>
<strong>
<!-- PhotoTitle.start -->FUNDAMENTAL ISSUES ON CHACHA<!-- PhotoTitle.end -->:</strong>
<!-- PhotoCaption.start -->Senator Edgardo J. Angara says the fundamental issues in the proposed amendments to the Constitution should address the change in the government structure that will favor local over the central government and the introduction of provisions that will enable the genuine devolution of authority to local government units.  Speaking during the weekly Kapihan sa Senado, Angara said he prefers the Constitutional Assembly (Con-Ass) instead of the Constitutional Convention (Con-Con) as the better mode to propose amendments to the 1987 Constitution but only after the May 2007 elections. <!-- PhotoCaption.end -->
			<strong>
