...
<title>Photo Release - Cambodian delegation</title>
...
<td>&nbsp;<a href="http://www.newsenatebuilding.com">Bagong Senado</a></td></tr></table></div></div>
   <table id="container">
      <tr>
         <td id="content">
Photo Release<br />
<!-- PhotoDate.start -->August 8, 2006<!-- PhotoDate.end --><p style="text-align: center;">
<img src="http://senate.gov.ph/photo_release/2006/photo_rel080806.jpg" /></p>
			<p>
<strong>
<!-- PhotoTitle.start -->CAMBODIAN DELEGATION<!-- PhotoTitle.end -->:</strong>
<!-- PhotoCaption.start -->Cambodian Senate delegation headed by Senator Chea Cheth (2nd from right) listens intently as Senator Franklin M. Drilon gives a briefing on the workings of the Philippine Senate vis--vis other constitutional organs in the local political setting.  Joining the delegation are (L-R) Country Representative of Konrad-Adenauer Foundation Wolfgang Meyer, Secretary General Oum Sarith, Sen. Kong Korm and Sen. Som Savuth.  The delegation is on a study tour co-organized by the Konrad-Adenauer Foundation. <!-- PhotoCaption.end -->
			<strong>
