...
<title>Photo Release - Solar Power</title>
...
<td>&nbsp;<a href="http://www.newsenatebuilding.com">Bagong Senado</a></td></tr></table></div></div>
   <table id="container">
      <tr>
         <td id="content">
Photo Release<br />
<!-- PhotoDate.start -->November 8, 2006<!-- PhotoDate.end --><p style="text-align: center;">
<img src="http://senate.gov.ph/photo_release/2006/photo_rel110806b.jpg" /></p>
			<p>
<strong>
<!-- PhotoTitle.start -->SOLAR POWER<!-- PhotoTitle.end -->:</strong>
<!-- PhotoCaption.start -->Senate President Manny Villar, president of the Nacionalista Party, enjoys a cup of coffee with model-actress Angel Aquino during the presentation and demonstration of the solar panels (behind them) in front of the Senate building which, apart from other renewable power from the wind and modern biomass, could provide the energy needs of the country.  An environmentalist, Villar is supporting the campaign to promote renewable energy that is derived from sources that are clean, self-generating and beneficial to the environment. <!-- PhotoCaption.end -->
			<strong>
