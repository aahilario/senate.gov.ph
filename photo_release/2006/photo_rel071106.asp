...
<title>Photo Release - Recto, Gary V join forces for Bahay Pag-Asa</title>
...
<td>&nbsp;<a href="http://www.newsenatebuilding.com">Bagong Senado</a></td></tr></table></div></div>
   <table id="container">
      <tr>
         <td id="content">
Photo Release<br />
<!-- PhotoDate.start -->July 11, 2006<!-- PhotoDate.end --><p style="text-align: center;">
<img src="http://senate.gov.ph/photo_release/2006/photo_rel071106.jpg" /></p>
			<p>
<strong>
<!-- PhotoTitle.start -->RECTO, GARY V JOIN FORCES FOR BAHAY PAG-ASA<!-- PhotoTitle.end -->:</strong>
<!-- PhotoCaption.start -->Senator Ralph Recto (3rd from left) hands over to Bro. JJ Gimenez (3rd from right) his initial donation of P250,000 as part of the efforts of the La Salle Greenhills High School (LSGH) Batch 82's fundraising for the benefit of Bahay Pag-Asa, a juvenile rehabilitation center run by the La Salle Brothers.  The LSGH Batch '82 hopes to build another facility similar to the one and only Bahay Pag-Asa Youth Center in Bacolod City for convicted youth offenders of Negros Occidental. Recto presented the check during the batch's "Dekada Otsenta", an 80s party/fundraising event held recently in Rockwell Tent, Makati. Other batch 82 members in photo are, L to R : Reggie Asuncion, Gary Valenciano, Anthony Pangilinan, Luigi Borromeo and Jaco Soler. <!-- PhotoCaption.end -->
			<strong>
