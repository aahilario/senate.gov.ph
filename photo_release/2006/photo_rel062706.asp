...
<title>Photo Release - Liberals tackle migration policy</title>
...
<td>&nbsp;<a href="http://www.newsenatebuilding.com">Bagong Senado</a></td></tr></table></div></div>
   <table id="container">
      <tr>
         <td id="content">
Photo Release<br />
<!-- PhotoDate.start -->June 27, 2006<!-- PhotoDate.end --><p style="text-align: center;">
<img src="http://senate.gov.ph/photo_release/2006/photo_rel062706.jpg" /></p>
			<p>
<strong>
<!-- PhotoTitle.start -->LIBERALS TACKLE MIGRATION POLICY<!-- PhotoTitle.end -->:</strong>
<!-- PhotoCaption.start -->Delegates to the Council of Asian Liberals and Democrats (CALD)-Alliance of Liberals and Democrats for Europe (ALDE)-Liberal International (LI) meeting discussed migration and population policy responses to demographic trends in marathon sessions held at the Philippine International Convention Center (PICC) Thursday (June 22). Photo shows (from left to right) Rep. Nereus Acosta, Liberal Party Secretary-General, Jonas Renze, member, International Federation of Liberal Youth, Hon. Graham Watson, ALDE Leader, and Senate President Frank Drilon, LP President enjoying a turon treat during a coffee break. <!-- PhotoCaption.end -->
			<strong>
<!-- PhotoBy.start -->(Photo by Joseph Vidal, PRIB)<!-- PhotoBy.end -->			</strong></p>
         </td>
<td id="sidepane">
