...
<title>Photo Release - Detained Sabio faces inquiry</title>
...
<td>&nbsp;<a href="http://www.newsenatebuilding.com">Bagong Senado</a></td></tr></table></div></div>
   <table id="container">
      <tr>
         <td id="content">
Photo Release<br />
<!-- PhotoDate.start -->September 14, 2006<!-- PhotoDate.end --><p style="text-align: center;">
<img src="http://senate.gov.ph/photo_release/2006/photo_rel091406.jpg" /></p>
			<p>
<strong>
<!-- PhotoTitle.start -->DETAINED SABIO FACES INQUIRY<!-- PhotoTitle.end -->:</strong>
<!-- PhotoCaption.start -->Senator Richard Gordon (left) asks Presidential Commission on Good Government chair Camilo Sabio to answer questions regarding the alleged loses of government sequestered corporations in todays (Sept.14, 2006) hearing by the Senate Committees on Government Corporations and Public Enterprises and Public Services. <!-- PhotoCaption.end -->
			<strong>
<!-- PhotoBy.start -->(Photo by Alex Nuevaespaa, SENATE PRIB)<!-- PhotoBy.end -->			</strong></p>
         </td>
<td id="sidepane">
