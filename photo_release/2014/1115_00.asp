...
<title>Organic Agri Congress</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 15, 2014<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2014/1115_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->ORGANIC AGRI CONGRESS:</strong>
		<!-- PhotoCaption.start -->	    
		Sen. Cynthia A. Villar, chair of the Senate Agriculture and Food Committee and Agriculture Sec. Proceso Alcala hold huge oranges from organic farming. The senator has been pushing for organic farming as one way to curb malnutrition while protecting the environment and contributing to the overall growth of the agriculture sector. Also in photo are DA Usec. Bernadette Romulo-Puyat and DA Region X1 Director, Remelyn R. Recoter.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
