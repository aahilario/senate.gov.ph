...
<title>Escudero attends flag raising ceremony</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2014/1027_03.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->ESCUDERO ATTENDS FLAG RAISING CEREMONY:</strong>
		<!-- PhotoCaption.start -->	    
		Senator Francis Joseph "Chiz" G. Escudero urges Senate officers and employees to continue their unwavering support and dedication to the institution amid the political turbulence in a message he delivered during Monday's flag raising ceremony. The Senate of the Philippines is currently celebrating its month-long 98th anniversary. (PRIB Photo by Jospeh Vidal/ 27 October 2014) </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
