...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2014/1022_04.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->LEFT BEHIND:</strong>
		<!-- PhotoCaption.start -->	    
		Marc Sueselbeck (center), the German fiancé of slain transgender Jeffrey “Jennifer” Laude, shakes the hand of Mark Clarence "Barbie" Gelviro (left), Laude’s friend and witness, who identified primary suspect US Marines Private First Class Joseph Scott Pemberton before the start of the public hearing on the Senate Committee on Foreign Affairs, Wednesday. Also in photo is Michelle Laude (right), sister of the victim, who stated that Jennifer was not a sex worker. (PRIB Photo by Romeo Bugante / 22 October 2014)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
