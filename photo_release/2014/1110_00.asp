...
<title>Sen Bongbong Marcos joins Taclobeños in remembering Yolanda</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2014/1110_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->SEN BONGBONG MARCOS JOINS TACLOBEÑOS IN REMEMBERING YOLANDA:</strong>
		<!-- PhotoCaption.start -->	    
		Sen.Bongbong Marcos joins the "Sundown Memorial Ceremony" in Tacloban City for the anniversary of the Typhoon Yolanda. The senator, whose mother hails from the said province, is a staunch advocate on the rehabilitation of the areas devastated by Yolanda.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
