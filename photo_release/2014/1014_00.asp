...
<title>Tara na sa LPPCHEA!</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 14, 2014<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2014/1014_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->TARA NA SA LPPCHEA!:</strong>
		<!-- PhotoCaption.start -->	    
		Senator Cynthia A. Villar leads the Tree Planting Coastal Clean-Up activity at the Las Pinas-Paranaque Critical Habitat and Ecotourism Area, included in the Ramsar List of Most Important Wetlands in the world. The senator has been fighting plans to reclaim the remaining mangrove forest in Metro Manila, which serves as shield to storm surge as well as habitat for various migratory birds. Also in photo are rocker Lou Bonnevie and LPPCHEA General Manager Reynaldo Aguinaldo. Aside from Bonnevie who celebrated her birthday through the Sunset Acoustic Jam in LPPCHEA, the famous bands of the early 90s- True Faith and Alamid also belted out their hit songs. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
