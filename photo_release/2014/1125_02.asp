...
<title>Uncertified Christmas Lights</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2014/1125_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->UNCERTIFIED CHRISTMAS LIGHTS:</strong>
		<!-- PhotoCaption.start -->	    
		Senator Bam Aquino (2nd from left) inspects the confiscated uncertified Christmas lights together with (third and fourth from left) Trade Secretary Gregory Domingo and Undersecretary Vic Dimagiba during the destruction of uncertified Christmas lights worth P1.3 million, on Tuesday at the DTI office in Makati City. </p>
		<p>Also in the photo is Jerry Maglalang, officer-in-charge of DTI’s Fair Trade Enforcement Bureau.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
