...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2014/1125_09.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->FINANCE BUDGET: </strong>
		<!-- PhotoCaption.start -->	    
		Senator Serge Osmeña (left), Senate President Pro-Tempore Ralph Recto (center) and Finance Secretary Cesar Purisima (right) discuss the agency’s P14.3 billion proposed budget for 2015 Tuesday, November 25, 2014. (PRIB Photo by Alex Nueva España/25 November 2014).</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
