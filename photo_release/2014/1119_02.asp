...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2014/1119_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->BUDGET DELIBERATIONS:</strong>
		<!-- PhotoCaption.start -->	    
		Budget Secretary Florencio Abad (right) shows Senator Paolo Benigno “Bam” Aquino (left) a copy of the proposed budget of the National Economic and Development Authority (NEDA) during deliberation of the proposed P2.606 trillion national budget for 2015. (PRIB Photo by Romeo Bugante/19 November 2014)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
