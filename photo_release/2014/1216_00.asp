...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 16, 2014<p style="text-align: center;">
		<img src="1216_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->COCONUT LEVY:</strong>
		<!-- PhotoCaption.start -->	    
		Senator Cynthia Villar, chair of the Senate committee on Agriculture and Food Committee, explains the necessity of putting in a trust fund the P100-billion coco levy funds, suggesting to use only its P2 billion to P3 billion interest that would benefit more than 3.5 million coconut farmers. The senator, chair of the Senate committee on Agriculture and Food, initially asked stakeholders on their stand on recommendations to place it in trust fund like investing in government bonds. Senator Ralph Recto sought for an audit of the coco levy funds.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
