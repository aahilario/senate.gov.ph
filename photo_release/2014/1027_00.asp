...
<title>Congress leaders meet US-ASEAN Business Council</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2014/1027_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->CONGRESS LEADERS MEET US-ASEAN BUSINESS COUNCIL:</strong>
		<!-- PhotoCaption.start -->	    
		Senate President Franklin M. Drilon (left) addresses the US-ASEAN Business Council Inc. headed by President and Chief Executive Officer (CEO) Alexander Feldman (middle) during the 2014 Business Mission to the Philippines held at the Manila Peninsula Hotel in Makati City on October 23, 2014, Thursday.  Along with House Speaker Sonny Belmonte Jr. (right), Drilon briefed the council on the priority legislation of the 16th Congress, which includes a package of economic reform measures aimed at improving the Philippines' business climate, boosting foreign investments and ensuring macroeconomic and fiscal sustainability. (PRIB Photo by Cesar Tomambo, October 23, 2014) </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
