...
<title>Drilon welcomes Czech envoy</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 27, 2014<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2014/1027_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->DRILON WELCOMES CZECH ENVOY:</strong>
		<!-- PhotoCaption.start -->	    
		Senate President Franklin M. Drilon presents a token gift to the new Czech Ambassador, Jaroslav Olša, during a courtesy call on October 22, 2014, Wednesday. Olša and Drilon discussed the historical ties between the Czech Republic and the Philippines, particularly the friendship of Dr. Jose Rizal and Dr. Ferdinand Blumentritt, the numerous parliamentary exchanges between the two nations, and as well as the Czech Republic’s renewed focus on the development of the Philippines, especially in areas affected by typhoon Yolanda. The Czech envoy also told Drilon that he will actively support natural conservation programs in the country to be funded by the Czech government, and to promote the Czech Republic as a tourist destination for Filipino tourists. (PRIB Photo by Cesar Tomambo/ October 23, 2014)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
