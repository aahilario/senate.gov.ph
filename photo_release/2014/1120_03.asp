...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2014/1120_03.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->DOJ BUDGET DELIBERATION:</strong>
		<!-- PhotoCaption.start -->	    
		Senator Loren Legarda, chair of the Senate Finance Subcommittee C, presides over the deliberation of the proposed P11.225 billion budget of the Department of Justice (DOJ) and its attached agencies for the year 2015 Thursday, November 20, 2014. (PRIB Photo by Joseph Vidal/20 November 2014) </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
