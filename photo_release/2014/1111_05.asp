...
<title>Legarda Calls for a Risk-Informed Lifestyle</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2014/1111_05.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->LEGARDA CALLS FOR A RISK-INFORMED LIFESTYLE:</strong>
		<!-- PhotoCaption.start -->	    
		Senator Loren Legarda, United Nations Champion for Disaster Risk Reduction and Climate Change Adaptation, calls for “a cultural revolution, for humanity to adapt to a fast changing environment and to adopt a risk-informed lifestyle,” during the Top Leaders Forum 2014, organized by SM Prime and the United Nations Office for DRR (UNISDR). She added that, “this should apply in all aspects of daily life and even for business--in designing a product, in building a structure, and in planning development programs or projects.”</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
