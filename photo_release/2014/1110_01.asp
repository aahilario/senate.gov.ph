...
<title>At the 18th general assembly of ICOMOS in Florence, Italy</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 10, 2014<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2014/1110_01.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->AT THE 18TH GENERAL ASSEMBLY OF ICOMOS IN FLORENCE, ITALY:</strong>
		<!-- PhotoCaption.start -->	    
		Senator Pia S. Cayetano (center) together with (left to right) ICOMOS Philippines president Architect Augusto Villalon, Ms. Darla Villalon, former ambassador to Italy Virgilio Reyes and Claire Vitug, a masteral student of conservation and art restoration at the University of the Philippines.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
