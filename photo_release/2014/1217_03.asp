...
<title>Senate probes MRT mishap</title>
...
<table id="container">
	<tr>
		...
		<img src="1217_03.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->SENATE PROBES MRT MISHAP:</strong>
		<!-- PhotoCaption.start -->	    
		Senator Grace Poe, co-chair of the Senate Committee on Public Services, questions officials of the Department of Transportation and Communication during the continuation of a hearing on an incident in March involving the Metro Rail Transit Line 3 (MRT 3) where several passengers were injured when its driver failed to observe the red light signal at the Guadalupe station. Poe, who rode the MRT after the incident, decried the long queue in MRT stations that the commuting public endures daily, saying that it usually takes 40 minutes to an hour before a commuter can ride the MRT train. (PRIB Photo by Romeo Bugante / 17 December 2014)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
