...
<title>Bgy. Tuburan, Ligao City</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 15, 2014<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2014/1015_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->BGY. TUBURAN, LIGAO CITY:</strong>
		<!-- PhotoCaption.start -->	    
		Sen. Nancy Binay and Ligao City Mayor Patricia Alsua make a surprise visit at the evacuation center in Bgy. Tuburan, Ligao City where twins Andrew and Andrei Bongayan were born. Sen. Binay visited Ligao to personally see the condition of evacuees who were temporarily relocated from barangays within the 7-kilometer Mayon Volcano danger zone. (Photo Credit - Jon Vicencio)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
