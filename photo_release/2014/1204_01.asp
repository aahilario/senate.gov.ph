...
<title>Hearing on Automated Election System</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 4, 2014<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2014/1204_01.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->HEARING ON AUTOMATED ELECTION SYSTEM:</strong>
		<!-- PhotoCaption.start -->	    
		 Senator Aquilino “Koko” Pimentel III (left), chairman of the Senate Committee on Joint Congressional Oversight Committee on Automated Election System, discusses with Commission on Elections (COMELEC) officials on whether  the Precinct Counting Optical Scan (PCOS) machines are complying with the minimum requirements under Republic Act No. 8436, as amended by R.A. No 9369 ( Automated Election System Law ), Thursday, December 04 2014. ( PRIB Photo by Albert Calvelo )</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
