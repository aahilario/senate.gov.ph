...
<title>Barangay Baesa, Quezon City</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2014/1125_01.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->BARANGAY BAESA, QUEZON CITY:</strong>
		<!-- PhotoCaption.start -->	    
		Senate Majority Leader Alan Peter Cayetano hands out financial assistance to families affected by a fire which hit Barangay Baesa, Quezon City last week. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
