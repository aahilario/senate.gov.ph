...
<title>Poster shot with the winners</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 6, 2014<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2014/1206_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->POSTER SHOT WITH THE WINNERS:</strong>
		<!-- PhotoCaption.start -->	    
		Former Senate President Manny Villar, Senator Cynthia Villar, Las Piñas Rep. Mark Villar and GoNegosyo Exec. Dir. Ramon Lopez pose with the raffle draw winners in the 4th OFW and Family Summit at the World Trade Center in Pasay City. The “Big Winner” got a House and Lot from Camella Homes. The other prizes included 10 Sari-sari store pangkabuhayan packages from All Day Convenience store, 2 Kettle Korn Business Karts, and motorcycle from KServico. Minor prizes were also given away.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
