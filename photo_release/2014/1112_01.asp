...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2014/1112_01.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->SMUGGLED MEAT:</strong>
		<!-- PhotoCaption.start -->	    
		Senator Cynthia Villar, chair of the Senate Committee on Agriculture and Food, asks Agriculture Undersecretary Jose Reaño  (right) on report about the entry of smuggled meat in the country during a public hearing Wednesday morning. (PRIB Photo by Cesar Tomambo/12 November 2014).</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
