...
<title>Sen. Bongbong Marcos leads windmill inauguration</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2014/1124_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->SEN. BONGBONG MARCOS LEADS WINDMILL INAUGURATION:</strong>
		<!-- PhotoCaption.start -->	    
		Sen. Bongbong pushes for the increased utilization of renewable energy sources during his speech at the inauguration of North Luzon Renewable Energy Corp.'s 81MW windmill site in Brgy. Caparispisan, Pagudpud, Ilocos Norte.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
