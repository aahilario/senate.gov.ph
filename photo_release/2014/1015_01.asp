...
<title>Sen. Nancy Binay distributes relief goods</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2014/1015_01.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->SEN. NANCY BINAY DISTRIBUTES RELIEF GOODS AT THE EVACUATION CENTER IN BGY. TUBURAN, LIGAO CITY:</strong>
		<!-- PhotoCaption.start -->	    
		Sen. Binay visited Ligao to personally see the condition of evacuees who were temporarily relocated from barangays within the 7-kilometer Mayon Volcano danger zone. With Sen. Binay is Ligao City Mayor Patricia Alsua. (Photo Credit - Jon Vicencio)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
