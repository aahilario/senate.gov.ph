...
<title>Senate checks gov’t performance</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2014/1210_03.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->SENATE CHECKS GOV’T PERFORMANCE:</strong>
		<!-- PhotoCaption.start -->	    
		Senator Chiz Escudero (center), chair of the Senate Committee on Finance, asks officials of the Bureau of Fire Protection to explain the delay in the procurement of fire trucks during a public hearing Wednesday, December 10, 2014. Among those present in the hearing were Finance Secretary Cesar Purisima (left) and Transportation and Communications Secretary Joseph Emilio Abaya (right).  (PRIB Photo by Albert Calvelo/10 December 2014).</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
