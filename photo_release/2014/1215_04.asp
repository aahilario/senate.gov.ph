...
<table id="container">
	<tr>
		...
		<img src="1215_04.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->KIDS SAFETY:</strong>
		<!-- PhotoCaption.start -->	    
		Senator Vicente C. Sotto III wants to ensure the safety of the children as he sponsors a committee report entitled:  “AN ACT TO ENSURE THE SAFETY OF CHILDREN ABOARD TWO-WHEELED MOTORCYCLES TRAVELLING ALONG PUBLIC AND PRIVATE ROADS” (Photo By Ramon Lopez—O/S Sotto)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
