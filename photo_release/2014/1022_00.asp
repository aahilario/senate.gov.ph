...
<title>Drilon welcomes Danish envoy</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2014/1022_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->DRILON WELCOMES DANISH ENVOY:</strong>
		<!-- PhotoCaption.start -->	    
		Senate President Franklin M. Drilon receives the new Danish Ambassador to the Philippines, Jan Top Christensen, during a courtesy call at the Senate on Tuesday, October 21, 2014. Drilon and the Danish envoy discussed the Philippines’ positive investment climate, Denmark’s expertise in renewable energy - particularly in wind farm technologies, and as well as tourism opportunities for the two countries. (PRIB Photo by Joseph Vidal, October 21, 2014) </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
