...
<title>Agro-technology seminar</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 8, 2014<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2014/1208_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->AGRO-TECHNOLOGY SEMINAR:</strong>
		<!-- PhotoCaption.start -->	    
		Senator Cynthia A. Villar, chairperson of the Senate Agriculture and Food Committee, receives a Certificate of Appreciation from SEARCA handed to her by SEARCA Director Dr. Gil Saguiguit, Jr. as UPLB Vice Chancellor of Planning and Development and Incoming UPLB Chancellor Dr. Fernando C. Sanchez Jr. looks on. Villar was the keynote speaker during the SEARCA-Agriculture Development Seminar Series (ADSS) at UP Los Baños, Laguna. She spoke on ‘Agro-Ecology for Sustainable Agriculture and Environment towards Food Security’.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
