...
<title>Senate commends Dr Alonzo Gabriel</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 15, 2014<p style="text-align: center;">
		<img src="1215_05.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->SENATE COMMENDS DR ALONZO GABRIEL:</strong>
		<!-- PhotoCaption.start -->	    
		Senate President Franklin M. Drilon presents a copy of Senate Resolution No. 875 introduced by Senator Manuel “Lito” M. Lapid, commending University of the Philippines (UP) professor and scientist Dr. Alonzo Gabriel (right) for being named as one of the Ten Outstanding Young Persons of the World (TOYP) by the Junior Chamber International (JCI). Gabriel was recognized for his know-how in food science, focusing on food hygiene and nutrition, and for sharing his thoughts and knowledge on proper food preparation to street vendors and mothers.  He is accompanied by Ten Outstanding Young Men (TOYM) Executive Director Larry Cruz (left). (PRIB Photo by Cesar Tomambo/15 December 2014)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
