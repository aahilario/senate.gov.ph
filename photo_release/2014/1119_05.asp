...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2014/1119_05.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->EBOLA GREETING:</strong>
		<!-- PhotoCaption.start -->	    
		Sen. Pia Cayetano with Senate reporters Dindo Matinig, Jeff Antiporda, Marvin Sy and TJ Burgonio doing the ‘Ebola greeting’ during a break at the Senate deliberations on the 2015 proposed national government budget. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
