...
<title>DFA budget approved</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2014/1125_07.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->DFA BUDGET APPROVED:</strong>
		<!-- PhotoCaption.start -->	    
		Senate President Franklin Drilon (left) congratulates Foreign Affairs Secretary Albert del Rosario (right) after the Senate approved the department’s P12.86 million budget for 2015 Tuesday morning, November 25, 2014. (PRIB Photo by Romeo Bugante/ 25 November 2014)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
