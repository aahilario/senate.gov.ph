...
<title>Inquiry on dams along fault lines</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1021_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->INQUIRY ON DAMS ALONG FAULT LINES:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Loren B. Legarda, Chair on Senate Committee on Climate Change with Senator Rodolfo Biazon  listens to Dirctor Renator Solidum of Philippine  Institute of Volcanology and Siesmology (Phivolcs) as he explains the conduciveness of dams against the occurrence of earthquake during the 4th hearing on climate change Wednesday morning. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
