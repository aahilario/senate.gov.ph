...
<title>Housing for movie workers behind the camera</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 13, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2009/1013_05.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->HOUSING FOR MOVIE WORKERS BEHIND THE CAMERA:</strong>
		<!-- PhotoCaption.start -->		 
		Members of Nagkakaisang Manggagawa ng Pelikulang Pilipino (NMPP) cheer as Senate Majority Leader Juan Miguel Zubiri (seated, 2nd from right) hands over the P 2 million Special Allotment Release Order (SARO) to movie director and NMPP President Joel Lamangan (2nd from left) during the simple turn-over ceremony held at Dulcinea in Tomas Morato Avenue, Quezon City on October 13, 2009. The fund is intended for the housing of movie workers behind the camera. Witnessing the rite are showbiz directors (standing, L-R) Kaka Balagtas, Mel Chionglo, Raquel Villavicencio, Tony Cruz, Mark Meily, Rez Cortez, Gil Portes (standing, 2nd from from right), Josie Tagle, Baldo Marro (seated, left) and Maning Borlaza (seated, right).</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
