...
<title>Enrile attends committee hearing reaorganizing the NTC</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1203_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->ENRILE ATTENDS COMMITTEE HEARING REORGANIZING THE NTC:</strong>
		<!-- PhotoCaption.start -->		 
		Senate President Juan Ponce Enrile points out to committee on public services chairman Sen. Bong Revilla the need to reorganize the National Telecommunications Commission (NTC), upon learning that the country’s telecommunications companies still manage to circumvent the rules and regulations set by the commission in its bid to protect the texting public from unfair trade practices. Senator Enrile is the principal sponsor of SB No. 3465, which calls for the reorganization of the National Telecommunications Commission, and defining its powers and functions thereof.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
