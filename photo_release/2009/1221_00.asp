...
<title>Sec. Reyes Receives Donation</title>
...
<table id="container">
	<tr>
		...
		<img src="1221_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->SEC. REYES RECEIVES DONATION:</strong>
		<!-- PhotoCaption.start -->		 
		Senate Secretary Emma Lirio Reyes receives a donation of 24 sets of desktop computers from the Honorable LIM In Gyu, Deputy Secretary General of the National Assembly of Korea. This donation is intended to strengthen the state of Information Technology of the Secretariat of the Philippine Senate. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
