...
<title>Thanksgiving rally</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 14, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="1214_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->THANKSGIVING RALLY:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Alan Peter "Compañero" S. Cayetano at a thanksgiving Rally for Senate’s Passage on second reading of Senate Bill 3308 (Freedom of Information Act); Support for further Action.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
