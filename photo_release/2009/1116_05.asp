...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 16, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2009/1116_05.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->SARO FOR KALINGA:</strong>
		<!-- PhotoCaption.start -->		 
		 Senate Majority Leader Juan Miguel Zibiri (seated, center) pose for photo opportunity with Kalinga Vice Governor Jocel Baac (seated right) after the distribution of P500,000 Special Allotment Release Order (SARO) to (not in order) Rizal, Kalinga Mayor Chris Mark Dela Cruz, Tabuk, Kalinga Mayor Camilo Lammawin Jr., Lubuagan, Kalinga Mayor James Alunday, Balbalan, Kalinga Mayor Jesse Mangaoang, Tanudan, Kalinga Mayor Rhustom Dagadag, Panukpuk, Kalinga Mayor Irving Dasayon (not in photo),  Tinglayan, Kalinga Mayor Johnny Maymaya (P600,000) and Pasil, Kalinga Mayor James Edubba (P600,000) held on October 27, 2009 at Emerald Garden in Manila. The funds are intended for the construction/rehabilitation of classroom buildings, day care centers, health centers and multi-purpose buildings.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
