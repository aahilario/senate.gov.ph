...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1013_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->PNRC MEDICAL TENT:</strong>
		<!-- PhotoCaption.start -->		 
		Philippine National Red Cross (PNRC) Chairman Senator Richard J. Gordon visits the first PNRC Medical Station set up at the PhilSport Arena (formerly known as Ultra Stadium) to prevent spread of diseases in the evacuation centers. Gordon said manageable diseases or cases can be treated at the medical station, which can accommodate 100 patients. Since it started operation, some 50 patients have already sought treatment at the station. Their ailments included upper respiratory tract infection, pneumonia, wounds, diarrhea, skin infection such as athlete’s foot, and an isolated case of suspected dengue fever.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
