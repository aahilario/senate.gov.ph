...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1019_04.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->TYPHOON VICTIMS:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Loren B. Legarda warmly welcomed by residents during her visit and occular inspection along the  Laguna de Bay Saturday morning.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
