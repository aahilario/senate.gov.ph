...
<title>Non-stop relief ops</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1008_02.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->NON-STOP RELIEF OPS:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Bong Revilla continues to reach out to the victims of typhoon “Ondoy” as shown in this photo, with Quezon City Vice-Mayor Herbert Bautista at Brgy. Capri, Novaliches, Quezon City . Revilla has been actively involved in relief operations throughout the severely flooded areas in the NCR and the provinces.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
