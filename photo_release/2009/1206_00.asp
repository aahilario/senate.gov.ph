...
<title>Voice call costs reduced</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 06, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2009/1206_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->VOICE CALL COSTS REDUCED:</strong>
		<!-- PhotoCaption.start -->		 
		Senate President Juan Ponce Enrile announces in a press conference at the National Telecommunications Commission the reduction of all domestic voice calls for cellular phone users, which will start on Dec. 6.  It was Enrile who first raised the issue of “vanishing load” affecting not only himself but also millions of subscribers. With the Senate President is NTC Commissioner Gamaliel Cordoba.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
