...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1029_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->CAVITE COALITION:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Manny Villar (right) of the Nacionalista Party and Cavite Rep. Jesus "Boying" Remulla (left) of Partido Magdalo, the dominant political party in the province with a reputation of ensuring poll victoryto its presidential bet, seal their alliance during the local party's convention in Kawit attended by 5, 000 leaders. Cavite has a voting population of 1.6 million, making it a crucial battleground for national contenders.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
