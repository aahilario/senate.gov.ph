...
<title>Pangilinans and Aquino support GK</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1012_05.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->PANGILINANS AND AQUINO SUPPORT GK:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Noynoy Aquino in a playful moment with Senator Francis "Kiko" Pangilinan and Megastar Sharon Cuneta's daughter Frankie Pangilinan. Senator Aquino and Senator Francis Pangilinan showed their support for Gawad Kalinga and their relief operations for typhoon Ondoy victims.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
