...
<title>Fire &amp; Rescue Truck and Firehouse</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 20, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2009/1020_02.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->FIRE &AMP; RESCUE TRUCK AND FIREHOUSE FOR VILLAGE EAST, CAINTA, RIZAL:</strong>
		<!-- PhotoCaption.start -->		 
		 Senate Majority Leader Juan Miguel Zubiri (4th from right) hands-over the P2 M Special Allotment Release Order (SARO) to Cainta, Rizal Mayor Mon Ilagan (4th from left) and Village East Homeoewners Association Incorporated (VEHAI) President Dondie Prats (center) intended for the purchase of fire & rescue truck and firehouse for the said village in a simple turn-over ceremony held at the VEHAI clubhouse on October 19, 2009. Witnessing the rite are (l-r)  SK President Carlo Prats, Councilor Pia Velasco, Councilor Gino Alcantara, Board Member Bobby Tolentino, Board Member Arlyn Villamayor and  Bureau of Fire Marshall Major Arturo Marcos.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
