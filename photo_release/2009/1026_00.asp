...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 26, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2009/1026_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->SEND IN THE CROWD:</strong>
		<!-- PhotoCaption.start -->		 
		Hundreds of flood-stricken residents of Lucao flock outside Stadia, the 1st class multi-purpose facility in Dagupan City, to receive relief goods from Senator Bong Revilla. Dagupan Mayor Alipio Fernandez Jr. (at the senator’s left) assisted Revilla in the distribution of relief goods as part of latter’s “Kaagapay sa Araw ng Pangangailangan” (KAP) humanitarian mission in typhoon-devastated areas in Northern Luzon.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
