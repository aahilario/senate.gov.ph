...
<title>First Joint Session</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1210_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->FIRST JOINT SESSION:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Alan Peter "Compañero" S. Cayetano converses with fellow lawmakers during the break of the first joint session of the Congress.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
