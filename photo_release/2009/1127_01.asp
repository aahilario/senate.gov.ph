...
<title>Breakfast with Media at Danarra Hotel</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1127_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->BREAKFAST WITH MEDIA AT DANARRA HOTEL:</strong>
		<!-- PhotoCaption.start -->		 
		Senate President Juan Ponce Enrile, together with Hon. Jesus Arranza (left), president of the Federation of Philippine Industries, and Sonny Casulla (right), vice president for internal affairs of the Liga ng mga Brodkaster sa Pilipinas and, answers questions given by members of media in a press conference held this morning at the Danarra Hotel in Quezon City.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
