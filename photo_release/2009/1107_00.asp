...
<title>Oath as new Liberals</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1107_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->OATH AS NEW LIBERALS:</strong>
		<!-- PhotoCaption.start -->		 
		Pangasinan Rep. Victor Agbayani and  other local officials of Pangasinan take their oath as new Liberals before Liberal Party President Sen. Mar Roxas, as LP Standard-Bearer Sen. Benigno "Noynoy" Aquino III looks on. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
