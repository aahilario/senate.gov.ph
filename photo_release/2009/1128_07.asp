...
<title>St. Ignatius Church, Camp Aquinaldo</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1128_07.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->ST. IGNATIUS CHURCH, CAMP AQUINALDO:</strong>
		<!-- PhotoCaption.start -->		 
		Nacionalista Party President Senator Manny Villar and Col Ariel Querubin with daughter Faye and wife Mariflor while singing the Lord's Prayer during the special mass for Col. Querubin as he retires from the military service to join the NP senatorial slate at St. Ignatius Church inside the Camp Aquinaldo.   </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
