...
<title>Pia with fisherfolk kids in La Union</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 22, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2009/1122_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->PIA WITH FISHERFOLK KIDS IN LA UNION:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Pia S. Cayetano (middle) shares a light moment with children at the Fishermen's Village housing project in Brgy. Poro, San Fernando City, La Union. Cayetano visited La Union over the weekend to lead medical missions and get an update on the situation of flooding victims from typhoon Pepeng last month.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
