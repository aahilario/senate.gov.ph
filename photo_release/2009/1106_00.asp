...
<title>Clean up operation</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 6, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2009/1106_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->CLEAN UP OPERATION:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Loren B. Legarda, Chair of Senate Committee on climate change led the cleaning up of Marilao-Meycauayan-Obando riverside to prevent floodings during a repeat of typhoons like Ondoy and Pepeng during the Public Hearing on site in Bulacan friday morning.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
