...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1116_04.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->SARO FOR NUEVA ECIJA FEDERATION OF FARMERS ASSOCIATION, INCORPORATED (NEFFAI):</strong>
		<!-- PhotoCaption.start -->		 
		 Majority Leader Juan Miguel Zubiri (5th from left) hands over the P500,000 Special Allotment Release Order (SARO) to Sto. Domingo, Nueva Ecija Mayor Marvin Pariñas (3rd from left) intended for the Nueva Ecija Federation of Farmers Association, Incorporated (NEFFAI) during the simple turn-over on November 14, 2009 at the covered court of Sto. Domingo, Nueva Ecija municipal ground. Witnessing the rites are (L-R) NEFFAI President Conrado Virtucio, Sto Domingo Municipal Consultant Monico Delgado, Zaragosa, Nueva Ejica Mayor Lydia Pagaduan, NEFFAI Business Management Committee member Engineer Eugenio Ramirez, Former 1st District Representative Josie Joson and Guimba, Nueva Ecija Mayor Jose Francis Steven Dizon.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
