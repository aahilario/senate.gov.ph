...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 24, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="../2009/1224_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->RELIEF GOODS:</strong>
		<!-- PhotoCaption.start -->
		 Liberal Standard-Bearers Senators Noynoy Aquino and Mar Roxas distribute relief goods to residents of Albay who were displaced by the impending eruption of Mayon Volcano. Aquino and Roxas went to Legaspi City, Albay on Tuesday to visit and check on the condition of evacuees. Together with Aquino and Roxas is Albay Gov. Joey Salceda.
  </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
