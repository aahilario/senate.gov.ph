...
<title>Fight Climate Change</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 15, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2009/1015_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->FIGHT CLIMATE CHANGE:</strong>
		<!-- PhotoCaption.start -->		 
		Sen. Loren Legarda, (L) Chair senate oversight committee on climate change, confer with Amb. Alistair MacDonald head of Delegation of the European Commission to the Phils., on the the climate change Forum entitled "Fight Climate Change" that aims to deepen the understanding on the impact of climate change on the phils., and further engage the senate, House of Representatives and non- governmental organization on shaping public policy to anddress these impact. Oct. 13, 2009.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
