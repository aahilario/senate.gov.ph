...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1208_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->FOI BILL:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Alan Peter "Compeñero" S. Cayetano (c) discusses the passage on second reading of the FOI bill with Senator Aquilino Pimentel  (L) and Senator Juan Miguel Zubiri (r).</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
