...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1104_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->ON SITE HEARING:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Loren B. Legarda, Chair on Senate Committee on climate change huddles with residents who are still in flood caused by typhoons in Sitio Bayside in Sta. Cruz Laguna  Wednesday morning.  Legarda led the on site hearing with Senator Pia Cayetano and 4th district representative Egay San Luis on how to save the lake and prevent further flooding. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
