...
<title>P25-M worth of donation</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 08, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2009/1008_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->P25-M WORTH OF DONATION:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Richard J. Gordon (Ind) receives around P25-million worth of goods, the largest foreign donation to the Philippine National Red Cross (PNRC). The assistance from the International Federation of the Red Cross (IFRC) and its members such as American, Netherlands, Luxembourg, Finish, German, and Japan Red Cross societies and coursed through the IFRC’s Asia Pacific Zone regional logistic unit based in Kuala Lumpur, Malaysia arrived at the Ninoy Aquino International Airport (NAIA) late Monday afternoon. Gordon said the donation will benefit 10,000 families affected by tropical storm Ondoy.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
