...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1016_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->COMELEC COMMISSIONER CONFIRMED:</strong>
		<!-- PhotoCaption.start -->		 
		Senate President Juan shakes the hand of confirmed Comelec Commissioner Elias Yusoph (right) after the Commission on Appointments (CA) hearing on October 14, Wednesday. Also in photo is House Majority Leader Eduardo Zialcita.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
