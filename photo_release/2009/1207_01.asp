...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1207_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->BUDGET DELIBERATIONS:</strong>
		<!-- PhotoCaption.start -->		 
		Senate President Juan Ponce Enrile listens to Sen. Edgardo Angara, chairman of the committee on finance, during today's budget deliberations for the Department of Energy.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
