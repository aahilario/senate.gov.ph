...
<title>Nobody, Nobody But Bong</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1026_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->NOBODY, NOBODY BUT BONG:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Bong Revilla somehow eases the pain of flood-stricken residents of Brgy. Poblacion, Villasis, Pangasinan as he gamely dances in front of them during his recent Kaagapay sa Araw ng Pangangailangan (KAP) relief operation in the said town.  </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
