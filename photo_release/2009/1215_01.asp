...
<title>Bacolod City Hall Press Corps</title>
...
<table id="container">
	<tr>
		...
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->BACOLOD CITY HALL PRESS CORPS:</strong>
		<!-- PhotoCaption.start -->		 
		Journalists representing the Bacolod City Hall Press Corps ask Senate President Juan Ponce Enrile about his views on martial law and the Maguindanao massacre during last week’s courtesy call at the Senate. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
