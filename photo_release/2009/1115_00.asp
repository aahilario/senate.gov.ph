...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 15, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2009/1115_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->KALIKASAN AWARDEE:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Loren B. Legarda, UN regional champion for climate change adaption for climate change adaption in Asia-Pacific received a award "Kalikasan award" from Dr. Ceasar Demayo, president of Philippine Society for the Study of Nature (PSSN)for her "valuable efforts" in saving and promoting the environment held in Iligan city.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
