...
<title>Unrepentant Telcos</title>
...
<table id="container">
	<tr>
		...
		<img src="1221_02.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->UNREPENTANT TELCOS:</strong>
		<!-- PhotoCaption.start -->		 
		Senate President Juan Ponce Enrile gives Atty. Roy Ibay, SMART Communications senior manager for regional affairs (left), and Atty. William Pamintuan, senior vice president and legal counsel for Digitel Mobile Philippines (right), and representatives of other telecommunications companies a dressing down during today’s joint public hearing of the committees on trade and commerce and public services. Enrile directed the two committees to conduct an inquiry into the nefarious activities committed by the Telcos against their subscribers, in violation of their respective franchises.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
