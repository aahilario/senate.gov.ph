...
<title>A portrait of the Senate President</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1123_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->A PORTRAIT OF THE SENATE PRESIDENT:</strong>
		<!-- PhotoCaption.start -->		 
		Senate President Juan Ponce Enrile recieves a portrait painting of himself from Chinese Chairman of the People's Political Consultative Conference of China Jia Quinglin during a dinner and courtesy call held in Sofitel Hotel, Pasay City last week.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
