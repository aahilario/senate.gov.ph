...
<title>Plaque of appreciation</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1021_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->PLAQUE OF APPRECIATION:</strong>
		<!-- PhotoCaption.start -->		 
		Senate President Juan Ponce Enrile receives a plaque of appreciation from Mayor Sonia Torres-Aquino (center) and Vice Mayor Julius Caesar Platon II (right), during the formal launching of the Motorcycle Repair and Maintenance Program of Honda Foundation, Inc. at the Brgy. Balele gymnasium in Tanauan City, Batangas. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
