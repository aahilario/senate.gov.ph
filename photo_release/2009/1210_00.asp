...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 10, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2009/1210_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->JOINT SESSION:</strong>
		<!-- PhotoCaption.start -->		 
		Senate President Juan Ponce Enrile together with House Speaker Prospero Nograles preside over the joint session at the House of Representatives. Congress is deliberating on the constitutionality of President Arroyo’s declaration of martial law. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
