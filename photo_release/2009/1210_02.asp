...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1210_02.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->"T-E-C-H-E-R":</strong>
		<!-- PhotoCaption.start -->		 
		Senator Alan Peter "Compañero" S. Cayetano points out during the DepEd budget hearing the misspelling of the word "teacher" into "T-E-C-H-E-R" in the notebooks distributed by the Local School Board of Taguig.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
