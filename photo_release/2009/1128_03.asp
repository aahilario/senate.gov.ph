...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1128_03.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->NEWLY MEMBER:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Loren B. Legarda with Rep. Jack Duavit (NPC Sec-Gen.) congratulated Mr. Ahong Chan as new member of Nationalist People's Coalition (NPC) during the ceremonial oath held in Quezon City Saturday morning.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
