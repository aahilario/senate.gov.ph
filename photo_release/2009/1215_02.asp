...
<title>Senate President ends joint session</title>
...
<table id="container">
	<tr>
		...
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->SENATE PRESIDENT ENDS JOINT SESSION:</strong>
		<!-- PhotoCaption.start -->		 
		Senate President Juan Ponce Enrile and Speaker Prospero Nograles end deliberations on the legality of the proclamation of Martial Law in Maguindanao on the last day of the joint session at the House of Representatives.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
