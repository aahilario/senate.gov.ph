...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1214_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->GUEST OF HONOR:</strong>
		<!-- PhotoCaption.start -->		 
		Senate President Juan Ponce Enrile draws the first lucky winner of a laptop computer, one of several gifts raffled off during today’s flag ceremony at the Senate grounds.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
