...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 16, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2009/1016_02.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->CLIMATE CHANGE HEARING:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Loren B. Legarda listens to Department of Environment and Natural Resources (DENR)  Secretary Lito Atienza (left) and Laguna Lake Development Authority (LLDA) General Manager Edgardo Manda as they show the map of  the Pasig River, Marikina River, Mangahan floodway and Laguna De Bay before the Senate Hearing of Climate Change Friday morning. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
