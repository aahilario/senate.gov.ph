...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1116_03.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->SARO FOR NUEVA ECIJA FEDERATION OF FARMERS ASSOCIATION, INCORPORATED (NEFFAI):</strong>
		<!-- PhotoCaption.start -->		 
		 Majority Leader Juan Miguel Zubiri delivers his speech to members of the Nueva Ecija Federation of Farmers Association, Incorporated (NEFFAI) during the distribution of Special Allotment Release Order (SARO) worth P500,000 on November 14, 2009 at the covered court of Sto Domingo, Nueva Ecija municipal grounds.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
