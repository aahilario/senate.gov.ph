...
<title>Gordon at VFP regional assembly</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 09, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2009/1209_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->GORDON AT VFP REGIONAL ASSEMBLY:</strong>
		<!-- PhotoCaption.start -->		 
		 Sen. Richard J. Gordon (Ind.) receives a warm welcome from the members and leaders of the Veterans Federation of the Philippines at the VFP regional assembly held at the Tolentino Sports Activity Center in Tagaytay City. Gordon is the guest of honor and speaker. Gordon is author of the Veterans Equity Law, which paved the way for the inclusion of the Filipino veterans’ benefit package in the American Recovery and Reinvestment Act of 2009.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
