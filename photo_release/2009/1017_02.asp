...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1017_02.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->OCCULAR INSPECTION:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Loren B. Legarda talks to the typhoon victims  during her visit in Lupang Arenda in Taytay Rizal,  Saturday morning. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
