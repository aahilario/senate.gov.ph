...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1012_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->LINGKOD LOREN:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Loren B. Legarda joined her staffs in repacking goods to be distributed to the typhoon victims in Pangasinan. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
