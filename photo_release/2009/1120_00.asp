...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 20, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2009/1120_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->LDP FOR LOREN:</strong>
		<!-- PhotoCaption.start -->		 
		The Laban ng Demokratikong Pilipino (LDP) headed by  Sen. Edgardo Angara formally endorsed their vice presidential candidacy of Senator Loren B. Legarda during the  LDP national executive council meeting held in Manila Hotel. Also in photo  are Governors Sally Perez and Bellaflor  Angara-Castillo.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
