...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1125_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->OCCULAR INSPECTION:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Loren B. Legarda, Chair of Senate Committee on Climate Change conducted an on-site inspection of San Roque Dam in San Manuel, Pangasinan with Tom Valdez of San Roque Power Corp. whose release of water during typhoonsOndoy and Pepeng had been blamed by local officials for the floods that devastated the province.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
