...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1105_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->STILL FLOODED:</strong>
		<!-- PhotoCaption.start -->		 
		Sen. Pia Cayetano, Social Justice Committee Chair, converses with one of the families affected by flooding in a farming community in Brgy. Gatid, Sta. Cruz, Laguna where the Climate Change Committee recently held an on-site inquiry on the devastation caused by typhoon Ondoy.  </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
