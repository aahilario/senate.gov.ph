...
<title>The aid must go on</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1022_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->THE AID MUST GO ON:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Bong Revilla extends relief assistance to the residents of Brgy. Bacnar in San Carlos City, Pangasinan, one of the most severely flooded barangays in the said city. The Senator has continuously been doing his Kaagapay sa Araw ng Pangangailangan (KAP) relief operations in areas hit by the recent typhoons.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
