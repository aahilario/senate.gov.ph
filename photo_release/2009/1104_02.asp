...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 4, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2009/1104_02.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->ON SITE HEARING:</strong>
		<!-- PhotoCaption.start -->		 
		The senate Committee on Climate Change chair by Sen. Loren Legarda,with Laguna 4th dist. Rep. Egay San Luis (in Yellow) ,local officials and  residents, joined her on an occular inspection on still flooded road of Sitio Bayside road, Brgy-1 & 2, Gahid Sta Cruz Laguna, at a public hearing to look on into the shallow of Laguna de Bay, causing the recent destructive floods, and how to save the lake and prevent further flooding,  Sta. Cruz , Laguna, Nov. 04, 2009, </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
