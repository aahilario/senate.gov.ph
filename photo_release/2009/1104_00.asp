...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1104_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->KAPIHAN SA SENADO:</strong>
		<!-- PhotoCaption.start -->		 
		Guest speaker Sen. Francis “Chiz” Escudero answers questions from the media during the weekly Kapihan sa Senado. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
