...
<title>Climate Change Law</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 23, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2009/1023_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->CLIMATE CHANGE LAW:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Loren B. Legarda author and sponsor of the Climate Change Act of 2009 with Senate President Juan Ponce Enrile,  witnessed the signing into law of the landmark legislation by President Gloria Macapagal Arroyo in Rizal Hall, Malacanang Palace Friday morning. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
