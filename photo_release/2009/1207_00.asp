...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 07, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2009/1207_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->GUEST SPEAKER:</strong>
		<!-- PhotoCaption.start -->		 
		Senate Secretary Atty. Emma Lirio-Reyes gives a certificate of appreciation to Atty. Emilio Gonzales III, Deputy Ombudsman for  the Military and Other Law Enforcement Offices (MOLEO), for being the guest speaker during Monday’s flag raising ceremony.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
