...
<title>Senate tackles issues on Martial Law</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1208_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->SENATE TACKLES ISSUES ON MARTIAL LAW:</strong>
		<!-- PhotoCaption.start -->		 
		Senate President Juan Ponce Enrile explains the intricacies of martial law during his speech before today’s start of budget deliberations while Senate Majority Floor Leader Juan Miguel Zubiri look on. The Senate is preparing for the joint committee meeting tomorrow at the House of Representatives, where both houses of Congress will tackle Proclamation 1959, declaring martial law in the province of Maguindanao.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
