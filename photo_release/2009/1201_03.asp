...
<title>MBV with Willie and Dolphy</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1201_03.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->MBV WITH WILLIE AND DOLPHY:</strong>
		<!-- PhotoCaption.start -->		 
		King of comedy Dolphy (right) and Wowowee host Willie Revillame (left) raise the hand of their presidential choice, Nacionalista Party standard bearer, Sen. Manny Villar Jr., during the proclamation on Sunday in Moriones, Tondo, of the senatorial candidates that Nacionalista Party will field in the 2010 elections.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
