...
<title>Senate President during a light moment</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1109_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->SENATE PRESIDENT DURING A LIGHT MOMENT:</strong>
		<!-- PhotoCaption.start -->		 
		Senate President Juan Ponce Enrile shares a light moment with PCIJ’s Malu Mangahas and Senate Majority Leader Juan Miguel Zubiri. Mangahas presents the senators with a copy of the Freedom of Info Act, as mandated by the 1987 Constitution. The Senate has only 23 session days left to pass its version of this law before it adjourns for the May 2010 elections.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
