...
<title>College Debate Competition</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1016_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->COLLEGE DEBATE COMPETITION:</strong>
		<!-- PhotoCaption.start -->		 
		Senate President Juan Ponce Enrile congratulates the champions from the Polytechnic University of the Philippines (PUP) for winning the first Senate College Debate Competition held last October 14, Wednesday, at the Senate of the Philippines. Also in photo is Sen. Aquilino Pimentel Jr.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
