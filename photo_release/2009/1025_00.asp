...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 25, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2009/1025_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->FEEDING PROGRAM:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Loren B. Legarda led the feeding of lugaw to the children residing in Gawad Kalinga in Calauan Laguna Sunday morning. Legarda also delivered a message on the celebration of Senior Citizen day.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
