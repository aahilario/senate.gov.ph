...
<title>Enrile speaks to Senate employees</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1012_03.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->ENRILE SPEAKS TO SENATE EMPLOYEES AT WEEKLY FLAG CEREMONY:</strong>
		<!-- PhotoCaption.start -->		 
		Guest speaker Senate President Juan Ponce Enrile commends Senate staff and employees for their selfless assistance extended to victims of typhoons Ondoy and Pepeng during the weekly flag ceremony held at the Senate grounds.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
