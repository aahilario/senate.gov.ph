...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 9, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2009/1109_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->BIKE ON, BIKE OFF:</strong>
		<!-- PhotoCaption.start -->		 
		Sen. Pia S. Cayetano joins cycling enthusiasts and environmentalists in the inauguration of the Light Rail Transit's "Bike on, Bike off" system. The program encourages LRT commuters to bring their folding bicycles to work as a form of exercise and to help reduce pollution in the metropolis. The launching was also graced by LRT Administrator Mel Robles and Environment Sec. Lito Atienza.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
