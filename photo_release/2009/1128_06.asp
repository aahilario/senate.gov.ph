...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1128_06.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->NP OATH TAKING:</strong>
		<!-- PhotoCaption.start -->		 
		Nacionalista Party President Senator Manny Villar administer the oath of Iloilo 4th District Incumbent and aspiring mayors at Hotel Del Rio in Iloilo City.  From left to right, Anilao Mayor Matet Debuque, Banotac Nuevo Mayor Hernan Biron, Sr., Dumangas Mayor Ronaldo Golez, running for Banate mayor Renerose Caborubias, Dingle Mayor Rufino Palabrica, San Enrique Mayor Trixie Fernandez, running for Passi mayor Hope Lapating and Duenas Mayor Robert Pama.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
