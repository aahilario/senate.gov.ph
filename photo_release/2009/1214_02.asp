...
<table id="container">
	<tr>
		...
		<img src="1214_02.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->MAKABAYAN:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Loren Legarda with Sen. Manny Villar, Rep. Satur Ocampo, and Rep Liza Maza, at Quezon City Sports Club. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
