...
<title>Women as agents of climate change action</title>
...
<table id="container">
	<tr>
		...
		<img src="1218_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->WOMEN AS AGENTS OF CLIMATE CHANGE:</strong>
		<!-- PhotoCaption.start -->		 
		Senator Loren Legarda, United Nations' champion for disaster risk reduction and climate change adaptation for Asia Pacific, and Finland President Tarja Halonen issue a joint call on world leaders to adopt gender-sensitive and gender-responsive policies and programs during the United Nations Conference on Climate Change in Copenhagen.  Women are most vulnerable to climate change impacts.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
