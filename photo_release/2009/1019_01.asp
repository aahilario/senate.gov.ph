...
<title>Gordon Inspects Collapsed Dikes</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1019_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->GORDON INSPECTS COLLAPSED DIKES:</strong>
		<!-- PhotoCaption.start -->		 
		Philippine National Red Cross (PNRC) Chairman Senator Richard J. Gordon inspects the collapsed Lipay Villasis dikes in Barangay Lipay Villasis, Pangasinan. The dikes were destroyed when Agno River overflowed and triggered massive floods after major dams in Northern Luzon have released water before super-typhoon “Pepeng” hit the province. Also in photo areVillasis Mayor Nonato Abrenica, board member Alfie Bince and Brgy Chairman Cesar Manangan.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
