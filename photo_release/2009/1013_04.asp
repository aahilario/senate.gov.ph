...
<title>Pledged of support</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2009/1013_04.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->PLEDGED OF SUPPORT:</strong>
		<!-- PhotoCaption.start -->		 
		Sen. Mar Roxas and actor Dennis Padilla flash the “Laban” after a luncheon at the Balay headquarters of the Aquino- Roxas campaign. Padilla pledged to campaign for Liberal Party standard bearers Senators Noynoy Aquino and Mar Roxas for the 2010 national elections.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
