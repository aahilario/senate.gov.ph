...
<title>Pia leads 'Bicycle-cade' to file CoC at Comelec</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 30, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2009/1130_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->PIA LEADS 'BICYCLE-CADE' TO FILE COC AT COMELEC:</strong>
		<!-- PhotoCaption.start -->		 
		Veering from traditional motorcades to stress her advocacies on the environment, health and women empowerment, Senator Pia S. Cayetano (holding Certificate of Candidacy) leads 100 "Pinay In Action" bikers to the Commission on Elections (Comelec) from the Mall of Asia in Pasay City to file her bid for reelection.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
