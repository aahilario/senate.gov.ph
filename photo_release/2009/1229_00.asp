...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 29, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="../2009/1229_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->GUEST OF HONOR:</strong>
		<!-- PhotoCaption.start -->
		 Senate President Juan Ponce Enrile congratulates the newly inducted board members and chapter officers of the Real Estate Broker's Association of the Philippines (REBAP). Enrile was the guest of honor at REBAP's 31st National Board and Chapter Officer's annual general assembly, which was recently held at the Quezon City Sports Club. (Photo by Joe Arazas)  </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
