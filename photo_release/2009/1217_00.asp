...
<title>Kapihan with the Senate President</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 17, 2009<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="1217_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start --><!-- PhotoTitle.end -->KAPIHAN WITH THE SENATE PRESIDENT:</strong>
		<!-- PhotoCaption.start -->		 
		Senate President Juan Ponce Enrile answer questions from the media at the weekly Kapihan sa Senado regarding the COMELEC’s preparations for the May 2010 national and local elections. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
