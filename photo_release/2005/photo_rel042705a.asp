...
<title>Photo Release - Sentinel of Freedom</title>
...
<td>&nbsp;<a href="http://www.newsenatebuilding.com">Bagong Senado</a></td></tr></table></div></div>
   <table id="container">
      <tr>
         <td id="content">
Photo Release<br />
<!-- PhotoDate.start -->April 27, 2005<!-- PhotoDate.end --><p style="text-align: center;">
<img src="http://senate.gov.ph/photo_release/2005/photo_rel042705a.jpg" />
			<p><strong>
<!-- PhotoTitle.start -->SENTINEL OF FREEDOM<!-- PhotoTitle.end --></strong>
<strong>
:</strong>
<!-- PhotoCaption.start -->Senate President 
					Franklin M. Drilon leads the unveiling of the Lapu-Lapu 
					monument, a symbol of freedom for the Filipino people, at 
					the Agrifina Circle on T.M. Kalaw St., Manila.&nbsp; Datu Lapu-Lapu, who once ruled the island of Cebu, 
					fought Spanish conquistadores led by Ferdinand Magellan 
					centuries ago.&nbsp; With the Senate President are Senators 
					Richard Gordon (2nd from right) and Edgardo Angara (4th from 
					left), Korean Embassy Consul General Shin Gil-Sou (3rd from 
					left), Tourism Undersecretary Oscar Palabyab (extreme left) 
					and some DOT officials.<!-- PhotoCaption.end -->
			<strong>
<!-- PhotoBy.start -->(Senate Photo by Albert Calvelo, PRIB)<!-- PhotoBy.end -->
			</strong></p>
         </td>
<td id="sidepane">
