...
<title>Photo Release - Unicef Cheif Lauds Philippines</title>
...
<td>&nbsp;<a href="http://www.newsenatebuilding.com">Bagong Senado</a></td></tr></table></div></div>
   <table id="container">
      <tr>
         <td id="content">
Photo Release<br />
<!-- PhotoDate.start -->April 5, 2005<!-- PhotoDate.end --><p style="text-align: center;">
<img src="http://senate.gov.ph/photo_release/2005/photo_rel040505.jpg" /></p>
			<p>
<strong>
<!-- PhotoTitle.start -->UNICEF CHIEF LAUDS PHILIPPINES<!-- PhotoTitle.end --></strong>
<strong>
:</strong>
<!-- PhotoCaption.start -->United Nations Childrens Fund (UNICEF) Executive Director Carol Bellamy (left) acknowledged the Philippines in her speech at the 112th General Assembly the Inter-Parliamentary Union (IPU) as impressive for having an anti-trafficking law. Bellamy later met with Senate President Franklin M. Drilon (right) to discuss other proposed legislation that are being pushed by UNICEF.<!-- PhotoCaption.end -->
			<strong>
<!-- PhotoBy.start -->(Photo By: Albert Calvelo Senate-PRIB)<!-- PhotoBy.end -->
			</strong></p>
         </td>
<td id="sidepane">
