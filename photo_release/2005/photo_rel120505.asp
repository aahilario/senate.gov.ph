...
<title>Photo Release - China Visitors</title>
...
<td>&nbsp;<a href="http://www.newsenatebuilding.com">Bagong Senado</a></td></tr></table></div></div>
   <table id="container">
      <tr>
         <td id="content">
Photo Release<br />
<!-- PhotoDate.start -->December 5, 2005<!-- PhotoDate.end --><p style="text-align: center;">
<img src="photo_rel120505.jpg" />
			<p><strong>
<!-- PhotoTitle.start -->CHINA VISITORS<!-- PhotoTitle.end --></strong>
<strong>
:</strong>
<!-- PhotoCaption.start -->Senate President Franklin M. Drilon assures Wang Zhonghu, vice chairman of the Chinese Peoples Political Consultative Conference (CPPCC), that the Senate supports the implementation of the P26.1-billion Northrail project but would want to assure that Philippine laws are not violated in the process. Wang and his delegation called on Drilon and Senate Pro Tempore Juan Flavier.<!-- PhotoCaption.end -->
			<strong>
