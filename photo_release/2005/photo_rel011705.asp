...
<td>&nbsp;<a href="http://www.newsenatebuilding.com">Bagong Senado</a></td></tr></table></div></div>
   <table id="container">
      <tr>
         <td id="content">
Photo Release<br />
<!-- PhotoDate.start -->January 17, 2005<!-- PhotoDate.end --><p style="text-align: center;">
<img src="http://senate.gov.ph/photo_release/2005/photo_rel011705.jpg" /></p>
			<p>
<strong>
<!-- PhotoTitle.start -->COURTESY CALL<!-- PhotoTitle.end --></strong>
<strong>
:</strong>
<!-- PhotoCaption.start -->Senate President and Liberal Party(LP) head Franklin M. Drilon shakes the hand of United Nations Development Programme (UNDP) representative Deborah Landey who called on him at the Senate. Landey volunteered to help invite UN Secretary General Kofi Annan to grace the Inter-Parliamentary Union opening ceremonies on April 3, 2005 in Manila.<!-- PhotoCaption.end -->
			<strong>
<!-- PhotoBy.start -->(PRIB Photo by ALBERT CALVELO)<!-- PhotoBy.end -->
			</strong></p>
         </td>
<td id="sidepane">
