...
<title>Photo Release - Senate 89th Anniversary</title>
...
<td>&nbsp;<a href="http://www.newsenatebuilding.com">Bagong Senado</a></td></tr></table></div></div>
   <table id="container">
      <tr>
         <td id="content">
Photo Release<br />
<!-- PhotoDate.start -->October 10, 2005<!-- PhotoDate.end --><p style="text-align: center;">
<img src="http://senate.gov.ph/photo_release/2005/photo_rel101005.jpg" />
			<p><strong>
<!-- PhotoTitle.start -->SENATE 89TH ANNIVERSARY<!-- PhotoTitle.end --></strong>
<strong>
:</strong>
<!-- PhotoCaption.start -->Senate President Franklin M. Drilon receives a plaque of appreciation from the Senate Employees Union (SENADO) headed by its President Perla Mayor during the flag raising ceremony which triggered the start of the month-long celebration of the Senates 89th anniversary. The Union said it supported Drilon for upholding the integrity and independence of the Senate in the face of severe criticisms from Malaca&ntilde;ang
.<!-- PhotoCaption.end -->
			<strong>
