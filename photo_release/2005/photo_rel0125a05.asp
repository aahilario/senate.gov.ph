...
<title>Photo Release - Woman by Two Artists</title>
...
<td>&nbsp;<a href="http://www.newsenatebuilding.com">Bagong Senado</a></td></tr></table></div></div>
   <table id="container">
      <tr>
         <td id="content">
Photo Release<br />
<!-- PhotoDate.start -->January 25, 2005<!-- PhotoDate.end --><p style="text-align: center;">
<img src="http://senate.gov.ph/photo_release/2005/photo_rel0125a05.jpg" /></p>
			<p>
<strong>
<!-- PhotoTitle.start -->WOMAN BY TWO ARTISTS<!-- PhotoTitle.end --></strong>
<strong>
:</strong>
<!-- PhotoCaption.start -->Senate President and Liberal Party (LP) head Franklin M. Drilon and LP Chair Manila Mayor Lito Atienza inspect a wooden statue during the inauguration of the journalists league Samahang Plaridel Clubhouse and Piano Bar on T. M. Kalaw, Manila Monday night. With them are Ilocos Rep. Imee Marcos and Philippine Star publisher Max Soliven.<!-- PhotoCaption.start -->
			<strong>
<!-- PhotoBy.start -->(Senate Photo: Albert Calvelo, PRIB)<!-- PhotoBy.end -->
			</strong></p>
         </td>
<td id="sidepane">
