...
<title>Villar Sipag awards new house & lot to lucky OFW</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 18, 2016<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2016/1118_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->VILLAR SIPAG AWARDS NEW HOUSE & LOT TO LUCKY OFW: </strong>
		<!-- PhotoCaption.start -->
		Former senator Manny Villar hands over the ceremonial key to Dalisay Mirabuenos after winning a new house and lot from Camella Homes during Villar SIPAG’s (Social Institute for Poverty Alleviation and Governance) 6th OFW and Family Summit in Manila. The event, organized in partnership with Go Negosyo, provided attendees with livelihood opportunities and seminars to help OFWs and their families manage their hard-earned income. Also in the photo are Rolando Palao (2nd from left), Villar SIPAG Director, Senator Cynthia A. Villar and Vista Land managing director Camille Villar            
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
