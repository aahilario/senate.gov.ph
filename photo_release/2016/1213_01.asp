...
<title>Norilsk Nickel delegation pays courtesy call</title>
...
<table id="container">
	<tr>
		...
		<img src="1213_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->NORILSK NICKEL DELEGATION PAYS COURTESY CALL:</strong>
		<!-- PhotoCaption.start -->
		Senate President Aquilino “Koko” Pimentel III poses with (from left) Markus Meurer, head of Global Sales and Marketing, and Anton Berlin, head of Strategic Marketing Division of the Norilsk Nickel Group, a Russian nickel and palladium mining and smelting company, during a courtesy call Tuesday, December 13, 2016. Also in photo are Russian Ambassador Igor Khovaev (2nd from right), and Russian Counsellor Andrey Zapozhnikov (right). (PRIB Photo by Albert Calvelo/13 December 2016)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
