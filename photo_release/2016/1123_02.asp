...
<title>LGUs for tourism growth</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2016/1123_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->LGUs FOR TOURISM GROWTH:</strong>
		<!-- PhotoCaption.start -->
		Senator Nancy Binay gave a keynote speech emphasizing the role of local government units (LGUs) in improving the country's local tourism industry during Tourism Summit of the Department of Tourism (DOT) at the Manila Diamond Hotel earlier today. She said that LGUs should collaborate with the DOT, regional development councils to align with the Administration's Ambisyon Natin 2040 national development plan.
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
