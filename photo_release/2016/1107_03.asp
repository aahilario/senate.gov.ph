...
<title>2015 Senate Milestone Awards</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 7, 2016<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2016/1107_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->2015 SENATE MILESTONE AWARDS:</strong>
		<!-- PhotoCaption.start -->
		Senate President Aquilino “Koko” Pimentel III (10th from left) and Senate Secretary Lutgardo Barbo (5th from right) join the 2015 Senate Milestone awardees, from left to right, Marcianito Aliola (Senate Office of International Relations and Protocol), Efren Sarsia (Senate Security Enforcement Service), Manolo Tesoro (Senate Maintenance and Physical Facilities Service), Ma. Corazon Ignacio (Debate Reporters Service), Norma Bermudez (Senate Maintenance and Physical Facilities Service), Delilah Calaor (Office of former Senator Ferdinand Marcos Jr.), Jaime Muego (Senate Maintenance and Physical Facilities Service), Carolina Driz (Committee Support Service B), Lourdes Amelita Tongco (Senate Debate Reporters Service), Isabelita Robles (Senate Committee Support C), Pacifico Odrial (Senate Bills and Index Service), Daniel Pugal (Senate Library Service), Emiliano Punzal Jr. (Senate General Services) and Virgilio Miranda (Office of the Senate Legal Counsel). The employees are recognized for their years of service and dedication to the institution. (PRIB Photo by Albert Calvelo/ 07 November 2016)  
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
