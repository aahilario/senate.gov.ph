...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2016/1116_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->MANILA:</strong>
		<!-- PhotoCaption.start -->
		As the Senate deliberated the P3.3-trillion national budget, women leaders from Samahan ng Nagkakaisang Pamilya ng Pantawid on Wednesday morning danced the zumba outside the Senate gates to get the senators’ attention regarding their worry: That 1.3 million of the 4.4 million families-beneficiaries would be removed from the program, so that rice subsidy may be given instead.
		<p>Senator Francis “Kiko” Pangilinan met with the women leaders, who included Helen Araojo.
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
