...
<title>Blue Ribbon Committee hearing</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2016/1206_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BLUE RIBBON COMMITTEE HEARING:</strong>
		<!-- PhotoCaption.start -->
		Senator Nancy Binay asks officials of the Department of Health (DOH) on the various vaccination procedures implemented by the agency during the Senate Blue Ribbon Committee's hearing on DOH's alleged vaccination of 280,000 students, using questionable dengue vaccines. The estimated P3.5 billion project was apparently administered without passing the World Health Organization's (WHO) prequalification requirements.<td id="sidepane">
		<div id="sidepane_l2">
		</div>
