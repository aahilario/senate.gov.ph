...
<title>Foreign Service Officers confirmed</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2016/1207_06.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->FOREIGN SERVICE OFFICERS CONFIRMED: </strong>
		<!-- PhotoCaption.start -->
		The Commission on Appointments (CA) confirmed today, December 7, 2016, the appointments of (L-R) Uriel Norman Robles Garibay as Ambassador to the Republic of Kenya, Jose Laurel V as Ambassador to Japan, Shirley Ho-Vicario as Ambassador to the Federal Republic of Nigeria and Jose Santiago Sta. Romana as Ambassador to the People's Republic of China. (PRIB Photo by Cesar Tomambo/07 December 2016)<td id="sidepane">
		<div id="sidepane_l2">
		</div>
