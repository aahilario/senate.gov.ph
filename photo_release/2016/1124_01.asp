...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2016/1124_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->400th NEGOSYO CENTER OPENS IN MARIKINA:</strong>
		<!-- PhotoCaption.start -->
		Senator Bam Aquino (left) leads the ribbon-cutting ceremony during the launching of the 400th Negosyo Center in Marikina City with Marikima Mayor Marcelino Teodoro,  Trade Assistant Secretary Amina Fajardo and PCCI Marikina President Ernesto Alcantara. Sen. Bam is the principal author and sponsor of the Republic Act No. 10644 or the Go Negosyo Act in the Senate.
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
