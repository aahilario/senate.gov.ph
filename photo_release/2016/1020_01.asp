...
<title>Koko attends Senate Mini-Olympics</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 20, 2016<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2016/1020_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->KOKO ATTENDS SENATE MINI-OLYMPICS:</strong>
		<!-- PhotoCaption.start -->
		Senate President Aquilino “Koko” Pimentel III shares a light moment with Senate officials before the opening of the Senate mini-Olympics, Thursday, October 20, 2016. In photo are (from left) External Affairs and Relations Deputy Secretary Peter Paul Pineda, Commission on Appointments Secretary Hector Villacorta, Senate Sergeant-at-Arms M/Gen. Jose Balajadia Jr., Senate Secretary Lutgardo Barbo, Senate Legal Counsel Valentina Cruz, and Senate Economic Planning Office Director General Ronald Golding. (OSP Photo by Ariel Cagadas/20 October 2016)  	 
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
