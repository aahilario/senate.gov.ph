...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2016/1115_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->RH LAW:</strong>
		<!-- PhotoCaption.start -->
		Senator Hontiveros and Rep. Aglipay-Villar vows to defend the RH law budget in a press conference last September. 
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
