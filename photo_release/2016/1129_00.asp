...
<title>Native animal production</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2016/1129_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->NATIVE ANIMAL PRODUCTION:</strong>
		<!-- PhotoCaption.start -->
		Participants to the three-day seminar on Native animal production proudly show their certificates as they posed for a picture raking with Sen. Cynthia A. Villar. The 105 graduates, who  came from Cordillera Autonomous Region, Regions 1,2 & 3, Metro Manila, San Jose Del Monte Bulacan, Visayas and Mindanao,  attended the seminar at Villar SIPAG Farm School,Georgia College, Brgy. Kaypian, San Jose Del Monte, Bulacan. The project was sponsored by Villar SIPAG where the senator sits as its managing director, in cooperation with the Department of Agriculture and Bureau of Animal Industry.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
