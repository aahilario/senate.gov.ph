...
<title>Clean-up drive and opening of pathway</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 3, 2016<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2016/1203_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->CLEAN-UP DRIVE AND OPENING OF PATHWAY:</strong>
		<!-- PhotoCaption.start -->
		Senator Cynthia A. Villar inspects the cleaning of the creek as she passes through the newly-opened pathway leading to the poor communities in Bagong Silangan and UnitedNursery near the BF Resort Village in Las Pinas City. The pathway, which runs from Cicero Street to BF Resort Village, serves as common way for entrance and exit point of residents. This project of the senator was made in cooperation with Las Pinas City Science High School, Homeowners association and Brgy. Talon 2.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
