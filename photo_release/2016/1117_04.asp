...
<title>A toast for PDP-Laban</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2016/1117_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->A TOAST FOR PDP-LABAN:</strong>
		<!-- PhotoCaption.start -->
		Senate President and Partido Demokratiko Pilipino - Lakas ng Bayan (PDP-Laban) President Aquilino "Koko" Pimentel III raises a toast during the PDP-Laban Thanksgiving dinner held at the Midas Hotel and Casino, Pasay City, Wednesday, November 17, 2016. The PDP-Laban, which includes President Rodrigo Duterte, Pimentel and House Speaker Pantaleon Alvarez, is currently the ruling political party in the country. (OSP Photo by Ariel Cagadas/ 17 November 2016)      
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
