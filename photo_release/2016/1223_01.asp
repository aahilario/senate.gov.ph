...
<table id="container">
	<tr>
		...
		<img src="1223_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->DANGAL NG HARAYA:</strong>
		<!-- PhotoCaption.start -->
		Senator Loren Legarda (5th from left) with the cultural performers from different indigenous cultural communities at the Dangal ng Haraya awarding ceremony. (Photos by Gil Nartea/ Office of Senator Loren Legarda)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
