...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2016/1129_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SPORTS HEARING:</strong>
		<!-- PhotoCaption.start -->
		Senator Manny Pacquiao, chair of the Senate Committee on Sports, confers with Senator Antonio Trillanes IV during a hearing looking into the alleged unliquidated funds received by the Philippine Olympics Committee (POC) from the Philippine Sports Commission (PSC). The hearing also looked into the alleged unjust disqualification of candidates for the position of the POC president. (PRIB Photo by Romeo Bugante/29 November 2016) <td id="sidepane">
		<div id="sidepane_l2">
		</div>
