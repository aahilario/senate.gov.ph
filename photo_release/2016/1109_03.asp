...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2016/1109_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->MANILA:</strong>
		<!-- PhotoCaption.start -->
		Sixteen Senators from the Senate Committees on Agriculture and Food and Finance on Wednesday signed and approved Committee Report on the Coco Levy Bill.    
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
