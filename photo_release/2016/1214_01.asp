...
<title>Senate approves Bicameral Conference report</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 14, 2016<p style="text-align: center;">
		<img src="1214_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SENATE APPROVES BICAMERAL CONFERENCE REPORT:</strong>
		<!-- PhotoCaption.start -->
		Majority of the senators vote for the approval of the Bicameral Conference report on the proposed P3.35 trillion national budget Wednesday, December 14, 2016. (PRIB Photo by Cesar Tomambo/14 December 2016)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
