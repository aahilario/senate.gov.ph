...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2016/1026_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->MSME: </strong>
		<!-- PhotoCaption.start -->
	 	Senator Loren Legarda with Lily Luglug of Lab Tie Dye Weavers Association, one of the many groups of weavers all over the country that Legarda supports. 
