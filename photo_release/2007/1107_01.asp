...
<title>Photo Release - Pia pushes for graphic warnings in cigarette labels</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 7, 2007<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2007/1107_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->PIA PUSHES FOR GRAPHIC WARNINGS IN CIGARETTE LABELS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Health and Demography Committee Chair Sen. Pia S. Cayetano shows samples of cigarette packs from other countries bearing picture-based warnings on the hazards of smoking at a press conference held at the World Health Organization (WHO) office in Manila last Nov. 7. Among those with her at the panel are Dr. Ma. Encarnita Limpin of the Framework Convention on Tobacco Control Alliance-Philippines (first from left) and Dr. Haik Nikogosian of WHO-Europe (first from right).
		<!-- PhotoCaption.end -->		
