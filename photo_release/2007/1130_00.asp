...
<title>Photo Release - Gift from IPU</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2007/1130_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->GIFT FROM IPU<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate President Manny Villar accepts a gift from Inter-Parliamentary Union Secretary General Anders Johnsson a gift after the Senate of the Philippines successfully hosted the three-day First Global Parliamentary Meeting on HIV/AIDS at the Manila Hotel. More than 200 lawmakers from over 55 IPU-member countries attended the meeting which ended today.  
		<!-- PhotoCaption.end -->		
