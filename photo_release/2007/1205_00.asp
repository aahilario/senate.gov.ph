...
<title>Photo Release - Raising public awareness on the dangers of smoking</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 5, 2007<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="1205_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->RAISING PUBLIC AWARENESS ON THE DANGERS OF SMOKING<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate President Manny Villar discusses with Dr. Haik Nigosian, Secretariat head of the World Health Organization Framework Convention on Tobacco Control in Geneva, Switzerland, the impact of picture warnings on cigarette packs to raise awareness on the hazards of smoking. Also present during the meeting are Jessica de Leon, Department of Health (DOH) adviser on health education and promotion and DOH Usec. Alexander Padilla.
		<!-- PhotoCaption.end -->		
