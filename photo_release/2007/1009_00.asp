...
<title>Photo Release - Rotary Club of Makati</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 9, 2007<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2007/1009_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->ROTARY CLUB OF MAKATI<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		SENATOR MAR ROXAS speaks before Rotary Club members on the need for reforms in the Philippines’ political leadership, in a recent meeting organized by Rotary Club of Makati West held at the Mandarin Oriental. Roxas also spoke of his desire to make a difference in government, and called those in attendance to “continue to believe in yourselves, in our country, and our future.” 
		<!-- PhotoCaption.end -->		
