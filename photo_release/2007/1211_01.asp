...
<title>Photo Release - Loren with MAP-ABCD Foundation</title>
...
<table id="container">
	<tr>
		...
		<img src="1211_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->LOREN WITH MAP-ABCD FOUNDATION<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Loren B. Legarda delivers her message to the members and officers during the weekly forum of the Management Association of the Philippines (AgriBusiness and Countryside Development Foundation) held in Manila Golf &amp; Country Club Tuesday afternoon.
		<!-- PhotoCaption.end -->		
