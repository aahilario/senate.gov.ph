...
<title>Photo Release - McDonald's Forum</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 31, 2007<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2007/1031_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->MCDONALD'S FORUM<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Mar Roxas shares with restaurant managers of McDonald's during their recent conference on how three core values--of never giving up the long term, of "getting real," and of working by design and not by default--have helped him personally. He also outlined how these are applicable to the restaurant managers' daily task, and to the task of building a nation as well.
		<!-- PhotoCaption.end -->		
