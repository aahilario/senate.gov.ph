...
<title>Photo Release - ‘Search for Ms. Iligan’ Coronation Night</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->September 29, 2007<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2007/0929_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->‘SEARCH FOR MS. ILIGAN’ CORONATION NIGHT<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		SENATOR MAR ROXAS is met by avid fans at the recent ‘Search for Ms. Iligan’ Coronation Night, held at Mindanao State University in Iligan  City. ‘Mr. Palengke’ crowned the winners of the event, and participated in a question and answer portion, together with Iligan City Mayor Lawrence Cruz. 
		<!-- PhotoCaption.end -->		
