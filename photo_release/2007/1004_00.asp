...
<title>Photo Release - JPEPA 'Round 4'</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2007/1004_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->JPEPA 'ROUND 4'<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Pia S. Cayetano asks the government panel why our negotiators were unable to get equal or better terms for our nurses and caregivers under the Japan-Philippines Economic Partnership Agreement (JPEPA) compared to other developing countries which also entered into bilateral deals involving the export of their medical professionals. With Cayetano are Senators Miriam Defensor Santiago and Mar Roxas at the October 4 joint hearing on JPEPA which tackled the issue of movement of natural persons. 
		<!-- PhotoCaption.end -->		
