...
<title>Photo Release - Loren visits Tagum</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 27, 2007<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2007/1027_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->LOREN VISITS TAGUM<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		A boy warmly welcomed the arrival of Senator Loren B. Legarda during her visit in  Barangay Madaum, Tagum City were she led the Ceremonial Ground Breaking of Kalagan Museum .  Legarda  also  delivered a message  to the convenors and organizers of Cultural Tourism Forum in the celebration of Indigenous  Peoples’ Month during the Regional Development Council Meeting held in Tagum City Friday Afternoon. 
		<!-- PhotoCaption.end -->		
