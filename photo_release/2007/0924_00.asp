...
<title>Photo Release - Jaycees' meet in Legaspi City</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->September 24, 2007<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2007/0924_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->JAYCEES’ MEET IN LEGASPI CITY<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Jaycees members show off their shirts carrying the name of their convention guest Senate President Manny Villar (fourth from left) and the emblem of the Nacionalista Party. Beside Villar is Jaycees leader Albay (2nd district) Rep. Al Francis Bichara (fifth from left)  at the Pepperland Hotel in Legaspi City recently. Villar stressed the importance of promoting a culture of entrepreneurship starting from the family during the conference.
