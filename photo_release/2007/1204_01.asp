...
<title>Photo Release - Accountability on Manila Peninsula standoff</title>
...
<table id="container">
	<tr>
		...
		<img src="1204_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->ACCOUNTABILITY ON MANILA PENINSULA STANDOFF<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Richard Gordon delivers a privilege speech and called for the Senate to stand for full application of the law against anyone who put the nation’s well-being and image at risk through violent means for their own aggrandizement. He also urged for an investigation on the events so that accountability will be properly attached to persons responsible.
		<!-- PhotoCaption.end -->		
