...
<title>Photo Release - Villar in Los Baños</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 27, 2007<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="21227_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->VILLAR IN LOS BAÑOS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate President Manny Villar (second from left), receives a token of appreciation from the 41st Infantry Division of the First Ready Reserve Battalion during a change of command ceremony in Camp Eldridge, Los Banos, Laguna where he was guest of honor recently. Looking on are Mayor Joaquin Chipeco (left) and Rep. Justin “Timmy” Chipeco (third from left).
		<!-- PhotoCaption.end -->		
