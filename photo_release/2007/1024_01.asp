...
<title>Photo Release - Ricky Reyes Hairdressers Cooperative</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2007/1024_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->RICKY REYES HAIRDRESSERS COOPERATIVE<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		SENATOR MAR ROXAS cuts the ribbon to open the day-long competition among hairdressers from around the world, an event hosted by the Filipino Hairdressers Cooperative and held on Wednesday at the Philtrade Center in Pasay. With Roxas are (left to right) Catherine Untalan, Miss Earth 2006 second runner-up from the Philippines, FilHair founder Ricky Reyes, and Miss Earth 2006 Hil Hernandez from Chile.  
		<!-- PhotoCaption.end -->		
