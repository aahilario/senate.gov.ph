...
<title>Photo Release - Angara signs MOA by the AACE</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 12, 2007<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2007/1112_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->ANGARA SIGNS MOA BY THE AACE<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Edgardo J. Angara signs a Memorandum of Agreement by the American Association of Clinical Endocrinologists (AACE) – Philippine Chapter in support of its advocacy campaign dubbed “Power of Prevention through Fitness and Nutrition” which aims to enlighten Filipinos about this serious health menace that is silently killing children and young adults.
		<!-- PhotoCaption.end -->		
