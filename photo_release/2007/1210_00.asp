...
<title>Photo Release - Philippine Coast Guard promotes Gordon</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 10, 2007<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="1210_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->PHILIPPINE COAST GUARD PROMOTES GORDON<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Admiral Danilo A. Abinoja, Commandant of the PCG (right) and Vice Admiral Joselito C. Aseniero, Philippine Coast Guard Auxiliary National Director (left) administered the awards ceremony for newly promoted Rear Admiral Richard Gordon of the PCGA held at PCG Headquarters, Port Area Manila.
		<!-- PhotoCaption.end -->		
