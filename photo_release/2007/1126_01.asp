...
<title>Photo Release - San Pablo Officers</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2007/1126_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SAN PABLO OFFICERS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Loren B. Legarda led the oath of 80 newly elected Barangay and Sanguniang Kabataan officers during the Mass Oath-taking held in San Pablo City Monday morning. Also in photo are (left) Board member and currently acting vice-governor Karen Agapay and (right) San Pablo Mayor Vicente Amante. 
		<!-- PhotoCaption.end -->		
