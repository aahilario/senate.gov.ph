...
<title>Photo Release - JPEPA fails to impress</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->September 21, 2007<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2007/0921_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->JPEPA FAILS TO IMPRESS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senators are disappointed by the explanation of government negotiators led by Department of Trade and Industry (DTI) Undersecretaries Thomas Aquino (second from left)  and Elmer Hernandez (seated next), after failing to answer basic questions on the benefits of the Japan-Philippines Economic Partnership Agreement (JPEPA) to the country. Photo also shows (from right), Senators Richard Gordon, Miriam Defensor-Santiago and Mar Roxas; and Jose Antonio Buencamino  from DTI.
