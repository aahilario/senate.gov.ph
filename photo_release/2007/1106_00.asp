...
<title>Photo Release - Help for Iloilo flood victims</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 6, 2007<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2007/1106_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->HELP FOR ILOILO FLOOD VICTIMS<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate President Manny Villar is being briefed by Zaraga Mayor Gregorio Brazas on the plight of flood victims in his town in Iloilo. Villar, whose late father hails from Iloilo, donated boxes of goods and noodles to the victims through the mayor’s office.
		<!-- PhotoCaption.end -->		
