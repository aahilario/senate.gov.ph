...
<title>Photo Release - The first supper</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 15, 2007<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2007/1115_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->The first supper<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Fresh from simple oath-taking ceremonies as the new batch of barangay authorities, Senate President Pro Tempore Jinggoy Ejercito Estrada poses with local officials of Barangay San Perfecto, San Juan, Metro Manila. The event seemed nostalgic on the part of the senator, as he is reunited with San Juan residents to whom he served as Mayor for three consecutive terms. 
		<!-- PhotoCaption.end -->		
