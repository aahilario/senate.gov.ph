...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2007/1015_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->WARM WELCOME<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Sen. Loren Legarda shakes hands with Inter Parliamentary Union (IPU) President Pier Fernandino at an IPU Meeting in Geneva, Switzerland. 
		<!-- PhotoCaption.end -->		
