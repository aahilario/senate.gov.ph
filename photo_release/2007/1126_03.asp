...
<title>Photo Release - Heavy equipment scam</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2007/1126_03.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->HEAVY EQUIPMENT SCAM<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		In the hearing conducted by his committee last November 21, Senate Committee on Public Works chairman Senator Ramon “Bong” Revilla Jr. revealed to the resource persons the practice of leasing the same heavy equipment to two or more different contractors, working on various projects on the same dates but at different sites, which often result to delayed completion of infrastructure projects. He earlier filed Senate Bill No. 14 which seeks the compulsory registration with the Land Transportation Office (LTO) of heavy equipment.
		<!-- PhotoCaption.end -->		
