...
<title>Photo Release - Representing the Philippines</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 16, 2007<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2007/1016_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->REPRESENTING THE PHILIPPINES<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		In one of the sessions, Legarda urged IPU members to take stronger action against human trafficking and exploitation of migrant workers.
		<!-- PhotoCaption.end -->		
