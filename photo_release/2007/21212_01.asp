...
<title>Photo Release - World Class Choir</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 12, 2007<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="21212_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->WORLD CLASS CHOIR<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate President Manny Villar led the Senate in commending the Philippine Madrigal Singers for their unprecedented and unparalleled excellence in choral singing.  Senate Adopted Resolution No. 16 recognized the group for being the first and only choir to win the ‘Choral Olympics of the World’ or the European Grand Prix for Choral Singing in Arezzo, Italy.
		<!-- PhotoCaption.end -->		
