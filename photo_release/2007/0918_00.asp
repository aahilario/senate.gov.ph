...
<title>Photo Release - CHED budget hearing</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->September 18, 2007<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2007/0918_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->CHED BUDGET HEARING<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senator Edgardo Angara questions officials from the Commission on Higher Education (CHED)  led by Secretary  Romulo Neri (far right)  during a hearing in the Senate on CHED’s proposed budget for 2008. Photo includes Dr. Henry Sojor (third from left),  president of Negros Oriental State University (NORSU) Dumaguete City, and CHED Executive Director Wilfredo Medrano. 
