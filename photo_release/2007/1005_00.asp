...
<title>Photo Release - Villar shows support for youth</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2007/1005_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->VILLAR SHOWS SUPPORT FOR YOUTH<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate President Manny Villar receives information kit of the National Youth Commission (NYC) from Chairman Ritchie Nalupta during a courtesy call at the Senate. Nalupta sought Villar’s support on NYC’s proposed programs and activities the Senate’s significant role in realizing these objectives. 
		<!-- PhotoCaption.end -->		
