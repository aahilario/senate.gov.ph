...
<title>Photo Release - PIPC Hearing</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->September 12, 2007<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2007/0912_02.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->PIPC Hearing<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		SENATOR MAR ROXAS (left) presides over the hearing of the Senate Trade &amp; Commerce committee Tuesday, on the Performance Investment Products Corp. (PIPC) scam that allegedly defrauded investors of up to $250 million, with Senators Juan Ponce Enrile and Loren Legarda (partially hidden), who had called for the probe. Among those invited to the inquiry were (right, L-R) PIPC General Manager Cristina Gonzalez-Tuason, Insurance Commission Deputy Commissioner Vida Chiong, Anti-Money Laundering Council Executive Director Atty. Vicente S. Aquino, Bangko Sentral Deputy Gov. Nestor Espenilla (partially hidden), Bangko Sentral Gov. Amando Tetangco, Securities and Exchange Commission Chairperson Fe Barin, SEC Director Atty. Hubert Dominic Guevarra.		<!-- PhotoCaption.end -->
