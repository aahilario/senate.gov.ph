...
<title>Photo Release - Security Assessment</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2007/1114_04.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SECURITY ASSESSMENT<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate President Manny Villar asks Senate Sergeant-at-Arms chief Gen. Jose Balajadia to justify and explain the proposed security tightening program at the Senate in the wake of the bombing attack on the House of Representatives.  
		<!-- PhotoCaption.end -->		
