...
<title>Photo Release - Senate Photo Exhibit</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2007/1105_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SENATE PHOTO EXHIBIT<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		Senate President Manny Villar cuts  the ceremonial ribbon during the opening of the photo exhibit organized by the Senate Press Photographers Association (SPPA) dubbed as “Senators at Work for the People.” Photo shows Villar (second from left), with SPPA officers Luis Garcia (Manila Bulletin), Rudy Rabulan (Saksi),  Junny “bong” Roy (The Daily Tribune), Roger Margallo (Philippine Daily Inquirer) and Joseph Muego (Panay News).
		<!-- PhotoCaption.end -->		
