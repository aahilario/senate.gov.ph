...
<title>Photo Release - Hearing on Cheaper Medicine Bill</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->September 10, 2007<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2007/0910_03.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->HEARING ON CHEAPER MEDICINE BILL<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		SENATOR MAR ROXAS, CHAIRMAN of the Senate committee on trade and commerce, together with 
		Committee on Health and Demography Chairwoman Senator Pia Cayetano, preside over the first hearing Monday on measures that seek to lower the prices of medicines in the country, at the Pecson Room in the Senate’s second floor. Among those present were the Department of Health, Department of Trade and Industry, Philippine International Trading Corp. (PITC), the Philippine Chamber of the Pharmaceutical Industry (PCPI), Pharmaceutical Healthcare Association of the Philippines (PHAP) and groups such as the Drugstore Association of the Philippines, Ayos na Gamot sa Abot-kayang Presyo (AGAP) and the World Health Organization.
		<!-- PhotoCaption.end -->
