...
<title>Photo Release - DBCC Briefing</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2007/0910_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->DBCC BRIEFING<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		(From left) Senators Rodolfo Biazon, Edgardo Angara, Juan Ponce Enrile (Finance Committee Chair) and Chiz Escudero listen to the briefing on the proposed 2008 budget conducted by the country’s economic managers led  by Finance Secretary Margarito Teves (3rd from right), Budget Secretary Rolando Andaya (4th from left), Bangko Sentral Vice-Gov. Diwa Guinigundo and Augusto Santos of the National Economic Development Authority (NEDA).  The Departments of Finance and Budget,  Bangko Sentral and NEDA consist the Development Budget Coordinating Council.
		<!-- PhotoCaption.end -->
