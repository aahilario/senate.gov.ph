...
<title>Photo Release - Smuggling of OFW in Iraq</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->September 19, 2007<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2007/0919_01.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SMUGGLING OF OFW IN IRAQ<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		SENATOR MAR ROXAS is shown the passport of Engr. Ruperto Mirhan (2nd from left), an Overseas Filipino Worker who arrived in the country last April after a year of work in Iraq. Although all Philippine passports state “Not Valid for Travel to Iraq,’ Special Envoy Roy Cimatu (third from left) reported to Roxas in a meeting Wednesday at the Senate that there are still 6,647 Filipinos working in Iraq as of this year. Also in the picture is DFA Usec. Rafael Seguis.
		<!-- PhotoCaption.end -->
