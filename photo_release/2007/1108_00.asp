...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 8, 2007<!-- PhotoDate.end --><p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2007/1108_00.jpg" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->JPEPA HEARING<!-- PhotoTitle.end -->:</strong>
		<!-- PhotoCaption.start -->
		SENATOR MAR ROXAS, presiding a hearing on the Japan-Philippines Economic Partnership Agreement (JPEPA), said that the confidence of the senators was being “severely tested” by the executive’s inability so far to provide specifically the benefits and threats of JPEPA and other data needed to assess whether JPEPA should be ratified.  He was joined by Senators Richard Gordon (left) and Edgardo Angara (center).
		<!-- PhotoCaption.end -->		
