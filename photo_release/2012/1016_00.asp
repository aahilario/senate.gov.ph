...
<title>Budget hearing on the Department of Agriculture</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 16, 2012<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2012/1016_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BUDGET HEARING ON THE DEPARTMENT OF AGRICULTURE:</strong>
		<!-- PhotoCaption.start -->
 		Officials from the Department of Agriculture headed by Secretary Proceso J. Alcala attend a Senate hearing looking into their agency's proposed 2013 budget, Tuesday, October 16, 2012. Senators in attendance were Finance Committee chair Franklin Drilon, Edgardo Angara and Kiko Pangilinan. (PRIB PHOTO by ALBERT CALVELO)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
