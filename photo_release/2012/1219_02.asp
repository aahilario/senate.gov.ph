...
<title>Bicam Okays RH Bill</title>
...
<table id="container">
	<tr>
		...
		<p><strong>
		<!-- PhotoTitle.start -->BICAM OKAYS RH BILL:</strong>
		<!-- PhotoCaption.start -->
	 	Members of the Senate and House panels do the 'thumbs up' sign after approving the bicameral conference committee report on the Reproductive Health (RH) bill.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
