...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 28, 2012<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2012/1128_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SPEAK UP:</strong>
		<!-- PhotoCaption.start -->
	 	Senator Pia Cayetano explains #SpeakUp, an online awareness campaign at the Bulong Pulungan media forum on Tuesday. Also in the panel are columnist Deedee Siytangco and UP Manila's Dr. Tony Leachon.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
