...
<title>Pass sin tax for health services</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1008_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->PASS SIN TAX FOR HEALTH SERVICES:</strong>
		<!-- PhotoCaption.start -->
 		Children with cancer and health advocates join Sen. Pia Cayetano, Chair of the Senate Committee on Health and Demography, at the opening of an exhibit calling for the passage of a 'meaningful' sin tax law.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
