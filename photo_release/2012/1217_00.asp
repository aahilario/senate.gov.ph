...
<title>Rock It Science Bus takes off</title>
...
<table id="container">
	<tr>
		...
		<p><strong>
		<!-- PhotoTitle.start -->ROCK IT SCIENCE BUS TAKES OFF:</strong>
		<!-- PhotoCaption.start -->
	 	Sen. Pia Cayetano welcomes the very first student visitors to the Rock It Science Bus, a mobile science laboratory which she initiated with the Department of Science and Technology and Taguig City government. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
