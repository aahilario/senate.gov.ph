...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 7, 2012<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2012/1107_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SHARED ADVOCACY:</strong>
		<!-- PhotoCaption.start -->
	 	Senator Gringo Honasan leads in the oath-taking of new members of the Search and Rescue Unit Foundation (SARUF) Wednesday, November 7, 2012. One of the principal sponsors of the Disaster Risk Reduction and Management Act, Honasan shares in SARUF’s advocacy of saving lives and managing disasters and calamities using all appropriate skills and available resources. (PRIB Photo by Joseph Vidal) </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
