...
<title>Sin tax deliberations</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1120_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SIN TAX DELIBERATIONS:</strong>
		<!-- PhotoCaption.start -->
	 	Senate President Juan Ponce Enrile shows Senators Edgardo Angara, Panfilo Lacson and Loren Legarda a chart showing the computation of the incremental revenue expected to be generated by the sin tax reform bill once it is implemented into law. The Senate resumed session Tuesday with deliberations on the sin tax bill. Deliberations on the proposed 2013 budget are also expected to start right after. (Photo by Joe Arazas)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
