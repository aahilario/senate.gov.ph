...
<title>Smuggled cigarettes?</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1129_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SMUGGLED CIGARETTE?:</strong>
		<!-- PhotoCaption.start -->
	 	Senate President Juan Ponce Enrile holds a pack of ‘Yun Yan’ cigarettes from China which can be bought in Divisoria for P20. Enrile warned that the proliferation of smuggled cigarettes may increase once the Sin Tax Bill is passed into law. (PRIB Photo by ALBERT CALVELO, November 29)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
