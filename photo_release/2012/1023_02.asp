...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1023_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->HIBLA PAVILION OF TEXTILES AND WEAVES OF THE PHILIPPINES:</strong>
		<!-- PhotoCaption.start -->
 		Senator Loren Legarda with the B’laans of Sarangani at the Hibla Pavilion of Textiles and Weaves of the Philippines. The B'laans of Sarangani continue the heritage of weaving mewel made of fine abaca fiber on a backstrap loom.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
