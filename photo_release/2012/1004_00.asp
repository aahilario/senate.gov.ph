...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1004_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->ENRILE AND SON:</strong>
		<!-- PhotoCaption.start -->
		Senate President Juan Ponce Enrile waves to the crowd as he accompanies Cagayan 1st District Representative Jack Enrile, to the Commission on Elections headquarters in Intramuros, Manila, to file his certificate of candidacy. (PHOTO by Joe Arazas)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
