...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 3, 2012<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2012/1203_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->HIV/AIDS FORUM:</strong>
		<!-- PhotoCaption.start -->
	 	Senator Pia Cayetano, chair of the Senate Committee on Health and Demography, presides over a forum on the Human Immunodeficiency Virus (HIV) which causes Acquired Immune Deficiency Syndrome (AIDS) December 3, 2012. Dr. Eric Tayag, head of the National Epidemiological Center of the Department of Health (DOH), Teresita Marie Bagasao, Country Coordinator of the Joint United Nations Programme on HIV/AIDS(UNAIDS), Romeo Dongeto, Executive Director of the Philippine Legislators’ Committee on Population and Development (PLCPD), and Senate Minority Floor Leader Alan Peter Cayetano also participated in the forum. (PRIB Photo by Alex Nuevaespaña)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
