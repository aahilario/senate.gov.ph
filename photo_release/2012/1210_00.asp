...
<title>Enrile attends Flag Raising Ceremony</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1210_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->ENRILE ATTENDS FLAG RAISING CEREMONY:</strong>
		<!-- PhotoCaption.start -->
	 	Senate President Juan Ponce Enrile and Senate President Pro-Tempore Jinggoy Estrada join Senate officers and employees in singing the national anthem during this morning’s flag raising ceremony. (PHOTO by JOE ARAZAS/Monday, December 10, 2012)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
