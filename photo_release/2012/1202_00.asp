...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 2, 2012<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2012/1202_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->MEXICO CITY:</strong>
		<!-- PhotoCaption.start -->
		...
		<p>Angara is in Mexico City as official representative of President Benigno Aquino III for the inauguration of President-Elect Enrique Peña Nieto of the United Mexican States.
</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
