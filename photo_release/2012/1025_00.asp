...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 25, 2012<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2012/1025_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->POWER COMMISSION:</strong>
		<!-- PhotoCaption.start -->
 		Senate President Juan Ponce Enrile listens as Senator Serge Osmeña stresses a point during a Joint Congressional Power Commission briefing held Thursday, October 25, 2012. Discussed during the briefing were updates on the rules and procedures on Retail Competition and Open Access and the implementation of the Independent Market Operator for the Wholesale Electricity Spot Market (WESM). (PRIB Photo by Albert Calvelo)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
