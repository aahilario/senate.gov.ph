...
<title>Legarda at LMP General Assembly</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 10, 2012<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2012/1210_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->LEGARDA AT LMP GENERAL ASSEMBLY:</strong>
		<!-- PhotoCaption.start -->
	 	Senator Loren Legarda, Chair of the Senate Committee on Climate Change, talks about the effects of Typhoon Pablo during the League of Municipalities of the Philippines (LMP) General Assembly at the Manila Hotel. She stressed that Typhoon Pablo, like Sendong, Ondoy, and many other natural hazards, test the country's resilience and compel everyone, especially those in government, to implement our laws better in order to alleviate the suffering of the people.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
