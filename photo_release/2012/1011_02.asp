...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 11, 2012<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2012/1011_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BUDGET DELIBERATIONS:</strong>
		<!-- PhotoCaption.start -->
 		Senator Edgardo Angara, chair of the Senate Committee on Education, Arts and Culture discusses the proposed 2013 budgets of the Commission on Higher Education (CHED) and State Universities and Colleges (SUCs) during a Senate hearing Thursday, October 11, 2012. (PRIB Photo by Joseph Vidal)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
