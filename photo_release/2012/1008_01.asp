...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1008_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->JPE AND THE KIDS:</strong>
		<!-- PhotoCaption.start -->
 		Senate President Juan Ponce Enrile and Senator Franklin Drilon greet young patients of the Philippine General Hospital during their visit to the Senate Monday, October 8, 2012. (Photo by Joe Arazas)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
