...
<title>Zubiri attends flag ceremony</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1008_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->ZUBIRI ATTENDS FLAG CEREMONY:</strong>
		<!-- PhotoCaption.start -->
 		Senate Secretary Emma Lirio-Reyes presents a certificate of appreciation to former Senator Juan Miguel Zubiri during the flag raising ceremony at the Philippine Senate, Monday, October 8, 2012. (PRIB Photo by Joseph Vidal)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
