...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1001_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->FLAG CEREMONY:</strong>
		<!-- PhotoCaption.start -->
		Senator Ramon B. Magsaysay, Jr., addresses employees and staff of the Philippine Senate during Monday’s flag ceremony at the Senate grounds. (PRIB Photo by Edward Ganal / October 1, 2012)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
