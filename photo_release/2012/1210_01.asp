...
<title>Koko awards contest winners</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1210_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->KOKO AWARDS CONTEST WINNERS:</strong>
		<!-- PhotoCaption.start -->
	 	Senator Koko Pimentel, former Senate President Nene Pimentel, and former Las Piñas Representative Cynthia Villar, pose with the winners of an essay writing contest for students and teachers held at the University of Makati, Monday, December 10, 2012. (PRIB PHOTO by ALEX NUEVAESPANA)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
