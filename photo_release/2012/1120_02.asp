...
<title>Senators discuss Sin Tax bill</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1120_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SENATORS DISCUSS SIN TAX BILL:</strong>
		<!-- PhotoCaption.start -->
	 	Senate President Juan Ponce Enrile together with Senators Franklin Drilon, Bongbong Marcos, Tito Sotto and Ralph Recto are seen in a huddle as they discuss provisions in the Sin Tax bill during plenary session, Tuesday, November 20, 2012. In caucus, the senators agreed on the P40 billion aggregate sin tax revenue for the first year for both cigarettes and alcohol that will help increase the budget of the Department of Health for healthcare services. (PRIB PHOTO by ALEX NUEVAESPANA)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
