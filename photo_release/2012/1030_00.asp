...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1030_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BILIB I.T.:</strong>
		<!-- PhotoCaption.start -->
		Senator Alan Peter Cayetano with TESDA Secretary Joel Villanueva and Informatics president Leo Riingen during the MOA signing for the BilibIT project that will give IT training to the inmates of BJMP.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
