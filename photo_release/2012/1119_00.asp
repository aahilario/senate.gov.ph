...
<title>Sin tax interpelation</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 19, 2012<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2012/1119_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SIN TAX INTERPELATION:</strong>
		<!-- PhotoCaption.start -->
	 	Senator Ramon Bong Revilla, Jr. queries Senate Committee on Ways and Means acting Chairman Franklin Drilon, primary author and sponsor of the substitute sin tax reform bill during his interpellation on the proposed tax measure.  Drilon acknowledged Revilla’s remark on apparently vague provisions regarding the incremental revenue and vowed to review it for the possible enumeration of all government programs that will be financed by the collection from the sin tax.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
