...
<title>Escudero files Certificate of Candidacy</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1002_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->ESCUDERO FILES CERTIFICATE OF CANDIDACY:</strong>
		<!-- PhotoCaption.start -->
		Re-electionist Senator Francis “Chiz” Escudero filed his Certificate of Candidacy (COC), Tuesday, October 2, 2012 at the COMELEC Head Office in Intramuros, Manila. Escudero will run for his second term as a Senator of the republic. (PRIB PHOTO by ALEX NUEVAESPANA)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
