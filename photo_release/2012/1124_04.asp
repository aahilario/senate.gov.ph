...
<title>Greeneration Summit</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1124_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->GREENERATION SUMMIT:</strong>
		<!-- PhotoCaption.start -->
	 	Students gather around Senator Loren Legarda, Chair of the Senate Committee on Climate Change, during the Greeneration Summit: A National Gathering for Youth Empowerment on Climate Change held at the Manila Hotel, where she encouraged the youth to help urge their communities to implement environmental laws, especially the Ecological Solid Waste Management Act.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
