...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/0930_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->LEGARDA VISITS PANGASINAN FOR CORN SEEDS DISTRIBUTION:</strong>
		<!-- PhotoCaption.start -->
		Sen. Loren Legarda urged farmers to take advantage of Agri-Pinoy Trading Centers, which aims to eliminate middlemen in the sale of farm goods, during the Corn Seeds Distribution in Villasis, Pangasinan.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
