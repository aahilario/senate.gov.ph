...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 6, 2012<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2012/1106_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BUDGET HEARING:</strong>
		<!-- PhotoCaption.start -->
	 	Senate President Juan Ponce Enrile questions officials of the Department of Transportation and Communications (DOTC) led by Secretary Jun Abaya, during a Senate hearing on the agency’s proposed budget for the year 2013. (PRIB Photo by Joseph Vidal/November 6, 2012)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
