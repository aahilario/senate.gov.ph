...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1017_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->COURTESY CALL:</strong>
		<!-- PhotoCaption.start -->
 		 Senator Franklin M. Drilon receives Korean Ambassador to the Philippines H.E. Lee Hyuk during the latter’s courtesy call at the Philippine Senate today (October 17, 2012). (PRIB Photo by Albert Calvelo). </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
