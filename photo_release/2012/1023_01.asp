...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1023_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->FLAG RAISING CEREMONY:</strong>
		<!-- PhotoCaption.start -->
 		Former Senator Jamby Madrigal graces the flag raising ceremony of the Philippine Senate Monday, October 22, 2012. (PRIB Photo by Joseph Vidal)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
