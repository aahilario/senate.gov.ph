...
<title>Enrile welcomes Iraqi delegation</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1009_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->ENRILE WELCOMES IRAQI DELEGATION:</strong>
		<!-- PhotoCaption.start -->
 		Senate President Juan Ponce Enrile gives a token of appreciation to delegates of the Iraqi Council of Representatives, led by Honorable Qusai Abdul Wahad Al-Suhail. Enrile was joined by Senate President Pro – Tempore Jinggoy Ejercito Estrada and Senate Majority Leader Tito Sotto. (PRIB PHOTO by ALBERT CALVELO)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
