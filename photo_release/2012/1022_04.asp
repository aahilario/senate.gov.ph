...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1022_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->HIBLA:</strong>
		<!-- PhotoCaption.start -->
 		Senator Loren Legarda with the Hanunuo Mangyans of Oriental Mindoro at the Hibla Pavilion of Textiles and Weaves of the Philippines. The Hanunuo Mangyans of Bulalacao, Oriental Mindoro use birikan (a bowl acting as a plinth for the burungan) and the burungan (a spool formed from the betel nut tree) to spin bunang (thread) as it is pulled from the wool of burak (wild cotton).</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
