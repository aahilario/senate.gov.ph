...
<title>Loren files her certificate of candidacy</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1002_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->LOREN FILES HER CERTIFICATE OF CANDIDACY:</strong>
		<!-- PhotoCaption.start -->
		Senator Loren Legarda, guest candidate of both the United Nationalist Alliance and the Liberal Party, filed her certificate of candidacy at the Commission on Elections’ main office in Intramuros, Manila Monday, October 1, 2012. (PRIB Photo by Joseph Vidal)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
