...
<title>Legarda Visits Pangasinan for Corn Seeds Distribution</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->September 30, 2012<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2012/0930_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->LEGARDA VISITS PANGASINAN FOR CORN SEEDS DISTRIBUTION:</strong>
		<!-- PhotoCaption.start -->
		Sen. Loren Legarda emphasized the importance of Republic Act 10000 or the Agri-Agra Reform Credit Act of 2009, which aims to improve the livelihood of farmers and agrarian reform beneficiaries, during the Corn Seeds Distribution at the Santa Maria Municipal Hall in Pangasinan.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
