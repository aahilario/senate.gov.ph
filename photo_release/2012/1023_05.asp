...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1023_05.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->IPU ASEAN+3 REGIONAL MEETING:</strong>
		<!-- PhotoCaption.start -->
 		Senators Angara and Guingona with the Singapore Delegation at the IPU ASEAN+3 Regional Meeting in Quebec, Canada.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
