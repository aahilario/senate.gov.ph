...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1113_07.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->COURTESY CALL:</strong>
		<!-- PhotoCaption.start -->
	 	 Senate President Juan Ponce Enrile welcomes Russian Federation Ambassador to the Philippines Nikolay R. Kudashev during the latter's courtesy call at the Philippine Senate Tuesday, November 13, 2012. (Photo by Joe Arazas)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
