...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1113_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->MIRIAM ON SIN TAX:</strong>
		<!-- PhotoCaption.start -->
	 	Senator Miriam Defensor Santiago, Senate sponsor of the Framework Convention on Tobacco Control (FCTC), calls on her fellow senators to raise sin taxes to decrease government spending on healthcare costs from tobacco-related diseases during the continuation of deliberations on the proposed measure raising the tax on alcohol on tobacco products. (PRIB Photo by Joseph Vidal/12 November 2012) </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
