...
<title>A teddy bear for health</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 8, 2012<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2012/1008_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->A TEDDY BEAR FOR HEALTH:</strong>
		<!-- PhotoCaption.start -->
 		Young patients from the Philippine General Hospital give Senator Pia Cayetano a teddy bear before the start of session Monday, October 8, 2012. The children trooped to the Senate to appeal for the immediate passage of measures increasing taxes on cigarette and tobacco products. (PRIB Photo by Joseph Vidal)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
