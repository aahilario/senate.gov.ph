...
<title>Legarda at PCL National Board Meeting</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1210_05.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->LEGARDA AT PCL NATIONAL BOARD MEETING:</strong>
		<!-- PhotoCaption.start -->
	 	Senator Loren Legarda, Chair of the Senate Committee on Climate Change, imparts her message on effective legislation and good governance in the face of natural hazards at the 4th Quarterly National Executive Officers and National Board Meeting of the Philippine Councilors League (PCL).</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
