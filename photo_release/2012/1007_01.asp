...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 7, 2012<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2012/1007_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BALER, AURORA:</strong>
		<!-- PhotoCaption.start -->
		Angara, together with his wife Gloria, headlined the closing ceremonies of the 5-Day Content Training attended by 191 Aurora public school teacher participants.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
