...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1115_04.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->ROTARY CLUB:</strong>
		<!-- PhotoCaption.start -->
	 	Senate President Juan Ponce Enrile speaks before members of the Rotary Club of Forbes Park, Makati City, Thursday, November 15, 2012. With Enrile are, from left, Rotary Club members Alex Ledesma, Frankie Adriano and Ruben Torres. (PRIB Photo by Albert Calvelo)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
