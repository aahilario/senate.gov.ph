...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1009_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BUDGET HEARING:</strong>
		<!-- PhotoCaption.start -->
 		Senator Ralph Recto presides over a Senate hearing looking into the proposed 2013 budget of the Department of Tourism and its attached agencies Tuesday, October 9, 2012. (PRIB Photo by Albert Calvelo) </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
