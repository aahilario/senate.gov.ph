...
<title>Repatriated OFWs from Dubai</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 30, 2012<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2012/1030_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->REPATRIATED OFWS FROM DUBAI:</strong>
		<!-- PhotoCaption.start -->
		Fifteen overseas Filipino workers from Dubai, United Arab Emirates arrived smiling with Senate President Pro Tempore Jinggoy Ejercito Estrada last Monday afternoon. Sen. Estrada, Chairman of the Senate Committee on Labor, Employment and Human Resources Development, learned of their cases upon his brief stopover in UAE and decided to shoulder the airfare for 20 distressed OFWs. However, only 15 were able to complete their exit clearance in time for their October 29 travel. The others are expected to return to the country in the coming days. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
