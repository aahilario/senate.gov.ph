...
<title>Relief for fire victims</title>
...
<table id="container">
	<tr>
		...
		<img src="1231_01.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->RELIEF FOR FIRE VICTIMS:</strong>
		<!-- PhotoCaption.start -->
	 	Senate President Pro Tempore Jinggoy Ejercito Estrada and daughter Janella distribute relief bags of food items to hundreds of families left homeless by a tragic fire incident in Brgy. St. Joseph, San Juan City which happened during the morning of Christmas day. Almost 1,700 families were rendered homeless and spent the holidays in evacuation centers around the area.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
