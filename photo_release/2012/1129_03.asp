...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1129_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->INFANTA, QUEZON:</strong>
		<!-- PhotoCaption.start -->
	 	Senator Loren Legarda at the Flashflood Commemorative Stone in Infanta, Quezon. Legarda was the Guest Speaker during the 8th Year commemoration of the REINA  flashflood caused by Tropical Storm Winnie in 2004.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
