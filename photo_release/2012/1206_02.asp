...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 6, 2012<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2012/1206_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BIOMETRIC REGISTRATION:</strong>
		<!-- PhotoCaption.start -->
	 	Sen. Koko Pimentel, chair of the Senate Committee on Electoral Reforms and People’s Participation, heads the bicameral conference committee meeting on the disagreeing provisions of Senate Bill No. 1030 and House Bill No. 3469, which requires all registered voters whose biometrics have not been captured, to appear before an election officer for the purpose of having their photographs, fingerprints and signatures captured through biometrics, to ensure that the automated fingerprint identification system (AFIS) can be utilized to cleanse the records of double or multiple registrants. (PRIB Photo by ALBERT CALVELO)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
