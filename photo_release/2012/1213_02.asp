...
<title>Energy Committee hearing</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 13, 2012<p style="text-align: center;">
		<img src="1213_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->ENERGY COMMITTEE HEARING:</strong>
		<!-- PhotoCaption.start -->
	 	 Senator Serge Osmeña, chair of the Senate Energy Committee, presides over a Senate hearing discussing the National Electrification Administration (NEA) Reform Act of 2012. The bill seeks to strengthen the NEA  and  the electric cooperatives (ECs) as  effective, responsive and pro-people vehicles for bringing reliable electricity  at reasonable rates to  all  Filipinos  all over the country, thereby  paving the way for a more balanced and sustainable development of the entire nation. (PRIB Photo by Alex Nuevaespaña)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
