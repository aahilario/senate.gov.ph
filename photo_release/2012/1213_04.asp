...
<title>Briefing on Typhoon Pablo</title>
...
<table id="container">
	<tr>
		...
		<p><strong>
		<!-- PhotoTitle.start -->BRIEFING ON TYPHOON PABLO:</strong>
		<!-- PhotoCaption.start -->
	 	Senator Loren Legarda, chair of the Senate Committee on Climate Change, points to a geohazard map during a briefing on Typhoon Pablo, which recently devastated Compostela Valley and other parts of Mindanao. Secretary Ramon Paje of the Department of Environment and Natural Resources (DENR) and Engr. Leo Jasareno, Acting Director of the Mines and Geosciences Bureau, also attended the briefing. (PRIB Photo by Edward Ganal)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
