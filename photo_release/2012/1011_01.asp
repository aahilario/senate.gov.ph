...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1011_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->BUDGET HEARING:</strong>
		<!-- PhotoCaption.start -->
 		Senator Serge Osmeña, chair of the Senate Committee on Energy, questions officials of the Department of Energy (DOE) during the continuation of budget deliberations on the agency’s proposed budget for the year 2013 Thursday, October 11, 2012. (PRIB Photo by Joseph Vidal) </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
