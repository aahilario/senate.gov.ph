...
<table id="container">
	<tr>
		...
		<p><strong>
		<!-- PhotoTitle.start -->RICE SMUGGLING:</strong>
		<!-- PhotoCaption.start -->
	 	Senate President Juan Ponce Enrile questions resource persons during the continuation of a Senate hearing investigating the alleged illegal shipment of 420,000 sacks of Indian rice in Subic Bay Freeport Zone. Senator Francis “Kiko” Pangilinan, chair of the Senate Committee on Agriculture and Food, also attended the hearing. (PRIB Photo by Joseph Vidal)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
