...
<title>Kahpihan sa Senado with Sen. Drilon</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1122_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->KAPIHAN SA SENADO WITH SENATOR DRILON:</strong>
		<!-- PhotoCaption.start -->
	 	Senator Franklin Drilon, chair of the Senate Finance Committee, answers questions on issues such as the sin tax bill, 2013 elections and the recent appointment of former UP College of Law Dean as Associate Justice of the Supreme Court during the Kapihan sa Senado, Thursday, November 22, 2012.(PRIB PHOTO by JOSEPH VIDAL)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
