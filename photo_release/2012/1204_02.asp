...
<title>Celebrating Kabaka's 27 years</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1204_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->CELEBRATING KABAKA’s 27 YEARS:</strong>
		<!-- PhotoCaption.start -->
	 	Senate President Juan Ponce Enrile together with Congressman Amado Bagatsing and Valenzuela Councilor Shalani Soledad leads the offertory rights during a mass celebrating the 27th Anniversary of the Kabalikat ng Bayan sa Kaunlaran (KABAKA), held yesterday at the Ninoy Aquino Stadium in Manila. (Photo by Joe Arazas).</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
