...
<title>Koko attends Human Security Convention</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1022_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->KOKO ATTENDS HUMAN SECURITY CONVENTION:</strong>
		<!-- PhotoCaption.start -->
 		 Senator Koko Pimentel speaks before participants of the 10th Luzon Convention on Advancing Human Security, which was hosted by the Provincial Board Members League of the Philippines at the Holiday Inn Galleria in Ortigas Center, Pasig City, last October 19, 2012. (PRIB Photo by Albert Calvelo) </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
