...
<title>Hearing on the Meat Inspection Code</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1204_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->HEARING ON THE MEAT INSPECTION CODE:</strong>
		<!-- PhotoCaption.start -->
	 	Senator Kiko Pangilinan, chair of the Senate Committee on Agriculture and Food, conducts a public hearing on the Meat Inspection Code of the Philippines, Tuesday, December 4, 2012. (PRIB PHOTO by ALEX NUEVAESPANA)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
