...
<title>Hearing on rice smuggling</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1017_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->HEARING ON RICE SMUGGLING:</strong>
		<!-- PhotoCaption.start -->
 		Senate President Juan Ponce Enrile stresses a point during a public hearing on the alleged rice smuggling incident at the Subic Bay Freeport Zone. Together with Enrile are Senators Kiko Pangilinan, chair of the Senate Agriculture and Food Committee, and TG Guingona, chair of the Senate Blue Ribbon Committee. (PRIB PHOTO by ALBERT CALVELO) </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
