...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1107_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SIN TAX DELIBERATIONS:</strong>
		<!-- PhotoCaption.start -->
	 	Senator Frank Drilon consults with Bureau of Internal Revenue (BIR) chief Kim Henares during sin tax deliberations Tuesday, November 6, 2012. Drilon, acting chair of the Senate Committee on Ways and Means, has filed a substitute bill that seeks to raise between P40 billion and P45 billion in additional taxes from tobacco and alcohol products in its first year of implementation. (PRIB Photo by Joseph Vidal)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
