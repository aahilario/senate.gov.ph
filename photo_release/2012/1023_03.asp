...
<title>Koko speaks at Broadcasting Workshop</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1023_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->KOKO SPEAKS AT BROADCASTING WORKSHOP:</strong>
		<!-- PhotoCaption.start -->
 		Senator Koko Pimentel speaks before student leaders during a broadcast workshop hosted by the Manila Broadcasting Company and AM radio station DZRH, which was held at the Development Academy of the Philippines (DAP) in Tagaytay City last October 22, 2012. (PRIB Photo by Alex Nuevaespaña)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
