...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1113_05.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->MEGAWORLD CORP:</strong>
		<!-- PhotoCaption.start -->
	 	 Senator Franklin M. Drilon discusses with Megaworld Corp. First Vice President Jericho Go, Ioilo City Representative Jerry Treñas, and Iloilo City Mayor Jed Patrick Mabilog the multi-million state-of-the-art Iloilo Convention Center - a brainchild of Drilon in support of the country’s business tourism and to make the Iloilo the next conference hub of Western Visayas and nearby regions. (Photo by Alex Nuevaespana/PRIB).</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
