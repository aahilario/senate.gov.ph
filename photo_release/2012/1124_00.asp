...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1124_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->AURORA BAMBOO CENTER:</strong>
		<!-- PhotoCaption.start -->
	 	Senator Edgardo J. Angara delivers a short message at the opening of the Aurora Bamboo Center, a project of his office together with local SMEs and the DTI.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
