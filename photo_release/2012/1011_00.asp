...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1011_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->COMELEC BUDGET:</strong>
		<!-- PhotoCaption.start -->
 		Senator Franklin Drilon, chair of the Senate Finance Committee, and Senator Allan Peter Cayetano question Commission on Elections (COMELEC) chairman Sixto Brillantes during the continuation of a Senate hearing looking into the agency’s proposed budget for the year 2013. (PRIB Photo by Albert Calvelo)  </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
