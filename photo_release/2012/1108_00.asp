...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1108_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->ENERGY COMMITTEE HEARING:</strong>
		<!-- PhotoCaption.start -->
	 	 Senator Serge Osmeña, chair of the Senate Energy Committee, conducts a public hearing on the Power Sector Assets and Liabilities Management Corporation (PSALM), Thursday, November 8, 2012. (PRIB PHOTO by JOSEPH VIDAL)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
