...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/1124_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->AURORA BAMBOO CENTER:</strong>
		<!-- PhotoCaption.start -->
	 	Senator Edgardo J. Angara and other local officials watch as workers demonstrate how bamboo slats are processed.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
