...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 10, 2012<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2012/1010_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->SIN TAXES:</strong>
		<!-- PhotoCaption.start -->
 		Senate President Pro-Tempore Jinggoy Ejercito Estrada looks at a PowerPoint presentation presented by Senator Ralph Recto during his sponsorship speech on Senate Bill No. 3299, which seeks to restructure the excise tax on alcohol and tobacco products. The Senate is set to start deliberating on the measure, which, Recto said, poses a deterrent that will keep people from being sick and at the same time generate revenues that will treat them when they get sick.(PRIB Photo by Joseph Vidal/10 October 2012)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
