...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2012/0930_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->LEGARDA VISITS PANGASINAN FOR CORN SEEDS DISTRIBUTION:</strong>
		<!-- PhotoCaption.start -->
		Senator Loren Legarda presents sacks of corn seeds to Sta. Maria Mayor Teodoro A. Ramos, Abono Partylist Chairman Engr. Rosendo So and members of the Local Government Unit of Sta. Maria, Pangasinan.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
