...
<title>Sen Angara with GAB officials</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2018/1008_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Sen Angara with GAB officials:</strong>
		<!-- PhotoCaption.start -->
		Sen. Sonny Angara poses with officials of the Games and Amusements Boad (GAB) during the sidelines of a Senate budget hearing on Monday.     
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
