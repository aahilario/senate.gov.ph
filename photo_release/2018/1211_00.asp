...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 11, 2018<p style="text-align: center;">
		<img src="../2018/1211_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->DepEd budget:</strong>
		<!-- PhotoCaption.start -->
		Education Secretary Leonor Magtolis Briones delighted as the Senate on Tuesday night approves in the plenary the proposed P499.5 billion budget of the agency for FY 2019 (Photo by Joseph Vidal, PRIB)   
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
