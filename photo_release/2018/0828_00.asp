...
<title>Philippine Harvest </title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2018/0828_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Philippine Harvest:</strong>
		<!-- PhotoCaption.start -->
		Senator Nancy Binay attends the launch of the Philippine Harvest initiative of the Department of Tourism event to promote farm tourism and the different local products in the country.<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
