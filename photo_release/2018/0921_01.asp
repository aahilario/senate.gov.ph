...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2018/0921_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Passing of the torch:</strong>
		<!-- PhotoCaption.start -->
		Church leaders and opposition stalwarts passed the torch to the youth leaders on the eve of the commemoration of Martial Law (September 20) at the historic Plaza Miranda. This act symbolizes the millennials' role in continuing the fight for the country's democracy.      
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
