...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2018/1111_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Pride of Cebu:</strong>
		<!-- PhotoCaption.start -->
		Sen. Grace Poe accompanied by GMR Megawide Chief Executive Advisor Andrew Harrison tours the world-class structure and facilities of the Terminal 2 of the Mactan-Cebu International Airport (MCIA). Poe says that the new terminal should serve as an example for future Public-Private Partnerships in the country.         
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
