...
<title>Simulated Birth Rectification Act</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 12, 2018<p style="text-align: center;">
		<img src="../2018/1212_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Simulated Birth Rectification Act:</strong>
		<!-- PhotoCaption.start -->
		Senators Risa Hontiveros, Nancy Binay and Bam Aquino, together with their counterparts in the House of Representatives signed today the Bicameral Conference Committee Report of the Simulated Birth Rectification Act which paves the way for the legal adoption of children whose birth records were simulated.   
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
