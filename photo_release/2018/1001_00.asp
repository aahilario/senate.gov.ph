...
<title>Escuela Taller exhibit</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2018/1001_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Escuela Taller exhibit:</strong>
		<!-- PhotoCaption.start -->
		We laud the efforts of Escuela Taller, the Intramuros Administration, and other advocates in safeguarding our country's built heritage by teaching the youth skills to preserve, conserve, and maintain historic structures. Thank you for inviting me to be part of the awarding and exhibition opening of Escuela Taller expansion competition.            
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
