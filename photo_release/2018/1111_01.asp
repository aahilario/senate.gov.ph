...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 11, 2018<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2018/1111_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->State of the art:</strong>
		<!-- PhotoCaption.start -->
		Sen. Grace Poe checks the Immigration Electronic Gates (E-Gates) of the newly-built Terminal 2 during a recent visit to Cebu on Saturday, November 10. The E-Gates are equipped with modern security features, including facial recognition, biometric scanning, bar code reading, and smart card recognition which aim to cut the processing time to 8-15 seconds from the average time of 45 seconds.        
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
