...
<title>Murcia, Negros Occidental</title>
...
<table id="container">
	<tr>
		...
		<img src="../2018/1210_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Murcia, Negros Occidental:</strong>
		<!-- PhotoCaption.start -->
		Senator Nancy Binay celebrates the town fiesta of Murcia, Negros Occidental with local officials led by Mayor Andrew Montelibano.       
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
