...
<title>Villar pushes developmental ways to fight hoarding, cartel</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->September 12, 2018<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2018/0912_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Villar pushes developmental ways to fight hoarding, cartel:</strong>
		<!-- PhotoCaption.start -->
		During the continuation of the hearing on the P55.9 billion proposed budget of the Department of Agriculture (DA), Sen. Cynthia Villar expressed exasperation over the failure to stop cartels and hoarding, which she identified as the ones causing the artificial shortage and high prices of rice and other agricultural products. The chairperson of the Committee on Agriculture and Food encouraged the DA to implement 'developmental' measures to counter the operation of cartels and hoarders by improving the productivity and competitiveness of local farmers. Villar said farm mechanization and the use of good seeds will increase the farmers' yield and will reduce the cost of producing palay. Photo also shows DA Sec. Emmanuel Pinol.       
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
