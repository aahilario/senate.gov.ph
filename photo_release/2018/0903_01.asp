...
<title>Bills on Education Reform</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->September 3, 2018<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2018/0903_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --> Bills on Education Reform:  </strong>
		<!-- PhotoCaption.start -->
		Senator Francis Escudero, chairman of the Senate Committee on Education, Arts and Culture, fields questions to officials from the Department of Education (DepEd) and Commission on Higher Education (CHED) regarding the state of the country's educational system during a hearing by the committee on Monday, September 3, 2018. The hearing focused on a package of bills on reforms to the education sector such as the proposed Class Size Act (SBN 1878) which would "regulate class size in public schools and prescribe additional compensation for teachers handling large classes." Also in photo are Senators Sonny Angara and Sherwin Gatchalian. (PRIB Photo by Albert Calvelo/ 03 September 2018)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
