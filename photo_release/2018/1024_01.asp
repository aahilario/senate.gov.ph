...
<title>Villar Cites the Global Demand for Cacao</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 24, 2018<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2018/1024_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Villar Cites the Global Demand for Cacao:</strong>
		<!-- PhotoCaption.start -->
		 As Chaiperson of the Senate Agriculture and Food Committee, Senator Cynthia A. Villar says she has been helping find international markets for our cacao products. She says these are exciting times for the cacao industry due to the increase in its global demand in the learning session on postharvest system for cacao with the operation of community-based cacao processing enterprises with rep. helen tan and gumaca, quezon mayor erwin carailan, the senator cites the importance of continuing education and training programs to make filipino farmers and other industry stakeholders more competitive and profitable.  
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
