...
<title>Why let the buses out?</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2018/1204_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Why let the buses out?:</strong>
		<!-- PhotoCaption.start -->
		 Sen. Grace Poe, chairperson of the Senate Committee on Public Services, questions officials of the Land Transportation and Franchising and regulatory Board for alllowing more than 300 provincial buses to traverse along EDSA and Roxas Blvd. instead of terminating their routes at the newly-opened Paranaque Integrated Terminal Exchange (PITX) during a public hearing Tuesday, December 4. (Photo by Alex Nueva Espana, PRIB)
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
