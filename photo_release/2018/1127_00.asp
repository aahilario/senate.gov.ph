...
<title>Sen. Angara rallies young Gentrisenos for nation building</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 27, 2018<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2018/1127_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Sen. Angara rallies young Gentrisenos for nation building:</strong>
		<!-- PhotoCaption.start -->
		Sen. Sonny Angara delivers a speech during the 7th General Trias Youth Leaders Summit with the theme "Young Gentrisenos: Transforming Vision into Action."
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
