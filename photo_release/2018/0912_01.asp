...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2018/0912_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Strong women:</strong>
		<!-- PhotoCaption.start -->
		Former Chief Justice Maria Lourdes Sereno on Wednesday made a courtesy visit to Akbayan Senator Risa Hontiveros to personally thank her for the latter's relentLess defense of democracy, human rights and the rule of law. The two women exchanged thoughts and perspectives regarding important national issues. (Photo by Joseph Vidal/PRIB)       
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
