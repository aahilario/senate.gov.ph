...
<title>'Seatmates' go to school in Cebu</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2018/1119_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->'Seatmates' go to school in Cebu:</strong>
		<!-- PhotoCaption.start -->
		Senators Nancy Binay, Sonny Angara, and JV Ejercito pose with students from Cebu Technological University Friday, November 16.
		<p>The three senators, who belong to the “Seatmates” bloc, also visited Cebu Normal University.
		<p>During their talk with the students, the senators urged for more youth participation in issues that affect the country.
		<p>While in Cebu, the Seatmates also discussed various national issues in separate talks with local media.
<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
