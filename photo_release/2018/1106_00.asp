...
<title>Sen. Bam receives prestigious award</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 6, 2018<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2018/1106_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Sen. Bam receives prestigious award:</strong>
		<!-- PhotoCaption.start -->
		Sen. Bam Aquino receives the prestigious IBPAP-PLDT Azure Flare for Industry Luminary Award in recognition of his contribution to develop and strengthen IT and BPO sector through his legislative work during Monday night’s awarding ceremonies at The Peninsula Manila. Also in photo are (from left) Miguel del Rosario (president of Animation Council Philippines), Vic Tria (First VP and head of PLDT Alpha), Jovi Hernandez (head of PLDT and Smart Enterprise Group), and Beng Coronel (HIMAP President).
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
