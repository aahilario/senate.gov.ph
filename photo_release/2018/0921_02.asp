...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2018/0921_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Moral courage:</strong>
		<!-- PhotoCaption.start -->
		Manila Archbishop Broderick Pabillo joined Akbayan Senator Risa Hontiveros at the Plaza Miranda on the eve of the commemoration of the declaration of Martial Law.      
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
