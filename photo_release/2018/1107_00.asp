...
<title>Resumption of hearing</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 7, 2018<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2018/1107_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Resumption of hearing:</strong>
		<!-- PhotoCaption.start -->
		Opposition Senator Leila M. de Lima, flanked by heavily-armed PNP personnel, leaves the Quezon City Hall of Justice after attending a hearing on the "Disobedience to Summons" case filed against her at the QC Metropolitan Trial Court, Branch 34. 
		<p>Despite the Court granted access to reporters during the two-minute hearing, the police escorts of Sen. De Lima still denied the media to interview or take better photographs of her. 
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
