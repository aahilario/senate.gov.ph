...
<title>Citizenship Endorsed</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 17, 2018<p style="text-align: center;">
		<img src="../2018/1217_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Citizenship Endorsed:</strong>
		<!-- PhotoCaption.start -->
		Senator Richard Gordon (left) and Majority floor leader Juan Miguel “Migz” Zubiri (right) congratulate Mohamad Wassim Nanaa (center) after the Senate Committee on Justice and Human Rights endorsed his application for Philippine citizenship Monday, 17 December 2018. Nanaa is the honorary consul general of the Philippines in Aleppo, Syria, a post he has occupied since 2008. (PRIB Photo by Cesar Tomambo/17 December 2018).   
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
