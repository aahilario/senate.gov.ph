...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2018/1111_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Terminal visit:</strong>
		<!-- PhotoCaption.start -->
		Sen. Grace Poe inspects the check-in counters of the newly opened Terminal 2 of the Mactan-Cebu International Airport which is expected to expand passenger capacity to 12.5 million per year.       
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
