...
<title>UP Singing Ambassadors</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 9, 2018<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2018/1009_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->UP Singing Ambassadors:</strong>
		Maraming salamat UP Singing Ambassadors Nawa'y patuloy kayong maging inspirasyon sa ating mga kababayan gamit ang inyong talento at musika.        
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
