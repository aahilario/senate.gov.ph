...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2018/1111_03.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Inspection:</strong>
		<!-- PhotoCaption.start -->
		Sen. Grace Poe conducts an ocular inspection of the facilities at the Terminal 2 of the Mactan-Cebu International Airport which showcased craftsmanship and ingenuity in its design.         
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
