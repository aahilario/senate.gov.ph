...
<title>Inspiring Filipino professionals to be globally competitive</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2018/1015_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Inspiring Filipino professionals to be globally competitive:</strong>
		<!-- PhotoCaption.start -->
		As the 7th Professional Summit tackles its "Trilemma" of challenges for globally competitive local professionals -- namely environment, socio-economic and health issues -- Sen. Sonny Angara delivered the keynote speech today to kickstart the two-day forum at the Manila Hotel.       
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
