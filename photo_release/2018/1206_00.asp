...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 6, 2018<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2018/1206_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Budget insertion:</strong>
		<!-- PhotoCaption.start -->
		Senator Loren Legarda, chair of the Committee on Finance, assures Sen. Panfilo Lacson there is no “pork” insertions in the proposed P3.757 trillion national budget for next year. (Photo by Cesar Tomambo, PRIB)<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
