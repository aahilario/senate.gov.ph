...
<title>Pacquiao starts LA training before dawn</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 26, 2018<p style="text-align: center;">
		<img src="../2018/1226_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Pacquiao starts LA training before dawn:</strong>
		<!-- PhotoCaption.start -->
		Manny Pacquiao and members of his training team run the streets of Los Angeles leading to Pan Pacific Park where they conclude their morning workout with some shadow boxing and abdominal exercises before dawn on Thursday. (Photos by Wendell Alinea/MP Promotions)   
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
