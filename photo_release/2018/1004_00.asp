...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 4, 2018<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2018/1004_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Quezon City:</strong>
		<!-- PhotoCaption.start -->
		Under heavy security, Opposition Senator Leila M. de Lima leaves the Quezon City Metropolitan Trial Court Branch 34 courtroom after the Prosecution failed to present its witness today, (04 October 2018). The hearing has been rescheduled for November 7.                
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
