...
<title>Hearing on DPWH 2019 Budget</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2018/0903_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start --> Hearing on DPWH 2019 Budget:  </strong>
		<!-- PhotoCaption.start -->
		 Senator Loren Legarda, chairperson of the Senate Committee on Finance, reviews the presentation made during the committee hearing on the proposed 2019 budget of the Department of Public Works and Highways (DPWH) on Monday, September 3, 2018.  Citing the executive branch's push for annual cash-based budgeting, Legarda urged the DPWH to ensure that their projects are not only obligated but "also implemented and disbursed within one year, with a possible extension only for payment until the first or second quarter of the following year." Also in photo are (from left to right) Senators Risa Hontiveros, Joseph Victor Ejercito and Panfilo Lacson. (PRIB Photo by Cesar Tomambo/3 September 2018)        <td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
