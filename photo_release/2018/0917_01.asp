...
<title>Villar pushes cheaper accreditation cost for organic produce</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->September 17, 2018<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2018/0917_01.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Villar pushes cheaper accreditation cost for organic produce:</strong>
		<!-- PhotoCaption.start -->
		Sen. Cynthia Villar, chairperson of the Committee on Agriculture and Food, discusses with Department of Agriculture Usec. Jose Gabriel Laviña and Engr. Christopher Morales of the National Organic Agriculture Program the amendment of Republic Act 10068 or the Organic Agriculture Act of 2010 for the implementation of the Participatory Guarantee System (PGS) as a way to accredit organic products. Villar said PGS will make organic products cheaper and more accessible to many consumers as this will only cost organic producers P1,000 in contrast to third party accreditation which costs P100,000.    
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
