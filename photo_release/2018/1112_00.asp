...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 12, 2018<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2018/1112_00.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->United Kingdom:</strong>
		<!-- PhotoCaption.start -->
		Sen. Emmanuel "Manny" D. Pacquiao was invited to speak before the debating societies at OXBRIDGE, University of Oxford and University of Cambridge, the two oldest and most prestigious universities in the United Kingdom on November 5 and 6, 2018.       
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
