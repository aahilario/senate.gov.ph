...
<table id="container">
	<tr>
		...
		<img src="1210_02.jpg" class="style1" /></p>
		<p><strong>
		<!-- PhotoTitle.start -->Alay Lakad:</strong>
		<!-- PhotoCaption.start -->
		Sen. Nancy Binay joins the Alay Lakad in Guagua, Pampanga, with local officials led by Mayor Dante Torres and Board Member Anthony Torres.       
		<td id="sidepane">
	 	<div id="sidepane_l2">
		</div>
