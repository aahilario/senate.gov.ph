...
<title>Senate starts budget deliberations</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1119_07.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->SENATE STARTS BUDGET DELIBERATIONS:</strong>
		<!-- PhotoCaption.start -->
		Senate President gives a thumbs-up to signal the start of budget deliberations Tuesday, November 19. Drilon earlier sought the creation of a special fund amounting to at least P10 billion in the proposed 2014 national budget that can be used to address the damages brought about by the recent calamities, including the devastating super typhoon Yolanda that wrought havoc in Central Visayas particularly Leyte, the typhoon Santi that hit Central Luzon, the siege in Zamboanga City, and the 7.2 magnitude earthquake that hit Bohol and Cebu provinces. (PRIB Photo by Joseph Vidal)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
