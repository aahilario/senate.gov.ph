...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1204_05.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->COURTESY CALL:</strong>
		<!-- PhotoCaption.start -->
		Senate President Franklin M. Drilon welcomes delegates from Papua New Guinea led by Autonomous Region of Bougainville President Dr. John Momis and his wife, Madame Elizabeth Momis, before the start of the plenary session, Wednesday afternoon. (PRIB Photo by Cesar Tomambo/4 December 2013)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
