...
<title>Senate Tribunal Oathtaking</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1128_01.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->SENATE TRIBUNAL OATHTAKING:</strong>
		<!-- PhotoCaption.start -->
		Senator Nancy Binay takes her oath of office, on (November 28, 2013),  as a member of the Senate Electoral Tribunal (SET). Supreme Court Associate Justice Antonio T. Carpio swore in the lady senator during the SET's meeting at the Sofitel Hotel, in Pasay City.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
