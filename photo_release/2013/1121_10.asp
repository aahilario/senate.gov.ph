...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1121_10.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->BUDGET HEARING:</strong>
		<!-- PhotoCaption.start -->
		Senate President Franklin Drilon and Commission on Elections (Comelec) Chairman Sixto Brillantes, Jr. engage in a brief conversation after deliberations for the 2014 budget of the Comelec, Thursday afternoon. (PRIB Photo by ALBERT CALVELO / November 21, 2013)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
