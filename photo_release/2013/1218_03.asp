...
<table id="container">
	<tr>
		...
		<img src="1218_03.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->CONFIRMED:</strong>
		<!-- PhotoCaption.start -->
	    Senator Nancy Binay congratulates Demosthenes C. Santillan after the Commission on Appointments (CA) approved his confirmation, promoting him from the grade of Colonel to the grade of Brigadier General Wednesday, December 18. (PRIB Photo by Alex Nuevaespaña)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
