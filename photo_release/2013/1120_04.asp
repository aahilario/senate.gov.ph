...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1120_04.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->DEFENSE BUDGET:</strong>
		<!-- PhotoCaption.start -->
		Senator Bam Aquino talks to Defense Secretary Voltaire Gazmin before the start of deliberations for the proposed 2014 budget of the Department of National Defense (DND) Wednesday, November 20. (PRIB Photo by Cesar Tomambo)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
