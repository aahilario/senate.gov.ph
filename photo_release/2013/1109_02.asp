...
<title>Cambodia Opposition Leader greets Drilon</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1109_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->CAMBODIA OPPOSITION LEADER GREETS DRILON:</strong>
		<!-- PhotoCaption.start -->
		The leader of the Cambodian Opposition, Hon. Sam Rainsy, touted as the Ninoy Aquino of Cambodia, greets Drilon after the latter delivered his speech which tackles the pork barrel issue and the essence of democracy. Cesar Tomambo/Senate PRIB </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
