...
<title>During a break in session</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1127_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->DURING A BREAK IN SESSION:</strong>
		<!-- PhotoCaption.start -->
		Senate President Franklin M. Drilon shares a light moment with Senators Serge Osmeña III, Juan Ponce Enrile, and Joseph Victor Ejercito after Enrile's privilege speech  last Wednesday afternoon. (PRIB Photo by Joseph Vidal/27 November 2013)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
