...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1210_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->ELECTORAL REFORMS:</strong>
		<!-- PhotoCaption.start -->
		Senator Aquilino "Koko" Pimentel, Chair of the Senate Committee on Electoral Reforms and People’s Participation, conducts an inquiry, in aid of legislation, on the allegations that the Commission on Elections (COMELEC) was still printing ballots months after the May 2013 elections. (PRIB Photo by Alex Nuevaespaña/10 December 2013)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
