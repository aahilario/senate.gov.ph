...
<title>During budget deliberations</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1121_16.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->DURING BUDGET DELIBERATIONS:</strong>
		<!-- PhotoCaption.start -->
		Senate President Franklin M. Drilon exchanges views with Senators Chiz Escudero, Cynthia Villar, Sonny Angara and Bam Aquino during a break in the ongoing deliberations for the 2014 budget of the Department of Environment and Natural Resources, Thursday, November 21. (PRIB Photo by Cesar Tomambo)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
