...
<table id="container">
	<tr>
		...
		<img src="1217_04.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->WAYS AND MEANS HEARING:</strong>
		<!-- PhotoCaption.start -->
	    The Senate Committee on Ways and Means, chaired by Sen. Sonny Angara, holds a public hearing on bills that seek to increase tax exemption cap for 13th month pay and other benefits.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
