...
<title>Estancia Fishport and Public Market</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1121_03.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->ESTANCIA FISHPORT AND PUBLIC MARKET:</strong>
		<!-- PhotoCaption.start -->
		Sen. Nancy Binay (with megaphone) addresses the crowd gathered in front of the Estancia Fishport and Public Market last week. The senator was in the Iloilo town to hand out relief goods to residents affected by the Super Typhoon "Yolanda."</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
