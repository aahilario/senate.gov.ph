...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1121_04.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->ZARRAGA, ILOILO:</strong>
		<!-- PhotoCaption.start -->
		Sen. Nancy Binay shares a light moment with the elderly residents of Zarraga, Iloilo last week.The senator was in the Iloilo town to hand out relief goods to residents and meet with local government officials affected by the Super Typhoon "Yolanda."</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
