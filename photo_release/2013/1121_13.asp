...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1121_13.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->PCOO BUDGET:</strong>
		<!-- PhotoCaption.start -->
		Senator Jinggoy Ejercito Estrada takes the podium and asks questions to Senate Finance Committee Chairman Sen. Francis Escudero regarding the modernization plans for government-owned television networks PTV4 and IBC 13 during the plenary deliberations on the 2014 budget of the Presidential Communications Operations Office (PCOO).</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
