...
<title>Gazmin attends budget deliberations</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 20, 2013<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2013/1120_05.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->GAZMIN ATTENDS BUDGET DELIBERATIONS:</strong>
		<!-- PhotoCaption.start -->
		Senate Finance committee chair Francis Escudero shares a light moment with Defense Secretary Voltaire Gazmin who attended the budget deliberations, Wednesday Morning. The proposed budget of the department for 2014 will amount to P 123.1 billion. (PRIB Photo by Alex Nuevaespana, November 20, 2013)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
