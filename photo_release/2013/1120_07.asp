...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1120_07.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->DTI BUDGET:</strong>
		<!-- PhotoCaption.start -->
		Senator Serge Osmeña defends the proposed 2014 budget of the Department of Trade and Industry, headed by Secretary Gregory Domingo, during budget deliberations Wednesday afternoon. (PRIB Photo by Cesar Tomambo/20 November 2013)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
