...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1121_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->BUDGET HEARING:</strong>
		<!-- PhotoCaption.start -->
		Senate President Franklin Drilon talks to Ombudsman Conchita Carpio Morales before the start of deliberations for the  2014 budget of the Office of the Ombudsman, Thursday, November 21, 2013. (PRIB Photo by ROMEO BUGANTE)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
