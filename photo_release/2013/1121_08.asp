...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1121_08.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->MARIBOJOC CHURCH:</strong>
		<!-- PhotoCaption.start -->
		Sen. Nancy Binay walks pass the fallen bell of Maribojoc Church one month after the 7.2 magnitude earthquake struck the town. The senator last week pledged that she will help in the reconstruction efforts in the town.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
