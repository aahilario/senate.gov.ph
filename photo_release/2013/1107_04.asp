...
<title>Continuation of the PDAF Scam Probe</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1107_04.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->CONTINUATION OF THE PDAF SCAM PROBE:</strong>
		<!-- PhotoCaption.start -->
		Senate President Franklin M. Drilon, Blue Ribbon Committee chair Sen. TG Guingona, Majority Leader Alan Peter Cayetano, and Sen. Bam Aquino discuss the request of Ms. Janet Lim Napoles for an executive session during the hearing on the pork barrel scam Thursday, November 7. Sen. Chiz Escudero also attended the hearing. (PRIB Photo by Cesar Tomambo) </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
