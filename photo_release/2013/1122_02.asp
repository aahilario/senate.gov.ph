...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1122_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->37TH UNESCO GENERAL CONFERENCE:</strong>
		<!-- PhotoCaption.start -->
		Senator Loren Legarda presents UNESCO Director General Irina Bokova with a copy of the book “Philippines: Archipel des Echanges”, which is a catalogue of the Philippine cultural objects and artworks featured in the exhibition held between April to July 2013 at the Musée du Quai Branly in Paris. Legarda, head of the Philippine Delegation to the 37th UNESCO General Conference, together with UNESCO Permanent Delegate Ambassador Cristina Ortega and Commission on Higher Education Secretary Dr. Patricia B. Licuanan, held bilateral talks with Bokova at the sidelights of the conference.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
