...
<title>Supreme Court, Manila</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 4, 2013<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2013/1104_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->SUPREME COURT, MANILA:</strong>
		<!-- PhotoCaption.start -->
		Vice President Jejomar C. Binay (first from left) and Senator Nancy S. Binay (second from left) pay their last respects to former Supreme Court Chief Justice Andres R. Narvasa during the memorial service held today at the SC session hall.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
