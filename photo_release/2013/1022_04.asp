...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1022_04.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->BREAST CANCER AWARENESS MONTH:</strong>
		<!-- PhotoCaption.start -->
		Senator Jinggoy Ejercito Estrada wears a pink ribbon on his chest as he joins in the observance of the Breast Cancer Awareness Month this October. Sen. Estrada is seen here asking questions to Senator Pia Cayetano after delivering her privilege speech which calls on the people to help raise awareness and dissemination of proper information about breast cancer. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
