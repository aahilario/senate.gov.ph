...
<title>Drilon welcomes Kasparov</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1120_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->DRILON WELCOMES KASPAROV:</strong>
		<!-- PhotoCaption.start -->
		Senate President Franklin M. Drilon welcomes former world chess champion Gary Kasparov during a courtesy call Tuesday afternoon. Kasparov is in Manila to campaign for the World Chess Federation (FIDE) presidency. (PRIB Photo by Joseph Vidal/20 November 2013)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
