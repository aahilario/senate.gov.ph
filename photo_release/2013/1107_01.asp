...
<title>Whistleblower Ben Luy Attends Senate Probe</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 7, 2013<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2013/1107_01.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->WHISTLEBLOWER BEN LUY ATTENDS SENATE PROBE:</strong>
		<!-- PhotoCaption.start -->
		Whistleblower Benhur Luy is accompanied by agents of the National Bureau of Investigation as he makes his way to the Senate’s plenary hall to attend the Blue Ribbon committee hearing on the alleged P10 billion Priority Development Assistance Fund (PDAF) scam. (PRIB Photo by Joseph Vidal/7 November 2013)   </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
