...
<title>Budget deliberation starts</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1119_06.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->BUDGET DELIBERATION STARTS:</strong>
		<!-- PhotoCaption.start -->
		Sen. Chiz Escudero, chair of the Senate Finance Committee, speaks before the start of budget deliberations Tuesday, November 19. He is joined by Budget Secretary Butch Abad, Socioeconomic Planning Secretary Arsenio Balisacan, Internal Revenue Commissioner Kim Henares and Finance Secretary Cesar Purisima. (PRIB Photo by Alex Nuevaespaña) </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
