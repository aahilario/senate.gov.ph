...
<title>Sen. Pimentel tests former world champion</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 21, 2013<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2013/1121_12.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->SEN. PIMENTEL TESTS FORMER WORLD CHAMPION:</strong>
		<!-- PhotoCaption.start -->
		Senator Aquilino “Koko” Pimentel, III (right) tests the mettle of former world chess champion Garry Kasparov with the black pieces when the latter visited him on the course of his short stop in the country to promote his worldwide tour for the FIDE (International Chess Federation) presidency next year. The late Florencio Campomanes was the first and only Filipino to head the elite sports body dominated by Soviet leaders for a long time.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
