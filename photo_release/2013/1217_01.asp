...
<title>South Korean envoy's courtesy call with Senate President Drilon</title>
...
<table id="container">
	<tr>
		...
		<p><strong>
		<!-- PhotoTitle.start -->SOUTH KOREAN ENVOY'S COURTESY CALL WITH SENATE PRESIDENT DRILON:</strong>
		<!-- PhotoCaption.start -->
	    South Korean ambassador to the Philippines Hyuk Lee confers with Senate President Franklin Drilon during the envoy's courtesy call at the Office of the Senate President on Tuesday, December 17. Lee has been serving as South Korea's representative to the country since 2012. (PRIB Photo by Cesar Tomambo)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
