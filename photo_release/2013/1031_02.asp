...
<title>Manila sends aid to Bohol</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1031_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->MANILA SENDS AID TO BOHOL:</strong>
		<!-- PhotoCaption.start -->
		The City of Manila led by Mayor Joseph Estrada, represented by his son Senator Jinggoy Ejercito Estrada and Manila City Administrator Simeon Garcia, Jr. (second from right), sends financial donation to the earthquake-devastated province of Bohol. The donation was received by Governor Edgardo Chatto last October 27 during Sen. Estrada’s visit to the province for another relief operation. Also seen in the photo (from left) are Balilihan Vice Mayor Maria Pureza Chatto, Cong. Erico Aris Aumentado and Provincial Administrator Alfonso Damalerio.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
