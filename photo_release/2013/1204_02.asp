...
<title>Legarda attends CA</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1204_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->LEGARDA ATTENDS CA:</strong>
		<!-- PhotoCaption.start -->
		Senator Loren Legarda, Chair of the Senate Committee on Environment, talks to members of the Commission on Appointments (CA) before the start of a hearing discussing the appointment of Environment and Natural Resources Secretary Ramon Paje Wednesday, December 4. (PRIB Photo by Cesar Tomambo)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
