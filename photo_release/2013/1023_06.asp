...
<title>Fiscal incentives hearing</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1023_06.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->FISCAL INCENTIVES HEARING:</strong>
		<!-- PhotoCaption.start -->
		The Senate Committee on Ways and Means chaired by Sen. Juan Edgardo M. Angara on Wednesday holds a hearing on the proposed granting of Fiscal and Non-Fiscal Incentives. Finance officials headed by DOF Secretary Cesar Purisima, BIR Commissioner Kim Jacinto Henares, other government officials and members of the different foreign business groups attended the said consultative meeting held at the Senate Wednesday, October 23. (PRIB Photo by ROMY BUGANTE)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
