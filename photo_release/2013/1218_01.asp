...
<title>Committee on Energy</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 18, 2013<p style="text-align: center;">
		<img src="1218_01.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->COMMITTEE ON ENERGY:</strong>
		<!-- PhotoCaption.start -->
	    Sen. Sergio Osmeña, Chair of Senate Committee on Energy, presides over a hearing looking into the planned big time increase in the generation cost charged by the Manila Electric Company (MERALCO), Wednesday morning. Senators Antonio Trillanes IV, TG Guingona, and Grace Poe also attended the hearing. (PRIB Photo by Alexis Nuevaespaña/18 December 2013)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
