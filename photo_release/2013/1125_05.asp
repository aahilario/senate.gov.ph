...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1125_05.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->BUDGET HEARING:</strong>
		<!-- PhotoCaption.start -->
		Department of Health (DOH) Secretary Enrique Ona discusses the proposed 2014 budget of the DOH with Senator Teofisto Guingona III, Chair of the Senate Committee on Health and Demography, during budget deliberations Monday afternoon. (PRIB Photo by ROMEO BUGANTE/ November 25, 2013)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
