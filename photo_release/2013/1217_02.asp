...
<title>Urban Planning, Housing and Resettlement</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 17, 2013<p style="text-align: center;">
		<img src="1217_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->URBAN PLANNING, HOUSING AND RESETTLEMENT:</strong>
		<!-- PhotoCaption.start -->
	    Committee on Urban Planning, Housing and Resettlement Chair Sen. Joseph Victor Ejercito and Sen. Ralph Recto conduct a hearing looking into proposed Senate Bill No. 1945, which seeks to extend the rent control of residential units, thereby amending Republic Act No. 9653, otherwise known as an Act establishing reforms in the regulation of rent of certain residential units, Tuesday, December 17. (PRIB Photo by Albert Calvelo)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
