...
<title>Ways and Means hearing</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1023_04.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->WAYS AND MEANS HEARING:</strong>
		<!-- PhotoCaption.start -->
		Senator JV Ejercito listens intently to John Forbes (left), Senior Adviser Senior Advisor for the USAID-funded Investment Climate Improvement Project (ICIP), and Rhicke Jennings, President of the American Chamber of Commerce, as they present their views on proposed Senate Bill No. 35, or the Investments and Incentives Code of the Philippines, and proposed Senate Bill No. 987, which seeks to harmonize the grant and administration of fiscal and non-fiscal incentives, during a hearing of the Ways and Means Committee Wednesday, October 23. (PRIB Photo by Cesar Tomambo)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
