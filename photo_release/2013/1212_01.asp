...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1212_01.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->COMMITTEE HEARING:</strong>
		<!-- PhotoCaption.start -->
		Senators Lito Lapid and Bongbong Marcos conduct a hearing on proposed Senate Bill No. 410, which seeks to establish a national green building code and rating system. The measure further seeks to attune the Philippines to the rising global standard in sustainable buildings and construction developments. (PRIB Photo by Romeo Bugante/12 December 2013)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
