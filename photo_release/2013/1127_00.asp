...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1127_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->PRIVILEGE SPEECH:</strong>
		<!-- PhotoCaption.start -->
		Senate Minority Leader Juan Ponce Enrile delivers a speech during 
		privilege hour, Wednesday afternoon, vehemently denying that he was the 
		mastermind behind the pork barrel scandal. He believed that history, in 
		a calmer and kinder social climate, will absolve him. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
