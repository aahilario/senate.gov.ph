...
<title>Philippine Association of University Women forum</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 10, 2013<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2013/1110_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->PHILIPPINE ASSOCIATION OF UNIVERSITY WOMEN FORUM:</strong>
		<!-- PhotoCaption.start -->
		Cynthia A. Villar receives a Plaque of Recognition from Phil. Assn. Of Univ. Women (UP Chapter) Pres. Carmela Pascual as the its Secretary, Adelaida Lucero, looks on. The senator calls on everyone to adopt a zero-waste lifestyle to protect the environment and avoid disasters during her Keynote Speech in the group's forum at Bahay ng Alumni, UP campus, Quezon City.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
