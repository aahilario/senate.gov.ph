...
<title>Senate employees greets Drilon on his Birthday</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1128_03.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->SENATE EMPLOYEES GREET DRILON ON HIS BIRTHDAY:</strong>
		<!-- PhotoCaption.start -->
		Senate employees led by Dulce Antonio of the Legislative Debate Reporters Service greet Senate President Franklin Drilon a happy birthday after the Finance Committee hearing, Thursday. Also in photo are Dax Millamena, Perla Mayor of the Samahan ng mga Empleyadong Nagkakaisa sa Adhikain ng Demokratikong Organisasyon (SENADO), together with Debate Reporters Isabel Barbadillo and Imelda Mejia. (PRIB Photo by Joseph Vidal/28 November 2013)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
