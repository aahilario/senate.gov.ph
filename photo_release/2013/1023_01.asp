...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1023_01.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->DRAGON BOAT:</strong>
		<!-- PhotoCaption.start -->
		Sens. Sonny Angara and Pia Cayetano with the Philippine Dragon Boat Team. At a Senate hearing on Tuesday, senators expressed hope that our paddlers could still compete at the 27th Southeast Asian Games after they were dropped from the national lineup, following a disagreement with their officials.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
