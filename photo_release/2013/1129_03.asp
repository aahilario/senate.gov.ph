...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1129_03.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->BRUSSELS, BELGIUM:</strong>
		<!-- PhotoCaption.start -->
		Senator Loren Legarda receiving the Award on Closing the Gender Gap (winner in South and Southeast Asia) from Kathy Calvin, President and CEO of the UN Foundation.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
