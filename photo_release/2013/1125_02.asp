...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 25, 2013<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2013/1125_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->DEPED BUDGET APPROVED:</strong>
		<!-- PhotoCaption.start -->
		Senator Chiz Escudero, Chair of the Senate Committee on Finance, congratulates Education Secretary Bro. Armin Luistro after the approval of the proposed 2014 Budget of the Department of Education (DEPED) Monday morning. (PRIB Photo by Cesar Tomambo/25 November 2013)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
