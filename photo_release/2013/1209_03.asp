...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1209_03.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->ALL SMILES:</strong>
		<!-- PhotoCaption.start -->
		Senator Jinggoy Ejercito Estrada shares a light moment with the residents of Guiuan, Eastern Samar during his recent visit to the municipality for a relief mission. Guiuan was one of the most devastated areas of super typhoon Yolanda, and where the storm considered as one of the strongest ever recorded in history made its first landfall.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
