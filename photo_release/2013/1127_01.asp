...
<title>Indonesian delegation visits the Senate</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 27, 2013<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2013/1127_01.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->INDONESIAN DELEGATION VISITS THE SENATE:</strong>
		<!-- PhotoCaption.start -->
		Senate President Franklin M. Drilon welcomes members of the Indonesian People’s Representative Council during a courtesy call at the Senate, Wednesday. In photo are (from left to right) Representatives Husni Nurin, Husnan Bey Fananie, Muchamad Rulan, Indonesian Ambassador Suprapto Martosetomo, Sayed Mustafa Usab, and Eko Hartono, Indonesia’s Consul General who is based in Davao City. (PRIB Photo by Cesar Tomambo/27 November 2013)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
