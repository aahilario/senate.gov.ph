...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1121_07.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->PASSI, ILOILO:</strong>
		<!-- PhotoCaption.start -->
		Sen. Nancy Binay (in blue shirt) meets with the mayor of Passi, Iloilo to discuss the devastation Super Typhoon "Yolanda" brought to their town and help enact measures to provide aid in the relief, rehabilitation and restoration efforts last week.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
