...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1119_10.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->BUDGET DELIBERATIONS:</strong>
		<!-- PhotoCaption.start -->
		Senator Chiz Escudero reviews documents before the start of budget deliberations Tuesday afternoon. (PRIB Photo by Romeo Bugante/19 November 2013)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
