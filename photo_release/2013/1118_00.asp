...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->November 18, 2013<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2013/1118_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->RICE IMPORTATION:</strong>
		<!-- PhotoCaption.start -->
		Senator Cythia A. Villar, chair of the Senate Committee on Agriculture, with Agriculture Secretary Proceso Alcala (left) and Customs Commissioner Ruffy Biazon (right) answers questions from the media on the actual state of rice supply in the country, recent rice importation from Vietnam, extent of damage brought by Super Typhoon Yolanda on crops, other agricultural products and infrastructure as well as the reported rampant rice smuggling in regional ports including Davao Ports.  (PRIB Photo by Cesar Tomambo)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
