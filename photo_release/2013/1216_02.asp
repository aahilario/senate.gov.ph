...
<title>Farewell Call from Outgoing Chinese Ambassador</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 16, 2013<p style="text-align: center;">
		<img src="1216_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->FAREWELL CALL FROM OUTGOING CHINESE AMBASSADOR:</strong>
		<!-- PhotoCaption.start -->
	    Senate President Franklin M. Drilon receives outgoing Chinese Ambassador to the Philippines Ma Keqing when the envoy made her farewell call at Drilon's residence in Greenhills, San Juan last night, December 15. Assigned to the Philippines since 2012, Ma had served as China's ambassador amid heightened territorial issues and security concerns between the two Asian countries. (PRIB photo by Cesar Tomambo)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
