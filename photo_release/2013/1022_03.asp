...
<title>Priority Labor Measures</title>
...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->October 22, 2013<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2013/1022_03.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->PRIORITY LABOR MEASURES:</strong>
		<!-- PhotoCaption.start -->
		Senator Jinggoy Ejercito Estrada, Chairman of the Committee on Labor, Employment and Human Resources Development, listens in as the officials from the Department of Labor and Employment discuss key legislative proposals of the administration. In the organizational meeting, the DOLE identified three priority measures for the 16th Congress, namely the Apprenticeship Bill, Strengthening the Public Employment Service Office (PESO) and the proposed Magna Carta for Seafarers. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
