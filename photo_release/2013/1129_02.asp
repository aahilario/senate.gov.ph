...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1129_02.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->BRUSSELS, BELGIUM:</strong>
		<!-- PhotoCaption.start -->
		Senator Loren Legarda delivering her acceptance speech for the Award on Closing the Gender Gap (winner in South and Southeast Asia)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
