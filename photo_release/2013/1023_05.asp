...
<title>DBM budget hearing</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1023_05.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->DBM BUDGET HEARING:</strong>
		<!-- PhotoCaption.start -->
		Finance Committee Chair, Senator Francis “Chiz” Escudero, talks Department of Budget and Management (DBM) Secretary Butch Abad and Metropolitan Manila Development Authority (MMDA) Chair Francis Tolentino before the start of a hearing looking into the proposed 2014 budget of the DBM and its attached agencies Wednesday, October 23. (PRIB Photo by Alex Nuevaespaña)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
