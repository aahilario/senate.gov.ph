...
<table id="container">
	<tr>
		...
		<!-- PhotoDate.start -->December 12, 2013<p style="text-align: center;">
		<img src="http://senate.gov.ph/photo_release/2013/1212_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->COMMITTEE HEARING:</strong>
		<!-- PhotoCaption.start -->
		Senator Antonio Trillanes IV, Chair of the Senate Committee on Civil Service and Government Reorganization, conduct a hearing looking into proposed Senate Bill No. 1708, which seeks to establish the Maritime Industry Authority (MARINA) as the single maritime administration responsible for the enforcement of international agreements/covenants governing maritime global professionals. (PRIB Photo by Alex Nuevaespana/10 December 2013)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
