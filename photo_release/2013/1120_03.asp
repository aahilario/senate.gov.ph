...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1120_03.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->DEFENSE BUDGET:</strong>
		<!-- PhotoCaption.start -->
		Senator Loren Legarda is briefed by Department of National Defense (DND) Secretary Voltaire Gazmin and Armed Forces of the Philippines (AFP) Chief-of-Staff General Emmanuel Bautista during budget deliberations Wednesday, November 20. (PRIB Photo by Joseph Vidal)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
