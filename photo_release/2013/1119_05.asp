...
<title>Start of budget deliberations</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1119_05.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->START OF BUDGET DELIBERATIONS:</strong>
		<!-- PhotoCaption.start -->
		Senator Bam Aquino welcomes Budget Secretary Florencio Abad before the start of budget deliberations Tuesday, November 19. According to Finance Committee chair Sen. Francis “Chiz” Escudero, next year’s proposed budget of P2.264 trillion is P3.2 billion lower than the proposed P2.268 trillion by Malacañang. The cut in the budget represents the P3-billion Priority Development Assistance Fund (PDAF) or “pork barrel” funds of 15 senators who gave up their P200-million allocation each next year and another P200-million PDAF from Vice President Jejomar Binay’s office. (PRIB Photo by Cesar Tomambo)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
