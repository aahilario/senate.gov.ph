...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1209_05.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->COMMITTEE HEARING:</strong>
		<!-- PhotoCaption.start -->
		Senator Bongbong Marcos talks to Tacloban City Mayor Alfred Romualdez and Leyte Representative Martin Romualdez before the start of a Congressional Oversight Committee hearing on the Philippine Disaster Risk Reduction and Management Act of 2010, Monday, December 9. (PRIB Photo by Romy Bugante)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
