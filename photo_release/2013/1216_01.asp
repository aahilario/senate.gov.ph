...
<title>Farewell Token for Outgoing Chinese Ambassador</title>
...
<table id="container">
	<tr>
		...
		<p><strong>
		<!-- PhotoTitle.start -->FAREWELL TOKEN FOR OUTGOING CHINESE AMBASSADOR:</strong>
		<!-- PhotoCaption.start -->
	    Senate President Franklin M. Drilon hands a farewell gift over to outgoing Chinese Ambassador to the Philippines Ma Keqing during the envoy's farewell call at Drilon's residence in Greenhills, San Juan last night, December 15. Assigned to the Philippines since 2012, Ma had previously served as an ambassador to Finland and as an official in China's Ministry of Foreign Affairs. (PRIB photo by Cesar Tomambo)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
