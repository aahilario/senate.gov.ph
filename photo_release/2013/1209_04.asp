...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1209_04.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->COMMITTEE HEARING:</strong>
		<!-- PhotoCaption.start -->
		Senator Antonio Trillanes IV and Muntinlupa City Representative Rodolfo Biazon preside over a Congressional Oversight Committee hearing on the Philippine Disaster Risk Reduction and Management Act of 2010, Monday, December 9. Tacloban City Mayor Alfred Romualdez also attended the hearing.  (PRIB Photo by Alex Nuevaespaña)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
