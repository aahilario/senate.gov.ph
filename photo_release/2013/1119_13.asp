...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1119_13.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->DOT BUDGET:</strong>
		<!-- PhotoCaption.start -->
		Senate President Frank Drilon and Sen. JV Ejercito congratulate Tourism Secretary Ramon Jimenez after the approval of the Department of Tourism’s budget for the year 2014, Tuesday afternoon. (PRIB Photo by Alex Nuevaespana)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
