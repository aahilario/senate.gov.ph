...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1121_09.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->MARIBOJOC, BOHOL:</strong>
		<!-- PhotoCaption.start -->
		Sen. Nancy Binay meets with the residents of Maribojoc, Bohol one month after the 7.2 magnitude earthquake struck the town. After Super Typhoon "Yolanda," ravaged the town recently, the senator returned last week and pledged that she will help in the rehabilitation and reconstruction efforts in the town. </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
