...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1203_01.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->PERYA NI ANDRES:</strong>
		<!-- PhotoCaption.start -->
		Sen. Nancy Binay watches students of the Philippine High School of the Arts (PHSA) perform the Ela Hai at the opening ceremonies of the Perya ni Andres at the Museo Pambata last November 30.</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
