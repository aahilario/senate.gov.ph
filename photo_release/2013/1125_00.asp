...
<title>Enrile greets Roxas</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1125_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->ENRILE GREETS ROXAS:</strong>
		<!-- PhotoCaption.start -->
		Senate Minority Leader Juan Ponce Enrile greets Interior and Local Government Secretary and former Senator Mar Roxas before the start of budget deliberations for the Department of Interior and Local Government, Monday morning. (Photo by Joe Arazas)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
