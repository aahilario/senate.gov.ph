...
<title>Napoles Attends Senate Probe</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1107_00.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->NAPOLES ATTENDS SENATE PROBE:</strong>
		<!-- PhotoCaption.start -->
		Janet Lim Napoles arrives at the Senate for the Blue Ribbon Committee hearing on the alleged P10 billion Priority Development Assistance Fund (PDAF) scam, which reportedly involves her group and several legislators. (PRIB Photo by Albert Calvelo/7 November 2013) </p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
