...
<title>Prioritizing labor measures</title>
...
<table id="container">
	<tr>
		...
		<img src="http://senate.gov.ph/photo_release/2013/1023_07.jpg" class="style1" /></p>

		<p><strong>
		<!-- PhotoTitle.start -->PRIORITIZING LABOR MEASURES:</strong>
		<!-- PhotoCaption.start -->
		Senator Jinggoy Estrada talks to Senate reporters before the start of the plenary session Wednesday, October 23. Estrada had earlier vowed to push for the passage of several priority measures of the administration as identified by the Department of Labor and Employment (DOLE). These measures include the Apprenticeship Bill; the Bill Strengthening the Public Employment Service Office (PESO); and the proposed Magna Carta for Seafarers. (PRIB Photo by Cesar Tomambo/23 October 2013)</p>
		</td>
		<td id="sidepane">
		<div id="sidepane_l2">
		</div>
