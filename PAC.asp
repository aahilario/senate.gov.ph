...
<title>Public Assistance Center (PAC) - Senate of the Philippines</title>
...
<table id="container">
	<tr>
		...
		<p class="h1_bold">Public Assistance Center (PAC)</p>
		<p class="auto-style3">Online Medical Assistance</p>
		<div class="pubitem">
			<div class="alight">
				<p>
			<table class="publist">
		...
		<!-- <p class="h3_uline">Report No. 1 on Implementation of Republic Act No. 11469</p>
				<div class="pubitem"><div class="alight">
				<ul>
				<li>			
					 
					<a href="PRRD_Report.pdf">			
					<span>Report to the Joint Congressional Oversight Committee on the implementation of Republic Act No. 11469</span>
					</a>
					</li>

				</div></div>

		<p class="h3_uline">Comments and Reactions of Senators on the Implementation of Republic Act 11469   </p>
				<div class="pubitem"><div class="alight">
				<ul>
				
				
					<li>
					<a href="press_release/2020/0402_cayetano1.asp">
					<span>Sen. Pia Cayetano</span>
					</a></li>
					<li>
					<a href="press_release/2020/0401_lacson1.asp">
					<span>Sen. Ping Lacson</span>
					</a></li>
					<!--<li>
					<span>Sen. Bong Go</span>
					</li>
					<li>
					<a href="press_release/2020/0402_drilon1.asp">
					<span>Sen. Franklin Drilon</span>
					</a></li>
					<li>
					<a href="press_release/2020/0401_pangilinan1.asp">
					<span>Sen. Kiko Pangilinan</span></a></li>-->
					
				</div></div>

		<p class="auto-style7">
		I<span class="auto-style8">n line with the Senate’s efforts to bring efficient service to the constituents despite the  
situation brought about by the COVID-19 pandemic,  submission of medical assistance requests  will be through online.
		</span>
		<p class="auto-style5">
		<span class="auto-style6">Kindly fill out the form provided. Attach the modified documentary requirements with  necessary attachments:</span>
		<span class="auto-style8"><em>(</em><a href="PAC_Form.pdf"><em>download 
		form here</em></a></span>)<p class="auto-style4">
		<span class="auto-style10">1.	Personal letter to the Senator 
</span>
		<p class="auto-style4">
		<span class="auto-style10">2.	Medical Certificate or Clinical Abstract 
		<br />
		</span>
		<p class="auto-style4">
		<span class="auto-style10">3.	Quotation of medicines / hospital bills 
		</span>
		<p class="auto-style4">
		<span class="auto-style10">4.	Copy of Patient’s ID and Representative’s ID 
 
        </span>
		<ul>
			<li>
			<p class="auto-style4"><span class="auto-style2">Must be a patient of the requested hospital 
			(Government hospitals only).
			</span></li>
		</ul>
		<p class="auto-style4">
		<span class="auto-style2">Send it through email at 
 
		<a href="mailto:pac@senate.gov.ph">pac@senate.gov.ph</a></span><p class="auto-style4">
		<span class="auto-style2">Senators with Medical Assistance: </span>
		<p class="auto-style9">
		<span class="auto-style2">a)	Office of Senator Juan Edgardo “Sonny” M. Angara<br />
		b)	Office of Senator Pia S. Cayetano <br />
		c)	Office of Senator Ronald “Bato” M. dela Rosa <br />
		d)	Office of Senator Franklin M. Drilon <br />
		e)	Office of Senator Win Gatchalian <br />
		f)	Office of Senator Christopher Lawrence T. Go <br />
		g)	Office of Senator Manuel “Lito” M. Lapid <br />
		h)	Office of Senator Imee R. Marcos<br />
		i)	Office of Senator Emmanuel “Manny” D. Pacquiao <br />
		j)	Office of Senator Aquilino “Koko” Pimentel III <br />
		k)	Office of Senator Grace Poe-Llamanzares <br />
		l)	Office of Senator Ramon Bong Revilla, Jr. <br />
		m)	Office of Senator Vicente C. Sotto III <br />
		n)	Office of Senator Francis “Tol” N. Tolentino <br />
		o)	Office of Senator Juan Miguel “Migz” F. Zubiri <br />
		&nbsp;<br />
		</span>
		<p class="auto-style4">
		<span class="auto-style2"><em>Drop box situated at the Senate entrance gate is also provided for those who do not have their email address.
		</em></span> 
<br />
